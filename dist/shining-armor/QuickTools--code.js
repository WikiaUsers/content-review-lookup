...
(function (window, $, mw) {
    ...
    if ( skin === 'oasis' || skin === 'wikia' ) {
        ...
        $('.global-navigation a[data-id="start-wikia"] span').html($(node));
        $('.global-navigation a[data-id="start-wikia"] span').parent().removeAttr("href");
    } else {
    ...
    //Main menu modal
    function mainMenu() {
        $.showCustomModal("Advanced Tools", '<form class="WikiaForm" method="" name=""><fieldset><div style="text-align: center;"><a class="wikia-button" id="at-block">Block user</a>&nbsp;<a class="wikia-button" id="at-delete">Delete page</a>&nbsp;<a class="wikia-button" id="at-move">Move page</a>&nbsp;<a class="wikia-button" id="at-protect">(Un)Protect page</a>&nbsp;<a class="wikia-button" id="at-purge">Purge page</a><br><br><a class="wikia-button" id="at-redirect">Redirect page</a>&nbsp;<a class="wikia-button" id="at-redlinks">Remove redlinks</a>&nbsp;<a class="wikia-button" id="at-switch">Switch skin</a>&nbsp;<a class="wikia-button" id="at-template">Add template</a>&nbsp;<a class="wikia-button" id="at-unsigned">Add unsigned</a>&nbsp;<a class="wikia-button" id="at-batch">Batch delete</a></div></fieldset><br /><h6 style="float:left;color:red;">WARNING: This version of advanced tools is set to be removed January 15, 2015!</h6></form>', {
            id: "advancedtools",
            width: 650,
            buttons: [{
                id: "close-menu",
    ...
    mw.loader.load('http://dev.wikia.com/wiki/ListFiles/code.js?action=raw&ctype=text/javascript');
