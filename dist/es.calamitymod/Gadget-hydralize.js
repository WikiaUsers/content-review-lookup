...
var l10n = (function(){
	var data = {
		en: { // This works for both English and Spanish
			watchlist: 'Mi lista de seguimiento', // in my account droplist
			view: 'Ver', // in right tabs
			more: 'Más', // in right tabs
			share: 'Compartir', // in left tabs
			pagetools: 'Herramientas', // in sidebar, section heading
			whatlinkshere: 'Lo que enlaza aquí',
			'cargo-pagevalues': 'Valores de la página', //in sidebar, under "Page Tools"
			'recentchangeslinked': 'Cambios enlazados', //in sidebar, under "Page Tools"
			'log': 'Logs',
			searchText: 'Buscar en '+mw.config.get('wgSiteName'), //placeholder for search box
			searchGo: 'Ir', //text for search button in search box 
			searchGoTitle: 'Ir a una página con este nombre exacto si existe', //hover text for search button
