...
////////////////////////////////////////////////////////////////////////////////////////////
 ...
 e = document.getElementById('WikiaMainContent');
...
ajaxPages = ["!@#$%* Wiki:RecentChanges","Special:RecentChanges"];
...
function mainPageRenameNamespaceTab() {
        try {
                ...
                if ( Node.textContent ) {      // Per DOM Level 3
                        Node.textContent = '!@#$%* Wiki';
                } else if ( Node.innerText ) { // IE doesn't handle .textContent
                        Node.innerText = '!@#$%* Wiki';
                } else {                       // Fallback
                        Node.replaceChild( Node.firstChild, document.createTextNode( '!@#$%* Wiki' ) ); 
                }
        } catch(e) {
                // bailing out!
        }
...
function npage() {
 ...
 document.getElementById('dynamic-links-write-article-link').setAttribute('href', 'http://!@#$%*.wikia.com/index.php?title='+newq+'&action=create');
}
