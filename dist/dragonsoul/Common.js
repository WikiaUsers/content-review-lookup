...
/*
 * Stash42 2016-09-01 11:25:27
 * ===========================
 * Put table header cells into a thead for tables with class .datatables.
 * Thanks to http://community.wikia.com/wiki/User:TK-999
 * http://community.wikia.com/wiki/Thread:1096520#4
 */

Array.prototype.slice.call(document.getElementsByClassName('datatable')).forEach(function(table) {
	var thead = document.createElement('thead'),
		row = document.createElement('tr'),
		headers = Array.prototype.slice.call(table.getElementsByTagName('th'));
