...
$(function() {
	...
	$('.module_content #stdSummaries').css({"background-color": '#bedaf3'});
	$('.module_content #stdSummaries').css({"color": '#3a3a3a'});
	$('.module_content #stdSummaries').css({"border": '1px solid #7eb4e7'});
