...
*/
window.bodyContentId = 'mw-content-text';
...
importScriptPage('MediaWiki:Common.js/Clases/LazyLoadVideo.js');
//</pre>
 ...
 ****************************************************************************/
$(function(){
    var icons = document.getElementsByClassName('titleicon');
    if (icons.length > 0) {
        $('<section class="railModule rail-module" id="artcle-info"><h2>Información del artículo</h2><section id="article-info-icons"></section></section>').appendTo('#WikiaRail');
        var artinf = document.getElementById("article-info-icons");
        var j = icons.length;
