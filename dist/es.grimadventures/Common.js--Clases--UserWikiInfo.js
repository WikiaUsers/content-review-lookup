...
(function($) {
	...
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/Severo y Malvado Wiki:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Severo y Malvado Wiki:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Severo y Malvado Wiki:Reversores">reversor</a>',
		asistente: '<a href="/wiki/Severo y Malvado Wiki:Asistentes">asistente</a>',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
