    ...
    $('.minute-filter').each(function(){
        $(this).click(function() {
			...
			if ($(this).attr('data-status') == 'Hide') {
            	$('.mw-collapsible.mw-collapsed.' + toggleclass).each(function() {
            		$(this).css('display', '').removeClass('mw-collapsed');
            	});
            	$(this).attr('data-status','Show');
            }
            else {
            	$('.mw-collapsible.' + toggleclass + ':not(.mw-collapsed)').each(function() {
            		$(this).css('display', 'none').addClass('mw-collapsed');
            	});
            	$(this).attr('data-status','Hide');
            }
            $('.mw-collapsible:not(.mw-collapsed):not(.' + toggleclass + ')').each(function() {
            		$(this).css('display', 'none').addClass('mw-collapsed');
            });
