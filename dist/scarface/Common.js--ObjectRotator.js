...
$(document).ready(function() {
    if(wgCategories.indexOf("3D Enabled") > -1) {
        $("img.pi-image-thumbnail").first().replaceWith("<div id=\"object-rotator\"><img src=\"http://scarface.fandom.com/wiki/Special:FilePath/3Ddef.png?width=214px\" style=\"position: absolute; bottom: 0; left: 0; opacity: 0.1\" /></div>");
        $("#object-rotator").css("background-image", "url(\"http://scarface.fandom.com/wiki/Special:FilePath/" + wgPageName + "_3D.png\")");
