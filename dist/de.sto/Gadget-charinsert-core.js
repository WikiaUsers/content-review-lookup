...
jQuery( document ).ready( function ( $ ) {
    var EditTools = {
        ...
        charinsert: {
            'Insert': ' – — ° ′ ″ ≈ ≠ ≤ ≥ ± − × ÷ ← → · §  ␥Sign_your_posts_on_talk_pages: ␥~~\~~  Zitieren_Sie_Ihre_Quellen: <ref>+</ref>',
            'Wiki markup': 'Einfügen:  – — ° ′ ″ ≈ ≠ ≤ ≥ ± − × ÷ ← → · § ␥~~\~~ <ref>+</ref>  Wiki_markup:  {\{+}}  {\{\{+}}}  |  [+]  [\[+]]  [\[Kategorie:+]]  [\[Datei:+]]  {\{#ev:youtube|+}}  #WEITERLEITUNG.[\[+]]  &nb'+'sp;  <s>+</s>  <sup>+</sup>  <sub>+</sub>  <code>+</code>  <pre>+</pre>  <blockquote>+</blockquote>  <ref.name="+"_/>  {\{#tag:ref|+|group="nb"|name=""}}  {\{Reflist}}  <references./>  <includeonly>+</includeonly>  <noinclude>+</noinclude>  {\{DEFAULTSORT:+}}  <nowiki>+</nowiki>  <!--.+_-->  <span.class="plainlinks">+</span>',
        ...
        createEditTools: function ( placeholder ) {
            ...
            box.title = 'Klicke auf das Zeichen oder den Tag um es in das Bearbeiten-Fenster einzufügen';
