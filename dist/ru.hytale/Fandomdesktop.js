/**
* Размещаемый ниже код JavaScript применяется к основной теме внешнего вида Фандома (FandomDesktop) у всех пользователей и посетителей настольной версии вики.
* Для кода обеих настольной и мобильной версий вики см. MediaWiki:Global.js.
...
/* Следите за делегированными событиями в изменчивом содержии */
...
mw.notify( 'Очистка не пройдена', { type: 'error' } );
} );
...
/* Делает окно предложений поиска отдельно стилизованным */
mw.loader.using( 'mediawiki.searchSuggest', function() {
$( '.suggestions:first' ).addClass( 'searchbar' );
} );


/* Установка значения 'Без творцовского права' в качестве творцовского права по умолчанию на страницах файлов.*/
