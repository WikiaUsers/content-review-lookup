...
$( function() {
	var i18n = {
		autopatrolled: 'Отпатрулирована автоматически',
		// $1 is the user, $2 is the timestamp
		patrolled: 'Отпатрулирована $1 ($2)',
		unpatrollable: 'Не может быть отпатрулирована',
		unpatrolled: 'Не отпатрулирована',
		autopatrolledLegend: 'автоматически отпатрулированная правка',
		patrolledLegend: 'отпатрулированная правка',
		unpatrollableLegend: 'правка, которая не может быть отпатрулирована',
		unpatrolledLegend: 'неотпатрулированная правка',
		error: 'Не удалось получить информацию о статусе патрулирования правки',
		rightsError: 'Не удалось получить информацию о наличии у участника прав автопатрулируемого',
