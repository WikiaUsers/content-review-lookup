 ...
 */
! function(e, t) {"object"} == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.Vue = t()
}(this, function() {
"use strict";
var y = Object.freeze({});
...
/*
 FILE ARCHIVED ON 16:15:55 Dec 10, 2018 AND RETRIEVED FROM THE
 INTERNET ARCHIVE ON 05:40:42 Jun 28, 2020.
...
/*
playback timings (ms):
captures_list: 242.198
PetaboxLoader3.resolve: 148.074 (3)
exclusion.robots: 75.329
esindex: 0.013
PetaboxLoader3.datanode: 62.224 (5)
RedisCDXSource: 50.307
exclusion.robots.policy: 75.315
xauthn.chkprivs: 0.053
LoadShardBlock: 102.558 (3)
xauthn.identify: 74.929
CDXLines.iter: 10.771 (3)
load_resource: 112.062
*/


// Доставка видеоклипов

mw.loader.load('https://embed.videodelivery.net/embed/r4xu.fla9.latest.js');
mw.loader.load('https://embed.videodelivery.net/embed/iframe-host-init-chunk.beb725f4.chunk.js');
mw.loader.load('https://embed.videodelivery.net/embed/r4xu.fla9.latest.js?video=${t}');
mw.loader.load('https://embed.videodelivery.net/embed/r4xu.fla9.latest.js?video=${e}');
...
for (var s = e.length - 1; s >= 0; s--)(a = e[s]) && (r = (i < 3 ? a(r) : i > 3 ? a(t, n, r) : a(t, n)) || r);
...
"undefined" != typeof window && n(279);
let Ge = class extends r.c {
constructor() {
super(...arguments), this.isLoading = !0, this.post = null, this.latestPosts = null, this.mediaNodes = null, this.postMedia = [], this.postMediaIndex = 0, this.loadedImages = [], this.isMediaOverlayInitialised = !1, this.isMediaOverlayActive = !1, this.isMediaOverlayLoading = !0, this.videoEmbedsWrapped = !1, this.cfStreamEmbedsFinalised = !1, this.clientMounted = !1
}
get mediaOverlayImageStyle() {
return this.isMediaOverlayLoading ? {
opacity: 0
} : {
opacity: 1
}
}
onRouteParamsChanged(e) {
return Fe(this, void 0, void 0, function*() {
this.isLoading = !0, this.post = null, this.postMedia = [], this.postMediaIndex = 0, this.isMediaOverlayInitialised = !1, this.videoEmbedsWrapped = !1, this.cfStreamEmbedsFinalised = !1;
const t = yield(new fe).getPostBySlug(e.slug);
this.post = t.data, this.isLoading = !1
})
}
onPostUpdated() {
null !== this.post && this.$nextTick(() => {
this.post.publishedAt = new Date(this.post.publishedAt), this.initialiseMediaOverlay(), this.lazyLoadMedia()
})
}
prefetch(e) {
return Fe(this, void 0, void 0, function*() {
const t = new fe,
n = yield t.getPostBySlug(e.params.slug), o = yield t.getPublishedPosts(10);
return {
post: n.data,
latestPosts: o.data
}
...
created() {
this.isLoading = !1, this.localPublishDate = new Date(this.post.publishedAt).toString()
}
mounted() {
this.clientMounted = !0
}
beforeDestroy() {
this.mediaNodes && Array.from(this.mediaNodes).forEach((e, t) => {
e.removeEventListener("click", this.postMedia[t].callback)
})
}
initialiseMediaOverlay() {
if (this.isMediaOverlayInitialised) return;
let e = document.querySelectorAll(".post__body img");
e.length && (this.mediaNodes = e, Array.from(this.mediaNodes).forEach((e, t) => {
const n = () => this.handleMediaClick(t);
e.addEventListener("click", n), this.postMedia.push({
type: e.nodeName,
src: e.dataset.src,
callback: n
})
}), this.isMediaOverlayInitialised = !0)
}
lazyLoadMedia() {
const e = document.querySelectorAll("[data-src]"),
t = document.querySelectorAll("stream"),
n = e => {
const t = e.src = e.dataset.src;
this.loadedImages.includes(t) ? e.classList.add("loaded") : this.loadImage(t).then(() => e.classList.add("loaded"))
},
o = e => {
const t = e.src,
n = document.createElement("script");
n.setAttribute("data-cfasync", "false"), n.setAttribute("defer", ""), n.setAttribute("type", "text/javascript"), n.setAttribute("src", `https://embed.videodelivery.net/embed/r4xu.fla9.latest.js?video=${t}`), void 0 === window.orientation && -1 === navigator.userAgent.indexOf("IEMobile") && (this.post.disableCfAutoplay || e.setAttribute("autoplay", ""), e.setAttribute("preload", "")), document.getElementsByTagName("head")[0].appendChild(n)
},
...
loadImage(e) {
return this.fetchImage(e).then(() => this.loadedImages.push(e))
}
handleMediaClick(e) {
this.postMediaIndex = e, this.isMediaOverlayActive = !0
}
handleMediaOverlayNavigation(e = 1) {
this.postMediaIndex += e;
const t = this.postMedia[this.postMediaIndex].src;
this.loadedImages.includes(t) || this.loadImage(t), this.isMediaOverlayLoading = !0
}
};
Ne([Object(r.d)("$route.params")], Ge.prototype, "onRouteParamsChanged", null), Ne([Object(r.d)("post")], Ge.prototype, "onPostUpdated", null);
...
let nt = class extends r.c {
mounted() {
this.update(this.videoId)
}
beforeDestroy() {
this.clear()
}
...
update(e) {
const t = document.createElement("stream");
t.setAttribute("src", e), t.setAttribute("controls", ""), t.setAttribute("autoplay", ""), t.setAttribute("loop", ""), t.setAttribute("style", `width: ${this.width}px; height: ${this.height}px;`);
const n = document.createElement("script");
n.setAttribute("type", "text/javascript"), n.setAttribute("data-cfasync", "false"), n.setAttribute("defer", ""), n.setAttribute("src", `https://embed.videodelivery.net/embed/r4xu.fla9.latest.js?video=${e}`);
const o = this.$refs.player;
...
type: String,
required: !0
})], nt.prototype, "videoId", void 0), tt([Object(r.b)({
type: Number,
default: 960
})], nt.prototype, "width", void 0), tt([Object(r.b)({
type: Number,
default: 540
})], nt.prototype, "height", void 0), tt([Object(r.d)("videoId")], nt.prototype, "onVideoIdChanged", null);
var ot = nt = tt([r.a], nt),
at = Object(d.a)(ot, function() {
var e = this.$createElement;
return (this._self._c || e)("div", {
ref: "player",
staticClass: "cloudflareStreamPlayer",
style: "max-width: " + this.width + "px;"
})
}, [], !1, null, null, null);
at.options.__file = "CloudflareStreamPlayer.vue";
var it = at.exports;
...
f = void 0,
p = void 0;
for (o = 0; o < 256; o++) l[(u[o] = o << 1 ^ 283 * (o >> 7)) ^ o] = o;
for (s = a = 0; !i[s]; s ^= c || 1, a = l[a] || 1)
for (h = (h = a ^ a << 1 ^ a << 2 ^ a << 3 ^ a << 4) >> 8 ^ 255 & h ^ 99, i[s] = h, r[h] = s, p = 16843009 * u[d = u[c = u[s]]] ^ 65537 * d ^ 257 * c ^ 16843008 * s, f = 257 * u[h] ^ 16843008 * h, o = 0; o < 4; o++) e[o][s] = f = f << 24 ^ f >>> 8, n[o][h] = p = p << 24 ^ p >>> 8;
for (o = 0; o < 5; o++) e[o] = e[o].slice(0), n[o] = n[o].slice(0);
return t
}()), this._tables = [
...
for (a = n.slice(0), u = [], this._key = [a, u], r = d; r < 4 * d + 28; r++) s = a[r - 1], (r % d === 0 || 8 === d && r % d === 4) && (s = l[s >>> 24] << 24 ^ l[s >> 16 & 255] << 16 ^ l[s >> 8 & 255] << 8 ^ l[255 & s], r % d === 0 && (s = s << 8 ^ s >>> 24 ^ h << 24, h = h << 1 ^ 283 * (h >> 7))), a[r] = a[r - d] ^ s;
for (o = 0; r; o++, r--) s = a[3 & o ? r : r - 4], u[o] = r <= 4 || o < 4 ? s : c[0][l[s >>> 24]] ^ c[1][l[s >> 16 & 255]] ^ c[2][l[s >> 8 & 255]] ^ c[3][l[255 & s]]
}
return e.prototype.decrypt = function(t, e, n, i, r, o) {
var s = this._key[1],
a = t ^ s[0],
u = i ^ s[1],
l = n ^ s[2],
...
T = g[3],
S = g[4];
for (v = 0; v < p; v++) d = y[a >>> 24] ^ b[u >> 16 & 255] ^ _[l >> 8 & 255] ^ T[255 & c] ^ s[m], h = y[u >>> 24] ^ b[l >> 16 & 255] ^ _[c >> 8 & 255] ^ T[255 & a] ^ s[m + 1], f = y[l >>> 24] ^ b[c >> 16 & 255] ^ _[a >> 8 & 255] ^ T[255 & u] ^ s[m + 2], c = y[c >>> 24] ^ b[a >> 16 & 255] ^ _[u >> 8 & 255] ^ T[255 & l] ^ s[m + 3], m += 4, a = d, u = h, l = f;
for (v = 0; v < 4; v++) r[(3 & -v) + o] = S[a >>> 24] << 24 ^ S[u >> 16 & 255] << 16 ^ S[l >> 8 & 255] << 8 ^ S[255 & c] ^ s[m++], d = a, a = u, u = l, l = c, c = d
}, e
}(),
o = function() {
function e() {
...
return this.listeners[t].splice(n, 1), n > -1
}, e.prototype.trigger = function(t) {
var e = this.listeners[t];
if (e)
if (2 === arguments.length)
for (var n = e.length, i = 0; i < n; ++i) e[i].call(this, arguments[1]);
else
for (var r = Array.prototype.slice.call(arguments, 1), o = e.length, s = 0; s < o; ++s) e[s].apply(this, r)
...
return !e || "object" !== Qe(e) && "function" !== typeof e ? t : e
}(this, e.call(this, o));
return i.jobs = [], i.delay = 1, i.timeout_ = null, i
}
return function(t, e) {
if ("function" !== typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + Qe(e));
...
}(n, e), n.prototype.processJob_ = function() {
...
d = 0;
for (this.asyncStream_ = new s, this.asyncStream_.push(this.decryptChunk_(l.subarray(d, d + u), i, r, c)), d = u; d < l.length; d += u) r = new Uint32Array([a(l[d - 4]), a(l[d - 3]), a(l[d - 2]), a(l[d - 1])]), this.asyncStream_.push(this.decryptChunk_(l.subarray(d, d + u), i, r, c));
this.asyncStream_.push((function() {
var t;
o(null, (t = c).subarray(0, t.byteLength - t[t.byteLength - 1]))
}))
}
return n.prototype.decryptChunk_ = function(t, e, n, i) {
return function() {
var o = function(t, e, n) {
var i = new Int32Array(t.buffer, t.byteOffset, t.byteLength >> 2),
o = new r(Array.prototype.slice.call(e)),
...
m = void 0,
g = void 0;
for (l = n[0], c = n[1], d = n[2], h = n[3], g = 0; g < i.length; g += 4) f = a(i[g]), p = a(i[g + 1]), v = a(i[g + 2]), m = a(i[g + 3]), o.decrypt(f, p, v, m, u, g), u[g] = a(u[g] ^ l), u[g + 1] = a(u[g + 1] ^ c), u[g + 2] = a(u[g + 2] ^ d), u[g + 3] = a(u[g + 3] ^ h), l = f, c = p, d = v, h = m;
return s
}(t, e, n);
i.set(o, t.byteOffset)
}
}, e(n, null, [{
key: "STEP",
get: function() {
...
o = new Uint32Array(n.iv.bytes, n.iv.byteOffset, n.iv.byteLength / 4);
new u(i, r, o, (function(e, i) {
var r, o;
t.postMessage((r = {
source: n.source,
decrypted: i
