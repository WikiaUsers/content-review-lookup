...
/* 
**    This file is a collection of reusable functions based on Wookieepedia.
**    For authors and source see: http://starwars.wikia.com/wiki/MediaWiki:Functions.js
*/
...
function substUsername() {
	$('.wgUserName').html(mw.config.get('wgUserName')
);
}
...
{
	//Oasis button
	$('.WikiaFooter .toolbar .tools > li:last-child').after('<li class="overflow"><a id="skin-preview" data-name="monobook" href="/index.php?title='+ encodeURIComponent(wgPageName)+ '&useskin=monobook" title="Diese Seite mit Monobook Skin" accesskey="s">Monobook</a></li>');
	//Monobook button
	$('div#p-cactions.portlet div.pBody ul li:nth-last-child(1)').after('<li id="ca-nstab-main" class="skinPreviewTab" style="margin:0 3px 0 36px"><a href="/index.php?title='+ encodeURIComponent(wgPageName) +'&useskin=wikia" title="Diese Seite mit Oasis Skin" id="skin-preview" accesskey="s">Oasis</a></li>');
}
