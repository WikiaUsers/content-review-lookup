/*<pre>*/
/* Add this line to prevent popup from home screen site loading */
if ( wgNamespaceNumber !=undefined && !window.appleapp ) {
	addOnloadHook( setappleapp );
}
 
var appleapp = true;
 
function setappleapp () {
    $('<meta name="apple-mobile-web-app-capable" content="yes">').insertBefore('head link[rel="apple-touch-icon"]');
}

/* Configurations that should be placed in MediaWiki:Common.js */
var addToHomeConfig = {
	animationIn: 'bubble',
	animationOut: 'drop',
	lifespan: 10000,
...
(function(){
	...
	options = {
		...
		startDelay: 20000, // 20 seconds
		lifespan: 20000, // 20 seconds
		bottomOffset: 14, // Distance of the balloon from bottom
		expire: 1440000, // (1440000) 24 Hours
		message: '',
