...
$(function(){
	...
	if (!newTitle) return;
	$(".firstHeading,#WikiaUserPagesHeader h1,#WikiaPageHeader h1").text().replace(mw.config.get('wgPageName'), newTitle);
	$(".#user_masthead_head h2").text().replace(mw.config.get('wgPageName'), newTitle);
});
