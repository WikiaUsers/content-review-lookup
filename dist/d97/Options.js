	...
	load: function() {
		...
		if (chatPlugins.loading) {
			...
			if( !$(".chatPluginsMenu.topiclink").length ) {
			    $("div.chattopic").append(' • <a href="#" id="chatPluginsButton" class="chatPluginsMenu topiclink"><img src="https://images.wikia.nocookie.net/__cb20140623220607/gamedezyner/images/b/bb/ChatPluginsButton.png" height="12px" class="optionsimage chattopic-icon" /> options</a>');
			}
