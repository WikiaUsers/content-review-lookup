...
importArticles({
    type: 'script',
    articles: [
        'w:c:pl.spongebob-polska:MediaWiki:Quiz.js'
    ]
});
importArticles({
    type: 'script',
...
function emptyLicenseAlert(form) {
	var msg = "Drogi mieszkańco Bikini Dolnego! Przesyłanie plików bez licencji jest karalne! W dodatku taki plik najprawdopodobniej będzie usunięty. Proszę, dodaj licencję."
