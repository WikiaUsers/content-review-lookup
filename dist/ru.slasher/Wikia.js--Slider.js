...
$('#slider1').click(function(){
	...
	if ($('#slider1').hasClass('closed') && $('#slider2').hasClass('opened') && $('#slider3').hasClass('opened')) {
		...
		$('#slider1').removeClass('closed').addClass('animated').animate({ width: "475px" }, "normal", "linear", function() {
		...
		$('#slider2').removeClass('closed').addClass('animated').animate({ width: "500px" }, "normal", "linear", function() {
		...
		$('#slider3').removeClass('closed').addClass('animated').animate({ width: "525px" }, "normal", "linear", function() {
...
function autoScroll() {
	if ($('#slider1').hasClass('opened') && $('#slider2').hasClass('opened') && $('#slider3').hasClass('opened')) {
		...
		$('#slider1caption').css({opacity: 0, visibility: "visible"}).animate({opacity: 1.0}, 500);
		$('#slider4arrow').css({opacity: 0, visibility: "visible"}).animate({opacity: 1.0}, 500);
		$('#slider4').removeClass('opened').addClass('animated').animate({ width: "548px" }, "normal", "linear", function() {
