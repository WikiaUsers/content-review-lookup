...
var chatOptions = {
	look: {
		...
		backgroundColor: getCookie("customisation", 0),
                modalIcon: "https://image.freepik.com/iconos-gratis/engranajes-mecanicos_318-80433.jpg"
	},
	modules: {
		chatHacks: {
			element: "#chatHacks",
		...
		multiKick: {
			...
			load: function () {
				...
				$('<a id="multiKickerButton" class="wikia-button" href="javascript:showPopup()" style="position:absolute; right:55px; top:22px;">Expulsar a todos</a>').appendTo('.Write'); // para prevenir que el botón no cargue
				this.loaded = true;
			}
		},
		multiPM: {
		...
		searchBar: {
			...
			loaded: false,
			load: function () {
				importScriptPage("MediaWiki:Searchbar.js","pintorkagamine");
				this.loaded = true;
			}
		},
		stopSideScroll: {
