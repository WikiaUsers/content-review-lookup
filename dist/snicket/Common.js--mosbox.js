...
$(function() {
	if(skin == "oasis") {
		$('#WikiaRail').bind('DOMNodeInserted', function(event) { //fires after lazy-loading takes place.  
			...
			var comboString ='<div style="background:none!important;margin-top:12px"><a class="twitter-timeline"  href="https://twitter.com/SnicketWiki">Tweets by @SnicketWiki</a></div>' +
