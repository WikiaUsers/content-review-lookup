...
if (navigator.info[0] == "Chrome") {
	...
	$('.Rail').prepend('<br><div id="partyTrigger" style="text-shadow: 0 0 5px gold; margin:auto; cursor: pointer; font-size:130%; font: black; bottom:4px; padding-bottom:2px; border-bottom: 1px solid #CCCCCC; width:90%;" align="center"><img src="https://i.imgur.com/7IAYwgt.png" width="18px"/>&nbsp;Botón del Mollete</div><br>'); // Prevent multiple buttons from being appended
    }
	console.log('ChatParty initialized');
}
else if (navigator.info[0] == "MSIE" && navigator.info[1] >= 10) {
	if (!$("#partyMenuButton").length) {
	$('.Rail').prepend('<br><div id="partyTrigger" style="text-shadow: 0 0 5px gold; margin:auto; cursor: pointer; font-size:130%; bottom:4px; padding-bottom:2px; border-bottom: 1px solid #CCCCCC; width:90%;" align="center"><img src="https://i.imgur.com/7IAYwgt.png" width="18px"/>&nbsp;Botón del Mollete</div><br>'); // Prevent multiple buttons from being appended
    }
	console.log('ChatParty initialized');
}
...
if (whiteLights === true) {
	...
	$('#ChatHeader .public').append('<a id="partyMenuButton"><span></span><div id="partyMenu" class="GlobalModule" style="display: none; text-shadow: none;"><form id="music" class="group" style="padding: 0 10px; font-size: 14px;"><p style="margin-bottom: -15px; font-weight: bold;">Música</p><label><input type="radio" id="option-1" name="music" value="option-1"' + checkSong1 + '/><span ' + glowSong1 + '">' + partyLinkText1 + '</span></label><label><input type="radio" id="option-2" name="music" value="option-2"' + checkSong2 + '/><span ' + glowSong2 + '">' + partyLinkText2 + '</span></label><label><input type="radio" id="option-4" name="music" value="option-4"' + checkSong4 + '/><span ' + glowSong4 + '">Apagada</span></label></form><form id="lights" class="group" style="padding: 0 10px; font-size: 14px; margin-top: 5px;"><p style="margin-bottom: -15px; font-weight: bold;">Luces</p><table><tr><td><label><input type="radio" id="colored" name="lights" value="colored"' + checkLights2 + '/><span ' + glowLights2 + '">Vistoso</span></label></td><td><label><input type="radio" id="white" name="lights" value="white"' + checkLights1 + '/><span ' + glowLights1 + '">Blanca</span></label></td><td><label><input type="radio" id="off" name="lights" value="off"' + checkLights3 + '/><span ' + glowLights3 + '">Apagada</span></label></td></tr></table></form><form id="skin" class="group" style="padding: 0 10px; font-size: 14px; margin-top: 5px;"><p style="margin-bottom: -15px; font-weight: bold;">Piel</p><table><tr><td><label><input type="radio" id="skinOriginal" name="skin" value="skinOriginal" checked /><span style="text-shadow: 0 0 5px white;">Original</span></label></td><td><label><input type="radio" id="skinGoku" name="skin" value="skinGoku" /><span>Son Gokū</span></label></td><td><label><input type="radio" id="skinBroly" name="skin" value="skinBroly" /><span>Vegetto y Broly</span></label></td></tr><tr><td><label><input type="radio" id="skinBlue" name="skin" value="skinBlue" /><span>Azul</span></label></td><td><label><input type="radio" id="skinGotenAndTrunks" name="skin" value="skinGotenAndTrunks" /><span>Goten y Trunks</span></label></td></tr></table></form></div></a>');
