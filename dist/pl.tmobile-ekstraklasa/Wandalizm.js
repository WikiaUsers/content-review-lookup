...
$(function() {
	...
	if(wgPageName=='T-Mobile Ekstraklasa Wiki:Wandalizmy') {
		var $div = $('#cvu_guide');
		var $form = $('<form />');
			...
			$div.empty().append($form);
                ...
                $("span").each(function() {
                    ...
                    if(this.id == 'cvu_remove' && this.className != 'zgłoś wandala') {
                        var $img1 = $("<img>").attr('src', 'http://images.wikia.com/runescape/images/f/fb/Yes_check.svg');
                        ...
                        var $img2 = $("<img>").attr('src', 'http://images.wikia.com/runescape/images/a/a2/X_mark.svg')
