...
(function () {
	if (mw.config.get("wgCanonicalSpecialPageName") == "Chat") {
		...
		var htmlContent = '<div id="messages" style="font-weight: bold; font-size: 11px; position: absolute; cursor: pointer; top: 5px; right: 190px;">' + textHeader + '<br /><span id ="count" style="font-size: 10px; color: #cc0000; display: none;">Loading...</span></div>';
		...
		function notify(json) {
			...
			var messageText = "You have " + (messagesNumber) + " unread message" + (messagesNumber > 1 || messagesNumber === 0 ? "s" : "") + ".";
