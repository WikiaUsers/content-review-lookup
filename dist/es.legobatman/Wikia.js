...
window.SkinNotification = {
	...
	render: function() {
		...
		var sn = $('<div data-type="100"><a class="sprite close-notification"></a>En junio 9 el lanzamiento del juego<a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'">Lego:DC Super Héroes</a>,no?,juégalo ya!.</div>');
...
"tagClose" : "\r| Sexo = \r| Especie = \r| Grupo = \r| Edad = \r| Serie = \r| Películas = \r| Doblaje = \r| Primera aparicion = \r| Habilidades = \r| Posesiones = \r| enlace_Wikipedia = \r\}\}",
"sampleText": ""};
...
"speedTip": "Insertar Plantilla:Personaje", 
"tagOpen" : "\{\{Personaje\r| nombre = ", 
"tagClose" : "\r| información = \r| Genero = \r| Apariciones = \r| Afiliaciones = \r| localización = \r| Nombre real = \r| }",
"sampleText": ""};