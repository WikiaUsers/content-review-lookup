...
(function(window, $, mw) {
    ...
    const buildCarousel = function() {
        $('.right-rail-carousel__wrapper').each(function() {
            ...
            const arrowSvg = '<svg viewBox="0 0 12 12" width="12" height="12"><path fill="currentColor" d="M11.707 3.293a.999.999 0 00-1.414 0L6 7.586 1.707 3.293a.999.999 0 10-1.414 1.414l5 5a.999.999 0 001.414 0l5-5a.999.999 0 000-1.414z"></path></svg>';
            
            $wrapper.html(
                '<div class="alice-carousel"><div class="alice-carousel__wrapper"><ul class="alice-carousel__stage"></ul></div>' +
                '<div class="alice-carousel__controls"><button class="alice-carousel__arrow arrow-prev">' + arrowSvg + '</button>' +
                '<button class="alice-carousel__arrow arrow-next">' + arrowSvg + '</button></div></div>'
            );
