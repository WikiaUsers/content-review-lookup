 ...
 */
var chatTopic = 'ESTUDIANTE:<br>Por favor lee las reglas antes de chatear :D';
...
setInterval(function () {
    ...
    $('.User.chat-mod .username').each(function () {
        if (this.innerHTML.match(/Ailourophile|AnimatedCartoons|Gumballamiyumi|InvaderrrZIM|Killer365|StickVentures720/)) {
            $(this).parent().addClass('admin').removeClass('chat-mod');
        }
        if (this.innerHTML.match(/SKYNX|MegaSonicX4/)) {
...
var night_button = 'Switch to Night Chat',
    ...
    foregroundColorDay = 'url("https://images.wikia.nocookie.net/fusionfall/images/8/8c/Chatbackground.png")',

    // User stats foreground color
    userStatsColorDay = 'url("https://images.wikia.nocookie.net/fusionfall/images/2/2d/Searchlist2.png")',
