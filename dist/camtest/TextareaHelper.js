/** <nowiki>
 * jquery.textareaHelper module
 *
 * @source <https://github.com/Codecademy/textarea-helper/blob/master/textarea-helper.js>
 * @author Amjad Masad <amjad.masad@gmail.com>
 * @license MIT <http://opensource.org/licenses/MIT>
 *
 * Loaded as a ResourceLoader module using mw.loader
 * Last updated: 2013-10-20
 */

/*
  To load this as a module:
...
;( function ( $, mw ) {
    ...
    mw.loader.using( [ 'mediawiki.api', mediawiki.util, 'jquery.textareaHelper' ], function () {
        $( foo.init );
    } );
