// Texts now in English, copy of code MediaWiki:Autobarcode/code.js
...
var TEXTA = 'Documented text parallels by page. Number of pages found in ';
var TEXTB = 'Pages not counted'
var TEXTC = 'Page with text parallel'
var TEXTD = 'more than 50 % of the page'
var TEXTE = 'more than 75 % of the page'
...
function generateCaption(svg, prefix)
{
	...
	headString = TEXTA + reference[prefix] + ": " + numPlagPages + ", i. e. " + plagPercent + " %";
	...
	var t = texts.string('Page numbers').span('Version: ' + TIMESTRING, {dx: BETWEENTEXTSPACE }).span('Source: vroniplag.wikia.org/de/wiki/' + prefix, {dx: BETWEENTEXTSPACE});
...
function addMouseHandler(div, prefix, stroke, svg)
{
	...
	div.bind('click', function (event) {
		...
		if(DEBUGLEVEL >= 2)
			console.log('https://vroniplag.wikia.com/de/wiki/' + prefix + page + ' (' + (event.pageX - div.offset().left - LEFTRIGHTMARGIN) + ', ' + (event.pageY - div.offset().top - HEADER) + ', ' + stroke + ')');
