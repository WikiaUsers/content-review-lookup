/** <pre>
 * Script para valorar artículos
 * Por: [[User:Cqm]]
 * @notes Requieren filtros antiabusos para funcionar
 */
        ...
        self = {
                                ...
                                $( '<div>' )
                                    ...
                                    .append(
                                        $( '<textarea>' )
                                            .attr( {
                                                'id': 'ar-comment',
                                                'placeholder': 'Añade tus comentarios y sugerencias aquí.',
                                                'maxlength': 2000
                                            } ),
                                        $( '<input>' )
                                            .attr( {
            ...
            submitFeedback: function () {
                ...
                var rating = $( '#ar-rating' ).attr( 'data-rating' ) || '-1',
                    ...
                    params = {
                        action: 'edit',
                        title: 'Un Show Más Wiki:Feedback/' + mw.util.wikiUrlencode( conf.wgPageName ),
                        text: toSubmit,
