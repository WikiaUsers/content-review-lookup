...
$(function () {
  if ($('.mw-collapsible').length > 1) {
    // if there's more than one collapsible element
    //   simulate a click to collapse uncollapsed autocollapse elements
    $('.mw-collapsible.mw-autocollapse:not(.mw-collapsed)').each(function (i, el) {
