...
$(function () {
    ...
    var $talkLink = $actionsDropdown.find('#ca-talk').clone(true).attr("id", null);
    ...
    // separate the talk edit count
    var labelParts = $talkLink.text().trim().match(editCountBrackets);
    var $editCount = $('<span class="dedicated-talk-button_edit-count">');
    mw.util.addCSS('.dedicated-talk-button_edit-count { display: inline; padding-inline-start: 0.5ch; }');
    if (labelParts) {
