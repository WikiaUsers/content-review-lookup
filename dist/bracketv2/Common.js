...
var blogID = '2146'; // What is the bracket blog ID?
...
var bracketEntries = {
    ...
    'submit': [{
        'buttonText': 'Submit your bracket', // What should the submit button say?
        'submitText': 'Are you happy with your current selections? If so, click the button below to "submit" your bracket. If not, click the arrow to the left and revisit your picks.' // What should the text accompanying the submit button say?
    }]
...
var highestNumber = 0;
var bracketTemplate = '{{' + templateName;
                    ...
                    callAPI({
                            ...
                            callAPI({
                                ...
                                if (response.edit.result == 'Success') {
                                    $.ajax({
                                        ...
                                        window.location.replace(wgServer + '/wiki/' + blogTitle + '?bracketSubmit=' + submittedMessage + '&bracketLink=' + pageName + '#comm-text-' + match[1]);
                                    });
                                } else {
                                    $('.createbracket .loader').css('display', 'none');
                        ...
                        // If so, update the bracket page and redirect to the blog
                            ...
                            callAPI({
                                ...
                                if (response.edit.result == 'Success') {
                                    $('.createbracket .loader').css('display', 'inline');
                                    window.location.replace(wgServer + '/wiki/' + blogTitle + '?bracketSubmit=' + editMessage + '&bracketLink=' + pageName);
                                } else {
                                    $('.createbracket .loader').css('display', 'none');
                                    $('.result').text(genericErrorMessage);
                                    $(that).removeAttr('disabled');
