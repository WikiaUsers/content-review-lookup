...
(function($, mw) {
	...
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/Wiki_Kenichi_El_discipulo_mas_fuerte:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Wiki_Kenichi_El_discipulo_mas_fuerte:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Wiki_Kenichi_El_discipulo_mas_fuerte:Reversores">reversor</a>',
		asistente: '<a href="/wiki/Wiki_Kenichi_El_discipulo_mas_fuerte:Asistentes">asistente</a>',
		bot: '<a href="/wiki/Wiki_Kenichi_El_discipulo_mas_fuerte:Bots">bot</a>',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
