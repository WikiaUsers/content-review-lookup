...
function initDiscordModule() {
    ...
    var discordJSON = "https://discordapp.com/api/servers/295912168992407554/embed.json";
            ...
            '<tbody>' +
                '<tr>' +
                    '<td style="vertical-align:middle; width:100%;">' +
                        '<p class="chat-name">' +
                            '<a href="https://ru.wikipedia.org/wiki/Discord" target="_blank">Discord</a> – бесплатный мессенджер для публичного общения вне Фэндома. <b>Подробнее <a href="http://ru.supermeatboy.wikia.com/wiki/Шаблон:Discord" target="_blank">тут</a></b>' +
                        '</p>' +
                    '</td>' +
                      '<td style="vertical-align:middle; width:90px;">' +
                        '<center>' +
                            '<img alt="Discord" src="http://trjvoron.ucoz.net/WIKI/discord2.png" class="discord-icon">' +
