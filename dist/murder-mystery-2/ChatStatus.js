 ...
 * 
 * @module          ChatStatus
 * @description     Replaces the default Away/Back status in chat with a more descriptive list of statuses; modified for custom statuses
 * @author          Penguin-Pal
