...
function appendedblogs () {
  if ( wgPageName == "Blog:Berita_Avatar" ) {
    /* Stickied blogs */
    /* End blogs */
  }
}
...
function masterblog () {
  if ( wgPageName == "Blog:Berita_Avatar"  && $.inArray("sysop", wgUserGroups) != -1 ) {
    $("#WikiaMainContentContainer .read-more").after('<a href="javascript:void(0)" style="float:right" class="wikia-button stickyBlog"><img height="16" src="https://images.wikia.nocookie.net/avatar/images/4/46/128px-Padlock-silver.svg.png" width="20" style="margin-left:-5px"> Blog lengket</a>');
      ...
      $.ajax({ 
        ...
        success: function (data) {
          ...
          $.ajax({
            type: "POST",
            url: mw.util.wikiScript('api'),
            data: { action:'edit', title:'MediaWiki:Common.js/masterblogprepend.js', text: content, summary:'Tambahkan blog ditempel', token: edittoken },
          });
        }
      });
    });
