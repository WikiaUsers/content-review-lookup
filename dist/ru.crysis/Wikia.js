                ...
                '<tr>' +
                    ...
                    '</td>' +
                      '<td style="vertical-align:middle; width:90px;">' +
                        '<center>' +
                            '<img alt="Discord" src="https://vignette.wikia.nocookie.net/crysis/images/5/59/IconDiscord.jpg/revision/latest?cb=20180616200646&path-prefix=ru" class="discord-icon">' +
                            '<span>В сети: <span id="discord-counter">?</span></span>' +
                            '<button class="discord-joined">Взойти на корабль цефов</button>' +
                        '</center>' +
                      '</td>' +
                '</tr>' +
                '<tr>' +
