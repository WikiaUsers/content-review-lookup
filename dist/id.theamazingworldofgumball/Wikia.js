...
if (mw.config.get('mwCustomEditButtons')) {
    mw.config.get('mwCustomEditButtons')[mw.config.get('mwCustomEditButtons').length] = {
        ...
        'speedTip': 'Permintaan penghapusan',
        'tagOpen': '{{hapus|alasan=',
        'tagClose': '}}',
...
setInterval(function () {
    ...
    $('.comments li.message blockquote .MiniEditorWrapper .edited-by a:not(.subtle)').each(function () {
        var $user = $(this).text();
        if ($user.match(/TrueGuy|Ivan the Brony Kaiju|Arifin.wijaya/g)) {
...
window.MessageWallUserTags = {
    ...
    users: {
        'TrueGuy': 'Birokrat',
        'Ivan_the_Brony_Kaiju': 'Birokrat',
        'Arifin.wijaya': 'Birokrat'
    }
};
