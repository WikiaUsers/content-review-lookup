...
if (mw.config.get('wgUserName').includes('VacantIntern') /*Intern*/ || 
    ...
    mw.config.get('wgUserName').includes('VacantHelper4') /*Placeholder*/ || 
    mw.config.get('wgUserName').includes('VacantHelper5') || 
    mw.config.get('wgUserName').includes('VacantHelper6') || 
...
window.dplforumBoards = [
  ...
  { boardName: 'roleplay',
    boardDescription: 'Want to roleplay? Here is the place!'
  },
  { boardName: 'fan-content',
    boardDescription: 'Want to share something you made? Fanfics, drawings, and more are accepted here!'
  },
  //News
  { boardName: 'news-and-announcements',
    boardDescription: 'Breaking news and information!'
  },
  { boardName: 'new-on-yandere-simulator-fan-wikia',
