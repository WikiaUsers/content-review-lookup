...
function initDiscordModule() {
    ...
    var discordJSON = "https://discordapp.com/api/guilds/421662698779181057/widget.json";
            ...
            '<tbody>' +
                '<tr>' +
                    '<td style="vertical-align:middle; width:100%;">' +
                        '<p class="chat-name">' +
                            '<a href="https://discordapp.com/" target="_blank">Discord</a> – бесплатное приложение для публичного общения вне Фэндома. <a href="https://ru.wikipedia.org/wiki/Discord" target="_blank">Подробнее в Википедии</a>. В случае возникновения каких-либо проблем администрация вики не несёт ответственности за сервер.'  +
                        '</p>' +
                    '</td>' +
