// https://help.gamepedia.com/Gamepedia_Help_Wiki:Discord_verification?user=<wiki-username>&discord=<discord-username>&tag=<discord-tag>
...
mw.loader.using(['site','mediawiki.ui.button','mediawiki.util','mediawiki.api']).then(function() {
	if ( mw.config.get('wgPageName') !== 'Ajuda_para_Wikis_da_Gamepedia:Verificação_do_Discord' || mw.config.get('wgAction') !== 'view' ) return;
	var verifyUser = {
		i18n: {
			"en": {
				"loading": "Loading...",
