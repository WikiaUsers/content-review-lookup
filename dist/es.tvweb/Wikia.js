...
article: 'Usuario Blog:Sebastiancoop/El Increible Mundo de Gumball ',
key: 'NfSkin',
init: function() {
...
tb.prepend('
<ul id="WikiaNotifications" class="WikiaNotifications"><li> </li></ul>');
nf = $('#WikiaNotifications');
$(document.body).addClass('notifications');
}

var sn = $('
<div data-type="100"><a class="sprite close-notification"></a> Por problemas con los archivos se han bloqueado temporalmente la subida de imagenes si quieres saber porque <a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'">¡lee esto!</a>.</div>');
...
function agregarEnlaceSkin() {
	...
	$('#WikiaFooter').children('div.toolbar').eq(0).children('ul.tools').eq(0).append('<li><a href="'+surl+'"><img width="15" height="15" class="monobook-icon" src="'+stylepath+'/common/blank.gif"/></a> <a href="'+surl+'" id="ca-changeskin" title="Ver Tv Web con la piel Monobook">Cambiar la apariencia a Monobook</a></li>');
