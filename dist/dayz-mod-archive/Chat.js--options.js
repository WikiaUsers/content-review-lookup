...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; font-size:150%; bottom:4px; padding-bottom:2px; border-bottom: 1px solid #CCCCCC; width:90%;" align="center"><img src="https://images.wikia.nocookie.net/dayz/images/d/da/ChatOptions.png" width="18px"/>&nbsp;Options&nbsp;<img src="https://images.wikia.nocookie.net/dayz/images/d/da/ChatOptions.png" width="18px"/></div>'); // Prevent multiple buttons from being appended
}
