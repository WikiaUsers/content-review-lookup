...
window.WikiNotification = {
	...
	render: function() {
		...
		var sn = $('<li><div data-type="100"><a class="sprite close-notification"></a>¿Esta cansado de los  episodios y de los mismo personaje?  ¡Pues <a href="'+wgServer+wgArticlePath.replace('$1',WikiNotification.article.replace(/\s/g,'_'))+'" title="'+WikiNotification.article+'"> South Park Fanon Wikia</a> es el lugar apropiado para tí!</div></li>');
		nf.append(sn);
