...
/* Пользовательские таблички */
MastRights = {};
MastRights["Черный огурец"] = ["Бывший основатель"];
MastRights["NovoImpossible"] = ["Бюрократ", "Разработчик JavaScript"];
MastRights["Печенькин21"] = ["rollback"];
