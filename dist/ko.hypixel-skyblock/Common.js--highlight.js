/*
Source: https://hypixel-skyblock.fandom.com/wiki/MediaWiki:Gadget-Highlight.js
*/

function highlight() {
	if (!$('.mw-highlight').length || !mw.config.get('wgPageName').match(/^Module:|^모듈|\.(css|js|lua|xml|json|sccs|less)$/)) return;
