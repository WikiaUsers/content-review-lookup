...
/* http://joeplayground.wikia.com/wiki/Setting_up_tooltips */
...
function showTip(e) {
    ...
    if ($p.hasClass("selflink") == false) {
        $t.removeAttr("title");
        $p.removeAttr("title");
        var url = "/index.php?title=" + $t.data("tt").replace(/ /g, "_").replace(/\?/g, "%3F").replace(/\&/g, "%26") + "&action=render div.tooltip-content";
