    ...
    mw.loader.using('mediawiki.util').then(function() {
        ...
        if (!mw.util.getParamValue('wpForReUpload')) {
            ...
            if (formstyle == "guided" || (formstyle === "" && window.location.search.indexOf('basic=true') == -1)) { // Add link to basic form
                $("#uploadtext").prepend('<div style="float: right;" id="uploadBasicLinkJS"><a href="https://homeworld.fandom.com/index.php?title=Special:Upload&basic=true" onclick="javascript:setCookie(\'uploadform\', \'basic\', 30)">Switch to basic form</a></div>'); // Stretch table to full width            
                ...
                jQuery(function ($) {
                    ...
                    function verifySummary() {
                        ...
                        if (!$.trim($customRows.find('#sourceBox').val())) {
                            ...
                            $.showModal('Improper Source', 'Google is not a valid source for images. Please enter the exact game for which the image was taken.');
                ...
                $("#uploadtext").prepend('<div style="float: right;" id="uploadBasicLinkJS"><a href="https://homeworld.fandom.com/index.php?title=Special:Upload" onclick="javascript:setCookie(\'uploadform\', \'guided\', 30)">Switch to the advanced form</a></div>');
            }
        }
    });
}