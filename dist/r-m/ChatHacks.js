 ...
 * Version 7.0
 * http://community.wikia.com/wiki/User:Monchoman45/ChatHacks.js?action=edit
 */
			...
			for(var i = 0; i < pings.length; i++) {
				if(text.toLowerCase().indexOf(pings[i].toLowerCase()) != -1 || this != mainRoom.viewDiscussion) {
					if(!window.hasFocus) { //Only annoy people if the window isn't focused
						document.getElementById('sound').innerHTML = '<audio src="https://vignette.wikia.nocookie.net/re-monster/images/0/01/Notification.ogg/revision/latest?cb=20150115045314" autoplay=""></audio>';
