...
──────────────────────────────────────────────────────────────────────────────
Description:
Imported and programmed by user:Smallketchup82 or sugondese#5733
This thingy gives a mouse parallax effect which otherwise couldn't be accomplished by plain CSS. It should not affect anything as long as
nothing uses the ID "parallax". Usage of this can be found here: https://github.com/wagerfield/parallax
──────────────────────────────────────────────────────────────────────────────
Configuration:
