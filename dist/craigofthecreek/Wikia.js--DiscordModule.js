            ...
            .append(
                $('<div>')
                    ...
                    .append(
                        $('<p>')
                            .append(
                                'The Craig of the Creek Wiki has an official Discord server! Click the button below to join and chat with fellow fans and editors, or click ',
                                $('<a>')
                        ...
                        $('<a>')
                            .attr('href', 'https://discord.gg/Zx7swKb')
                            .addClass('wds-button')
                            .text('Connect')
                    )
          )
