...
if ( wgIsArticle ) {
    ...
    ArticleComments.init = function() {
        ...
        fixPagination();
        $('#article-comm').attr('placeholder', 'Remember to read the rules before commenting.');
    };
}
...
/* Editcount Tab on User Profiles */
$(function() {
    var olds = $(".tabs-container > ul.tabs").html();
    var address = "https://craigofthecreek.fandom.com/wiki/Special:Editcount/" + wgTitle;
