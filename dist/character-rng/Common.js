...
var imageBox = document.getElementById('hover-random-image');
...
var starterRarity = "common"; // Default rarity for the starter image
...
function applyBackground(newImage, rarity) {
...
applyBackground(starterImage, starterRarity);
...
imageBox.addEventListener('mouseenter', function() {
    ...
    applyBackground(newImage, rarity);
});

// Event listener for click to redirect to a specific link
