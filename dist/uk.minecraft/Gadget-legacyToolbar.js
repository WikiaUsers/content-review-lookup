mw.util.addCSS(
    '.client-js .mw-editform > #wpTextbox1 { margin-top: 1px;}'
);
...
mw.toolbar.addButton( {
    ...
    speedTip: "Зовнішнє посилання",
    tagOpen: "[",
    tagClose: "]",
    sampleText: "http://www.example.com назва посилання",
    imageId: "mw-editbutton-extlink"
} );

mw.toolbar.addButton( {
    imageFile: "//upload.wikimedia.org/wikipedia/commons/f/fb/Button_headline.png",
    speedTip: "Заголовок 2-го рівня",
    tagOpen: "== ",
    tagClose: " ==",
    sampleText: "Назва розділу",
...
mw.toolbar.addButton( {
    ...
    speedTip: "Медіа-файл",
    tagOpen: "[[Файл:",
    tagClose: "|міні|Опис медіа-файлу.]]",
...
if ( mw.user.options.get( 'gadget-extra-toolbar-buttons' ) == "1" ) {
				mw.loader.load('/uk/index.php?title=MediaWiki:Gadget-extra-toolbar-buttons.js&action=raw&ctype=text/javascript');
