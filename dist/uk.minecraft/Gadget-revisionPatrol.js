...
$( function() {
	var i18n = {
		autopatrolled: 'Перевірено автоматично',
		// $1 is the user, $2 is the timestamp
		patrolled: 'Перевірено $1 ($2)',
		unpatrollable: 'Не може бути перевірено',
		unpatrolled: 'Не перевірено',
		autopatrolledLegend: 'автоматично перевірене редагування',
		patrolledLegend: 'перевірене редагування',
		unpatrollableLegend: 'редагування, яке не може бути перевірено',
		unpatrolledLegend: 'неперевірене редагування',
		error: 'Не вдалося отримати інформацію про статус перевіреності редагування',
		rightsError: 'Не вдалося отримати інформацію про наявність у користувача прав autopatrol',
	...
	makeRevsRcReq().then( function( data ) {
		...
		$.when.apply( null, patrolReqs ).then( function() {
			...
			var legendElem = document.querySelectorAll( '.mw-history-legend > p' )[1];
