...
var i18n = {
	blockedNotice: 'Ви не можете редагувати цей спрайт, оскільки ви перебуваєте під блокуванням.',
	blockedReason: 'Причина: $1',
	browserActionNotSupported: 'Чи не підтримується вашим браузером.',
	changesSavedNotice: 'Ваші зміни збережені.',
	controlNewName: 'Нова назва',
	ctxDeleteImage: 'Видалити зображення',
	ctxDownloadImage: 'Використати зображення',
	ctxReplaceImage: 'Замінити зображення',
	diffError: 'Не вдалося визначити різницю версій',
	diffErrorMissingPage: 'Не вдалося завантажити сторінку',
	dupeName: 'Ця назва вже існує.',
	dupeNamesNotice: 'В редагуванні є назви-дублікати, які слід виправити, перш ніж зберегти зміни.',
	errorApi: 'Помилка API',
	errorConnection: "Помилка з'єднання",
	errorConnectionText: "Перевірте з'єднання з Інтернетом",
	errorGeneric: 'Помилка',
	errorHttp: 'Помилка HTTP',
	genericError: 'Щось пішло не так',
	luaKeyDeprecated: 'застарів',
	luaKeyId: 'id',
	luaKeyIds: 'ids',
	luaKeyName: 'name',
	luaKeyPos: 'pos',
	...
	noPermissionNotice: 'У вас немає права редагувати цей спрайт.',
	panelChangesIdTitle: 'Зміни ідентифікаторів',
	panelChangesNoDiffFromCur: 'Щодо поточної версії змін немає.',
	panelChangesSheetTitle: 'Зміни таблиці спрайтів',
	panelChangesTitle: 'Розгляньте свої зміни',
	panelCloseTip: 'Закрити',
	panelConflictCurText: 'Поточний текст',
	panelConflictReview: 'Розгляньте зміни',
	panelConflictSave: 'Зберегти',
	panelConflictText: 'Відбувся конфлікт редагування, який не міг бути дозволеним в автоматичному режимі.',
	panelConflictTitle: 'Конфлікт редагування',
	panelConflictYourText: 'Ваш текст',
	panelDiscardContinue: 'Продовжити редагування',
	panelDiscardDiscard: 'Закрити без змін',
	panelDiscardText: 'Ви впевнені, що не хочете зберегти свої зміни?',
	panelDiscardTitle: 'Незбережені зміни',
	panelEcchangesReturn: 'Повернутися до вирішення конфлікту редагування',
	panelEcchangesTitle: 'Розгляньте свої власноручні зміни',
	sectionPlaceholder: 'Введіть назву розділу',
	sectionUncategorized: 'Некатегоризовані',
	titleEditing: 'Редагування спрайта $1',
	toolbarHelp: 'Довідка',
	toolbarHelpPage: 'Довідка:редактор спрайтів',
	toolbarNewImage: 'Нове зображення',
	toolbarNewSection: 'Новий розділ',
	toolbarRedo: 'Повторити',
	toolbarReviewChanges: 'Розглянути зміни',
	toolbarSave: 'Зберегти',
	toolbarSummaryLabelTip: 'Коротенько опишіть ваші зміни',
	toolbarSummaryPlaceholder: 'Підсумуйте внесені вами зміни',
	toolbarToolDeprecate: 'Відзначити застарілим',
	toolbarToolDeprecateTip: 'Відзначити назви як застарілі',
	toolbarTools: 'Інструменти',
