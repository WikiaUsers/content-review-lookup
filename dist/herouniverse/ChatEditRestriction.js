...
// Written by Foodbandlt modified by Ricky Spanish
// ********************************************
...
var undereditMessage = "Hi "+ wgUserName+"! Thanks for trying to use the  HeroVerse. However, the HeroVerse is only for players, and you haven't yet made the minimum number of edits required to use it. Our chat policy (which can be found at http://heroverseworld.wikia.com/wiki/HeroVerse:Terms_of_Use) requires that you make at least 15 edits, with at least 10 of these being in our mainspace (that is, on the wiki articles that make up the heroes, villains, locations, powers, and missions). We apologize for this inconvenience and hope to see you soon in the HeroVerse.";
...
// Page to redirect to 
var redirectPage = "HeroVerse:Terms of Use";
...
var exceptionList = ["Foodbandlt", "EdBoy3"];
