//Authors https://dev.fandom.com/wiki/MediaWiki:TZclock.js?action=history
(function ($) {
    'use strict';
    ...
    function onTick() {
        ...
        for ( i = 0; i < clock.length; ++i ) {
            ...
            var thetime;
            const options = { year: 'numeric', month: 'long', day: 'numeric', hour: 'numeric', minute: 'numeric', timeZoneName: 'short', timeZone: 'UTC' };
