...
function emptyLicenseAlert(form) {
	var msg = "Le fichier de licence n'a pas été sélectionné."
...
importArticles({
    type: 'script',
    articles: [
        'w:c:fr.cartoonnetwork:MediaWiki:Common.js/BackToTopButton.js', // "Back to top" button - Obtained from Wikia Developers Wiki @ w:c:dev:BackToTopButton
    ]
});
...
var hasClass = (function () {
 ...
 var autoCollapse = 2;
 var collapseCaption = "reduire";
 var expandCaption = "étendre";
