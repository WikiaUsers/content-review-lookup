...
function addMastheadTags() {
  ...
  rights["Kubar906"]                  = ["Il Mentore"],
  rights[""]                  = ["Il Mentore"];
 
   // ADMINISTRATORZY
 
  rights["Oseron"]           = ["Mistrz"],
  rights[""]                = ["Mistrz"],
  rights[""]               = [""];
  ...
  rights["Rga"]        = ["Weteran"],
  rights["Mengallo3453"]        =["Weteran"],
  rights["RuthlessChimpanzee"]        = ["Weteran"],
  rights["Trindave"]        = ["Weteran"];
  rights["TheRuddy0703"]        = ["Weteran"];
  rights["Wesoły666"]        = ["Weteran"];
  rights["Oseron"]        = ["Weteran"];
  rights["DarknessEyes23"]        = ["Weteran"];
  rights["Matik7"]        = ["Weteran"];
