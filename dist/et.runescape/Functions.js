/* <pre style="overflow:scroll; height:50em"><nowiki> */
 
/*  This file is a collection of reusable functions from Wookieepedia. */
 
///////////////////////////////////////////////////////////////////////////
//  This global variable specifies if client-side persistent storage 
//  is available. 
//
//  Currently, only Firefox 2 supports this specification. 
//  On Wookieepedia, this global storage is used to store information 
//  about which infoboxes are hidden.
///////////////////////////////////////////////////////////////////////////
...
function storePageName() {
    window.pageName = (getFirstHeading() != null && getFirstHeading().childNodes[0].nodeValue != null) ? getFirstHeading().childNodes[0].nodeValue.trim() : '';
}
...
//  and returns its index, or -1 if it's not in the array.
//
...
///////////////////////////////////////////////////////////////////////////
//  ContentLoader
//  the class to encapsulate "creative differences" with XHR
///////////////////////////////////////////////////////////////////////////
//  Usage:
//      - construct a ContentLoader object: var loader = new ContentLoader();
//      - set necessary state parameters (via fields); 
//          e.g. loader.myvar = 'mytext';
//      - set the callback: loader.callback = myfunc;
//      - send the request:
//          loader.send(url, postdata = null, 
...
///////////////////////////////////////////////////////////////////////////
//
//  getElementsByClass, which complements getElementById and getElementsByTagName, 
//  returns an array of all subelements of ''node'' that are tagged with a specific 
//  CSS class (''searchClass'') and are of the tag name ''tag''. 
//
//  If tag is null, it searches for any suitable elements regardless of the tag name.
//
//  Example: 
//
...
//  Returns the parameter as it appears in the query string. 
//  Equivalent to $_GET[p] in PHP.
//
...
///////////////////////////////////////////////////////////////////////////
//  Dynamically load a combobox's content by pagename 
//  (e.g. Template:Stdsummaries)
//
//  The page should be of the same format as 
//  http://starwars.wikia.com/wiki/Template:Stdsummaries
//
///////////////////////////////////////////////////////////////////////////
...
//  (as stored in the database) and inserts it at the cursor position
///////////////////////////////////////////////////////////////////////////
...
//  Makes the image on the search form, if one is present, point to 
//  the search page instead of the Wikia main page.
//
function rewriteSearchFormLink() {
    var links = document.getElementById('searchform').getElementsByTagName('a');
 
    if(links.length > 0) links[0].href = "/index.php?title=Special:Search&adv=1";
}
