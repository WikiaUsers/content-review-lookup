...
@importURL(http://fonts.googleapis.com/css?family=Open+Sans);
...
ajaxPages = ["Special:WikiActivity","Special:RecentChanges","Special:Log","Special:ListUsers"];
...
importArticles({
    ...
    articles: [
        // ...
         "w:c:hetalia:MediaWiki:Common.js/displayTimer.js",
         "w:c:dev:InactiveUsers/code.js",
         'u:dev:AutoEditDropdown/code.js', // automatically open edit menu on hover
         'u:dev:FloatingToc/code.js', //create fixed floating table of contents
         'u:dev:BackToTopButton/code.js',
         'u:dev:ShowHide/code.js',
         'u:dev:PurgeButton/code.js', // add "refresh" link to edit dropdown
         'w:c:dev:SignatureCheck/code.js', // Signature Reminder
         'u:dev:DisableArchiveEdit/code.js,' //discourage editing of talk archives
         'u:dev:EditIntroButton/code.js' //adds "edit intro" to edit dropdown
    ]
});
