/* The following code belongs to SpongeBob Answers Wiki */
...
window.snowStorm = {
	...
	animationInterval: 30,		// Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
	...
	snowColor: '#00dfff',		// Don't eat (or use?) yellow snow.
	snowCharacter: '&#x2299;',	// &bull; = bullet, &middot; is square on some systems etc.
