...
$(document).ready(function() {
    if (skin == 'oasis') 
        $('<li>  <img style="padding-top:2px;" title="Visitas Totales" src="http://contador-de-visitas.com/hit.php?id=1685499&counter=24" />  </li>').appendTo('#GlobalNavigation');
    else
        $('#p-navigation ul').append('<li> <img title="Visitas Totales" src="http://contador-de-visitas.com/hit.php?id=1685499&counter=24" /></li></li>');
});
