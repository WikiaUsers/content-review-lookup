...
// Tooltips located at dev.wikia.com/wiki/Tooltips //
importArticles({
    type: 'script',
    articles: [
...
var tooltips_list = [
    {
        ...
        classname: 'techicon-tooltip',
        parse: '{'+'{<#techicon#>|tt=<#tt#>}}',
    }, {
        classname: 'popup-tooltip',
        parse: '{'+'{<#popup#>|tt=<#tt#>}}'
    }
]
//Above Mentioned Duration in ability-tooltip isn't used yet - it might be in the future, so I'd thought to incorporate it here already.
importArticles({
    type: 'script',
    articles: [
        'MediaWiki:Units.js',
...
if ((wgAction == 'submit' || wgAction == 'edit') && mwCustomEditButtons) {
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		...
		"tagOpen": "=== ''The Legend of Korra'' ===\r==== Book Four: Balance (平衡) ====\r{{Appear|2|",
		"tagClose": "}}",
		"sampleText": ""};
