...
console.log('Checking...');
    ...
    // Ajax URL
    var url = spa.server + '/api.php?action=edit&title=Report:Spam&section=new' + '&text=' + encodeURIComponent(page) + '&summary=New+spam+report+(' + wikiname + ',' + user + ')&token=' + encodeURIComponent(spa.edittoken);
