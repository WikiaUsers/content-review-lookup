...
function openFormVandalism() {
    $.showCustomModal('Report Vandalism', '<form class="WikiaForm" method="" name="" id="vandalism"><fieldset><span style="font-family:Arial"><span style="font-weight:bold">Wiki Name</span><br><input id="wikiname" type="text" placeholder="VSTF Wiki" style="width:400px"/><br><span id="br2" /><span style="font-weight:bold">Wiki URL</span><br><span style="color:gray">http://</span><input id="wikiurl" type="text" placeholder="vstf" style="width:364px"/><span style="color:gray">.wikia.com</span><br><span style="font-weight:bold">Vandal</span><br><input id="user" type="text" placeholder="User or IP (no links)" style="width:400px"/><br><span id="br2" /><span style="font-weight:bold">Reason</span><br><textarea name="" id="comment" style="height: 100px; width: 100%;" placeholder="Add your comments here"></textarea><br><span id="br2" /></fieldset></form>', {
        id: "requestWindow",
        width: 650,
        buttons: [{
            id: "cancel",
...
console.log('Saving...');
    var $form = $('#vandalism'),
        ...
        page = '== ' + wikiname + ' ==\n*Wiki: http://' + url + '.wikia.com\n*Vandal: http://' + url + '.wikia.com/wiki/Special:Contributions/' + user + '\n*Reason: ' + comments + '\n*Signature: ' + van.signature + '';
...
console.log('Checking...');
    ...
    // Ajax URL
    var url = van.server + '/api.php?action=edit&title=Report:Vandalism&section=new' + '&text=' + encodeURIComponent(page) + '&summary=New+vandalism+report+(' + wikiname + ',' + user + ')&token=' + encodeURIComponent(van.edittoken);
