...
this.hideme = {
    ...
    idtxt: {},
    msgs: {
        hiddenLinkText: "View content",
        messageQuestion: "Hello! Welcome, and thank you for visiting Brick Wiki! Would you like to continue?",
        messageShown: "The confidential content is below."
    },
    init: function() {
...
var t = '<div id="mlnwiki_legal">LEGO&reg; is a trademark of the LEGO Group. MLNWiki is not owned or operated by the LEGO Group.</div>';
...
// Make mlnlinks in a new tab/window

$(function () {
    $(".mlnlink a").attr("target", "_blank");
});
...
$(function () {
    $(".xmlid").each(function () {
        $(this).find(".xmlid-last").hide();
        $(this).find(".xmlid-ellipse").show();
        $(this).click(function () {
            $(this).find(".xmlid-last").show();
            $(this).find(".xmlid-ellipse").hide();
        });
    });
});
$(function() {
	var nick = (wgUserName == null) ? ('MLNW-Visitor-' + Math.floor(Math.random() * 10)) : wgUserName.replace(/ /g, '_'); 
	$('#IRCReplace').html('<iframe src="http://webchat.freenode.net/?nick=' + nick + '&channels=mlnw&prompt=true&uio=OT10cnVlJjExPTUxJjEyPXRydWU37" width="625" height="400" style="border:0;"></iframe>');
});

$('ul.tools li:first-child').after('<li><a href="/index.php?title=Brick Wiki:Manual of Style">Please view the Manual of Style</a></li>');
...
/* Minify took 0.0047390460968018 */

.ChatModule .chat-live{border-top-left-radius:3px;-moz-border-radius-topleft:3px;-webkit-border-top-left-radius:3px;border-top-right-radius:3px;-moz-border-radius-topright:3px;-webkit-border-top-right-radius:3px;border-bottom-left-radius:3px;-moz-border-radius-bottomleft:3px;-webkit-border-bottom-left-radius:3px;background:#006cb0;color:white;font-size:14px;padding:5px
12px;position:absolute;right: -4px;top:21px}.ChatModule .chat-live:before{border-width:2px;border-style:solid;border-color:#003658 transparent transparent #003658;content:url(http://images1.wikia.nocookie.net/__cb34568/common/skins/common/blank.gif);height:0px;width:0px;position:absolute;bottom: -4px;right:0}.ChatModule .chat-join{text-align:right}.ChatModule
.avatar{border:1px
solid #d9d9d9;height:32px;margin-right:10px;vertical-align:middle;width:32px}.ChatModule .chat-whos-here{margin:10px
0}.ChatModule .chat-whos-here
h2{display:block !important;margin-bottom:8px}.ChatModule .chat-whos-here
.avatar{margin:0}.ChatModule .chat-whos-here
li{display:inline;margin:0
0 0 15px}.ChatModule .chat-whos-here li:first-child{margin:0}.ChatModule.module
h1{margin-bottom:15px;margin-right:50px}.ChatModule.module
h2{font-size:13px;padding:0}
...
importScriptPage('MediaWiki:Common.js/IFrame2.js', 'legobrick');