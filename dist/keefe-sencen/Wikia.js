...
window.DiscordIntegratorConfig = {
    siderail: {
        title: "[[File:Discord icon.png|20px]] Keefe Sencen Idolization Wiki Discord",
        id: "475812908912214016",
        theme: "light"
    }
};
...
/* SOMETHING FROM THE DEV WIKI I'M TESTING; CREDITS TO THE AUTHOR OF THE LINK PREVIEW CODE. I JUST WANTED TO TEST OUT DIFFERENT STYLING VERSIONS OF THIS. */
...
(function wrapper ($) {
    ...
    function hlpPreview (uri, div, img, force) {
        //preview helper
    ...
    function ngetPreview (ev, forcepath) {
        ...
        //save bandwith
        log('gp uri: ', nuri, ' curel.href: ', currentEl.href, nuri.truepath === currentEl.href);
        if (!forcepath && (nuri.truepath != currentEl.href)) {
            pp.stop();
            return;
        }
        ...
        if (Settings.apid) {
            ...
            $.getJSON(apipage).done(function(data) {
                ...
                hlpPreview(nuri, div, item.thumbnail, forcepath ? true : false);
                return this;
            })// apid.done
            .fail(function(data) {
