    ...
    function loadWidgets(invType) {
        ...
        if (inviteWidgets.length > 0) {
            ...
            $.getJSON("https://discordapp.com/api/v9/invites/" + invCode + "?with_counts=1", function(data) {
                ...
                var widget = $("<a class=\"discord-invite-widget ff-" + invType + "\" href=\"https://discord.gg/" + invCode + "\"><img/><div><span class=\"discord-title\">Fantastic Frontier</span><span class=\"discord-online\"><span class=\"member-count\"><div class=\"indicator online\"></div>" + online + "&nbsp;&nbsp;&nbsp;&nbsp;</span><span class=\"member-count\"><div class=\"indicator offline\"></div>" + members + "</span></span><span class=\"discord-link\">https://discord.gg/" + invCode + "</span></div></a>");
