...
function addMastheadTags() {
  ...
  rights["StyleMazter"]                  = ["Founder", "Bureaucrat"];
  rights["ZeroXEbony"]                  = ["Bureaucrat"];
 
   // ADMINISTRATORS
 
  rights["CarlosIXA"]             = ["Administrator"];
  rights["TheKeyofTwilight"]             = ["Administrator"];
  rights["MegaSonic55"]               = ["Administrator"];
