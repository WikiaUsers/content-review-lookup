...
$(function() {
    ...
    catnav.data.markup.html = '<nav id="catnav">\n' +
        ...
        '\t\t\t</h3>\n' +
        '\t\t\t<h4>\n' +
        '\t\t\t\tĐể không mất công tạo lại danh sách yêu thích trên nhiều thiết bị, bạn hãy tạo trang Lưu thể loại yêu thích <b>(yêu cầu phải đăng nhập trên Sonako)</b>: <a target="_blank" title="Với những bạn chưa tạo trang lưu (kèm hướng dẫn)." href="http://sonako.wikia.com/wiki/Special:MyPage/catnav.css?action=edit&preload=Template:CatNav">Click tại đây (dành cho tạo mới)</a> hoặc <a target="_blank" title="Với những ai đã tạo trang lưu trước đó." href="http://sonako.wikia.com/wiki/Special:MyPage/catnav.css?action=edit">Click tại đây để chinh sửa</a>' +
        '\t\t\t</h4>\n' +
        '\t\t\t<h4>\n' +
        '\t\t\t\tNhập/Xuất dữ liệu thể loại yêu thích từ trang <a target="_blank" title="Trang lưu dữ liệu thể loại ưu thích." href="http://sonako.wikia.com/wiki/Special:MyPage/catnav.css">Lưu cài đặt: </a>' +
    ...
    catnav.fn.queryPages = function(titles, cb) {
        ...
        req.open("get", "/api/v1/Articles/Details?&abstract=0&width=140&height=140&ids=" + missingTitles.join(","), true);
        req.onload = function() {
    ...
    catnav.fn.addGlobalFavorites = function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (pageid in pages) {
                    if (pageid == -1) {
                        alert("Không tìm thấy dữ liệu. Hãy đảm bảo là trang 'http://sonako/wiki/User:" + user + "/catnav.css' có tồn tại");
                    } else {
    ...
    if (mw.config.get("wgNamespaceNumber") === -1 && mw.config.get("wgTitle") == "CatNav") {
        ...
        $("body").append(
            ...
            '\t\t</h3>\n' +
            '\t\t<p>\n' +
            '\t\t\tSao chép lại thông tin phía dưới và lưu vào cuối trang <a target="_blank" href="http://sonako.wikia.com/wiki/Special:MyPage/catnav.css?action=edit">Dữ liệu cài đặt</a> của bạn.<br />\n' +
