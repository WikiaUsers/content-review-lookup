...
(function (nsfwTag, mw, window, document, undefined) {
    ...
    nsfwTag.addTag = function () {
        ...
        var warning = '<div id="nsfw-tag" style="background-color: #f0f0f0; text-align: center; padding: 20px;"> \
            <h2 style="border: 0; margin: 0;">NSFW!</h2> \
            <p style="margin: 0;">This has content that is <em>NSFW</em> (not safe for work) and may not be suitable for all audiences. Please use your own discretion to decide whether to proceed.</p> \
