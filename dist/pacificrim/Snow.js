...
window.snowStorm = {
	...
	flakesMax: 500,			// Limit total amount of snow made (falling + sticking)
	flakesMaxActive: 50,		// Limit amount of snow falling at once (less = lower CPU use)
	animationInterval: 200,		// Theoretical "miliseconds per frame" measurement. 50 = fast + smooth, but high CPU use. 200 = more conservative, but faster
...
if (snowStorm.autoStart) {
	snowStorm.events.add(window, 'load', doStart, true);
}