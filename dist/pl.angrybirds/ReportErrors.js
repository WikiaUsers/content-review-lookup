...
console.log('Sprawdzanie...');
    ...
    // Ajax URL
    var url = des.server + '/api.php?action=edit&title=AngryBirds Wiki:Zgłaszanie_błędów&section=new' + '&text=' + encodeURIComponent(page) + '&token=' + encodeURIComponent(des.edittoken);
...
console.log('To powinno być:',r);
    $("#requestWindow").closeModal();
window.location = des.server + '/wiki/' + 'AngryBirds_Wiki:Zgłaszanie_błędów#' + encodeURIComponent(des.pagename);
    });
