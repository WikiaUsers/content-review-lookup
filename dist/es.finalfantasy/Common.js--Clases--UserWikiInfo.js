...
*/
var UserWikiInfo = {
	tmpl: '<div class="useravatar"><a href="/wiki/Usuario:{u}" title="Avatar de {U}"><img src="https://images.wikia.nocookie.net/__cb20081128203240/messaging/images/thumb/1/19/Avatar.jpg/50px-Avatar.jpg" width="100" height="100" alt="Avatar" /></a></div>' +
	...
	groupseparator: ', ',
	groups: {
		bureaucrat: '<a href="/wiki/Final Fantasy Wiki:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Final Fantasy Wiki:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Final Fantasy Wiki:Reversores">reversor</a>',
		asistente: '<a href="/wiki/Final Fantasy Wiki:Asistentes">asistente</a>',
		'fb-user': false
	},
