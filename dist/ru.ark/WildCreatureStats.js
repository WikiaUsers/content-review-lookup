...
function changeCreature(creature) {
    ...
    tableRows += '<tr><td><a href="/Скорость">Скорость [%]</a></td><td title="Дикие существа всегда имеют 100% скорость">100</td><td id="wildStatCalcSpeed"></td></tr>';
    ...
    wildStatCalcDiv.innerHTML = '<table class="wikitable">' +
      ...
      '<tr><th>Характеристика</th><th>Значение</th><th>Повышения</th></tr>' +
      tableRows +
      '</table>';
    calcNatStats();
}
        ...
        for (var id in wildStatCalcStats) {
            if (stats[id + '1']) {
                ...
                if (stats[id + '1'] && stats[id + 'Inc'] && stat >= stats[id + '1']) {
                    ...
                    levelEl.title = 'Этот уровень находится выше на ' + percentile + '% по сравнению со всеми дикими существами 120-го уровня.';
                    totallevel += level;
                    determinedStatsNr++;
                }
            }
