...
window.SpoilerAlertJS = {
    question: 'This area contains spoilers. Are you sure you want to view it?',
    yes: 'Yes',
    no: 'No',
    fadeDelay: 1000
};

// MathJax code by Hexirp which works for preview and comments (copied from Googology Wiki)
