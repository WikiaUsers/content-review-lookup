...
function searchJavaScript() 
{
	...
	function addItems(elem) {
		...
		//CheckBoxes
		cContainer = document.getElementById("abilitiesContainer");
		addCheckBox.bind(this, elem, cContainer, "Abilities")();
		...
		cContainer = document.getElementById("levelContainer");
		addIntegerComparison.bind(this, elem, cContainer, "Level")();
