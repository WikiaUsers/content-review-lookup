...
mw.hook( 'wikipage.content' ).add( function( $content ) {
    var $graceContainer = $content.find( '.grace' ).length ? $content.find( '.grace' ) : $( '.grace' );
    
    if ( $graceContainer.length && !$graceContainer.data( 'grace-initialized' ) ) {
        $graceContainer.data( 'grace-initialized', true );
