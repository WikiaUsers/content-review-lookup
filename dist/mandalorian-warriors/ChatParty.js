/* CSS for ChatParty - will be removed soon. */
...
function shell() {
    partyLink1 = "http://vignette1.wikia.nocookie.net/legomessageboards/images/8/87/Sheppard_-_Geronimo.ogg";
    partyLinkIE1 = "";
    partyLinkText1 = "Geronimo - Sheppard";
    partyLink2 = "http://vignette3.wikia.nocookie.net/legomessageboards/images/9/9a/Caramelldansen_Swedish_Original.ogg";
    partyLinkIE2 = "";
    partyLinkText2 = "Caramelldansen";
    partyLink3 = "http://images.wikia.com/lmbtest/images/7/7d/Viva_La_Vida.ogg";
    partyLinkIE3 = "http://k007.kiwi6.com/hotlink/1q82nrxp54/viva_la_vida.mp3";
    partyLinkText3 = "Viva La Vida - Coldplay";
    $('#partyTrigger').toggle(function() {
            ...
            $('#colored').click(function() {
                ...
                $('.light.blue').css({
                    'background': 'blue',
                    'boxShadow': '0 0 20px 20px blue'
                });
                $('.light.orange').css({
                    'background': 'orange',
                    'boxShadow': '0 0 20px 20px orange'
                });
                $('.light.red').css({
                    'background': 'red',
            ...
            if (navigator.info[0] == "MSIE") {
                $.get('/index.php', {
                    action: 'raw',
                    title: 'User:' + wgUserName + '/Party-link-ie-1'
                }, function success(data) {
                    if (data.substring(0, 7) == 'http://') {
                        window.customLink1 = data;
                        $('#option-1-group').show();
                    }
                });
                $.get('/index.php', {
                    action: 'raw',
                    title: 'User:' + wgUserName + '/Party-link-ie-2'
                }, function success(data) {
                    if (data.substring(0, 7) == 'http://') {
                        window.customLink2 = data;
                        $('#option-2-group').show();
                    }
                });
                $.get('/index.php', {
                    action: 'raw',
                    title: 'User:' + wgUserName + '/Party-link-ie-3'
                }, function success(data) {
                    if (data.substring(0, 7) == 'http://') {
                        window.customLink3 = data;
                        $('#option-3-group').show();
                    }
                });
                $.get('/index.php', {
                    action: 'raw',
                    title: 'MediaWiki:Party-special-ie'
                }, function success(data) {
                    if (data.substring(0, 7) == 'http://') {
                        window.specialLink = data;
                        $('#option-special-group').show();
                    }
                });
            } else {
                $.get('/index.php', {
                    action: 'raw',
                    title: 'User:' + wgUserName + '/Party-link-1'
                }, function success(data) {
                    if (data.substring(0, 7) == 'http://') {
                        window.customLink1 = data;
                        $('#option-1-group').show();
                ...
                $.get('/index.php', {
                    action: 'raw',
                    title: 'User:' + wgUserName + '/Party-link-2'
                }, function success(data) {
                    if (data.substring(0, 7) == 'http://') {
                        window.customLink2 = data;
                        $('#option-2-group').show();
                ...
                $.get('/index.php', {
                    action: 'raw',
                    title: 'User:' + wgUserName + '/Party-link-3'
                }, function success(data) {
                    if (data.substring(0, 7) == 'http://') {
                        window.customLink3 = data;
                        $('#option-3-group').show();
            ...
            $.get('/index.php', {
                action: 'raw',
                title: 'User:' + wgUserName + '/Party-link-1-text'
            }, function success(data) {
                $('#option-4').next('span').text(data);
            });
            $.get('/index.php', {
                action: 'raw',
                title: 'User:' + wgUserName + '/Party-link-2-text'
            }, function success(data) {
                $('#option-5').next('span').text(data);
            });
            $.get('/index.php', {
                action: 'raw',
                title: 'User:' + wgUserName + '/Party-link-3-text'
            }, function success(data) {
                $('#option-6').next('span').text(data);
            });
            $.get('/index.php', {
                action: 'raw',
                title: 'MediaWiki:Party-special-text'
            }, function success(data) {
                $('#option-special').next('span').text(data);
            });
            $.get('/index.php', {
                action: 'raw',
                title: 'MediaWiki:Party-special-descrip'
            }, function success(data) {
                $('#option-special-descrip').text(data);
            });
            ...
            $('#option-7').on('click', function() {
                if ($('#partyMode audio')[0]) {
                    $('#partyMode audio').remove();
                    if (navigator.info[0] == "MSIE" || navigator.info[0] == "Firefox") {} else {
            ...
            function skinInverted() {
                $('#style').append('<style type="text/css">html{-webkit-filter:invert(100%);filter:invert(100%);}</style>');
            }
            $('#partyInfo').click(function() {
                $(this).hide();
                $('#partyTech').show();
...
$('#Write textarea').keydown(function(e) {
    ...
    if ($('#Write textarea').val() == "/pattys" && e.keyCode == 13 && chatParty == true) {
        $(this).unbind('keypress').val('');
        importScriptPage('MediaWiki:ChatParty.js/Pattys.js', 'lmbtest');
    }
    if ($('#Write textarea').val() == "/barney" && e.keyCode == 13 && chatParty == true) {
        $(this).unbind('keypress').val('');
        importScriptPage('MediaWiki:ChatParty.js/Barney.js', 'lmbtest');
    }
