...
// ===============================
// Loghi dei giochi nei portali
// ===============================

if (wgPageName === 'Portale:Fallout') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{FO1 Logo}}&format=json', function(data) {
...
if (wgPageName === 'Portale:Fallout_2') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{FO2 Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
...
if (wgPageName === 'Portale:Fallout_Tactics') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{FOT Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
...
if (wgPageName === 'Portale:Fallout_3') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{FO3 Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
...
if (wgPageName === 'Portale:Fallout:_New_Vegas') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{FNV Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
...
if (wgPageName === 'Portale:Fallout_4') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{FO4 Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
...
if (wgPageName === 'Portale:Fallout_Shelter') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{FOS Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
...
if (wgPageName === 'Portale:Fallout:_Brotherhood_of_Steel') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{FOBOS Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
...
if (wgPageName === 'Portale:Van_Buren') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{VB Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
...
if (wgPageName === 'Portale:Project_V13') {
  $(function() {
      var newSection = '<section id="activities"></section>';
      $('#WikiaRail').append(newSection);
      $.getJSON('/api.php?action=parse&text={{PV13 Logo}}&format=json', function(data) {
          var code = data.parse.text['*'];
          $('section#activities').append(code);
      });
  });
