...
$('#wsec_10kinput').replaceWith('<input id="wsec_10k" class="wsec_input10k" value="0" type="number"/>');
...
var x3 = $('#wsec_10k').val()*10000*basemultiplier;
var x4 = $('#wsec_20k').val()*spirit*basemultiplier;
var x5 = $('#wsec_40k').val()*40000*basemultiplier;
var xsum = x1+x2+x3+x4+x5+current_value;
    xsum = xsum + 1;
...
$('#wsec_10k').on('input',function(e){testfunction();});
