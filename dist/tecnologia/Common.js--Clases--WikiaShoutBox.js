/** WikiaShoutBox v1.10: Conector para el Widget ShoutBox de Wikia
...
var WikiaShoutBox = {
	...
	sendMsg: function(wId) {
		...
		var message = $.trim(messageBox.attr('value')).replace(new RegExp('\\{\\{', 'g'), '{&#123;').replace(new RegExp('<', 'g'), '&lt;').replace(new RegExp('>', 'g'), '&gt;');
		var isMe = false;
