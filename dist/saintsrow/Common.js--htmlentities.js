...
function convertEntities(input) {
	...
	if ((input != undefined) && (input != null)) {		//cancelling prompt returns null.
		var encode = htmlentities.encode(input);	//if input, encoded entities
...
htmlentities.encode = function(string, options) {
	options = merge(options, htmlentities.options);
