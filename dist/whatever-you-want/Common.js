...
window.UserTagsJS = {
	...
	tags: {},
		...
		promking: { u:'Prom King' },
		promqueen: { u:'Prom Queen' },
...
window.UserTagsJS = {
	modules: {
			...
			newuser: true,},
	tags: {
		bureaucrat: { link:'Austin_%26_Ally_Wiki:Administrators#Bureaucrat_abilities' },
		sysop: { link:'Austin & Ally Wiki:Administrators' },
		chatmoderator: { link:'Austin & Ally Wiki:Chat Moderators' },
		rollback: { u:'Rollback', link:'Austin & Ally Wiki:Rollbacks' },
