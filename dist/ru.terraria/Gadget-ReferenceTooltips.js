...
window.pg || $(document).ready( function($) {
    ...
    if ( $.inArray(mw.config.get('wgCanonicalNamespace'), [ "", "Project", "Help", "Draft" ]) !== -1 ) {
		mw.messages.set( {
			"RT-enable" : "Включить всплывающие подсказки",
			"RT-disable" : "Отключить всплывающие подсказки",
			"RT-disablenote" : "После отключения всплывающие подсказки можно повторно включить, используя ссылку в нижней части страницы.",
			"RT-delay" : "Задержка перед появление подсказки (в миллисекундах): ",
			"RT-activationmethod" : "Подсказка активируется при помощи:",
			"RT-hovering" : "наведения",
			"RT-clicking" : "щелчка",
			"RT-options" : "Меню  всплывающих подсказок",
			"RT-options-save" : "Сохранить изменения",
			"RT-settings" :"Настройки подсказок"
		} );
        function toggleRT(o){
        ...
        $(".reference").each( function() {
            ...
            $(this)[ isTouchscreen ? 'click' : 'hover' ](function( e ){
                    ...
                    showTimer = setTimeout( function() {
                            ...
                            $(tooltipNode).css({top: o.top - oH + addedHeightOffset, left: o.left - 7 });
