...
if (wgNamespaceNumber > -1) {
	...
	if (document.getElementById('ca-ve-edit')) { // only if the preference to use it is set (an "edit source" nav tab exists)
    	...
    	'<a href="/ru/index.php?title=' + wgPageName + '&amp;veaction=edit&amp;section=0" title="' + l10n('title') + '">' + l10n('edit') + '</a>' +
    	'<span class="mw-editsection-bracket"> | </span>' +
    	'<a href="/ru/index.php?title=' + wgPageName + '&amp;action=edit&amp;section=0" title="' + l10n('title') + '">' + l10n('edit_source') + '</a>' +
    	'<span class="mw-editsection-bracket"> ]</span>' +
		'</span>';
	}
    ...
    // regular version (one edit link)
    	...
    	edittopHTML = '<span class="mw-editsection">' +
    	'<span class="mw-editsection-bracket">[ </span>' +
		'<a href="/ru/index.php?title=' + wgPageName + '&amp;action=edit&amp;section=0" title="' + l10n('title') + '">' + l10n('edit') + '</a>' +
    	'<span class="mw-editsection-bracket"> ]</span>' +
		'</span>';
    }
