...
function submitLog(restart) {
	...
	callAPI({
		...
		callAPI({
			'minor': 'yes',
			'bot': 'yes',
			'summary': 'Adding to chatlog using [['+(wgDBname=="runescape"?'':'runescape:')+'User:Joeytje50/ChatLogger.js|ChatLogger]] script',
			'action': 'edit',
...
Recent Activity
    ...
    Mighty banshee
    edited by An anonymous contributor 6 seconds ago
    TzHaar Whip 7
    edited by The Mol Man 1 minute ago
    Adventurer's Log/Quest complete
    edited by 10finland01 1 minute ago
    Queen Black Dragon
    edited by An anonymous contributor 1 minute ago

See more >	
Latest Files
Add a File	
50,598files on the wiki	
