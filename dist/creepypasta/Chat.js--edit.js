...
// Disable message (1 = enabled, 0 = disabled)
    ...
    window.chatRestr.undereditMessage = "Hi "+ wgUserName+"! Thanks for trying to use the Creepypasta chat room. However, the chat room is only for active editors of the Creepypasta wiki, and you haven't yet made the minimum number of edits required to use it. You need at least 10 edits on the wiki mainspace to confirm that you are a legitimate user and not a previously banned troll or spammer. We are sorry for the inconvenience and hope to see you soon! ";
    ...
    // Page to redirect to 
    window.chatRestr.redirectPage = "Main_Page";
...
var exceptionList = ["Foodbandlt" , "Lieutenant Lesbian"]; 
