...
(function($, mw, jsSHA) {
	...
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/High_School_Dxd _Wiki:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/High_School_Dxd _Wiki:Administradores">administrador</a>',
		rollback: '<a href="/wiki/High_School_Dxd _Wiki:Reversores">reversor</a>',
		asistente: '<a href="/wiki/High_School_Dxd _Wiki:Asistentes">asistente</a>',
		bot: '<a href="/wiki/High_School_Dxd _Wiki:Bots">bot</a>',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
