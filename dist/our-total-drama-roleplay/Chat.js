...
var chatTopic = 'Welcome to the Our Total Drama Roleplay Wiki! Have fun RPing or not!'
 
//Switch to RP mode button
var RP_button = 'Switch to RP mode';
 
//Switch to normal chat button
var normal_button = 'Switch to normal Chat';
 
 
//
//Color scheme for NORMAL Chat
//
  //Link color
    var linkColorNormal = '#FFFD69';
 
  //Self text background color
    var selfTextColorNormal = '#FFFC21';;
 
  //Chat background color
    var backgroundColorNormal = '#64FF73';;
 
  //Chat foreground color
    var foregroundColorNormal = '#FF4646';
 
  //User stats foreground color
    var userStatsColorNormal = 'Silver';
 
//END NORMAL Chat color scheme
 
//
//Color scheme for RP MODE Chat
//
  //Link color
    var linkColorRP = '#FF0000';
 
  //Self text background color
    var selfTextColorRP = '#00FF09';
 
  //Chat background color
    var backgroundColorRP = '#FF3232';
 
  //Chat foreground color
    var foregroundColorRP = '#32FF44';
 
  //User stats foreground color
    var userStatsColorRP = 'Silver';
 
//END RP MODE Chat color scheme
