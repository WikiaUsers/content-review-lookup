...
window.quizName = "Test your Kamiwaza Wanda knowledge!";
window.quizLang = "en";
window.resultsTextArray = [ 
    "You might know about other things in life, but definitely not about Kamiwaza Wanda!",
    "Your knowledge about Kamiwaza Wanda is quite solid, but still far away from perfect.",
    "Congrats! Your knowledge about Kamiwaza Wanda is extremely impressive!" 
];
window.questions = [
    ["Who is Yuto‘s Promin buddy?",
    "Turbomin",
    "Kagimin",
    "Denkyumin"], 

    ["Who of those Promins formerly owned by Yuto is now owned by Masato?",
    "Freezemin",
    "Tonkmin",
    "Dorirumin"],

    ["Who of those friends of Yuto was initially his rival?",
    "Masato",
    "Mirai",
    "Souma"]
    ];
