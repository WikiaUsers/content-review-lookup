...
(function(window, $, mw, config) {
	...
	config = $.extend({
		...
		preamble: 'Il y a quelques problèmes potentiels avec votre modification:\n\n',
		epilogue: '\nÊtes-vous sûr de vouloir tout de même publier?\n[Une violation des règles peut provoquer un avertissement]',
		noForumheader: '!! Il n’y a pas d’entête de forum sur cette page de forum. Vous ne devez pas créer de page de forum sans l’entête sinon ils risquent de ne pas apparaître dans la liste du forum.\n',
		noSignature: '?? Il semble que vous avez oublié de signer votre message. Utilisez ~~~~ pour signer.\n',

		// Other stuff
		forumheader: 'EntêteForum', // Can be falsy to disable
		checkSignature: true
	}, config);
