        ...
        if (_cactions.uname) {
            with (_cactions) {
                menus[menus.length] = createMenu('opt-user',Array(
                    ...
                    ['c-u-editcount',   'Счётчик правок',       'http://toolserver.org/~tparis/count/index.php?lang=ru&wiki=wikipedia&name='+uname.replace(/_/g,'+')]         ,
                    ['c-u-editsum',     'Описания правок',   'http://toolserver.org/~tparis/editsummary/index.php?lang=ru&wiki=wikipedia&name='+uname.replace(/_/g,'+')]   ,
