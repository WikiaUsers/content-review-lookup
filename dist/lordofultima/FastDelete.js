 ...
 *
 * This version adapted for use on Lord of Ultima Wiki by RyaNayR.
 */
        ...
        init: function() {
            ...
            switch (skin) {
                ...
                case 'wikia':
                    ...
                    for (var i = 0; i < fdButtons.length; i++) {
                        deleteButtons += '<a class="wikia-button fastDelete" title="Delete page'
                    ...
                    switch (wgNamespaceNumber) {
                        ...
                        case 502:
                            ...
                            break;
                        default:
                            $('.WikiaPageHeader > .wikia-menu-button').after(deleteButtons);
                            break;
                    }
                    break;
            }
