...
// version info
wikEd.programVersion = '0.9.121';
wikEd.programDate    = 'November 20, 2013';
...
wikEd.InitGlobalConfigs = function() {
	...
	wikEd.InitMainEditCSS = function() {
		wikEd.InitObject(wikEd.config.mainEditCSS, {
			...
			'.wikEdButtonsPasted img:hover': 'background-color: #e4e0dd;',
...
wikEd.GetText = function(obj, whichFragment, wikify) {
	...
	if (obj.whole == null) {
		if (/whole|selectionWord|selectionLine|selectionPara|focusWord|focusLine|focusPara/.test(whichFragment) == true) {
			...
			obj.whole.plain = obj.whole.plain.replace(/\s*<br\b[^>]*>\s*/g, '\n');
	...
	if (obj.selection == null) {
		if (/selection\b|selectionWord|selectionLine|selectionPara/.test(whichFragment) == true) {
			...
			obj.selection.plain = obj.selection.plain.replace(/\s*<br\b[^>]*>\s*/g, '\n');
	...
	if (obj.focusWord == null) {
		if (/focusWord|focusLine|focusPara/.test(whichFragment) == true) {
			...
			obj.focusWord.plain = obj.focusWord.plain.replace(/\s*<br\b[^>]*>\s*/g, '\n');
			...
			obj.focusLine.plain = obj.focusLine.plain.replace(/\s*<br\b[^>]*>\s*/g, '\n');
			...
			obj.focusPara.plain = obj.focusPara.plain.replace(/\s*<br\b[^>]*>\s*/g, '\n');
	...
	if (obj.selectionWord == null) {
		if (/selectionWord|selectionLine|selectionPara/.test(whichFragment) == true) {
			...
			obj.selectionWord.plain = obj.selectionWord.plain.replace(/\s*<br\b[^>]*>\s*/g, '\n');
			...
			obj.selectionLine.plain = obj.selectionLine.plain.replace(/\s*<br\b[^>]*>\s*/g, '\n');
			...
			obj.selectionPara.plain = obj.selectionPara.plain.replace(/\s*<br\b[^>]*>\s*/g, '\n');
...
// version info
wikEd.diffProgramVersion = '0.9.19';
wikEd.diffProgramDate    = 'October 06, 2013';
