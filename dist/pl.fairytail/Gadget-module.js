...
if (hasGroup('sysop')) {
	...
	.append(
		...
		$('<ul />').css({'width':'50%','float':'left'})
		.append(
			$('<li><a href="http://fairytail.wikia.com">ENG Fairy Tail Wiki</a></li>'),
		...
		.append(
			...
			$('<li><a href="http://www.wikia.com/WAM?searchPhrase=fairytail">Wikia WAM</a></li>')
		)
                ),
                $('<table />')
                .append(
                    ...
                    .append(
                        ...
                        $('<td><a href="/index.php?title=' + encodeURIComponent( wgPageName ) + '&useskin=monobook" title="Zmień skórkę na Monobook" class="wikia-button secondary" style="font-size:11px;margin:8px 2px">Zmień skórkę</a></td>')
                    )
                )
            )
        )
