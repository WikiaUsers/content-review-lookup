//Code for Template:Ebook: http://sonako.wikia.com/wiki/Template:Ebook
...
//Pocket Button
$(function() {
    if (document.getElementsByClassName("pocket-button")[0] !== null) {
        $('.pocket-button').append('<a data-pocket-label="pocket" data-pocket-count="none" class="pocket-btn" data-lang="en"></a>');
        ! function(d, i) {
...
$(function() {
    if (document.getElementsByClassName("pdf-button")[0] !== null) {
        ...
        var pfCustomCSS = 'https://sonako.wikia.com/index.php?title=MediaWiki:Print_Snk.css&action=raw&ctype=text/css&maxage=3600&smaxage=3600';
        var pfBtVersion = '1';
        (function() {
            var js, pf;
        ...
        $('.pdf-button').html('<a href="https://www.printfriendly.com" style="color:#6D9F00;text-decoration:none;" class="printfriendly" onclick="window.print();return false;" title="Lưu trang dưới dạng PDF"><img style="border:none;-webkit-box-shadow:none;box-shadow:none;" src="https://i.imgur.com/Caln35q.gif" alt="Lưu trang dưới dạng PDF"/></a>');
    }
});
...
$(function() {
    if (document.getElementsByClassName("epub-button")[0] !== null) {
        $('.epub-button').html('<a class="dotEPUB" href="http:\/\/dotepub.com" title="Lưu trang dưới dạng Epub & Mobi" data-dotepublang="en" data-dotepublinks="0" data-dotepubformat="ask" data-dotepubtext="Đang chuyển đổi. Hãy đợi trong giây lát!"><img style="border:none;-webkit-box-shadow:none;box-shadow:none;" src="https://i.imgur.com/ce96AAI.png" alt="Dotepub"/></a>');
        (function() {
