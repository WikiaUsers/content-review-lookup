(function ( $ ) {
	$.fn.totopscroller = function(options) {
		...
		var defaults = {
			...
			link: false,
			linkTarget: '_self',
			toTopHtml: '<a href="#" style="display: block"></a>',
			toBottomHtml: '<a href="#" style="display: block"></a>',
			toPrevHtml: '<a href="#" style="display: block"></a>',
			linkHtml: '<a href="#" style="display: block"></a>',
...
$(function() {
    $('body').append('<div id="totopscroller"> </div>');
