/* Add powerusers checkbox to Special:Listusers */
...
if (!$("#ca-diff").length && $("a[id='ca-history']").closest("ul").length) { //adapted from NullEditButton script
    $("a[id='ca-history']").closest("ul").prepend($('<li>').html(
        $('<a/>').attr({
            href: $("li>a[id=ca-history]").attr("href").replace("action=history", "diff=cur"),
            accesskey: "0",
            id: "ca-diff",
