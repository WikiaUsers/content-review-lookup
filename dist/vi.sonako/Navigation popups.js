// Get the code from: https://en.wikipedia.org/wiki/MediaWiki:Gadget-popups.js
// See more description here: https://en.wikipedia.org/wiki/Wikipedia:Tools/Navigation_popups
// Updated on 14/10/2016 (Date-Month-Year format)
// Add this line for CatNav: pg.setupTooltips = setupTooltips;
// Always check history of the page so it can be updated to the latest version: https://en.wikipedia.org/w/index.php?title=MediaWiki:Gadget-popups.js&action=history
// STARTFILE: main.js
// **********************************************************************
// **                                                                  **
	...
	if ( action ==  'enable' && !modifierPressed(evt) ||
		...
		case 'enable':
			...
			a.addEventListener('mouseout', function() {
					document.removeEventListener(on+'keydown',
...
function loadDiff(article, oldid, diff, navpop) {
	...
	var go = function() {
		...
		if ( getValueOf('popupAdjustDiffDates') && tz === null) {
			pendingNavpopTask(navpop);
