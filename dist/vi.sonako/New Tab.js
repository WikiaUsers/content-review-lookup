$(document).ready(function() {
    ...
    $('a[href^="http"]').not('a[href*=sonako]').not('a[href*=logout]').attr('target', '_blank').attr('title', 'Mở link sang Tab mới.');
    $('a[href$="sonakolightnovel"]').attr('target', '_blank').attr('title', 'Mở link sang Tab mới.');
});
    ...
    (function() {
        ...
        $("body").on("DOMNodeInserted", markup, function() {
            $(markup).find("a").each(function() {
                $('a.external').attr('target', '_blank').attr('title', 'Mở link sang Tab mới.');
                $('a[href^="http"]').not('a[href*=sonako]').attr('target', '_blank').attr('title', 'Mở link sang Tab mới.');
            });
        });
    }());
}
