  ...
  $.ornament = function(options) {
    ...
    for (var i = 0; i < options.flake_number; i++) {
      ...
      if (typeof(options.flake_folder) == 'object') {
        ...
        flake_elem = '<img src="' + options.flake_folder + 'ornament-' + (Math.floor(random() * options.flake_imgs)+1) + '.gif' + '" style="border:0!important; background-color:transparent!important; margin:0!important; padding:0!important;" width="' + flake_size + '" height="' + flake_size + '" />';
      }
    ...
    timer = setInterval(methods.ornament, Math.round(1/parseInt(options._fps)*1000));
  }; // fn.ornament
} (jQuery));
