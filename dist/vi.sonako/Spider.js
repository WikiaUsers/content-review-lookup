...
var BugDispatch = {
    ...
    options: {
        ...
        maxSmallTurnDeg: 10,
        maxWiggleDeg: 5,
        imageSprite: 'https://vignette.wikia.nocookie.net/sonako/images/c/cb/Fly-sprite.png',
        bugWidth: 13,
        bugHeight: 14,
        num_frames: 5,
...
var SpiderController = function() {
    var spiderOptions = {
        imageSprite: 'https://vignette.wikia.nocookie.net/sonako/images/c/cf/Spider-sprite.png',
        bugWidth: 69,
        bugHeight: 90,
        num_frames: 7,
        canFly: false,
