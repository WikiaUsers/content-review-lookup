...
$(function () {
    var rights = {};
    var botTag = "<a href='http://warframe.wikia.com/wiki/WARFRAME_Wiki:Administrators#Bots'>Bot</a>";
    var chatMod = "<a href='http://warframe.wikia.com/wiki/Project:Administrators'>Chat Moderator</a>";
    var adminTag = "<a href='http://warframe.wikia.com/wiki/Project:Administrators'>Administrator <img src='https://images.wikia.nocookie.net/__cb20150423210907/warframe/images/c/c7/Wikia_Badge_2.png' alt='Admin' /></a>";
    var bureaucratTag = "<a href='http://warframe.wikia.com/wiki/Project:Bureaucrats'>Lotus <img src='https://images.wikia.nocookie.net/__cb20150423210907/warframe/images/c/c7/Wikia_Badge_2.png' alt='Admin' /></a>";
    var moderatorTag = "<a href='http://warframe.wikia.com/wiki/WARFRAME_Wiki:Administrators#Moderators'>Moderator</a>";
    ...
    rights["Twilight053"]              = [adminTag, disciple],
    ...
    rights["ChickenBar"]               = [adminTag, hunter],
    ...
    rights["Juper0"]                   = [adminTag, master],
    rights["=WSC= Patriarch"]          = [master],
    rights["Fundance"]                 = [master],
    rights["Darthmufin"]               = [adminTag, master],
    ...
    rights["MrDESC"]                   = [adminTag, grandmaster],
    rights["Flaicher"]                 = [adminTag, grandmaster],
    rights["Raigir"]                   = [adminTag, grandmaster],
    rights["Thedeer"]                  = [grandmaster],
    rights["Dav36rye"]                 = [grandmaster],
    rights["MueR"]                     = [grandmaster],
    rights["Brizingr5"]                = [adminTag, grandmaster],
    rights["Voqualin"]                 = [adminTag, grandmaster],
    ...
    rights["Catbot"]                   = [botTag],
    rights["Owlbot"]                   = [botTag],
    rights["Arctic's Ludicrous Anti-Spam Bot"] = [botTag],
    rights["Flaibot"]                   = [botTag],
    rights["NAME"]                     = [botTag],
 
    //Chat Moderators
  
    rights["DaExile"]                  = [chatMod],
    rights["Doudich"]                  = [chatMod, moderatorTag],
    rights["Somedude1000"]             = [chatMod],
    rights["Hennils"]                  = [moderatorTag],
    rights["TunaInABottle"]            = [moderatorTag],
 
    //Administrators
 
    rights["Emailformygames"]          = [adminTag],
    rights["Imargam"]                  = [adminTag],
    rights["Noctuaa"]                  = [adminTag],
    rights["Tnargraef"]                = [adminTag],
    rights["DE Glen"]                  = [adminTag],
    rights["DEDrew"]                   = [adminTag],
    rights["SonyaUliana"]              = [adminTag],
    rights["USouLz"]                   = [adminTag],
    rights["6079Smith"]                = [adminTag],
    rights["ArcticEngie"]              = [adminTag],
    rights["NAME"]                     = [adminTag],

    //Bureaucrats
 
    rights["Rebulast"]                 = [bureaucratTag],
    rights["NAME"]                     = [bureaucratTag],

    //Moderator
 
    rights["Hilycker"]                 = [moderatorTag],
    rights["Protonus"]                 = [moderatorTag],
    rights["Blizt1998"]                = [moderatorTag],
    rights["Misdirected"]              = [moderatorTag],
    rights["Starfreak911"]             = [moderatorTag],
    rights["Jeloxale"]                 = [moderatorTag, chatMod],
    rights["Kselia"]                   = [moderatorTag],
    rights["Gat235"]                   = [moderatorTag],
    rights["Grunni"]                   = [moderatorTag],
    rights["94Connor949"]              = [moderatorTag],
    rights["NoLngrRomng1"]             = [moderatorTag],
    rights["NAME"]                     = [moderatorTag],
    
    //Guide of the Lotus
    rights["Somedude1000"]             = [lotusguide, chatMod],
