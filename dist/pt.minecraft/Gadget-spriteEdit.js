...
var i18n = {
	blockedNotice: 'Você não pode editar este sprite enquanto estiver bloqueado.',
	blockedReason: 'Razão: $1',
	browserActionNotSupported: 'Não suportado pelo seu navegador.',
	changesSavedNotice: 'Suas alterações foram salvas.',
	controlNewName: 'Novo nome',
	ctxDeleteImage: 'Excluir',
	ctxDownloadImage: 'Baixar',
	ctxReplaceImage: 'Substituir',
	diffError: 'Falha ao recuperar diff',
	diffErrorMissingPage: 'Falha ao recuperar a página',
	dupeName: 'Este nome já existe.',
	dupeNamesNotice: 'Existem nomes duplicados que devem ser resolvidos antes de salvar.',
	errorApi: 'Erro da API',
	errorConnection: 'Erro de conexão',
	errorConnectionText: 'Verifique a sua conexão com a internet',
	errorGeneric: 'Erro',
	errorHttp: 'Erro HTTP',
	...
	noPermissionNotice: 'Você não tem permissão para editar este sprite.',
	panelChangesIdTitle: 'Alterações de dados',
	panelChangesNoDiffFromCur: 'Nenhuma alteração da revisão atual.',
	panelChangesSheetTitle: 'Alterações na folha de sprite',
	panelChangesTitle: 'Revise suas alterações',
	panelCloseTip: 'Fechar',
	panelConflictCurText: 'Texto atual',
	panelConflictReview: 'Rever alterações',
	panelConflictSave: 'Salvar',
	panelConflictText: 'Ocorreu um conflito de edição e não pôde ser resolvido automaticamente.',
	panelConflictTitle: 'Editar conflito',
	panelConflictYourText: 'Seu texto',
	panelDiscardContinue: 'Continuar editando',
	panelDiscardDiscard: 'Descartar as alteraçõess',
	panelDiscardText: 'Tem certeza de que deseja descartar suas alterações?',
	panelDiscardTitle: 'Mudanças não salvas',
	panelEcchangesReturn: 'Retornar para editar o formulário de conflito',
	panelEcchangesTitle: 'Revise suas alterações manuais',
	sectionPlaceholder: 'Digite um nome de seção',
	sectionUncategorized: 'Sem categoria',
	titleEditing: 'Editando sprite $1',
	toolbarHelp: 'Ajuda',
	toolbarHelpPage: 'Ajuda:Editor de sprite',
	toolbarNewImage: 'Nova imagem',
	toolbarNewSection: 'Nova seção',
	toolbarRedo: 'Refazer',
	toolbarReviewChanges: 'Rever alterações',
	toolbarSave: 'Salvar',
	toolbarSummaryLabelTip: 'O número de bytes restantes',
	toolbarSummaryPlaceholder: 'Resuma as mudanças que você fez',
	toolbarToolDeprecate: 'Obsoleto',
	toolbarToolDeprecateTip: 'Alternar nomes como obsoletos',
