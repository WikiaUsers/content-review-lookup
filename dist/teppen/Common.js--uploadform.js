    ...
    var upload = {
        ...
        categories: {
            'Game Series': {
                ...
                'Bionic Commando Images': 'Bionic Commando',
                'Breath of Fire Images': 'Breath of Fire',
                'Cannon Spike Images': 'Cannon Spike',
                'CROSS×BEATS Images': 'CROSS×BEATS',
                'Darkstalkers Images': 'Darkstalkers',
                'Dead Rising Images': 'Dead Rising',
                'Devil May Cry Images': 'Devil May Cry',
                'Dino Crisis Images': 'Dino Crisis',
                'Ghosts \'n Goblins Images': 'Ghosts \'n Goblins',
                'Haunting Ground Images': 'Haunting Ground',
                'Mega Man Images': 'Mega Man',
                'Monster Hunter Images': 'Monster Hunter',
                'Ōkami Images': 'Ōkami',
                'Onimusha Images': 'Onimusha',
                'Otoranger Images': 'Otoranger',
                'Red Earth Images': 'Red Earth',
            ...
            'Other': {
                'Full Illustrations': 'Full card illustration',
                'Card Pack Images': 'Card pack/Expansion',
                'Special Pack Images': 'Special pack',
                'Version Update Images': 'Version Update',
