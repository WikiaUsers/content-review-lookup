...
importScriptPage("MediaWiki:Czatmotyw.js","pl.s124test");
...
StyleSwitcher = {
    ...
    circleToggle: function() {
        if (StyleSwitcher.circleType == "circle") {
            ...
            $('head').append('<link href="http://pl.s124test.wikia.com/index.php?title=MediaWiki:Czatkolo1.css&action=raw&ctype=text/css" rel="stylesheet" type="text/css" id="ChatSkinsCircle"/>');
