...
function addTwitterButton() {
   $('#twitter-button').append('<a href="http://twitter.com/zenescopeentertainment" class="twitter-follow-button" data-show-count="true" data-show-screen-name="false">Follow @Zenescopeentertainment</a><script src="https://platform.twitter.com/widgets.js" type="text/javascript"></script>');
}
$(addTwitterButton);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
http://zenescopeentertainment.wikia.com/index.php?title=Zenescope Entertainment Database:Comic Template&action=edit&section=T-1
*/
...
function changeLinks(editLinks,pageTitle){
	...
	for (var i = 0; i < editLinks.length; i++){
		...
		if (editLink != null){
			...
			newLink = newLink.replace("Zenescope_Entertainment_Database:Comic_Template/Header", pageTitle);
			newLink = newLink.replace("Zenescope_Entertainment_Database:Comic_Template", pageTitle);
			newLink = newLink.replace("Zenescope_Entertainment_Database:Character_Template/Header", pageTitle);
			newLink = newLink.replace("Zenescope_Entertainment_Database:Character_Template", pageTitle);
...
/*
/////////////////////////////////////////////////////////////////////////////////
// Changing the Link from Special:CreatePage to Zenescope_Entertainment Database:Create a New Page
/////////////////////////////////////////////////////////////////////////////////
*/
function createPage(){
	var createPageLink = document.getElementById('dynamic-links-write-article-icon');
	if (createPageLink != null){
		createPageLink.href = "/wiki/Zenescope_Entertainment_Database:Create_a_New_Page";
