// Credit to Hypixel Skyblock Wiki
(function($){
	// prevent double load
	...
	var stylesheetPrefix = "https://unstable-universe-mc.fandom.com/index.php?action=raw&ctype=text/css&title=";
	var themes = [
		{
			id: 'default',
			name: 'Default',
			note: 'Light & Dark',
			image: "https://static.wikia.nocookie.net/unstable-universe-mc/images/0/08/Site-background-dark/revision/latest/"
		},
		{
			id: 'wemmbu',
			name: "Wemmbu",
			note: 'Light & Dark',
			stylesheet: stylesheetPrefix+"MediaWiki:Gadget-ThemeSelector.js/Wemmbu.css",
			image: "https://yt3.googleusercontent.com/wmYjiTTw2GL1_Dk5HfK7-1CG6tA-qM7G8HWPrsiEdoS9TquDDYd-dc44rAa19htZnf3kLGRGlRc"
		},
		{
			id: 'flamefrags',
			name: "FlameFrags",
			note: 'Light & Dark',
			stylesheet: stylesheetPrefix+"MediaWiki:Gadget-ThemeSelector.js/FlameFrags.css",
			image: "https://yt3.googleusercontent.com/kyD6uEZWs8-3YaUR090SkPyaozy5a3Xgj4zZ7zxCB704Ei2Siy25frANDxaCzhTiFrZRmcHbeg"
		},
		{
			id: 'parrotx2',
			name: "ParrotX2",
			note: 'Light & Dark',
			stylesheet: stylesheetPrefix+"MediaWiki:Gadget-ThemeSelector.js/ParrotX2.css",
			image: "https://yt3.googleusercontent.com/Y-BFjK7uyxBQYfdawsuc8J8W_IR_JEUlMdxJvhu1bCLhNQ_3NpreyieY0HmAr0ezGpisAZvjuTs"
		},
		{
			id: 'spoke',
			name: "SpokeIsHere",
			note: 'Light & Dark',
			stylesheet: stylesheetPrefix+"MediaWiki:Gadget-ThemeSelector.js/SpokeIsHere.css",
			image: "https://yt3.googleusercontent.com/iVYU4eS-2QpRF724vvc5CVEwCNDZqS-DTJpp422yLzKow0aOUqWB7F4j36pmM6vXSiAU4BIMvw"
		},
	];
