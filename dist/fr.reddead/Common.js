		...
		if (!mw.util.getParamValue('wpForReUpload')) {
			...
			if (formstyle == "guided" || (formstyle == "" && window.location.search.indexOf('basic=true') == -1)) { // Add link to basic form
				...
				jQuery(function ($) {
					...
					customRows += fromListboxTemplate('Jeu', 'jeuBox', [ { value: '',           label: '-' },
																		 { value: 'Red Dead Revolver'      },
																		 { value: 'Red Dead Redemption'    },
																		 { value: 'Undead Nightmare'       },
																		 { value: 'Red Dead Redemption II' },
																		 { value: 'Red Dead Online'        }
                                                					] );
					customRows += fromListboxTemplate('Année', 'anneeBox', [ { value: '', label: '-'},
																			 { value: '1898'        },
																			 { value: '1899'        },
																			 { value: '1907'        },
																			 { value: '1911'        },
