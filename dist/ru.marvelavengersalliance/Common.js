...
importArticles({
    ...
    articles: [
        ...
        "MediaWiki:Bjqs.js", /* scarlet project  */
        "MediaWiki:Sandbox.js", /* scarlet project  */
    ]
}, {
    type: "style",
    articles: [
        ...
        "MediaWiki:Bjqs.css", /* scarlet project  */
    ]
});
...
function fBox() {
    $('#fbox').append('<iframe scrolling="no" height="275" frameborder="0" align="top" width="290" src="https://www.facebook.com/connect/connect.php?id=maarus&amp%3Bconnections=30" marginwidth="0" marginheight="0"></iframe>');
}
