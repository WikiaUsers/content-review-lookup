...
importArticles({
    ...
    articles: [
        ...
        'w:c:de.harry-grangers-test:MediaWiki:Marquee.js'
...
//Forumsheader wieder über den Boards
var el = $('section.Forum > h3, section.Forum > section.blurb');
$('section.Forum > h3, section.Forum > section.blurb').detach();
$('section.Forum ul.boards li:last-child').css('border','none');
$('ul.boards').before(el);
...
importArticles({
    ...
    articles: [
        ...
        'MediaWiki:Tabchange.js',
        'MediaWiki:GalleryControl.js'
    ]
});
