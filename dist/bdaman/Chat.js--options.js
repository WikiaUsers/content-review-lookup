...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; font-size:150%; bottom:4px; padding-bottom:2px; border: 1px solid black; border-top:0; width:97%; border-bottom-left-radius:10px; border-bottom-right-radius:10px; background:powderblue;" align="center"><img src="http://www.derehamreclaim.co.uk/_images-pages/icon-hammerSpanner.jpg" width="18px"/>Options</div>'); // Prevent multiple buttons from being appended
}
