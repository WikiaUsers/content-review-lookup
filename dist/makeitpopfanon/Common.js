...
window.UserTagsJS = {
	modules: {
			...
			newuser: true,},
	tags: {
		bureaucrat: { link:'Make_It_Pop_Fanon_Wiki:Administrators#Bureaucrat_abilities' },
		sysop: { link:'Make_It_Pop_Fanon_Wiki:Administrators' },
		chatmoderator: { link:'Make_It_Pop_Fanon_Wiki:Chat Moderators' },
		rollback: { u:'Rollback', link:'Make_It_Pop_Fanon_Wiki:Rollbacks' },
