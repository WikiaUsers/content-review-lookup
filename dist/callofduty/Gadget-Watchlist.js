...
var cgscriptloc = cgscriptloc?cgscriptloc:"ul.tools";
...
$.getJSON('http://callofduty.wikia.com/api.php?action=query&list=watchlist&wllimit=1&wldir=older&format=json&wlexcludeuser=' + excludeuser + '&wlprop=ids|user|title|comment', function(wlid) {
...
if (isChat) {
	...
	$(cgscriptloc).append('<li id="WatchlistNotify" onLoad="watchlistupdate()"></li>');
	$('head').append('<style type="text/css">a#WLNotifyLink:visited {color:#77F !important;}</style>');
