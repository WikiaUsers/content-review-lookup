$(document).ready(function() {
    var launchAdding = function() {
            ...
            $('#WikiaRecentActivity').after('<section class="NewSection module" id="NewSection"></section>');
            ...
            for (var i=0; i<Object.keys(getObjects).length; i++) {
                $('#ExplTable').append('<tr><td><img src="https://images.wikia.nocookie.net/swtor/ru/images/'+getObjects[i][1]+'" width="16" height="16"></td><td>'+getObjects[i][0]+'</td></tr>');
            }
        },
        searchCount = 0,
