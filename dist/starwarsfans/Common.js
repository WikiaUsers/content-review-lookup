...
$(document).ready(function() {
	...
	$('#wpUploadDescription').append(document.createTextNode("==Summary==\r\n{{Information\r\n|attention=\r\n|description=\r\n|source=\r\n|author=\r\n|filespecs=\r\n|licensing=\r\n|other versions=\r\n|cat artist=\r\n|cat licensee=\r\n|cat subject=\r\n|cat type=\r\n}}"));
...
/* getParameterByName function: gets the paramaters from the URL */
...
var blogTitle = 'User_blog:Brandon_Rhea/Predict_the_Madness';
if (mediaWiki.config.get('wgPageName') === blogTitle) {
	...
	if (confirmationMessage != '') {
		$('.WikiaHeader').after('<div class="global-notification confirm"><button class="close wikia-chiclet-button"><img src=" https://images.wikia.nocookie.net/common/skins/oasis/images/icon_close.png"></button><div class="msg">' + confirmationMessage + '</div></div>');		
	}
}
// </nowiki></pre>