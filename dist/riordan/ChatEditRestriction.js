...
// Disable message (1 = enabled, 0 = disabled)
    ...
    window.chatRestr.undereditMessage = "Hi "+ wgUserName+"! Thanks for trying to use the CHB Wiki chat room. However, the chat room is only for active editors of the wiki, and you have not yet made the minimum number of edits required to use it. Our chat policy (which can be found at http://camphalfblood.wikia.com/wiki/Camp_Half-Blood_Wiki:Chat_Policy) requires that you make at least 10 edits to be able to enter the chat. We apologize for this inconvenience and hope to see you in the chat soon.";

    // Enable redirect (1 = enabled, 0 = disabled)
    window.chatRestr.enableRedirect = 1;

    // Page to redirect to 
    window.chatRestr.redirectPage = "Camp_Half-Blood_Wiki:Policy";
