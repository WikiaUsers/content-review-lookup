...
$(function() {
	if(skin == "oasis") {
		...
		var comboString = "<div style='margin-top:5px; align:center'><table style='width:100%'><td style='*'><h6>Ilość wizyt od<br />17 lipca 2012</h6></td><td style='text-align:right'><a href='http://s13.sitemeter.com/stats.asp?site=s13wielkabrytania' target='_top'><img src='http://s13.sitemeter.com/meter.asp?site=s13wielkabrytania' alt='SiteMeter' border=0 /></a></td></tr></table></div>";
 
		$sidebar.html($sidebar.html() + comboString);
	} else if(skin == "monobook") {
		var $sidebar = $('#p-tb');
		var comboString = "<div style='margin:5px'></div><h5>licznik wizyt</h5><div class='pBody'><div style='margin-top:2px; margin-bottom:5px'><table style='width:100%; text-align:center'><tr><td style='font-size:85%'>Ilość wizyt od<br />17 lipca 2012</td></tr><tr><td><a href='http://s13.sitemeter.com/stats.asp?site=s13wielkabrytania' target='_top'><img src='http://s13.sitemeter.com/meter.asp?site=s13wielkabrytania' alt='SiteMeter' border=0 /></a></td></tr></table></div></div>";
		$sidebar.html($sidebar.html() + comboString);
	}
});