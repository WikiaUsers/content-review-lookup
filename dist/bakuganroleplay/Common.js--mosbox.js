...
$(function() {
	if(skin == "oasis") {
		...
		var comboString = "<div id='mosbox' style='margin-top:5px; align:center'><table style='width:100%'><td style='*'>Help us add new articles in order to share and develop our wiki information. Although it's not all work, remember to enjoy yourself on this site!<br /></td><td style='text-align:right'><a href='http://bakuganroleplay.wikia.com/wiki/Special:Leaderboard' target='_top'><img src='https://images.wikia.nocookie.net/bakugan/images/f/f7/Yjbxduungb.png' alt='The only game on this wiki that has Rassilon's Great Seal of Approval' border=0 /></a></td></tr></table></div>";
