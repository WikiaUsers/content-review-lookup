...
var i18n = {
	blockedNotice: '您不能编辑此精灵图，因为您已被封禁。',
	blockedReason: '原因：$1',
	browserActionNotSupported: '您的浏览器不支持。',
	changesSavedNotice: '已保存您的更改。',
	controlNewName: '新建名字',
	ctxDeleteImage: '删除',
	ctxDownloadImage: '下载',
	ctxReplaceImage: '替换',
	diffError: '无法获取差异',
	diffErrorMissingPage: '无法获取页面',
	dupeName: '此名字已存在。',
	dupeNamesNotice: '存在重复的名字，在保存之前请解决此问题。',
	errorApi: 'API错误',
	errorConnection: '连接错误',
	errorConnectionText: '请检查您的网络连接',
	errorGeneric: '错误',
	errorHttp: 'HTTP错误',
	genericError: '出现了一些错误',
	...
	noPermissionNotice: '您没有权限编辑此精灵图。',
	panelChangesIdTitle: '数据更改',
	panelChangesNoDiffFromCur: '与当前版本无差异。',
	panelChangesSheetTitle: '精灵图表更改',
	panelChangesTitle: '检查您的更改',
	panelCloseTip: '关闭',
	panelConflictCurText: '当前文本',
	panelConflictReview: '检查更改',
	panelConflictSave: '保存',
	panelConflictText: '发生了编辑冲突，并且无法自动解决。',
	panelConflictTitle: '编辑冲突',
	panelConflictYourText: '您的文本',
	panelDiscardContinue: '继续编辑',
	panelDiscardDiscard: '放弃更改',
	panelDiscardText: '您确定要放弃您的更改吗？',
	panelDiscardTitle: '未保存的更改',
	panelEcchangesReturn: '返回编辑冲突表单',
	panelEcchangesTitle: '检查您的手动更改',
	sectionPlaceholder: '输入一个分类名',
	sectionUncategorized: '未分类',
	titleEditing: '正在编辑$1',
	toolbarHelp: '帮助',
	toolbarHelpPage: 'en:Help:Sprite editor',
	toolbarNewImage: '新建图像',
	toolbarNewSection: '新建分类',
	toolbarRedo: '恢复',
	toolbarReviewChanges: '检查更改',
	toolbarSave: '保存',
	toolbarSummaryLabelTip: '剩余字节数',
	toolbarSummaryPlaceholder: '您所作更改的摘要',
	toolbarToolDeprecate: '弃用',
	toolbarToolDeprecateTip: '将名字切换为已弃用',
	toolbarTools: '工具',
	toolbarUndo: '撤销',
};
