...
//Nutt, please dont touch this, im going to be using this as the basis for ships and weather in chat. -tato

//known issues so far: if the mouse cursor is on the screen before the page loads, script breaks and throws errors 
//about not being able to read property "active" of "undefined" at line 409(somewhere around there). However, if mouse cursor starts offscreen
//and then moves onto screen after pageload is complete, script works fine
...
window.snowStorm = {
	...
	excludeMobile: false,		// Snow is likely to be bad news for mobile phones' CPUs (and batteries.) By default, be nice.
	...
	flakeWidth: 200,			// Max pixel width reserved for snow element
	flakeHeight: 200,			// Max pixel height reserved for snow element
