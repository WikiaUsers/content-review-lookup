...
/*Modified by Seaside98 and ShermanTheMythran. Not recommended that you edit this.*/
window.ajaxPages = [ 'Special:RecentChanges', 'Special:WikiActivity', 'Special:Log' ];
window.ajaxRefresh = 2500;
window.ajaxIndicator = 'http://images2.wikia.nocookie.net/dev/images/8/82/Facebook_throbber.gif';
...
( function ( window, $, mw, Wikia ) {
	...
	function preloadAJAXRL() {
		...
		var $appTo = $( '.firstHeading' ).length ? $( '.firstHeading' ) :
			// most oasis pages
			( $( '#WikiaPageHeader h2 nav ul' ).length ? $( '#WikiaPageHeader h2 nav ul' ) :
				// wikiactivity
					( $( '#WikiaPageHeader h2' ).length ? $( '#WikiaPageHeader h2' ) :
...
importScriptPage('MediaWiki:Quiz.js','drew1200test');