...
var chatTopic = '<font color="#FFFFFF">Welcome to the Resident Evil Wiki Chat.<br /> All personnel should revise standardized <a href="/wiki/en:Resident_Evil_Wiki:Chat_Policy" target="_blank" title="Resident Evil Wiki:Chat Policy"><u>protocol</u></a> while utilising the system.</font>'
...
setInterval(function() {
	$('#Rail .User.chat-mod:not(.admin) .username').each(function() {
		if (!this.innerHTML.match(/Forerunner|Spleepoppetween|News Bot|Twilight Sparkle|Helljumper 96|Riley Heligo/)) {
