...
$('#Write textarea').keydown(function(e) {
	if( $('#Write textarea').val() == "/lag" && e.keyCode == 13 ) {
		...
		unKey(this);
		if(skinType != 'fall') { addFallSkin(); } else { removeSkin(); }
