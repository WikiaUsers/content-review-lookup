 ...
 * |  Please discuss changes on the talk page, https://zh.wikipedia.org/wiki/Wikipedia:VPT or GitHub before editing.  |
 * |_________________________________________________________________________________|
 *
 * Built from source code at HanAssist GitHub repository https://github.com/wikimedia-gadgets/HanAssist.
 * All changes should be made in the repository, otherwise they will be lost.
 *
 * To update this script from GitHub, you must have a local repository set up. Then
 * follow the instructions at https://github.com/wikimedia-gadgets/HanAssist/blob/main/README.MD#%E6%9E%84%E5%BB%BA%E6%96%B9%E6%B3%95.
 *
 * For license information, see https://github.com/wikimedia-gadgets/HanAssist/blob/main/LICENSE.
 */
// <nowiki>

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
    typeof define === 'function' && define.amd ? define('HanAssist', ['exports'], factory) :
    ...
    function elect(candidates, locale) {
        var _a;
        const fallback = (_a = FALLBACK_LIST[locale]) !== null && _a !== undefined ? _a : DEFAULT_FALLBACK;
    ...
    function preprocessLocale(locale) {
        if (locale == null) {
    ...
    function safeElect(candidates, locale) {
        ...
        const result = (_a = elect(candidates, locale)) !== null && _a !== undefined ? _a : '';
    ...
    function convByVar(candidates) {
        var _a, _b;
        return safeElect(candidates, (_b = (_a = mw.config.get('wgUserVariant')) !== null && _a !== undefined ? _a : new URL(location.href).searchParams.get('variant')) !== null && _b !== undefined ? _b : mw.user.options.get('variant'));
    }
    /**
    ...
    function batchConv(candidatesDict, locale = mw.config.get('wgUserLanguage')) {
        ...
        for (const key in candidatesDict) {
            ...
            if (isPlainObject(candidates)) {
                const electResult = (_a = elect(candidates, locale)) !== null && _a !== undefined ? _a : '';
    ...
    {
        void Promise.resolve().then(function () { return shims; });
    }
