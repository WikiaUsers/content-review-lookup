...
if (wgNamespaceNumber == 6) {
	function QLicenseUI() {
		...
		if (document.getElementById('ESWLicensed')) {
			html += '&nbsp;<span style="color:red; font-weight:bold; text-align:center;">Posiada licencję!</span></p>';
		} else {
			html += '&nbsp;<span style="color:green; font-weight:bold; text-align:center;">Nie posiada licencji!</span></p>';
		}
	...
	if (wgCanonicalNamespace == 'File') {
		...
		importArticles({
			type: "script",
			articles: ['u:pl.tes:MediaWiki:APIQuery.js']
		});
	}
}