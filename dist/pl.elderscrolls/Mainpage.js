...
$('.GamesArrowLeft').click(function () {
    scroll = $('#TestScroll1').scrollLeft();
    $('#TestScroll1').animate({'scrollLeft': scroll-1181},1000);
});
...
$('#communitytitle').click(function(){
	if (timerTime > 0) {
		...
		if ($('#communitylinks').hasClass('closed')) {
			$('#communitylinks').removeClass('closed').addClass('opened').animate({ height: "240px" }, 1000).css('padding-top','5px');
