...
modnav += '<li class="subnav-3-item"><a class="subnav-3a" href="http://casualtybbc.wikia.com/wiki/Casualty_Wiki">Casualty Wiki</a></li>';
modnav += '<li class="subnav-3-item"><a class="subnav-3a"></a></li>';
modnav += '<li class="subnav-3-item"><a class="subnav-3a" href="http://casualtybbc.wikia.com/wiki/Special:Forum">Casualty Wiki Forum</a></li>';
modnav += '<li class="subnav-3-item"><a class="subnav-3a" href="/wiki/Special:Forum ">Holby City Wiki Forum </a></li>';
modnav += '</ul>';
modnav += '</li>';
