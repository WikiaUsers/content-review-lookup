...
$(function() {
    ...
    var names = {}, cacheEnabled = (window.linkImagePopupCachingDisabled ? false : true), pendingPages = {},
      categories = ['Characters', 'Living characters', 'Deceased characters', 'Males',
      'Females', 'Monkeys', 'Apes', 'Bears', 'Penguins',
      'Dogs'//character categories
      'Episodes', 'Season 1 episodes'//episode categories
