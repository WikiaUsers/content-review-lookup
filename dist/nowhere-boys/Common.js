...
// Changing PuppetSagaBot to Aura
$(".edited-by a[href='http://nowhere-boys.wikia.com/wiki/Message_Wall:PuppetSagaBot']:not(.subtle)").text("Aurathegrojfan14");
$("img[src='https://images.wikia.nocookie.net/4b23a926-8401-48e8-aeb9-3546a083448b/scale-to-width-down/50']").attr('src', 'https://images.wikia.nocookie.net/74b33543-23a1-4a83-b327-ac6824539664/scale-to-width-down/50');
$("#notificationsEntryPoint").click(
    function() {
        console.log("clicked...waiting...");

        setTimeout(
            function() {
$("#notificationsEntryPoint p").text(function () {
    return $(this).text().replace("PuppetSagaBot", "Aurathegrojfan14"); 
});
$("#notificationsEntryPoint p").text(function () {
    return $(this).text().replace("PuppetSagaBot\'s", "Aurathegrojfan14\'s"); 
});
$("img[src='https://images.wikia.nocookie.net/4b23a926-8401-48e8-aeb9-3546a083448b/scale-to-width-down/50']").attr('src', 'https://images.wikia.nocookie.net/74b33543-23a1-4a83-b327-ac6824539664/scale-to-width-down/50');
            },
            600);
    });
$("a[href='http://nowhere-boys.wikia.com/wiki/Message_Wall:PuppetSagaBot']").attr('href', 'http://nowhere-boys.wikia.com/wiki/Message_Wall:Aurathegrojfan14');
/* $("a").attr('href','/wiki/Special:Random');
setTimeout(
  function() 
  {
    $("a").attr('href','/wiki/Special:Random');
...
{
    mw.util.addCSS(
        "#numbertwo { display: none; } \
         #numbertwo[common=" + mw.config.get('wgUserName') + "] { display: inline !important; } \
         #numberone[common=" + mw.config.get('wgUserName') + "] { display: none !important; }"
    );
});
$(".edited-by").prepend('<a href="javascript:void(0)" class="hid-the-button" onclick="return false">[-]</a>');
$(function() {
    $(".hid-the-button").click(function () {
    $(this).html(
        $(this).html() == "[-]" ? "[+]" : "[-]");
    });
});
$(".hid-the-button").click(function(){
    $(this).parents(".MiniEditorWrapper").children(".editarea").toggle();
    $(this).parents(".MiniEditorWrapper").children(".msg-toolbar").toggle();
});
$(".replacewithreddit").replaceWith('<script async src="https://www.redditstatic.com/comment-embed.js"></script>');