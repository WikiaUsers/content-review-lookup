...
//        }
    ...
    access:function(article,rank) {
      ...
      // httpRequest.open('GET', 'http://ageofempiresonline.wikia.com/index.php?action=raw&ctype=text/css&title='+article+'&templates=expand&section=0', true);
      // Try full page request for now
      httpRequest.open('GET', 'http://ageofempiresonline.wikia.com/index.php?title='+article, true);
      httpRequest.send('');
    }
  };
}();
...
function LocationMap() {
  ...
  this.access = function() {
    ...
    httpRequest.open('GET', 'http://ageofempiresonline.wikia.com/index.php?title=File:MapChunk_'+chunkx+'_'+chunky+'.jpg', true);
    httpRequest.send('');
    return true;
  }
