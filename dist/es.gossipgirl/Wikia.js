...
window.SkinNotification = {
	article: 'Usuario Blog:LordVamdemon666/Bienvennid@s',
	key: 'NfSkin',
	init: function() {
	...
	render: function() {
		...
		var sn = $('<div data-type="100"><a class="sprite close-notification"></a>Bienvenido a el wiki, quedate a editar e informate de todo<a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'"> aquí</a>.</div>');
...
function agregarEnlaceSkin() {
	...
	$('#WikiaFooter').children('div.toolbar').eq(0).children('ul.tools').eq(0).append('<li><a href="'+surl+'"><img width="15" height="15" class="monobook-icon" src="'+stylepath+'/common/blank.gif"/></a> <a href="'+surl+'" id="ca-changeskin" title="Ver Gossip Girl con la piel Monobook">Cambiar la apariencia a Monobook</a></li>');
...
function Gossip_Girl_WikiaSkinLoad() {
	var ug = '';
