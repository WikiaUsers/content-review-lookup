...
// Add external javascipt files
// Thanks to Dantman
document.write('<script type="text/javascript" src="'
		+ '/index.php?title=MediaWiki:HeroQuest.js'
...
// **************************************************
// -end- Hide namespaces in categories (Splarka)
// **************************************************
...
*/
 ...
 if (mwCustomEditButtons) {
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/heroquest/images/b/b4/Button_lienjournal.png",
     "speedTip": "Log entry",
     "tagOpen": "{{",
     "tagClose": "}}",
     "sampleText": "subst:Log|"};
  }