...
importArticles({
 ...
 articles:[
  ...
  'MediaWiki:Common.js/mainpage.js',
  'MediaWiki:Common.js/recipe.js',
...
if (mw.config.get('wgPageName') == 'Meisterschaftsplaner') {
  (new Image()).src = "https://images.wikia.nocookie.net/test-lol/de/images/b/ba/Button-icons.jpg";
  (new Image()).src = "https://images.wikia.nocookie.net/test-lol/de/images/c/ca/Req-bars.png";
  (new Image()).src = "https://images.wikia.nocookie.net/test-lol/de/images/d/de/Tree-icons.png";
  importArticles({
  type: 'script',
  articles: ['MediaWiki:Data.js', 'MediaWiki:Calculator.js', 'MediaWiki:ZeroClipboard.js']
  });
}
...
// Skin-Wechsel-Button für Monobook-Design zu Oasis-Design und umgekehrt.
// Außerdem Skin-Wechsel-Button von Monobook und Oasis zu Wikiamobile-Design.
 
$( function () {
  if ( !document.getElementById( 'ca-skins' ) ) {
    if ( skin === 'oasis' || skin === 'wikia' ) {
      $( '<li id="ca-skins"><a href="/index.php?title=' + encodeURIComponent( wgPageName ) + '&useskin=monobook" title="Skin wechseln">MB</a></li>' ).appendTo( '#AccountNavigation' ); 
    } else {
      $( '<li id="ca-skins"><a href="/index.php?title=' + encodeURIComponent( wgPageName ) + '&useskin=wikia" title="Skin wechseln">Oasis</a></li>' ).appendTo( '#p-cactions > .pBody > ul' ); 
    } 
  }
} );
