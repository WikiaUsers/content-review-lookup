// Dodatkowe przyciski w edytorze źródłowym
if (typeof (mwCustomEditButtons) !== 'undefined') {
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Button_center.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/2/29/Button_justify.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/8/89/Button_bigger.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/0/0d/Button_smaller.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/3/30/Btn_toolbar_rayer.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Button_underline.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/3/3b/Comment-button-bg.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/6/62/Button_desambig.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/5/50/Button_tidyman.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/b/b4/Button_category03.png',
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		'imageFile': 'https://upload.wikimedia.org/wikipedia/commons/9/9e/Button_star_better.png',
