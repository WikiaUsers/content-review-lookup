...
var ajaxPages =["Special:WikiActivity", "Special:WikiActivity"];
...
UserTagsJS.modules.custom = {
	'Cuddlefan': ['sysop', 'bureaucrat', 'handy'],
	'Yong feng': ['sysop', 'bureaucrat', 'petunia'],
	'Denzal689': ['flaky'],
        'AnimationFan15': ['sysop', 'mime'],
};
...
window.MessageWallUserTags = {
    ...
    users: {
        'username': 'usergroup',
        'Cuddlefan': 'Founder • Bureaucrat • Handy',
        'Yong_feng': 'Bureaucrat • Petunia',
        'Dominik_Player_13': 'Admin',
        'AnimationFan15': 'Admin • Mime',
    }
};
