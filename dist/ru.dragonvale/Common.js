...
$(function(){
  ...
  $('.page-Dragon_Reference_Chart div.var2').last().prepend('<label>Show dragons with element:</label><select id="elementSelector"><option value="all">All</option><option value="plant">Plant</option><option value="earth">Earth</option><option value="fire">Fire</option><option value="cold">Cold</option><option value="lightning">Lightning</option><option value="water">Water</option><option value="air">Air</option><option value="metal">Metal</option><option value="epic">Epic</option></select>');
