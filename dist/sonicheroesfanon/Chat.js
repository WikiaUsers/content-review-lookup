...
var chatTopic = 'Welcome to the Sonic Heroes Fanon Wiki Chat! Please make sure to read the rules <a href="/wiki/Project:Chat" target="_blank" title="Project:Chat"><u>here</u></a>, OR DIE!!!'
 
//Switch to night button
var night_button = 'Switch to Metal Overlord';
 
//Switch to day button
var day_button = 'Switch to Seaside Hill';
...
//
  ...
  //Self text background color
    var selfTextColorDay = '#ffd28a';
 
  //Chat background color
    var backgroundColorDay = '#068407';
 
  //Chat foreground color
    var foregroundColorDay = '#fbdea7';
 
  //User stats foreground color
    var userStatsColorDay = 'skyblue';
