/***********************************************************************/
/***********************************************************************/
/******* ChatCommand.js 2.4.3 - Chat Commands for Chat since 2016. *****/
...
/***********************************************************************/
    ...
    'rainbow':     function (s,t) {
                 if (t.charAt(0) === '/') {
                     ...
                     s = s.replace('[rainbow]', '<span style="color:#FFB6C1;font-size:100%;animation-name:rainbow;animation-duration:10s;animation-iteration-count:infinite;-webkit-background-clip:text;-webkit-text-fill-color:transparent;">');
                 }
                 return s;
             },
    's':    function (s,t) {
