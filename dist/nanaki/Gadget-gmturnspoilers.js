window.spoilerTags = [
    {
        ...
        notice: 'This section contains spoilers from GM turns.<p><a href="#show">Click here to reveal it.</a></p>'
    }
];
...
$(function(){
    $(spoilerTags).each(function(i, tag) {
        $('#mw-content-text').find(tag.selector).each(function(i, elem) {
            ...
            var notice = $('<div></div>').addClass('spoiler-section-notice').append($('<span></span>').html(tag.notice)).css({position:'absolute'});
            notice.css({
