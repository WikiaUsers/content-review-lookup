...
$(function() {
	...
	if (protectionLevel === "autoconfirmed") {
		mimicIndicator(
			...
			"9/9b",
			"หน้านี้ถูกกึ่งล็อก สามารถแก้ไขได้เฉพาะผู้ใช้ที่ลงทะเบียนแล้ว"
		...
		mimicIndicator(
			...
			"8/85",
			"หน้านี้ถูกล็อก สามารถแก้ไขได้เฉพาะกรรมการบริหาร"
		).appendTo($(".mw-indicators"));
		...
		mimicIndicator(
			...
			"4/49",
			"หน้านี้ถูกล็อกอย่างสมบูรณ์ สามารถแก้ไขได้เฉพาะผู้ดูแลระบบ"
		).appendTo($(".mw-indicators"));
	}
});