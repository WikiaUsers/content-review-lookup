...
function placeJodl(radius) {
	...
	if (typeof radius == 'undefined') {
		...
		var jodlleft = Math.floor( Math.random() * ($('body').width()-80) )
	} else {
		var jodlpos = $('div#jodl').position()
		var jodltop = jodlpos.top - radius + Math.floor(Math.random() * radius * 2)
...
function spawnJodl() {
	...
	}).append('<audio id="jodl1"><source src="https://images.wikia.nocookie.net/hitlerparody/images/8/86/Jodlghost1.ogg"></audio><audio id="jodl2"><source src="https://images.wikia.nocookie.net/hitlerparody/images/5/5a/Jodlghost2.ogg"></audio><audio id="jodl3"><source src="https://images.wikia.nocookie.net/hitlerparody/images/c/c8/Jodlghost4.ogg"></audio>' /* problems with older IDM */
	).click( function() {
		tauntJodl()
	}).mouseenter( function() {
		placeJodl(40)
