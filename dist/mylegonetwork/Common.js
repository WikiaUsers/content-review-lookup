...
$('.AdminDashboardGeneralHeader h1, #firstHeading')[s].innerHTML += '&nbsp;<span style="font-size: xx-small; border-bottom: 1px dotted; cursor:help;" title="Enable soft auto-refreshing Recent Changes every 60 seconds">AJAX:</span><input type="checkbox" id="ajaxRCtoggle" onClick="toggleRC();">';
...
$('ul.tools li:first-child').after('<li><a href="/index.php?title=w:c:lego.answers">Ask a question about LEGO!</a></li>');