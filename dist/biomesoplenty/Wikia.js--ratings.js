        ...
        self = {
                    ...
                    .append(
                        ...
                        $( '<div>' )
                            ...
                            .append(
                                ...
                                $( '<a>' )
                                    .attr( {
                                        href: mw.util.wikiGetlink( 'Biomes_O%27_Plenty_Wiki:Advertisements' ),
                                        title: 'Biomes_O%27_Plenty_Wiki:Advertisements'
                                    } )
                                    .text( 'here' ),
                                '.'
                            )
            ...
            submitFeedback: function () {
                ...
                var rating = $( '#ar-rating' ).attr( 'data-rating' ) || '-1',
                    ...
                    params = {
                        action: 'edit',
                        title: 'Biomes_O%27_Plenty_Wiki:Feedback/' + mw.util.wikiUrlencode( conf.wgPageName ),
                        text: toSubmit,
