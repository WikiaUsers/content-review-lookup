...
$(document).ready(function() {
    ...
    $("span#ampOptionsHarness").html('<div id="ampOptions"> <div id="ampOptionsInner"> <div id="numOfAmpsOption">Number of Damage Amplifiers affecting the Defense: <select name="numOfAmps" id="numOfAmps"> <option value="0">0</option> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </div> <div id="firstAmpOption" style="display: none;"> <span id="firstAmpFirstWord" style="display: none;">First </span>Damage Amplifier\'s Mark: <select name="firstAmp" id="firstAmp"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </div> <div id="secondAmpOption" style="display: none;">Second Damage Amplifier\'s Mark: <select name="secondAmp" id="secondAmp"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </div> <div id="thirdAmpOption" style="display: none;">Third Damage Amplifier\'s Mark: <select name="thirdAmp" id="thirdAmp"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </div> </div> </div> <center> <span id="showAmpOptions" class="ampOptionsTrigger">Show Damage Amplifier Options</span> <span id="hideAmpOptions" class="ampOptionsTrigger ampOptionsTriggerHidden">Hide Damage Amplifier Options</span> </center>');
    $("span#generatorOptionsHarness").html('<div id="generatorOptions"> <div id="generatorOptionsInner"> <div id="numOfGeneratorsOption">Number of Shield Generators on the Base: <select name="numOfGenerators" id="numOfGenerators"> <option value="0">0</option> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </div> <div id="firstGeneratorOption" style="display: none;"> <span id="firstGeneratorFirstWord" style="display: none;">First </span>Shield Generator\'s Mark: <select name="firstGenerator" id="firstGenerator"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </div> <div id="secondGeneratorOption" style="display: none;">Second Shield Generator\'s Mark: <select name="secondGenerator" id="secondGenerator"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </div> <div id="thirdGeneratorOption" style="display: none;">Third Shield Generator\'s Mark: <select name="thirdGenerator" id="thirdGenerator"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </div> </div> </div> <center> <span id="showGeneratorOptions" class="generatorOptionsTrigger">Show Shield Generator Options</span> <span id="hideGeneratorOptions" class="generatorOptionsTrigger generatorOptionsTriggerHidden">Hide Shield Generator Options</span> </center>');
   ...
   $("#changeBonusButton").click(function() {
      ...
      $(".BH").each(function() {
        ...
        if ($("select#numOfGenerators").val() == 3) {
