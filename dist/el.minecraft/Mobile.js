...
/* Use better random link */
mw.loader.using( [ 'skins.minerva.scripts.top', 'mediawiki.util' ] ).then( function() {
	$( '.mw-ui-icon-random' ).prop( 'href', mw.util.getUrl( 'Special:RandomRootPage' ) );
} );
