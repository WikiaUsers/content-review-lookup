...
$(document).ready(function(){
	...
	//Zawartość
	$('<div class="fb-like-box" data-href="https://www.facebook.com/pages/RabbideerZ-Wiki-spo%C5%82eczno%C5%9B%C4%87-fan%C3%B3w-K%C3%B3rlik%C3%B3w/1479807385605888" data-width="253" data-height="361" data-show-faces="false" data-stream="true" colorscheme="dark" data-header="false"></div>').css({marginTop:"10px", marginLeft:"47px"}).appendTo("#FacebookWnd");
