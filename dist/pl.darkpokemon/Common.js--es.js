...
$(function() {
	...
	$combo = $('<select />').attr('id', 'Opis_Zmian').change(function() {
		var val = $(this).val();
...
$(function() {
	...
	$('.module_content #Opis_Zmian').css({"width": '258px'});
	$('.module_content #Opis_Zmian').css({"margin-bottom": '5px'});
})
