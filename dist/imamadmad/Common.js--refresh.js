(function (window, $, mw, Wikia) {
    ...
    var ajaxIndicator = window.ajaxIndicator || config.stylepath + '/common/images/ajax.gif';
    var ajaxTimer;
    var ajRefresh = window.ajaxRefresh || 60000;
    var ajPages = window.ajaxPages || [];
    var ajSpecialPages = window.ajaxSpecialPages || ['Recentchanges'];
