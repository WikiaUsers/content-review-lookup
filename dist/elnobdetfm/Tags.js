...
chatags.tags = {
	...
	'spoiler':    function (s,t) {
				if (t.charAt(0) === '/') {
					...
					s = s.replace('[spoiler]', '<div class="spoiler"><input type="button" onclick="showSpoiler(this);" value="Spoiler" /><div class="inner" style="display:none;">');
				}
				return s;
			},
	'img':   function (s,t) {
	...
	'youtube':   function (s,t) {
				 ...
				 if (t.charAt(0) !== '/') {
					 try {
						 t = t.split('="');
						 t[1] = t[1].replace('"', '');
						 s = s.replace('[youtube="' + t[1] + '"]', '<iframe class="chat-ytvideo" width="480" height="270" src="https://www.youtube.com/embed/' + mw.html.escape(t[1]) + '" frameborder="0" allowfullscreen></iframe>');
					 } catch(e) { console.log(e) }
				 }
				 return s;
			 }
