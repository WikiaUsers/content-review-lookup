...
// Configuration
var bracketPages = ['Books_Hub:Mockingjay_Bracket/1','Books_Hub:Mockingjay_Bracket/2','Books_Hub:Mockingjay_Bracket/3','Books_Hub:Mockingjay_Bracket/4']; // What pages should the script load on?
var bracketName = 'Books_Hub:Mockingjay_Bracket'; // What is the name of the bracket pages?
var bracketFinal = 4; // What is the final bracket page?
var blogTitle = 'User_blog:Asnow89/Create_the_Ultimate_Mockingjay_Fantasy_Cast'; // What is the bracket blog title?
var blogID = '8130'; // What is the bracket blog ID?
var templateName = 'Bracket'; // What is the name of the bracket template?
var bracketPageName = 'User:' + wgUserName + '/Mockingjay_bracket'; // What should the namespace of the bracket submissions be?
...
if(wgPageName == 'Books_Hub:Mockingjay_Bracket/1') {
	var bracketEntries = {
		'left-2-1': [{
			...
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/d/dc/Annie2_Melissa_Benoist.jpg'
		}],
		'left-2-2': [{
			'name': 'Ginny Gardner',
		...
		'right-2-1': [{
			'name': 'Molly Quinn',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/6/6d/Annie3_MollyQuinn.jpg'
		}, {
			'name': 'Saoirse Ronan',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/6/69/Annie4_Saoirse_Ronan.jpg'
		}],
		'right-2-2': [{
			'name': 'Karen Gillan',
...
else if(wgPageName == 'Books_Hub:Mockingjay_Bracket/2') {
	var bracketEntries = {
		'left-2-1': [{
			'name': 'Sigourney Weaver',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/7/7e/Coin1_Sigourney-Weaver.jpg'
		}, {
			'name': 'Meryl Streep',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/2/2b/Coin2_Meryl_streep.jpg'
		}],
		'left-2-2': [{
			'name': 'Blythe Danner',
		...
		'right-2-1': [{
			'name': 'Kate Winslett',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/b/bc/Coin3_Kate_Winslett.png'
		}, {
			'name': 'Cate Blanchett',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/2/2e/Coin4_Cate_Blanchett.jpg'
		}],
		'right-2-2': [{
...
else if(wgPageName == 'Books_Hub:Mockingjay_Bracket/3') {
	var bracketEntries = {
		'left-2-1': [{
			'name': 'Teresa Palmer',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/3/3f/Cressida1_Teresa_Palmer.jpg'
		}, {
			'name': 'Eliza Taylor',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/f/f0/Cressida2_Eliza_Taylor.jpg'
		}],
		'left-2-2': [{
		...
		'right-2-1': [{
			'name': 'Odette Annable',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/c/cc/Cressida3_Odette_Annable.jpg'
		}, {
			'name': 'Olivia Hallinan',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/a/ae/Cressida4_Olivia_Hallinan.jpg'
		}],
		'right-2-2': [{
			'name': 'Rutina Wesley',
		...
		'submit': [{
			'buttonText': 'Next Casting', // What should the submit button say?
			'submitText': 'Are you happy with your current selections? If so, click the button below for the final set of choices!' // What should the text accompanying the submit button say?
		}]
	};
}
else {
	var bracketEntries = {
		'left-2-1': [{
			'name': 'Alex Pettyfer',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/1/1c/Finnick1_Alex_Pettyfer.jpg'
		}, {
			'name': 'Hunter Parrish',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/b/b4/Finnick2_Hunter_Parrish.jpg'
		}],
		'left-2-2': [{
			'name': 'Armie Hammer',
		...
		'right-2-1': [{
			'name': 'Zac Efron',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/e/e9/Finnick3_zac-efron.jpg'
		}, {
			'name': 'Xavier Samuel',
			'image': 'https://images.wikia.nocookie.net/bracketv3/images/2/2f/Finnick4-Xavier_Samuel.jpg'
		}],
		'right-2-2': [{
								...
								if (response.edit.result == 'Success') {
									if(mediaWiki.config.get('wgPageName') == bracketName + '/' + bracketFinal) {
										$.ajax({
											...
											window.location.replace(wgServer + '/wiki/' + blogTitle + '?bracketSubmit=' + submittedMessage + '#comm-text-' + match[1]);
											setCookie('bracket',1,10);
										});
									}
									else {
										$('.createbracket .loader').css('display', 'none');
										window.location.replace(wgServer + '/wiki/' + bracketName + '/' + nextBracketNumber);								
									}
								} 
								else {
									$('.createbracket .loader').css('display', 'none');
                        ...
                        // If so, update the bracket page and redirect to the blog
                            ...
                            callAPI({
                                ...
                                if (response.edit.result == 'Success') {
									if(mediaWiki.config.get('wgPageName') == bracketName + '/' + bracketFinal) {
										$('.createbracket .loader').css('display', 'inline');
										window.location.replace(wgServer + '/wiki/' + blogTitle + '?bracketSubmit=' + editMessage + '#WikiaArticleComments');
									}
									else {
										$('.createbracket .loader').css('display', 'none');
										window.location.replace(wgServer + '/wiki/' + bracketName  + '/' + nextBracketNumber);									
