...
$(document).ready(function(){
	...
	//Zawartość
	$('<div class="fb-like-box" data-href="https://www.facebook.com/pages/Risenpedia/469792026476449?fref=ts" data-height="361" data-show-faces="false" data-stream="true" colorscheme="light" data-header="false"></div>').css({marginTop:"10px", marginLeft:"47px"}).appendTo("#FacebookWnd");
