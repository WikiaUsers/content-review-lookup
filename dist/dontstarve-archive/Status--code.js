...
/* Documentation: dev.wiki.com/Status
/* ######################################################################### */
...
function getUserStatus(data) {
	...
	if(recentEdits > 0 && recentEdits < 2) {
		return {
			status: 'Online',
			color: 'green',
			image: '//vignette3.wiki.nocookie.net/scratchpad/images/5/58/Ledgreen.png/revision/latest/scale-to-width-down/20'
		};
	} else if(recentEdits > 1 && recentEdits < 10) {
		return {
			status: 'Editing',
			color: 'yellow',
			image: '//vignette3.wiki.nocookie.net/scratchpad/images/0/0a/Ledyellow.png/revision/latest/scale-to-width-down/20'
		};
	} else if(recentEdits > 9) {
		return {
			status: 'Busy editing',
			color: 'orange',
			image: '//vignette2.wiki.nocookie.net/scratchpad/images/8/80/Ledorange.png/revision/latest/scale-to-width-down/20'
		};
	} else {
		return {
			status: 'Away',
			color: 'red',
			image: '//vignette3.wiki.nocookie.net/scratchpad/images/6/6d/Ledred.png/revision/latest/scale-to-width-down/20'
		};
	}
}
