$(function() {
  if(mw.config.get('wgNamespaceNumber') === 0) {
    ...
    $('.WikiaPageHeader h1').after('<a href="/wiki/Galeria:' + mw.config.get('wgPageName') + '"><img src="http://i.imgur.com/T7KMTWI.png" title="Odwiedź galerię artykułu ' + mw.config.get('wgTitle') + '" /></a>');
 } else {
