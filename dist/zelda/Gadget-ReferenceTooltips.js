...
window.pg || $(document).ready( function($) {
	...
	// Make sure we are in article, project, help or user namespace
		...
		$(".reference").each( function() {
			...
			$(this)[ isTouchscreen ? 'click' : 'hover' ](function( e ){
					...
					showTimer = setTimeout( function() {
							...
							$(tooltipNode).css({top: o.top - oH - 29, left: o.left - 7 }); ///Added 29 for the gamepedia netbar
							...
							if( checkFlip ) {
								if( o.top < tooltipNode.offsetHeight + ( window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0 ) ) { // is part of it above the top of the screen?
									$(tooltipNode).addClass("RTflipped").css({top: o.top + 12 - 29}); ///Added 29 for the gamepedia netbar
