...
hotcat.settings.biggest_wikis=["en","de","ru","es","fr","pl","nl","ja","it","pt","ka","fi","cs","hu","tr","uk","ko","el","sr","da","sv","no","zh","bg","hr","ro","la","sl","id"]; //Biggest foreign wikis, sorted by number of articles
 
//List of wikis in other languages - code, language and accepted interwiki links
hotcat.settings.wikis=[
{id:'bg', name:'Bulgarian', domain:'starwars.fandom.com', path:'/bg/', interlang:true, installed_iws:['ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'ca', name:'Catalan', domain:'starwars.fandom.com', path:'/ca/', interlang:true, installed_iws:['bg','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'cs', name:'Czech', domain:'starwars.fandom.com', path:'/cs/', interlang:true, installed_iws:['bg','ca','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'da', name:'Danish', domain:'starwars.fandom.com', path:'/da/', interlang:true, installed_iws:['bg','ca','cs','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'de', name:'German', domain:'www.jedipedia.net', path:'/', interlang:false,installed_iws:['bg','ca','cs','da','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'el', name:'Greek', domain:'starwars.fandom.com', path:'/el/', interlang:true, installed_iws:['bg','ca','cs','da','de','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
...
{id:'eo', name:'Esperanto', domain:'starwars.fandom.com', path:'/eo/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'es', name:'Spanish', domain:'starwars.fandom.com', path:'/es/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'fa', name:'Persian', domain:'starwars.fandom.com', path:'/fa/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'fi', name:'Finnish', domain:'jedipedia.fi', path:'/', interlang:false, installed_iws:['bg','ca','cs','da','de','el','en','es','fa','fr','fy','hr','hu','id','it','ja','ko','la','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','tr','uk','zh']},
{id:'fr', name:'French', domain:'starwars.fandom.com', path:'/fr/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'fy', name:'West Frisian', domain:'starwars.fandom.com', path:'/fy/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'ga', name:'Irish', domain:'starwars.fandom.com', path:'/ga/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'gl', name:'Galician', domain:'starwars.fandom.com', path:'/gl/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'gsw', name:'Alemannic German', domain:'starwars.fandom.com', path:'/gsw/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'hr', name:'Croatian', domain:'starwars.fandom.com', path:'/hr/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'hu', name:'Hungarian', domain:'starwars.fandom.com', path:'/hu/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'id', name:'Indonesian', domain:'starwars.fandom.com', path:'/id/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'is', name:'Icelandic', domain:'starwars.fandom.com', path:'/is/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'it', name:'Italian', domain:'starwars.fandom.com', path:'/it/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'ja', name:'Japanese', domain:'starwars.fandom.com', path:'/ja/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'ka', name:'Georgian', domain:'starwars.fandom.com', path:'/ka/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'ko', name:'Korean', domain:'starwars.fandom.com', path:'/ko/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'la', name:'Latin', domain:'starwars.fandom.com', path:'/la/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'mn', name:'Mongolian', domain:'starwars.fandom.com', path:'/mn/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'nl', name:'Dutch', domain:'starwars.fandom.com', path:'/nl/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'no', name:'Norwegian', domain:'starwars.fandom.com', path:'/no/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
...
{id:'pt', name:'Portuguese', domain:'starwars.fandom.com', path:'/pt/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','ro','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'ro', name:'Romanian', domain:'starwars.fandom.com', path:'/ro/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ru','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'ru', name:'Russian', domain:'starwars.fandom.com', path:'/ru/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','sk','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'sk', name:'Slovakian', domain:'starwars.fandom.com', path:'/sk/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sl','sr','sv','th','tr','uk','vi','zh']},
{id:'sl', name:'Slovenian', domain:'starwars.fandom.com', path:'/sl/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sr','sv','th','tr','uk','vi','zh']},
{id:'sr', name:'Serbian', domain:'starwars.fandom.com', path:'/sr/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sv','th','tr','uk','vi','zh']},
{id:'sv', name:'Swedish', domain:'starwars.fandom.com', path:'/sv/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','th','tr','uk','vi','zh']},
{id:'th', name:'Thai', domain:'starwars.fandom.com', path:'/th/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','tr','uk','vi','zh']},
{id:'tr', name:'Turkish', domain:'starwars.fandom.com', path:'/tr/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','uk','vi','zh']},
{id:'uk', name:'Ukrainian', domain:'starwars.fandom.com', path:'/uk/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','vi','zh']},
{id:'vi', name:'Vietnamese', domain:'starwars.fandom.com', path:'/vi/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','zh']},
{id:'zh', name:'Chinese', domain:'starwars.fandom.com', path:'/zh/', interlang:true, installed_iws:['bg','ca','cs','da','de','el','en','eo','es','fa','fi','fr','fy','ga','gl','gsw','hr','hu','id','is','it','ja','ka','ko','la','mn','nl','no','pl','pt','ro','ru','sk','sl','sr','sv','th','tr','uk','vi']}
];
...
hotcat.exzstatus = false;//Is Wookieepedia article featured
hotcat.lwastatus = false;//Is Wookieepedia article good
hotcat.castatus = false;//Is Wookieepedia article comprehensive
...
hotcat.addlink = function () {
	...
	// HotCat is only allowed in namespaces Article, Wookieepedia, File, Help and Category
		...
		success: function(d) {
			if (d.error) {
				...
				if (d.parse.wikitext !== undefined) {
					...
					// find type (disabled to improve performance, currently has no use)
					/*if (/\/Legends/.test(hotcat.curpage)) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|type=legends(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|type=canon(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=kanon\n' + data;}
					else if (/{{Eras(\\|.+)*\\|pre(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|btr(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|old(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|imp(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|reb(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|new(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|njo(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|leg(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|inf(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=legends\n' + data;}
					else if (/{{Eras(\\|.+)*\\|real(\\|.*)*}}/i.test(d.parse.wikitext['*'])) {data = 'type=kanon\n' + data;}
...
hotcat.init = function () {
	...
	hctmp.e.helplink.href = "https://starwars.fandom.com/wiki/Help:HotCat";
	...
	for (var i=0; i<hctmp_googlewoerter.length; i++) {// Remove duplicate entries
	...
	for (var i=0; i<hctmp_googlewoerter.length; i++) {// Remove bad words
	...
	hctmp_interwiki_search_query += '!!+site:starwars.fandom.com+OR+site:ossus.pl+OR+site:wookiepedia.fr+OR+site:jedipedia.fi';
...
hotcat.interwikis.cleanup = function() {
	...
	//------------- New interwiki links -------------
	// Links missing in Wookieepedia -> [2,3] has a link [0,1] that is not in Wook
	...
	for (var j=0; j<hotinter_newlinks.length; j++) {
		if (hotinter_newlinks[j][0] != hotinter_newlinks[j][2] && hotinter_newlinks[j][0] != mw.config.get('wgContentLanguage')) {
			...
			hctmp.cleanbuttoncustom = document.createElement("span");//Add new link in Wookieepedia
	...
	//Links of Wookieepedia missing elsewhere -> on [2,3] the link [0,1] is missing
	...
	for (var j=0; j<hotinter_nolinks.length; j++) {
		...
		hctmp.cleanbuttoncustom = document.createElement("span");//Add a link from Wookieepedia to this wiki
		...
		hctmp.cleanbuttondel = document.createElement("span");//Remove incorrect link in Wookieepedia
	...
	//Links different elsewhere -> [2,3] has a different link than Wookieepedia for [0,1]
	...
	for (var i=0; i<hotinter_difflinks.length; i++) {
		...
		hctmp.cleanbuttoncustom = document.createElement("span");//Correct the link to be identical with Wookieepedia
