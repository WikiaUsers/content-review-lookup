...
*/
var UserWikiInfo = {
	tmpl: '<div id="UserWikiInfo"><div class="useravatar"><a href="/wiki/Usuario:{u}" title="Avatar de {U}"><img src="http://images4.wikia.nocookie.net/__cb20081128203240/messaging/images/thumb/1/19/Avatar.jpg/50px-Avatar.jpg" width="75" height="75" alt="Avatar" /></a>{editavatar}</div>' +
	...
	groupseparator: ', ',
	groups: {
		bureaucrat: '<a href="/wiki/Donkey Kong Wiki:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Donkey Kong Wiki:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Donkey Kong Wiki:Reversores">reversor</a>',
		asistente: '<a href="/wiki/Donkey Kong Wiki:Asistentes">asistente</a>',
		'fb-user': false
	},
