...
COPIED FROM https://dev.fandom.com/wiki/MediaWiki:Medals/code.js

FOR LITTLE CHANGES AND MODYFICATION - I wanted to change image width, I don't wanna changing code on dev for modificate like this. 

UCP changes WikiaRail -> WikiaRailWrapper
*/
...
// Main function
        medalMainFunction: function() {
            ...
            $.each(MedalSettings.dataUser[user], function (i, v) {
                ...
                imgBody += $('<img style="cursor:help; vertical-align:middle;" width="80" onmouseover="medalFunctions.tooltip(this);" />').attr('src', MedalSettings.dataMedal[v].image_url).attr('data-title', MedalSettings.dataMedal[v].title).attr('data-name', v).prop('outerHTML');
