...
mw.loader.using(["mediawiki.api", "mediawiki.util", "mediawiki.Uri"]).then(function () {
    ...
    $(".scribunto-error").eq(0).text("Возникла проблема при загрузке этого. Обновите и свяжитесь с администраторами, если проблема не устранена.");
...
if (mw.config.values.wgPageName.toLowerCase() === "special:myblockid") {
    ...
    api.get({
        ...
        mw.util.$content.html([
            ...
            r.blockreason ? "В данный момент вы заблокированы, ваш идентификатор блокировки равен " : "В данный момент вы не заблокированы. Если вы все еще уверены, что вы заблокированы, пожалуйста, попробуйте еще раз с другой учетной записью или обратитесь за помощью к администратору через discord.",
            r.blockreason ? $("<a>", {
