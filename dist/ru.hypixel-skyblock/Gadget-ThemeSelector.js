(function($){
	...
	var stylesheetPrefix = "https://hypixel-skyblock.fandom.com/ru/index.php?action=raw&ctype=text/css&title=";
	var themes = [
		{
			id: 'default',
			name: 'По умолчанию',
			note: 'Светлый и Темный',
		},
		{
			id: 'crimson-isle',
			name: "Багровый Остров",
			note: 'Светлый и Темный',
		...
		},
		{
			id: 'easter',
			name: "Пасха",
			note: 'Только баннер в светлом режиме',
	...
	function initDropdownHtml() {
		...
		var $toggle = $("<a>").addClass("wds-dropdown__toggle").attr("title", "Выбор Темы вики").html(TOOLBAR_ICON).appendTo($dropdown);
	...
	function renderThemesList() {
		...
		$content.html("");
		// Add header
		$('<div class="hsw-theme-header"><strong>Выбор Темы вики</strong></div>').appendTo($content);
