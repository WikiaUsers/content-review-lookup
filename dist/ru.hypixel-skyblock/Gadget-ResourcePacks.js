(function($){
	...
	function initDropdownHtml() {
		...
		var $toggle = $("<a>").addClass("wds-dropdown__toggle").attr("title", "Ресурс паки").html(TOOLBAR_ICON).appendTo($dropdown);
	...
	function renderPacksList() {
		...
		$content.html("");
		// Add header
		$('<div class="hsw-pack-header"><strong>Выбор ресурс пака</strong></div>').appendTo($content);
