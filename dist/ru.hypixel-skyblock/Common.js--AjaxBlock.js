    ...
    function show_modal(i18n, user, config, unblocking, expiry_times, block_reasons, unblock_reasons) {
        ...
        $content.append(
            ...
            $("<div>", {
                id: "AjaxBlockLinks",
                html: [
                    "<b>Ссылки на пользователей: </b>",
                    $("<a>", {
                        html: user,
                        href: pagePathname + "Участник:" + user,
                        title: "Участник:" + user,
                    }),
                    " (",
                    $("<a>", {
                        html: "Стена",
                        href: pagePathname + "Стена сообщений:" + user,
                        title: "Стена сообщений:" + user,
                    }),
                    " | ",
                    $("<a>", {
                        html: "Вклады",
