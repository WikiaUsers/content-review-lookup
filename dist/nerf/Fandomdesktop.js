...
window.pPreview = $.extend(true, window.pPreview, {RegExp: (window.pPreview || {}).RegExp || {} });
    ...
    window.pPreview.RegExp.iimages = [new RegExp('^Badge-.*'), new RegExp('^Flag_*'), /Split_transp\.png/, /DiscBlaster\.png/, /NerfLogo_template\.png/, /Under_construction2\.png/, /DiscSeries-2\.png/, /1000px-Warning_sign\.png/, /Stub\.png/, /Update\.png/, /Padlock\.svg/, /Cscr-featured\.svg/];