...
$(function() {
	...
	$('.editpage-sourcewidemode-on .module_content #stdSummaries').css({"margin-left": '-5px'});
	$('.editpage-sourcewidemode-on .module_content #stdSummaries').css({"margin-top": '28px'});
	$('.editpage-sourcewidemode-on .module_content #stdSummaries').css({"max-width": '278px'});
	$('.mode-wysiwyg .module_content #stdSummaries').css({"margin-left": '0'});
	$('.mode-wysiwyg .module_content #stdSummaries').css({"margin-top": '0'});
	$('.mode-wysiwyg .module_content #stdSummaries').css({"max-width": '284px'});
	$('#EditPage .module > .module_content').css({"padding": '8px'});
})