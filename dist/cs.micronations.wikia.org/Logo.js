...
(function($) {
    for (var name in messageWallUserTags) {
        $('a.subtle[href$="Message_Wall:' + name + '"]').after('<img src="https://images.wikia.nocookie.net/__cb20140418184709/micronations/images/d/db/Microwikistafflogo.png" alt="MicroWiki Tým ' + messageWallUserTags[name] + '">');
    }
}(jQuery));
//</syntaxhighlight>