...
mw.loader.using([
    ...
    if (
        ...
        !/sysop|bureaucrat|staff|helper|wiki-representative|wiki-specialist|util|theskeletonsglobaluser/.test(config.wgUserGroups.join())
    ) {
        return;
    }
	...
	Api.get({
		 ...
		 */
		function show () {
		    // Removes options admins can use
