...
var chatTopic = 'You are now in the Kitchen. <br>Read  <a href="Chowder_Fan_Club:Rules" target="_blank">the rules</a> or suffer the consequences.' 
...
//
  ...
  //Self text background color
    var selfTextColorDay = '#cca6d1';
 
  //Chat background color
    var backgroundColorDay = '#000000';
 
  //Chat foreground color
    var foregroundColorDay = '#cca6d1';
