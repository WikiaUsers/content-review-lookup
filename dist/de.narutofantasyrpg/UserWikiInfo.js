...
/*
* UserWikiInfo v2.0: Una colección de enlaces útiles relacionados con el usuario que aparece en contribuciones, página de usuario y discusión, con recuento de ediciones y avatar, para Monobook
* 
...
var UserWikiInfo = {
	tmpl: '<div class="useravatar"><a href="/wiki/Benutzer:{u}" title="Avatar von {U}"><img src="https://images.wikia.nocookie.net/__cb20081128203240/messaging/images/thumb/1/19/Avatar.jpg/50px-Avatar.jpg" width="100" height="100" alt="Avatar" /></a></div>' +
		'<span class="userlink"><a href="/wiki/Benutzer:{u}" title="Benutzerseite"><b>{U}</b></a></span> &#124; <span class="talklink"><a href="/wiki/Benutzer_Diskussion:{u}" title="Diskussionsseite">Diskussion</a></span> &#124; <span class="bloglink"><a href="/wiki/Benutzer_Blog:{u}" title="Blogbeiträge des Benutzers">Blog</a></span> &#124; <span class="contribslink"><a href="/wiki/Spezial:Beiträge/{u}" title="Benutzerbeiträge">Beiträge</a></span>{group}'+
		'<div class="contribdetails"></div>',
	contrtmpl: '<div style="padding-top:5px;"><font size=5px><b>{c}</b></font> Bearbeitungen in diesem Wiki seit dem {fe}.</div>',
	grouptmpl: ' &#124; <span class="usergroups" title="Gruppen, zu denen der Benutzer gehört">{g}</span>',
	editavatar: 'Avatar ändern',
	editavatardescription: 'Wähle ein Bild von deinem PC aus, das du als Avatar verwenden willst. Es sollte quadratisch sein (gleiche Höhe und Breite). Wenn das Bild länglich geschnitten ist, kann es sein, dass es verzerrt dargestellt wird. Es wird empfohlen, die Abmessungen des Bilds erst zu in einem Bildbearbeitungsprogramm einzustellen. Die optimale Größe ist 150x150px.',
	previewsaveavatar: 'Dies ist das Bild, das du hochgeladen hast und das nun als Avatar verwendet werden soll. Wenn du einverstanden bist, bestätige die Änderung. Beachte, dass das vorherige Avatarbild für eine Weile weiterhin angezeigt wird, weil dein Browser noch die alte Version gespeichert hat.',
	saveavatar: 'Neuen Avatar übernehmen',
	datefm: '{d}. {m} {y}',
	months: ['Januar', 'Februar', 'März', 'April', 'Mai', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember'],
	groupseparator: ', ',
	groups: {
		bureaucrat: '<a href="/wiki/Spezial:Benutzer/bureaucrat">Bürokrat</a>',
		sysop: '<a href="/wiki/Spezial:Benutzer/sysop">Administrator</a>',
		rollback: '<a href="/wiki/Spezial:Benutzer/rollback">Rollback</a>',
		helper: '<a href="/wiki/Spezial:Benutzer/helper">Helfer</a>',
                chatmoderator: '<a href="/wiki/Spezial:Benutzer/chatmoderator">Chatmoderator</a>',
		'*': false,
		user: false,
		autoconfirmed: false,
	...
	init: function() {
		...
		} else if (window.wgCanonicalNamespace == 'User' || window.wgCanonicalNamespace == 'User_talk' || window.wgCanonicalNamespace == 'Benutzer_Blog') {
			u = window.wgTitle;
			var sl = u.indexOf('/');
			if (sl != -1) {
				u = u.substr(0, sl);
	...
	changeAvatar: function(o) {
		...
		if (!UserWikiInfo.tb) {
			...
			$('#TB_window').width(500).append(
				'<div id="TB_title"><div id="TB_closeAjaxWindow"><a href="#" id="TB_closeWindowButton">schließen</a></div></div><div id="TB_ajaxContent"></div>').bind(
				'unload', function() {
