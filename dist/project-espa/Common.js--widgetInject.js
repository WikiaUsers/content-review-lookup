...
$.getJSON("https://discordapp.com/api/guilds/440150882689220628/widget.json", function(json) {
    ...
    $("<a></a>")
        ...
        .attr("href", "https://discord.gg/wjqcdj2?utm_source=Discord%20Widget&utm_medium=Connect")
        .attr("target", "_blank")
    ...
    function addToRail() {
        ...
        $railModuleTitle.append("JG Discord");
    ...
    $(".CustomDiscordIntegrator").each(function () {
        ...
        $containerTitle.append("JG Discord");
