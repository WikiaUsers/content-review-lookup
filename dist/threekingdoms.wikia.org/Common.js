...
if (mwCustomEditButtons) {
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/__cb20100611120456/thethreekingdoms/images/1/16/Button_reflink_alternate.png",
     "speedTip": "References",
     "tagOpen": "<ref>",
     "tagClose": "</ref>",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": 
"https://images.wikia.nocookie.net/__cb20100328145146/central/images/c/c1/Button_Bold_Italic.PNG",
     "speedTip": "Bold and Italic text",
     "tagOpen": "'''''",
     "tagClose": "'''''",
     "sampleText": "Bold and Italic text"};
...
$(function () {
    var wgTitleLastPart = wgTitle.split('/').slice(-1)[0] //get the "last" part of the pagename
    $('h1.firstHeading').html(wgTitleLastPart); //change title to last part
});
 
/************************************************************/
/****************THREE KINGDOMS WIKI OASIS/WIKIAjs***********/
/************************************************************/
...
/************************************************************/
/* CHANGE DISPLAYTITLE OF ARTICLES                          */
/************************************************************/
...
/************************************************************/
/* SocialIcons (http://dev.wikia.com/wiki/SocialIcons)      */
/************************************************************/
...
if(mw.config.get('wgIsMainPage') || $('.mainpage').length) {
