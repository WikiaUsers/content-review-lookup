...
$(function () {
    ...
    addTalkPageLink()
    // Adding a Rate button on Builds via JS should no longer be necessary.
    // Adding the Rate button has been fixed in the PvXRate extension
    // as part of the MW 1.37 upgrade.
   // addBuildRateLink()
})
