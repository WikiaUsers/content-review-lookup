...
function snow() {
    for (var i = 0; i < 10; i++) {
        ...
        if (flake.y < 0 - (flake.size + 10)) {
            flake.y = bodyHeight + 20;
        }
...
function init() {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        flake.style.backgroundImage = "url('https://vignette.wikia.nocookie.net/lps2012/images/4/4a/CD_Heart.png/revision/latest?cb=20150214010836')";
        flake.style.backgroundSize = size + "px " + size + "px";
