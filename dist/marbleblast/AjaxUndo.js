...
jQuery(document).ready( function ( $ ) {
	...
	function createUndoLink( diffUndoUrl ) {
		var $ajaxUndoLink = $( '<a />' ).text( 'AJAX Undo' ).attr( 'href', '#' ).click( function () {
			...
			$ajaxUndoLinkob.html( ' <img src="https://images.wikia.nocookie.net/marbleblast/images/b/b4/FB_Throbber_Orange.gif" style="vertical-align: baseline;" border="0" alt="Undoing..." />' );
