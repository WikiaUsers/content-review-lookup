importStylesheetPage('MediaWiki:DomCasualFont.css','marbleblast');
/**
 * ChatOptions
...
var chatOptions = {
	look: {
		...
		backgroundColor: getCookie("customisation", 0),
                modalIcon: "http://wordpress.c21redwood.com/wp-content/uploads/2013/09/AppleSettingsIcon.png"
	},
	modules: {
		chatHacks: {
			element: "#chatHacks",
			...
			load: function () {
				if ($("#pingspan").length > 0 || this.loaded)
					return;
				importScriptPage("MediaWiki:ChatHacks.js", "marbleblast");
				this.loaded = true;
			}
		},
		tabComplete: {
			...
			loaded: false,
			load: function () {
				importScriptPage("MediaWiki:Chat_Enter_Button.js","marbleblast");
				this.loaded = true;
			}
		},
		multiKick: {
