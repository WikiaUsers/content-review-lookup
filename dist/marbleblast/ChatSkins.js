/* Credit to Seaside98 and Nxtstep101 */
//Temp for CHRISTMAS!! :D
setTimeout(function() { 
	skinType = 'winter';
...
var fallCss = '<link href="http://marbleblast.wikia.com/index.php?title=MediaWiki:ChatSkins.js/Fall.css&action=raw&ctype=text/css" rel="stylesheet" type="text/css" id="ChatSkins"/>';
var winterCss = '<link href="http://marbleblast.wikia.com/index.php?title=ChatSkins.js/Winter.css&action=raw&ctype=text/css" rel="stylesheet" type="text/css" id="ChatSkins"/>';
var skinType = 'normal';
var snowLeft = 0;
var snowflakes;
var totalSnow = 0;
...
function logCount() {
	if(skinType=='winter') {
		console.log("There are a total of "+(totalSnow+50)+" snowflakes.");
	} else if(skinType=='fall') {
		console.log("There are a total of "+(totalSnow+20)+" leaves.");
	}
}
