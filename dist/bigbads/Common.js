...
window.MessageWallUserTags = {
    ...
    glow: false,
    users: {
        'Tysonjackson': 'Big Bad'
    }
};

Mature = {
    isMature: function () {
        return -1 !== wgCategories.indexOf('Mature');
    }
};
