...
var chatTopic = 'Welcome to the Friendship is Magic Wiki Chat! Please make sure to read the <a href="/wiki/Project:Chat" target="_blank" title="Project:Chat"><u>chat guidelines</u></a>.<br />Take part in discussion concerning the chat on the <a href="/wiki/Forum:Chat_discussion" target="_blank">chat forum</a>. Chat logs can be found on the <a href="/wiki/Project:Chat/Logs?action=purge" target="_blank" title="Project:Chat/Logs">log index</a>.';
...
function nighttime_moon() {
	...
	var noModStar = ["Foodbandlt", "Juan The American Brony", "UnknownProdigy", "The Candlekeeper", "Novabomb1", "Callofduty4"],
	chatBots = ["FlutterBot", "Icecreambot", "Noteworthy"];
