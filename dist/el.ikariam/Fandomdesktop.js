...
var bdur = {
	'Ακαδημία':(function(){var t=[],c={a:1440,b:1,c:1.2,d:720,e:[983]};for(var i=0;i<50;i++){var d=Math.round(c.a/c.b*Math.pow(c.c,i+1)-c.d)-(c.e!=undefined?(c.e[i]!=undefined?c.e[i]:0):0);t.push((d>1728e3?1728e3:d));}return t;})(),
	...
	'Εμπορικός Λιμένας':(function(){var t=[],c={a:50400,b:23,c:1.15,d:1512,e:[588]};for(var i=0;i<74;i++){var d=Math.round(c.a/c.b*Math.pow(c.c,i+1)-c.d)-(c.e!=undefined?(c.e[i]!=undefined?c.e[i]:0):0);t.push((d>1728e3?1728e3:d));}return t;})(),
	...
	'Θέση Εμπορικών Συναλλαγών':(function(){var t=[],c={a:108000,b:11,c:1.1,d:9360};for(var i=0;i<72;i++){var d=Math.round(c.a/c.b*Math.pow(c.c,i+1)-c.d)-(c.e!=undefined?(c.e[i]!=undefined?c.e[i]:0):0);t.push((d>1728e3?1728e3:d));}return t;})(),
	'Η Κατοικία του Κυβερνήτη':(function(){var t=[],c={a:11520,b:1,c:1.4,d:0};for(var i=0;i<20;i++){var d=Math.round(c.a/c.b*Math.pow(c.c,i+1)-c.d)-(c.e!=undefined?(c.e[i]!=undefined?c.e[i]:0):0);t.push((d>1728e3?1728e3:d));}return t;})(),
	...
	'Λατομείο':(function(){var t=[],c={a:72000,b:11,c:1.1,d:6120};for(var i=0;i<61;i++){var d=Math.round(c.a/c.b*Math.pow(c.c,i+1)-c.d)-(c.e!=undefined?(c.e[i]!=undefined?c.e[i]:0):0);t.push((d>1728e3?1728e3:d));}return t;})(),
	...
	'Στρατώνες':(function(){var t=[],c={a:25200,b:11,c:1.1,d:1728,e:[732]};for(var i=0;i<49;i++){var d=Math.round(c.a/c.b*Math.pow(c.c,i+1)-c.d)-(c.e!=undefined?(c.e[i]!=undefined?c.e[i]:0):0);t.push((d>1728e3?1728e3:d));}return t;})(),
...
function Tips(q,r,s,a)
{
	...
	switch(r)
	{
		...
		case 'Α': // Μείωση Αλφαδιού
			...
			for(var i=0;i<26;i++)
			{
				t += '<tr><td>2 %</td>'+(r==='Γ'||r==='Α'?'<td>4 %</td>':'')+(r==='Α'?'<td>8 %</td>':'')+(r==='Τ'?'':'<td>'+(r==='Γ'?6:(r==='Α'?14:0))+' %</td>')+'<td>'+i+'</td><td>'+i+' %</td><td>'+((r==='Τ'?2:(r==='Γ'?6:(r==='Α'?14:0)))+i)+' %</td><td style="text-align:right">'+FrmtNumToStr(Math.ceil(((r==='Τ'?2:(r==='Γ'?6:(r==='Α'?14:0)))+i)*q/100))+icon(s,12,10)+'</td><td style="text-align:right">'+FrmtNumToStr(Math.floor((100-((r==='Τ'?2:(r==='Γ'?6:(r==='Α'?14:0)))+i))*q/100))+icon(s,12,10)+'</td><td style="text-align:right">'+FrmtNumToStr(Math.floor((100-((r==='Τ'?2:(r==='Γ'?6:(r==='Α'?14:0)))+i))*a/100))+icon(s,12,10)+'</td><td'+(i==25?' colspan="6"':'')+'>'+(i==25?'':(i+26)+'</td><td>'+(i+26)+' %</td><td>'+((r==='Τ'?2:(r==='Γ'?6:(r==='Α'?14:0)))+(i+26))+' %</td><td style="text-align:right">'+FrmtNumToStr(Math.ceil(((r==='Τ'?2:(r==='Γ'?6:(r==='Α'?14:0)))+(i+26))*q/100))+icon(s,12,10)+'</td><td style="text-align:right">'+FrmtNumToStr(Math.floor((100-((r==='Τ'?2:(r==='Γ'?6:(r==='Α'?14:0)))+(i+26)))*q/100))+icon(s,12,10)+'</td><td style="text-align:right">'+FrmtNumToStr(Math.floor((100-((r==='Τ'?2:(r==='Γ'?6:(r==='Α'?14:0)))+(i+26)))*a/100))+icon(s,12,10))+'</td></tr>';
			}
