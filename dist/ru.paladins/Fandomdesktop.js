...
function updateTimer(timerParams, num) {
    ...
    if ((numLoops === loopLimit) && (endDate.getTime() <= now.getTime())) {
        document.getElementById("endText_" + num).setAttribute("style", "display:visible; font-size:12px; font-weight:normal; line-height: 0.7;");
    ...
    // Time string will result in "02h 00m 00s" thus far
        ...
        document.getElementById("bText_" + num).setAttribute("style", "display:visible; font-size:12px; font-weight:normal; line-height: 0.7;");
        document.getElementById("aText_" + num).setAttribute("style", "display:visible; font-size:12px; font-weight:normal; line-height: 0.7;");
        document.getElementById("aDelayText_" + num).setAttribute("style", "display:none");
        document.getElementById("bDelayText_" + num).setAttribute("style", "display:none");
    ...
    // text, and only show delay time periods specified by date format
        ...
        document.getElementById("bText_" + num).setAttribute("style", "display:none");
        document.getElementById("aText_" + num).setAttribute("style", "display:none");
        document.getElementById("bDelayText_" + num).setAttribute("style", "display:visible; font-size:12px; font-weight:normal; line-height: 0.7;");
        document.getElementById("aDelayText_" + num).setAttribute("style", "display:visible; font-size:12px; font-weight:normal; line-height: 0.7;");
