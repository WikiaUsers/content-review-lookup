	...
	'youtube': function (s, t) {
		...
		if (t.charAt(0) !== '/') {
			try {
				t = t.split('="');
				t[1] = t[1].replace('"', '');
				s = s.replace('[youtube="' + t[1] + '"]', '<video class="chat-video" controls preload="auto" poster="https://img.youtube.com/vi/' + mw.html.escape(t[1]) + '/hqdefault.jpg"><source src="http://elnobdetfm-files.cf/yt/getvideo.mp4?videoid=' + mw.html.escape(t[1]) + '"></video><br /><a href="https://www.youtube.com/watch?v=' + mw.html.escape(t[1]) + '" target="_blank">[Ver en YouTube]</a><br />');
			} catch (e) {
				console.log(e);
			}
		}
