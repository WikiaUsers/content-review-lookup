...
DisplayClock
******************************/
window.DisplayClockJS = 'Server Time: %2I:%2M:%2S %p %2d %{January;February;March;April;May;June;July;August;September;October;November;December}m %Y';
// Prevent double runs
...
(function($, mw, window, Date) {
	...
	function updateTime() {
		...
		var d = new Date();
		d.setMinutes(d.getMinutes() + d.getTimezoneOffset() - (60*7));	// To UTC
