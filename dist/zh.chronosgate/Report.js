...
function submit(input, text) {
	...
	$.post("http://zh.chronosgate.wikia.com/api.php", {
		action: 'edit', 
		appendtext: text,
		...
		location.href = 'http://zh.chronosgate.wikia.com/wiki/Project:管理員告示板';
	}).fail(function() {
		alert('送出失敗');
	});
}
...
$('#preview').click(function() {
	...
	$.getJSON('http://zh.chronosgate.wikia.com/api.php',
		{
			action: 'parse',
			format: 'json',
			text: text
