...
var extDB = "http://ru.wow.wikia.com/";
...
dbs = new Array("http://us.battle.net/wow/en/search?q=","http://ru.wowhead.com/?search=","http://db.mmo-champion.com/search/all/");
...
$("#stl" + tableNum).html('[<a href="/'+tablePage+'?action=edit">править</a>]&nbsp;[<a href="javascript:;" id="htl' + tableNum + '" onClick="hideTable(' + tableNum + ');">скрыть</a>]');
ttMouseOver(0);
}
});
}
