...
(function (window) {
    ...
    var game;
    game = {};
    game.worlds = ["Adra", "Alumbra", "Antica", "Ardera", "Astera", "Belobra", "Bona", "Cadebra", "Calmera", "Carnera", "Celebra", "Celesta", "Concorda", "Damora", "Descubra", "Dibra", "Emera", "Epoca", "Estela", "Famosa", "Fera", "Ferobra", "Fervora", "Firmera", "Garnera", "Gentebra", "Gladera", "Harmonia", "Honbra", "Illusera", "Impera", "Inabra", "Javibra", "Juva", "Kalibra", "Karna", "Kenora", "Libertabra", "Lobera", "Luminera", "Lutabra", "Marcia", "Menera", "Mercera", "Mitigera", "Monza", "Mudabra", "Nefera", "Nexa", "Nossobra", "Ocebra", "Ombra", "Optera", "Pacembra", "Pacera", "Peloria", "Premia", "Quelibra", "Quintera", "Ragna", "Refugia", "Reinobra", "Relania", "Relembra", "Secura", "Serdebra", "Serenebra", "Solidera", "Talera", "Tembra", "Trona", "Unica", "Unisera", "Utobra", "Venebra", "Versa", "Visabra", "Vunira", "Wintera", "Wizera", "Xandebra", "Xylona", "Yonabra", "Ysolera", "Zenobra", "Zuna", "Zunera"];
