...
(function (window) {
    ...
    var game;
    game = {};
    game.worlds = ["Adra", "Alumbra", "Antica", "Assombra", "Astera", "Belluma", "Belobra", "Bona", "Calmera", "Carnera", "Celebra", "Celesta", "Concorda", "Cosera", "Damora", "Descubra", "Dibra", "Duna", "Emera", "Epoca", "Estela", "Faluna", "Famosa", "Fera", "Ferobra", "Fervora", "Firmera", "Funera", "Furia", "Garnera", "Gentebra", "Gladera", "Harmonia", "Helera", "Honbra", "Impera", "Inabra", "Javibra", "Jonera", "Juva", "Kalibra", "Karna", "Kenora", "Libertabra", "Lobera", "Luminera", "Lutabra", "Macabra", "Marcia", "Menera", "Mercera", "Mitigera", "Monza", "Mudabra", "Nefera", "Nexa", "Noctera", "Nossobra", "Olera", "Ombra", "Optera", "Pacembra", "Pacera", "Peloria", "Premia", "Pyra", "Quelibra", "Quintera", "Ragna", "Refugia", "Reinobra", "Relania", "Relembra", "Secura", "Serdebra", "Serenebra", "Solidera", "Talera", "Tembra", "Torpera", "Tortura", "Unica", "Unisera", "Utobra", "Venebra", "Visabra", "Vita", "Vunira", "Wintera", "Wizera", "Xandebra", "Xylona", "Yonabra", "Ysolera", "Zenobra", "Zuna", "Zunera"];
