...
(function () {
  ...
  creature_items_name_change = {
    ...
    'Brain Head': {'Amber': 'Amber (Item)','Enchanted Ring of Souls':'Ring of Souls'},
    ...
    'Creepy Crawler': {'Amber': 'Amber (Item)'},
    'Crusader': {'Cookbook': 'Cookbook (Creature Product)'},
    'Crypt Construct': {'Amber': 'Amber (Item)'},
    'Crypt Crawler': {'Amber': 'Amber (Item)'},
    'Crypt Fiend': {'Amber': 'Amber (Item)'},
    ...
    'The Pale Worm': {'Amber': 'Amber (Item)','Enchanted Ring of Souls':'Ring of Souls'},
