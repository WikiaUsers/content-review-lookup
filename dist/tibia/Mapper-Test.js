...
$(window).load(function() {
    ...
    minimap_mapper_page = 'http://tibia.fandom.com/wiki/Mapper';
    ...
    minimap_images[0] = [
    'http://images2.fandom.nocookie.net/tibia/en/images/9/97/Minimap_Symbols.gif',
    'http://images4.fandom.nocookie.net/tibia/en/images/6/6c/Minimap_Loading.gif'
    ];
    ...
    '',
    '',
    'http://images.fandom.com/tibia/en/images/c/c5/Minimap_Floor_7h.png',
    '',
    '',
    '',
    '',
