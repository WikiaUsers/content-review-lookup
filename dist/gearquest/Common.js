...
/* DOM navigation */
if (typeof domreadycheck=="undefined") //global variable to detect if DOM is ready
...
arrowpointers:{
	downarrow: ["none", 11,7], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: ["none", 12,12], //[path_to_right_arrow, arrowwidth, arrowheight]
...
buildmenu:function(mainmenuid, header, submenu, submenupos, istoplevel, dir){
	...
	this.addEvent(header, function(e){ //mouseover event
		if (menu.ismobile || !menu.isContained(this, e)){
			...
			if (submenubottomedge-scrollY>menu.docheight){ //no room downwards?
			...
			if (menu.enableshim && (menu.effects.enableswipe==false || menu.nonFF)){ //apply shim immediately only if animation is turned off, or if on, in non FF2.x browsers
	...
	this.addEvent(header, function(e){ //mouseout event
		var submenu=menu.subuls[this._master][parseInt(this._pos)]
		if (this._istoplevel){
			if (!menu.isContained(this, e) && !menu.isContained(submenu.parentNode, e)) //hide drop down div if mouse moves out of menu bar item but not into drop down div itself
