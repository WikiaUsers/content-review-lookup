...
window.UserTagsJS = {
	modules: {
			...
			newuser: true,},
	tags: {
		bureaucrat: { link:'Kareems-Official-Newscast_Wiki:Administrators#Bureaucrat_abilities' },
		sysop: { link:'Kareems Official Newscast Wiki:Administrators' },
		chatmoderator: { link:'Kareems Official Newscast Wiki:Chat Moderators' },
		rollback: { u:'Rollback', link:'Kareems Official Newscast Wiki:Rollbacks' },
