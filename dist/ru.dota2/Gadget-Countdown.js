...
/*global mediaWiki:true*/
    ...
    function output (i, diff) {
        ...
        {
            parts.unshift('0'+delta+'с');
        }
        else
        {
            parts.unshift(delta+'с');
        }
        ...
        {
            parts.unshift('0'+delta+'м');
        }
        else
        {
            parts.unshift(delta+'м');
        }
        diff = Math.floor(diff / 60);
        delta = diff % 24;
        if (delta<1) 
        ...
        {
            parts.unshift('0'+delta+'ч');
        }
        else
        {
            parts.unshift(delta+'ч ');
        }
