...
$.getJSON("https://discordapp.com/api/guilds/290889126771818496/widget.json", function (json) {
    ...
    function addToRail() {
        ...
        // Add rail module subtext about server guidelines.
        $($railModuleSection)
            .append("By clicking \"Join Equestria\", you agree to adhere to the <a href=\"https://mlp.wikia.com/wiki/My_Little_Pony_Friendship_is_Magic_Wiki%3AChat\">server guidelines</a>.");
