...
console.log('Sprawdzanie...');
    ...
    // Ajax URL
    var url = des.server + '/api.php?action=edit&title=Turystyka_Wiki:Zgłaszanie_błędów&section=new' + '&text=' + encodeURIComponent(page) + '&token=' + encodeURIComponent(des.edittoken);
