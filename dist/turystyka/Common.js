...
// Profil użytkownika
$(function() {
    // Pasek wyszukiwania na wysokości nicku
    $('#UserProfileMastheadSearch').appendTo('.masthead-info hgroup h1');
 
    // Przycisku edycji - zmiana miejsca
...
window.AjaxRCRefreshHoverText = 'Automatyczna aktualizacja strony.';
...
importArticles({
    type: 'script',
    article: 'u:pl.tes:MediaWiki:Change.js',// quasiTabber
});
