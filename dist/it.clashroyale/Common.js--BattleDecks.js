...
==== Filtri tabella Battle Deck DPL
     Di King Dragonhoff
    
    Questo script fa funzionare i filtri inseriti nella 
    pagina mazzi da battaglia nel Template:BDFiltri.
    
    L'unica dipendenza di questo script è il template Carte
    e i template da cui dipende. Questo script
    non dovrebbe richiedere aggiornamenti dopo un aggiornamento del gioco.
