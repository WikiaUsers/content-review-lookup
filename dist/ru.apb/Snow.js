 ...
 * DHTML Snowstorm! JavaScript-based Snow for web pages
 <nowiki>*</nowiki> --------------------------------------------------------
 <nowiki>*</nowiki> Version 1.43.20111201 (Previous rev: 1.42.20111120)
 <nowiki>*</nowiki> Copyright (c) 2007, Scott Schiller. All rights reserved.
 <nowiki>*</nowiki> Code provided under the BSD License:
 <nowiki>*</nowiki> http://schillmania.com/projects/snowstorm/license.txt
 <nowiki>*</nowiki>/
 
/*global window, document, navigator, clearInterval, setInterval */
/*jslint white: false, onevar: true, plusplus: false, undef: true, nomen: true, eqeqeq: true, bitwise: true, regexp: true, newcap: true, immed: true */
 
/* Пока отключено! Для включения, снять /* и */  
/*
...
window.snowStorm = {
	...
	autoStart: true,		// Будет снег запускаться автоматически или нет.
	flakesMax: 80,			// Ограничьте общее количество снега из (падение + налипание)
	flakesMaxActive: 80,		// Предельная сумма падения снега сразу 
	animationInterval: 20,		// Теоретически измерение "миллисекунд за кадр" . 20 = быстрый + гладкий, но высокий уровень использования процессора. 50 = более медленней, но медленный
	excludeMobile: false,		// Снег, вероятно, будет плохой новостью для процессоров мобильных телефонов "(и батарей). По умолчанию, будет отключено.
	flakeBottom: null,		// Число для Y предела ось снег, 0 или NULL для "полного экрана" снег эффект
	followMouse: true,		// Движение Снега может реагировать на мышь пользователя
	snowColor: '#fff',		// Изменить цвет снега.Не ешьте желтый снег.
	snowCharacter: '&bull;',	// &bull; = bullet, &middot; is square on some systems etc.
	snowStick: true,		// Будет или нет "придерживаться" в низу снег. При выключенной никогда не будем собирать.
	targetElement: WikiaPage,	//элемент, на который будет добавлен снег(null = document.body) - может быть элементом ID, например. "myDiv", или ссылка DOM узел
	useMeltEffect: true,		// (или редко, при падении), будет "таять" и исчезать, если браузер поддерживает его
	useTwinkleEffect: false,	// Разрешить снег случайно "мерцание" в и вне поля зрения во время падения
	usePositionFixed: true,		// true = снег не сдвигается по вертикали при прокрутке. Может увеличить нагрузку на процессор, по умолчанию отключена - если включено, только если поддерживается
