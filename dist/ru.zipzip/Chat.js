...
$(function() {
    ...
    var headline_bar = '<div id="HeadLineBar" style="' + headline_styles + '">Добро пожаловать в чат Зип Зип Вики.</br><a href="/wiki/Зип Зип Вики:Правила_чата" target="_blank">Правила</a> — <a href="/wiki/MediaWiki:Emoticons" target="_blank">Смайлики</a></div>';
...
if (wgUserName != 'KORNiUX') { // import for all except developer. (KORNiUX)
