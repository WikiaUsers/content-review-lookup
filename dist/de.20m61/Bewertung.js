...
function SetBewertung(ListenElement){
  ...
  var Optionen    = ListenElement.parentNode.getElementsByTagName("li").length;
  ...
  xmlhttp.onreadystatechange=function()  {
    ...
    if (xmlhttp.readyState==4 && (xmlhttp.status==404 || xmlhttp.status==410)) {
          ...
          NeueBewertung += "  |"+Name+" = {{#switch: {{{Zeige|}}} ";
          NeueBewertung +=   "|Wert = "+Wert;
          NeueBewertung +=   "|Anzahl = 1 ";
          NeueBewertung +=   "|Optionen = "+Optionen;
          NeueBewertung +=   "|Durchschnitt = "+Wert;
          NeueBewertung +=   "|Durchschnitt_Prozentual = "+Wert/Optionen*100;
          NeueBewertung +=   "}}\n"
          ...
          ListenElement.parentNode.parentNode.style.width = Wert/Optionen*100 +"%";
          ListenElement.parentNode.parentNode.parentNode.childNodes[0].textContent = "Bewertet mit "+ Wert;
          ListenElement.parentNode.parentNode.parentNode.childNodes[0].style.backgroundColor= ""; // Standardfarbe herstellen
    ...
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
      ...
      if(RestAjax.search(Name) < 0){
          ...
          NeueBewertung += "  |"+Name+" = {{#switch: {{{Zeige|}}} ";
          NeueBewertung +=   "|Wert = "+ajaxWert;
          NeueBewertung +=   "|Anzahl = 1";
          NeueBewertung +=   "|Optionen = "+Optionen;
          NeueBewertung +=   "|Durchschnitt = "+ajaxWert;
          NeueBewertung +=   "|Durchschnitt_Prozentual = "+ajaxWert/Optionen*100;
          NeueBewertung +=   "}}\n";
      } else {
          ...
          NeueBewertung += " = {{#switch: {{{Zeige|}}} ";
          NeueBewertung +=      "|Wert = "+ajaxWert;
          NeueBewertung +=      "|Anzahl = "+ajaxAnzahl;
          NeueBewertung +=      "|Optionen = "+Optionen;
          NeueBewertung +=      "|Durchschnitt = "+ajaxDurchschnitt;
          NeueBewertung +=      "|Durchschnitt_Prozentual = "+ajaxDurchschnitt/Optionen*100;
          NeueBewertung +=      "}}\n";
      ...
      ListenElement.parentNode.parentNode.style.width = Wert/Optionen*100 +"%";
      ListenElement.parentNode.parentNode.parentNode.childNodes[0].textContent = "Bewertet mit "+ Wert;
      ListenElement.parentNode.parentNode.parentNode.childNodes[0].style.backgroundColor= ""; // Standardfarbe herstellen für Schutz (grün)
      Keksdose(BewertungID, Wert); // Cookie setzen, damit er nicht nochmal bewerten kann + sich erinnert, was er bewertet hat
    }
  }
  ListenElement.parentNode.parentNode.parentNode.classList.add("bewertet"); // diese Bewertung als "bewertet" markieren (löst einige CSS-Funktionen aus)
  ListenElement.parentNode.parentNode.parentNode.childNodes[0].textContent = "Bitte warten..."; // Info für Benutzer, was er gewählt hat.
  ListenElement.parentNode.parentNode.parentNode.childNodes[0].style.backgroundColor= "#04075A"; // Schutz bekommt andere Farbe um "Warten" deutlich zu machen.
...
for (var i=0; i<Bewertung.length; i++) {
    if(Bewertung[i].classList.contains('Bewertung')) {
        ...
        if (Keksdose(BewertungID, false)) {
            Bewertung[i].parentNode.parentNode.classList.add("bewertet");
            Bewertung[i].parentNode.parentNode.childNodes[0].textContent = "Bewertet mit "+ Keksdose(BewertungID, false);
        }
    }
}