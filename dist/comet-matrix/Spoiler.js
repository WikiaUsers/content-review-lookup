/* creepypasta wiki */
SpoilerAlert = {
    question: 'This page contains content that may be triggering and may not be suitable for all audiences. Do you wish to continue to view this page?',
    yes: 'Yes, I do',
    no: 'No, I do not',
    isSpoiler: function () {
        return -1 !== wgCategories.indexOf('Trigger_Warning');
    }
};
...
$(function () {
    ...
    window.SpoilerAlert = (function (my, console, Math) {
        ...
        var dialog =
        '<table id="dialog" border="0" cellpadding="20" style="background-color: purple; border-radius: 4px; border: 2px solid black;">' +
            '<tr>' +
                '<td colspan="2" style="padding: 20px 30px; border-style: none; text-align: center; color: red">' +
                    my.question +
                '</td>' +
            '</tr>' +
            '<tr>' +
