...
window.UserTagsJS = {
	modules: {},
	tags: {
		bureaucrat: { u:'Bureaucrat', link:'Mech-X4 Wiki:Administrators' },
        sysop: { u:'Admin', link:'Mech-X4 Wiki:Administrators' },
        chatmoderator: { link:'Mech-X4 Wiki:Administrators' },
        rollback: { link:'Mech-X4 Wiki:Administrators' },
	}
};
