...
(function( $ ){
    $.fn.clipboard = function(options) {     
        var defaults = {
            prepend: "转自<b>冰与火之歌中文维基</b>:<br />", // content to prepend to copy selection
            append: "http://zh.asoiaf.wikia.com/index.php?curid="+wgArticleId,  // content to append to copy selection
