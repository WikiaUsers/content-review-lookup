 ...
 * 
 * The script follows Wikia JS guidelines or MediaWiki coding standards where the Wikia
 * guidelines do not specify:
 * - <https://github.com/Wikia/guidelines/blob/master/JavaScript/CodingConventions.md>
 * - <https://www.mediawiki.org/wiki/Manual:Coding_conventions/JavaScript>
 *
 * The scripts have extremely high usage across Wikia, please do not deploy without
 * extensive testing. Be aware that these scripts must be ES3 compliant due to the
 * minifier used by ResourceLoader.
 */
 
/* global mw, UserTagsJS, $cl */ 
 
/* jshint bitwise:true, browser:true, camelcase:true, curly:true, devel:true,
         eqeqeq:true, es3:true, forin:true, immed:true, jquery:true,
         ...
         asi:true, boss:true, debug:true, eqnull:true, evil:true, 
         expr:true, lastsemic:true, loopfunc:true, moz:true, proto:true,
         scripturl:true
*/
...
window.DiscordIntegratorConfig = {
    siderail: {
        title: "#hypotheticalhurricanes",
        id: "160178253431046144"
    }
};