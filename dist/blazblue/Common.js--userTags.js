...
function addMastheadTags() {
  var rights = {};
  rights["Night Vision"]             = ["Bureaucrat", "Administrator"];
  rights["Face Monster"]             = ["Content moderator", "Discussions moderator"];
  rights["Night Bot"]             = ["Bot"]
...
$(function() {
    ...
    window.InactiveUsers = function (my, debug) {
        ...
        my = $.extend({ text: 'inactive', gone: [], months: 2 }, my);
