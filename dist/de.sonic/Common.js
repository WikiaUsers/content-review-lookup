...
addOnloadHook(function () {
    if ($.inArray("Spiele", wgCategories) > -1) {
        var pageName = 'Wertung:' + wgPageName;
        disableEdit = false;
        var symbolInactive = new Image();
        symbolInactive.src = 'https://images.wikia.nocookie.net/sonicwiki/de/images/9/91/SonicGamesRatingInactive.png';
        var symbolActive = new Image();
        symbolActive.src = 'https://images.wikia.nocookie.net/sonicwiki/de/images/9/95/SonicGamesRatingActive.png';
...
/* DisplayClock-Variabeln */
window.DisplayClockJS = '%2H:%2M:%2S %2d %{Januar;Februar;März;April;Mai;Juni;Juli;August;September;Oktober;November;Dezember}m %Y (UTC)';
