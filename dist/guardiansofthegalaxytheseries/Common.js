...
$(function() {
    if ($('#IRClogin').length) {
        ...
        $('#IRClogin').html('<iframe src="http://webchat.freenode.net/?nick=' + nick + '&channels=the7d&prompt=true" width="660" height="400" style="border:0;"></iframe>');
    }
});
...
for (index = 0; index < a.length; ++index) {
    element = a[index];
    element.innerHTML=element.innerHTML + "<small><span style=\"color:white;\"><br/>PICKLE & PEANUT WIKI</span></small>";
}
...
if((wgAction == "edit" || wgAction == "submit") && mwCustomEditButtons)
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		"imageFile": "https://vignette.wikia.nocookie.net/guardiansofthegalaxytheseries/images/2/2f/Plus.png/revision/latest?cb=20150112004443",
		"speedTip": "Insert Tabber",
		"tagOpen": "<tabber>",
		"tagClose": "</tabber>",
		"sampleText": ""
	};
...
if(mwCustomEditButtons)
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		 "imageFile": "https://vignette.wikia.nocookie.net/guardiansofthegalaxytheseries/images/1/19/Icons8-Ios7-Editing-Underline.ico/revision/latest?cb=20170611022324",
...
if(mwCustomEditButtons)
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		 "imageFile": "https://vignette.wikia.nocookie.net/guardiansofthegalaxytheseries/images/7/71/VisualEditor_-_Icon_-_Strikethrough-s.svg.png/revision/latest?cb=20170611022449",
		 "speedTip": "Strike Text",
		 "tagOpen":  "<strike>",
		 "tagClose": "</strike>",
...
if(mwCustomEditButtons)
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		 "imageFile": "https://vignette.wikia.nocookie.net/guardiansofthegalaxytheseries/images/9/96/Fonts-icon.png/revision/latest?cb=20170611022602",
		 "speedTip": "Font",
		 "tagOpen":  "{{Font|",
		 "sampleText": "Insert text here}}"
	};