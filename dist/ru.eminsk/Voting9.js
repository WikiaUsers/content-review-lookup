(function(){
    ...
    var conf = {
            ...
            'pagepath': 'Википедия:Выборы арбитров/Осень 2009/Голосование',
            'talkpath': 'Википедия:Выборы арбитров/Осень 2009/Обсуждение/',
            'votepath': 'Википедия:Выборы арбитров/Осень 2009/Голосование/'
        }
    var ico = {
    ...
    var loc = {
            ...
            <p style="font-size:smaller">Если что-то осталось непонятным, можно <a target="_blank" href="/wiki/Обсуждение_Википедии:Выборы_арбитров/Осень_2009/Голосование">задать вопрос</a>.</p>\
            </div>',
    ...
    var cand = 'AndyVolykhov · Blacklake · Claymore · Dmitry Rozhkov · Drbug · George Shuklin · Ilya Voyager · LEMeZza · NBS · Ole Førsten · Rave · VasilievVV · Vlsergey · VPliousnine · Wulfson · А.Крымов · Воевода · Дядя Фред · Кондратьев'.split(' · ')
