function searchPage() {
 var searchEngines = {
  ...
  'Google': 'http://www.google.com/custom?q=%s&hl=ru&domains=ru.eminsk.wikia.com&sitesearch=ru.eminsk.wikia.com',
  'Yahoo': 'http://search.yahoo.com/search?p=%s&vs=ru.eminsk.wikia.com',
  'Яндекс': 'http://yandex.ru/yandsearch?text=%s&site=ru.eminsk.wikia.com&site_manually=true&ras=1'
  }
