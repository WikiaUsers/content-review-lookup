function addFuncBtn2(id, func, img, title){
...
$j(document).ready(function(){
 ...
 addFuncBtn2('wikif', Wikify, 'commons/0/06/Wikify-toolbutton.png', 'Викификатор — автоматический обработчик текста')
 var i, b
 for (i in mwCustomEditButtons){
  b = mwCustomEditButtons[i]
  if (!b.length) continue
  addFuncBtn2(i, b[0], b[1], b[2])
 }
