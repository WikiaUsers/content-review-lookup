...
// debug stuff
//$('<div onclick="alerter()" style="left:50%; margin-left:2px;margin-right:2px; display:inline; text-align: center; cursor: pointer;" align="center"><a class="wikia-button">Alerter</a></div>').prependTo('.Rail');
//$('<div onclick="loadChatSkin()" style="left:50%; margin-left:2px;margin-right:2px; display:inline; text-align: center; cursor: pointer;" align="center"><a class="wikia-button">Load</a></div>').prependTo('.Rail');
