...
importScriptPage('MediaWiki:Chat.js/newmessage.js');
// ****************
// END Chat options
// ****************
...
setInterval(function() {
	$('#Rail .User.chat-mod:not(.admin) .username').each(function() {
		if (!this.innerHTML.match(/Yamichidori1|DragonKnight99|Zachattack31/)) {
