...
function addBackToTop () {
	if( skin == 'oasis' ) {
		$('<li id="backtotop" style="position: absolute; right:20px; top:0px; border:none;"><button type="button" value="Вгору" onClick="goToTop();">Вгорух</button></li>').appendTo('#WikiaBarWrapper .toolbar > .tools');	
		hideFade ();
	}	
}
...
mwCustomEditButtons[mwCustomEditButtons.length] = {
    ...
    "tagOpen": "\n<nowiki><nowiki><youtube>\n",
    "tagClose": "\n</youtube></nowiki></nowiki>",
