...
var chatTopic = 'Are you gonna Make it or Break It?'
 
//Switch to night button
var night_button = 'The Duffy Danger Chat';
 
//Switch to day button
var day_button = 'The Viper Venom Chat';
 
 
//
//Color scheme for The Viper Venom Chat
//
  //Link color
    var linkColorDay = '##C0C0C0';
 
  //All text Color
    var textColorDay = '#FFFFFF';
 
  //Self text background color
    var selfTextColorDay = '#C0C0C0';
 
  //Chat background color
    var backgroundColorDay = '#000000';
 
  //Chat foreground color
    var foregroundColorDay = '#FF0000';
 
  //User stats foreground color
    var userStatsColorDay = '#C0C0C0';
 
//END The Viper Venom Chat color scheme
 
//
//Color scheme for The Duffy Danger Chat
//
  //Link color
...
//END The Duffy Danger Chat color scheme
