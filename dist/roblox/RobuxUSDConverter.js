/*
 * RobuxUSDConverter
 * @description Allows users to see the exchange rate between Robux and USD.
 * For [[Robux Converter]], [[Robux#Exchange Rate]] and [[Create#Exchange Rate]].
 * @author Thundermaker300
 *
 * Current DevEx Rate: 0.0035 USD per Robuk
 * USD to Robux: n / 0.0035
 * Robux to USD: n * 0.0035
 *
 * Current Purchase Rate: 0.0125 USD per Robuk
