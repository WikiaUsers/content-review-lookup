 ...
 * @version         v1.1-Roblox (Branch of Dev v1.1)
...
(function ($, mw) {
    ...
    var Main = {
         ...
         * Passes override for sysop-only actions, if on a non-public userpage.
         * @method getJSON
         * @returns {void}
         */
        getJSON: function () {
            ...
            $.getJSON(mw.util.wikiScript('api'), {
                ...
                if (!d.error) {
                	...
                	if (config.wgNamespaceNumber === 2) {
            			if (!config.wgTitle.startsWith(config.wgUserName)
                				&& !$(userPublicSel).length)
            				overrides.editSysop = true;
    					overrides.moveSysop = true;
                	}
