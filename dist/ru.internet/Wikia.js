$(function () { var d = new Date(); if (d.getHours() < 5) { document.body.className += ' BG4'; } else if (d.getHours() < 9) { document.body.className += ' BG3'; } else if (d.getHours() < 18) { document.body.className += ' BG1'; } else if (d.getHours() < 22) { document.body.className += ' BG2'; } else if (d.getHours() < 24) { document.body.className += ' BG4'; } });
...
window.snowStorm = {
	...
	flakesMax: 200,			// Limit total amount of snow made (falling + sticking)
	flakesMaxActive: 200,		// Limit amount of snow falling at once (less = lower CPU use)
	animationInterval: 50,		// Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
