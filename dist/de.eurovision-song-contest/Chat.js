...
var chatTopic = 'Welcome to the Beyblade Wiki Chat! Please make sure to read the rules and other information <a href="Beyblade Wiki:Chat Policy" target="_blank" title="Project:Chat"><u>here</u></a>.'
 
//Switch to night button
var night_button = 'Switch to Zero-G Chat';
 
//Switch to day button
var day_button = 'Switch to MFB Chat';
...
//
  ...
  //Self text background color
    var selfTextColor = '#ECECEC';

  //Chat background color
    var backgroundColor = '#9A0A00';
