...
$(function() {
 ...
 var rollback = "<a href=\"/wiki/Dom dla zmyślonych przyjaciół pani Foster Wiki:Administratorzy:Automatyczny rewert\"><span style=\" color:white;\">Rollback</span></a>";
 var chatMod = "<a href=\"/wiki/Specjalna:Chat\"><span style=\" color:white;\">Moderator czatu</span></a>";
 var admin = "<a href=\"/wiki/Dom dla zmyślonych przyjaciół pani Foster Wiki:Administratorzy\"><span style=\" color:white;\">Administrator</span></a>";
 var biurokrata = "<a href=\"/wiki/Dom dla zmyślonych przyjaciół pani Foster Wiki:Biurokraci\"><span style=\" color:white;\">Biurokrata</span></a>";
 var founder = "<a href=\"/wiki/Dom dla zmyślonych przyjaciół pani Foster Wiki:Administratorzy\"><span style=\" color:white;\">Założyciel</span></a>";
...
//Be sure that the last line listed for modified rights is proceeded by a semi-colon rather than a comma.
 ...
 rights["Lollipopik"]  = [chatMod]

   //Rollback

 rights["Vía"]  = [rollback],
 rights["Moisissure"]  = [rollback, chatMod]

  //Administratorzy

 rights["Cartoons23"]  = [admin, chatMod]
