...
if($('.sonidonotificacion a').text() == "Sonidos de notificación 
[OFF]") {
$('.sonidonotificacion a').html('Sonidos de notificación <span 
...
$('.sonidonotificacion a').text() == "Sonidos de notificación 
]") {
"#notificacion")[0].play();