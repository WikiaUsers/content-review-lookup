$(function()
{
    ...
    $.get(location.origin + "/wiki/" + (config.page || "Project:Policies/Chat") + "?action=render", function(data)
    {
        ...
        button.innerHTML = config.vocab.rules || "Chat Rules";
        button.className = "ChatRulesButton";
        button.onclick = function()
        {
            $.showModal(config.vocab.rules || "Chat Rules", modalContent,
            {
                id: "ChatRulesModal",
