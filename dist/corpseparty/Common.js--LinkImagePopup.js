// LinkImagePopup by Bobogoobo: shows a popup image of a character/episode
$(function() {
    ...
    var names = {}, cacheEnabled = (window.linkImagePopupCachingDisabled ? false : true), pendingPages = {},
      categories = ['Characters'],//included pages with no representative image (also detected automatically)
      lists = ['Characters'],
      mouseIsOver;
