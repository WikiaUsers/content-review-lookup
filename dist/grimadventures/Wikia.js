...
$(function() {
    ...
    var address = "http://grimadventures.wikia.com/wiki/Special:Editcount/" + wgTitle;
...
/*Keep favicon as correct GAoBaM logo instead of reverting to Wikia logo*/

document.write('<link REL="shortcut icon" HREF="/images/6/64/Favicon.ico" />')

// Chat statement
var statement = 'Read the <a href="http://grimadventures.wikia.com/wiki/Project:Chat">chat rules</a> before joining'
