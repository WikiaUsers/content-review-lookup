$(document).ready(function() { //on document ready
    ...
    function formulate() {
        ...
        //call grow multiplier for level
        var growmultia = 0;
        ...
        $(this).parents('.stat-container').find('.hp-calculated').text(hpsuminitial.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
        ...
        $(this).parents('.statcalc .stat-container').find('.ap-calculated').text(apsuminitial.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
        //replace multi hit attack with calculated stat
        $(this).parents('.stat-container').find('.multihit1c').text(aphit1c.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
        $(this).parents('.stat-container').find('.multihit2c').text(aphit2c.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
        $(this).parents('.stat-container').find('.multihit3c').text(aphit3c.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
        $(this).parents('.stat-container').find('.multihit4c').text(aphit4c.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
        $(this).parents('.stat-container').find('.multihit5c').text(aphit5c.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
        $(this).parents('.stat-container').find('.multihit6c').text(aphit6c.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
        
        //calculate DPS
        var dpssuminitial = apsuminitial * (30 / attackspeed);

        //replace DPS with calculated value
        $(this).parents('.stat-container').find('.dps-calculated').text(dpssuminitial.toLocaleString('en-US',{maximumFractionDigits: fractionlimit}));
    }
