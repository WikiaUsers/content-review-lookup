...
function layoutButton(){
	if ($(".page-Puzzle_Dragons_Wiki").length==0 && $("#fullForce").length == 0){
		$(".tally:first-child").append($("<button class='wikia-menu-button' id='switchLayoutButton'>Wide Layout</button>"));
		switchLayout();
...
function switchLayout(){
	if ($.cookie("layout")=="wide" || $("#fullForce").length > 0){
		$("#switchLayoutButton").html("Normal Layout");
		...
		$("#switchLayoutButton").html("Wide Layout");
