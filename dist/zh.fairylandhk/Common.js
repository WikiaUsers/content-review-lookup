...
$(function(){
    ...
    if (mw.config.values.wgPageName == '童話Online_香港版wiki') MainPage();
});
...
$(function() {
    $(".license-description").append("<div style='font-weight:bold; font-size:12pt; background: rgba(0,0,0,0.5); border-radius: 5px; padding: 5px; text-shadow: 1px 1px 0px rgba(155,155,155,0.5);'><img style='vertical-align:middle' src='https://images.wikia.nocookie.net/__cb20131122002606/tos/zh/images/thumb/c/c7/Attention.png/45px-Attention.png'> 嚴禁發佈<span style='color: yellow'>個人或他人隱私資料（包括但不僅限真實姓名、手機號碼等）、外掛程式、輔助程序</span>以及<span style='color: yellow'>涉及政治言論</span>訊息。違反<a href='javascript:void(0)' onclick=window.open().location.href='https://fairylandhk.fandom.com/zh/wiki/香港童話online_wiki:用戶守則'>用戶守則</a>將會封禁帳號處分。</div>");
