 ...
 * Copy the one-line js to sublicalcume, HTML prettify it, scroll down to the
...
function addPOPEStats() {
    ...
    if (data.isFinalEvolution) {
        ...
        console.log("Familiar.js: added POPE stats");
    }
}
...
function addSkillInfo () {
    ...
    var skillList = ((document.getElementsByClassName("portable-infobox-item item-type-group group-layout-default"))[0]).getElementsByTagName("a");
