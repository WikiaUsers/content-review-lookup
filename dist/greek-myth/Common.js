...
$(window).load(function(){
    $('#WikiaRail').append('<section class="module" id="facebookmodule"><iframe src="http://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2FOUaTWiki&width260&height=290&colorscheme=light&show_faces=true&header=true&stream=false&show_border=true" align="top" frameborder="0" width="280" height="280" scrolling="no" /></section>');
});
