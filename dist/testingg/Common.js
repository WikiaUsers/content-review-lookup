$(function() {
  ...
  if (!$('#search').length) $('body').prepend('<div id="search"></div>');
  if (!$('#filter-type').length) $('body').prepend('<div id="filter-type" class="filter-section"></div>');
  if (!$('#filter-rarity').length) $('body').prepend('<div id="filter-rarity" class="filter-section"></div>');
  if (!$('#filter-effect').length) $('body').prepend('<div id="filter-effect" class="filter-section"></div>');
  if (!$('#filter-sea').length) $('body').prepend('<div id="filter-sea" class="filter-section"></div>');
