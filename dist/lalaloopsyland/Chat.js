...
setInterval(function () {
    ...
    $('.User.chat-mod .username').each(function () {
        if (this.innerHTML.match(/Thenaturals/)) {
            $(this).parent().addClass('founder').removeClass('chat-mod');
        }
        if (this.innerHTML.match(/Chrismh|RGL Victor The Great/)) {
            $(this).parent().addClass('bureaucrat').removeClass('chat-mod');
        }
        if (this.innerHTML.match(/Pepsicola45/)) {
...
var night_button = 'Lights on chat',
    ...
    selfTextColorDay = 'transparent',
 
    // Chat background
    backgroundImageDay = 'url("http://i.imgur.com/vyS0xbK.png")',
 
    // Chat foreground color
    foregroundColorDay = 'url("http://i.imgur.com/QkBW9FF.png")',
 
    // User stats foreground color
    userStatsColorDay = 'transparent',
    ...
    // Self text background color
    selfTextColor = 'transparent',
 
    // Chat background
    backgroundImage = 'url("http://i.imgur.com/KRW9Syh.png")',
 
    // Chat foreground color
    foregroundColor = 'url("http://i.imgur.com/QkBW9FF.png")',
 
    // User stats foreground color
    userStatsColor = 'transparent',
