...
$(function() {
 ...
 rights["Enetrel SP"]                     = ["Кечальгобальхестербисандарбитатор"];
 rights["Депачо Имперский"]                     = ["Большая жижа"];
 rights["Артемий Аделард де Фоссе"]                     = ["Лыковый лыжник"];
 rights["Никодисеас"]                     = ["Никлюклюклёко-ко-ко-пюдисюсясисеас"];
 rights["Брайан-АМ"]                     = ["Читак"];
 rights["Яков из Шарарама"]                     = ["Русофоб"];
 rights["Эдельвейс"]                     = ["Дух 76-го, Папа Форестерианский"];
 rights["Vinegrad"]                    = ["Беспечный рыцарь тьмы"];
