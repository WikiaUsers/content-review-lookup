...
(function(window, $, mw) {
	...
	var messages = {
		...
		pl: {
			...
			wallHistory: 'Historia tablicy'
                ...
                fr: {
			editGreeting: 'Modifier Accueil',
			history: 'Historique Accueil',
			wallHistory: 'Historique du Mur'
		},
                de: {
			editGreeting: 'Begrüßung bearbeiten',
			history: 'Versionen ansehen',
			wallHistory: 'Versionen der Nachrichten'
                },
                pt: {
			editGreeting: 'Modificar Boas-Vindas',
			history: 'Histórico de Boas-Vindas',
			wallHistory: 'Histórico do Mural'
                },
                'pt-br': {
			editGreeting: 'Modificar Boas-Vindas',
			history: 'Histórico de Boas-Vindas',
			wallHistory: 'Histórico do Mural'
                ...
                uk: {
			editGreeting: 'Змінити привітання',
			history: 'Історія привітань',
			wallHistory: 'Історія обговорень'
                },
	};
	...
	function createOasis(url, wallUrl) {
		...
		var $button = $(window.Mustache.render(
			...
			'</ul></nav></div>',
			messages
		)).prependTo('#WikiaMainContentContainer').children();
