...
var hasClass = (function () {
 ...
 if (mwCustomEditButtons) {
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/digimonuniverse/pl/images/c/c4/Button_ref.png",
     "speedTip": "Przypis",
     "tagOpen": "<ref>",
     "tagClose": "</ref>",
     "sampleText": "Wpisz tekst przypisu tutaj"};
  }

function ChangeRedirectImage() {
	$('.redirectMsg img').attr('src', 'https://images.wikia.nocookie.net/digimonuniverse/pl/images/b/b5/Redirectltr.png');
  }
