...
$.getJSON("https://discordapp.com/api/guilds/602463757196722177/widget.json", function (json) {
    ...
    function populateAdmins() {
         ...
         *
         * Dan                        539786966422650886
         * Shinon                     353857475482746884
         * burninginsidemylight       320450913582055424
         * Mỳ gói Hảo Hảo             474250124369985547
         * Liêm sỉ                    602527765362900993
         */
        return [
            '539786966422650886',
            '353857475482746884',
    ...
    function populateTrans() {
         ...
         * 
         * This function populates an array with the
         * Slave user ids and returns the array.
         *
         * Yuu                      602492998735101972
         * Riri                     347552378779598860
         * ky0ka                    266801227684118528
         * Suzu                     315681420205096964
         * Rina                     544086583205167106
         * HLong151darkm1n1         605740569729433600
         * Dang Nguyen              629302108348219402
         * Gin                      534245421376339979
         */
        return [
            '602492998735101972',
            '347552378779598860',
    ...
    function populateWikiasupporter() {
        /**
         * Wikia Supporter
         * 
         * This function populates an array with the
         ...
         *
         * Just A Weeaboo                 467678403567550474
         */
        return [
            '467678403567550474'
        ];
    ...
    $($widgetHeaderMembersOnline)
        ...
        .html("<strong>" + membersOnline + "</strong> nô lệ")
        .appendTo($widgetHeader);
    ...
    $($widgetFooterText)
        ...
        .append("Khu đàn áp nô lệ và dân đen")
    ...
    function addToRail() {
        ...
        railModuleTitleIconPath.style.fill = "#7e5492";
