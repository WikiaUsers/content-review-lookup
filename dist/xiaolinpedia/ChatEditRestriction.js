...
var undereditMessage = "Hi "+ wgUserName+"! Thanks for trying to use the Temple Chat. However, Xiaolinpedia is an encyclopedia and as such encourages all contributors to edit, and you haven't yet made the minimum number of edits required to use it. Our chat policy (which can be found at http://xiaolinpedia.wikia.com/wiki/Project:Chat) requires that you make at least 15 edits, with at least 10 of these being in our mainspace (that is, on the wiki articles such as Character, Episode, and Wu pages.). We apologize for this inconvenience and hope to see you soon in the Showdown Arena.";
...
var exceptionList = ["Foodbandlt", "SpanishBot", "RockLepus145ES"];
