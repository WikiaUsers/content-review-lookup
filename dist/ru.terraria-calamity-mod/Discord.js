...
/* ---------- Правки под данную Вики: ByCl0wn ---------- */
(function () {
...
function initDiscordModule() {
    ...
    var discordJSON = "https://discordapp.com/api/guilds/429684299541905438/widget.json";
...
function setupModule(data) {
    ...
    $('<section class="rail-module">' +
        '<h2>Общение</h2>'+
        '<table style="padding: var(--default); paddint-top: 16px;">' +
            '<tbody>' +
                '<tr>' +
                ...
                '<tr>' +
                    '<td colspan="2">' +
                        '<hr/>' +
                        '<h4 class="discord-users-online">Пользователи онлайн - <span id="users-counter">?</span><div class="discord-chevron"></div></h4>' +
                    '</td>' +
                '</tr>' +
                '<tr>' +
                    '<td colspan="2">' +
    ...
    $module.find('#users-counter').text(data.members.length);
