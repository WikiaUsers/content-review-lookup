...
var l10n = (function(){
	var data = {
		en: {
			...
			more: 'Больше', // in right tabs
			share: 'Share', // in left tabs
			pagetools: 'Инструменты', // in sidebar, section heading
			whatlinkshere: 'Ссылки сюда',
			'recentchangeslinked': 'Связанные правки', //in sidebar, under "Page Tools"
			'log': 'Логи',
			searchText: 'Искать', //placeholder for search box
...
(function(){
	...
	$('<form></form>', {action: mw.config.get('wgScript'), id: 'searchform'}).appendTo($topbar).append(
		$('<div></div>', {id: 'simpleSearch'}).append(
			$('<input/>', {
				type: 'search',
				name: 'search',
				placeholder: 'Искать на вики',
				title: 'Искать на вики',
				id: 'searchInput',
				tabindex: '1',
				accesskey: 'f',
				autocomplete: 'off'
	...
	searchboxesSelectors = ['#searchInput'];
