...
var	ajaxIndicator = 'https://images.wikia.nocookie.net/casualty/images/7/73/Throbber.svg',
	ajaxTimer,
	ajaxRefresh = 60000,
	refreshText = 'AJAX',
...
function preloadAJAXRL() {
	...
	appTo.append( '&nbsp;<span style="font-size: xx-small; line-height: 100%;" id="ajaxRefresh"><span style="cursor: default;" id="ajaxToggleText" title="' + refreshHover + '">' + refreshText + ':</span><input type="checkbox" style="margin-bottom: 0;" id="ajaxToggle"><span style="display: none;" id="ajaxLoadProgress"><img src="' + ajaxIndicator + '" style="vertical-align: baseline; float: none; height: 12px; width: 12px;" border="0" alt="Refreshing page" /></span></span>' );
