...
importArticles({
    type: "script",
    articles: [
 "MediaWiki:Common.js/icons.js", /* Icon placement courtesy of OuaT wiki */
 "w:c:Outcast:MediaWiki:Common.js/ImageHover.js",
...
'{{Licensing\n|description= <!-- Describe the image -->\n|source= <!--Enter link to where image was obtained-->\n|licensing= <!-- {{Comic book licensing|Issue name here|character in this photo|second character in this photo|etc}}, {{Promotional}}, {{Fairuse}},{{Screenshot|Episode name here}}, etc -->\n}}';
     }
}
