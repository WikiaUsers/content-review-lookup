...
var chatTopic = 'Bem-vindo ao chat da The Sims Fanon Wiki.<br /><a href="/wiki/The_Sims_Fanon_Wiki:Política_do_Chat" target="_blank" title="The Sims Fanon Wiki:Política do Chat" style="position:relative;text-decoration:underline;">Política do Chat</a>'
...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; color:Blue; font-size:120%; font-family:Arial; margin-top: 6px; bottom:4px; padding-bottom:2px; border-bottom: solid 4px Blue; width:40%;" align="center">Opções</div>'); // Prevent multiple buttons from being appended
}
