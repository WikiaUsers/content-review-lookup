...
$(".quiz").click(function() {
    ...
    console.log(num);
    if(num == "0") {
        location.href = "http://drew1200test.wikia.com/wiki/User:Drew1200/LMBW Quiz/end";
    }
    else if(num == "1") {
        var myWindow = window.open("http://drew1200test.wikia.com/wiki/User:Drew1200/LMBW Quiz/start", "", "height=400, width=500");
    }
    else {
        num = (num * 2) + 4;
        location.href = "http://drew1200test.wikia.com/wiki/User:Drew1200/LMBW Quiz/"+num;
    }
});

if(wgPageName == "User:Drew1200/LMBW Quiz/end") {
  window.onbeforeunload = function(e) {
    location.href = "http://drew1200test.wikia.com/wiki/User:Drew1200/LMBW Quiz";
  };
}
