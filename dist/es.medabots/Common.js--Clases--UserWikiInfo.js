...
(function($, mw) {
	...
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/Medateca:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Medateca:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Medateca:Reversores">reversor</a>',
		asistente: '<a href="/wiki/Medateca:Asistentes">asistente</a>',
		bot: '<a href="/wiki/Medateca:Bots">bot</a>',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
