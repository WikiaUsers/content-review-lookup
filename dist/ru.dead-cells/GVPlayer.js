        ...
        for (var index = 0; index < spans.length; index++) {
            ...
            switch (spans[index].className.split(' ')[0]) {
                ...
                case "Others":
                    ...
                    ncreatePlayer(spans[index], 'video', 'video/mp4', ' poster="https://images.wikia.nocookie.net/bindingofisaac/ru/images/c/ca/Trjplayer.gif" loop preload="none" ' + encodeURIComponent(spans[index].getAttribute("data-widget-ap")));
                    break outerLoop;
                case "Ogg":
