...
PlantillaPlegable.prototype = {
	...
	init: function(){
		...
		$UT.addHandler(this.oCtrl, 'click', function(thisArg){ return function(){ thisArg.cambiarEstado(!thisArg.bPlegada); }; }(this));
		$UT.addHandler(this.oCtrl, 'keyup', function(thisArg){ return function(e){ $E.getCharCode(e)==13 && thisArg.cambiarEstado(!thisArg.bPlegada); }; }(this));
