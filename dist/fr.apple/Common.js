...
importArticles({
    ...
    type: "style",
    article: [
        "u:zh.pad.wikia.com:MediaWiki:CountDown.css", /* Compte à rebours */
    ]
});
...
UserTagsJS.modules.mwGroups = ['bureaucrat', 'sysop', 'bannedfromchat', 'rollback', 'chatmoderator', 'bot', 'blocked', 'bot-global'];
