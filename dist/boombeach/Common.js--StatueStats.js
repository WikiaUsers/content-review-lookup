...
$(document).ready(function() {
    ...
    /* Squad Leader Lt. Julius Mass */
	$("span#TalentOptionsJuliusMassHarness").html('<div id="juliusMassTalentOptions"> <div id		="juliusMassTalentOptionsInner"> <div id="juliusMassTalentOption"> Talent from Lt. Julius Mass: <select name="juliusMassTalentToggle" id="juliusMassTalentToggle"> <option value="0">NO TALENT</option> <option value="1">TALENT</option> </select> </div> </div> </div>');
	/* Squad Leader Julia Weights */
	$("span#TalentOptionsJuliaWeightsHarness").html(
    '<div id="juliaWeightsTalentOptions"> <div id="juliaWeightsTalentOptionsInner"> <div id="juliaWeightsTalentOption"> Talent from Julia Weights: <select name="juliaWeightsTalentToggle" id="juliaWeightsTalentToggle"> <option value="0">NO TALENT</option> <option value="1">TALENT</option> </select> </div> </div> </div>');
   ...
   $("#changeBonusButton").click(function() {
    ...
    var talentActiveJuliusMass = $("#juliusMassTalentToggle").val() * 1;
    ...
    $(".TD").each(function() {
	var cellValueTD = $(this).attr("title") * 1;
	var talentActiveJuliaWeights = $("#juliaWeightsTalentToggle").val() * 1;
	var totalPercentTD = getInputTD;

    // Without Talent
    var calcNewTD = roundNum(3, cellValueTD * (1 + (totalPercentTD / 100))
    );

	    // With Julia Weights Talent
	    if (talentActiveJuliaWeights == 1) {
	    	calcNewTD = roundNum(3, calcNewTD * 4);
    }
    ...
    if (talentActiveJuliaWeights == 1) {
        $(".TD").addClass("StatModifiedTalent");
    } else {
        $(".TD").removeClass("StatModifiedTalent");
    }
});
      $(".BH").each(function() {
        ...
        var fifthGenerator = $("#fifthGenerator").val() * 1;
        if ($("select#numOfGenerators").val() == 5) {
            var shieldBonusAmount = (calcBoostedBH * ((firstGenerator * 50) / 100)) + (calcBoostedBH * ((secondGenerator * 50) / 100)) + (calcBoostedBH * ((thirdGenerator * 50) / 100)) + (calcBoostedBH * ((fourthGenerator * 50) / 100)) + (calcBoostedBH * ((fifthGenerator * 50) / 100));
        } else if ($("select#numOfGenerators").val() == 4) {
      ...
      $(".DBD").each(function() {
        ...
        var fifthAmp = $("#fifthAmp").val() * 1;
        if ($("select#numOfAmps").val() == 5) {
            var ampBonusAmount = (cellValueDBD * (((firstAmp * 25) + 25) / 100)) + (cellValueDBD * (((secondAmp * 25) + 25) / 100)) + (cellValueDBD * (((thirdAmp * 25) + 25) / 100)) + (cellValueDBD * (((fourthAmp * 25) + 25) / 100)) + (cellValueDBD * (((fifthAmp * 25) + 25) / 100));
        } else if ($("select#numOfAmps").val() == 4) {
      ...
      $(".HE").each(function() {
         ...
         var calcNewHE = roundNum(1,cellValueHE * (1 + (getInputHE / 100)));
    ...
    $(".talentOptionsTrigger").click(function() {
        $(".talentOptionsTrigger").toggleClass("talentOptionsTriggerHidden");
        $("#talentOptions").slideToggle("1000");
    });
    ...
    $("#numOfAmps").change(function() {
    	if ($("select#numOfAmps").val() == 5) {
            ...
            $("#fifthAmpOption").css("display", "block");
            ...
            $("#thirdAmpOption").css("display", "block");
            $("#fourthAmpOption").css("display", "block");
            $("#fifthAmpOption").css("display", "none");
            $("#firstAmpFirstWord").css("display", "inline");
        } else if ($("select#numOfAmps").val() == 3) {
            $("#firstAmpOption").css("display", "block");
            $("#secondAmpOption").css("display", "block");
    ...
    $("#numOfGenerators").change(function() {
    	if ($("select#numOfGenerators").val() == 5) {
            ...
            $("#fifthGeneratorOption").css("display", "block");
            ...
            $("#thirdGeneratorOption").css("display", "block");
            $("#fourthGeneratorOption").css("display", "block");
            $("#fifthGeneratorOption").css("display", "none");
            $("#firstGeneratorFirstWord").css("display", "inline");
        } else if ($("select#numOfGenerators").val() == 3) {
            $("#firstGeneratorOption").css("display", "block");
            $("#secondGeneratorOption").css("display", "block");
    ...
    $("#resetBonusButton").click(function() {
        ...
        $("#juliusMassTalentToggle, #juliaWeightsTalentToggle").val("0");
        $(".StatueStat").each(function() {
            ...
            $(this).removeClass("StatModifiedTalent");
        });
    });
});