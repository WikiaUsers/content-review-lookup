$(document).ready(function() {
    ...
    $("#hqrushinhqrushouttarget").change(function () {
        ...
        if (this.value === "Headquarters" || this.value === "Power Core") {
            $("#jcFormhqrushin th:contains('Shield Generators')").parent().show();
            $("#jcFormhqrushin th:contains('Number of Mark I Generators'), #jcFormhqrushin th:contains('Number of Mark II Generators'), #jcFormhqrushin th:contains('Number of Mark III Generators')").parent().show();
        } else {
            $("#jcFormhqrushin th:contains('Shield Generators')").parent().hide();
            $("#jcFormhqrushin th:contains('Number of Mark I Generators'), #jcFormhqrushin th:contains('Number of Mark II Generators'), #jcFormhqrushin th:contains('Number of Mark III Generators')").parent().hide();
        }
        ...
        if (this.value === "Power Core") {
            $("#jcFormhqrushin th:contains('Target Building Level')").parent().hide();
        } else {
            $("#jcFormhqrushin th:contains('Target Building Level')").parent().show();
        }
    });
    ...
    $("input#armystatinarmystatoutthstatues, input#armystatinarmystatouttdstatues, input#hqrushinhqrushouttdstatues, input#hqrushinhqrushoutbhstatues, input#tlootintlootoutstatues, input#hqdmginhqdmgouthpboost, input#arthtkinarthtkoutBHBonus, input#autofillconfiginautofillconfigoutthstatues, input#autofillconfiginautofillconfigouttdstatues, input#autofillconfiginautofillconfigoutrrstatues").change(function() {
        if (eval(this.value) < 0) {
            $(this).val("0");
            alert("This input cannot have a value less than zero.");
        }
    });
