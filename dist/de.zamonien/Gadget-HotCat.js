...
window.HotCat = {
  ...
  messages :
    {cat_removed  : 'entfernte [[Category:$1|Kategorie:$1]]'
	,template_removed  : 'entfernte {{[[Category:$1|Kategorie:$1]]}}'
	,cat_added    : 'fügte [[Category:$1|Kategorie:$1]] hinzu'
	,cat_keychange: 'new key for [[Category:$1|Kategorie:$1]]: "$2"' // $2 is the new key
	,cat_notFound : 'Kategorie "$1" nicht gefunden'
	,cat_exists   : 'Kategorie "$1" existiert bereits; nicht hinzugefügt.'
	,cat_resolved : ' (redirect [[Category:$1|Kategorie:$1]] resolved)'
	,uncat_removed: 'entfernte {{uncategorized}}'
	,separator    : '; '
	,prefix       : ""
		// Some text to prefix to the edit summary.
	,using        : ' in Verwendung von [[Hilfe:HotCat|HotCat]]'
