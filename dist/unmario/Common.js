...
/* Namespace specific disabling (disabled)
    var bodyClass = document.getElementsByTagName('body')[0].className;
    if(bodyClass != 'ns-0' && bodyClass != 'ns-102' && bodyClass != 'ns-106')
        return; */
...
/*    firstHeading.removeChild(node);

    node = firstHeading.childNodes[0];
    var cloneNode = titleDiv.cloneNode(true);

    if(node == null || node == undefined)
        firstHeading.appendChild(cloneNode);
    else
        firstHeading.insertBefore(cloneNode, node); */
