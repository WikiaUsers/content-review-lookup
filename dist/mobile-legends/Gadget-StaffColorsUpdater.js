/** <nowiki>
 * Taken from https://hypixel-skyblock.fandom.com/wiki/MediaWiki:Gadget-StaffColorsUpdater.js
 * StaffColorUpdater script for Hypixel Skyblock Wiki
 */
...
mw.loader.using(['mediawiki.api']).then(function() {
	...
	function parse() {
		...
		$.getJSON("https://mobile-legends.fandom.com/wiki/MediaWiki:Gadget-StaffColorsUpdater.js/staff-colors.json?action=raw&ctype=text/json").then(function(data) {
			new mw.Api().get({
				action: "query",
				list: "allusers",
