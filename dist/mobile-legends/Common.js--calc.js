...
$('<link>', { 
	rel: 'stylesheet', 
	href: 'https://mobile-legends.fandom.com/wiki/MediaWiki:Common.js/calc.css?action=raw&ctype=text/css'
}).appendTo('head');
        ...
        helper = {
            ...
            tParams: {
                ...
                fixed: function ($td, param) {
                    $td.text(param.def);
                    param.$ui = $td; // [mlwiki] custom way of doing much less involved "param.ooui"
                    return $td;
                },
                ...
                select: function ($td, param, id) {
                    ...
                    param.$ui = $select; // [mlwiki] custom way of doing much less involved "param.ooui"
                    $td.append($select);
                    return $td;
                },
