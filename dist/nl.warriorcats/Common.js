 ...
 * Article imports
 *
 * Please do not add any other importArticle() or importScriptPage()
 * statements below this one. Instead please integrate all future imports
 * into this one.
 */
importArticles({
    type: "script",
    articles: [
        ...
        // Snow
        "u:nl.warriorcats.wikia.com:MediaWiki:Snow.js",
        // SearchSuggest
 ...
 *
 *  Uitleg: Maakt het mogelijk om tabellen uit te klappen, waardoor je normaal alleen een stukje tekst ziet. Zie
 *               [[Wikipedia:NavFrame]].
 *  Gebruikers: [[User:R. Koot]]
 */
