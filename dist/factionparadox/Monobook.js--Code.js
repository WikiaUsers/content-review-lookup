...
/* ===================
   BEGIN JavaScript title rewrite -- jQuery version and new wikia skin fixes by Grunny.  A big shout out to Grunny who personally helped with implementation on this wiki, via [[starwars:user talk:CzechOut]] 
   ==================== */
...
//The following necessary to call the whole thing into life:
...
function PosicionaElementosToolbox() {
	...
	$('#t-multiupload').children().eq(0).text('Upload multiple images');
 
	$('#t-contributions').before('<hr style="margin: 5px; margin-bottom: -1px; background-color: #fff;color:white;" />');
	$('#t-print').before('<hr style="margin: 5px; margin-bottom: -1px; background-color: #fff;color:white;" />');
	$('#t-upload').before('<hr style="margin: 5px; margin-bottom: -1px; background-color: #fff;color:white;" />');
	$('#t-whatlinkshere').before('<hr style="margin: 5px; margin-bottom: -1px; background-color: #fff;color:white;" />');
