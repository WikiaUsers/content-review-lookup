...
// To disable this script, add <code>mwCustomEditButtons = [];<code> to [[Special:Mypage/monobook.js]]
 ...
 if (mwCustomEditButtons) {
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://upload.wikimedia.org/wikipedia/commons/e/e2/Button_bold.png",
     "speedTip": "Bold tags",
     "tagOpen": "<b>",
     "tagClose": "</b>",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://upload.wikimedia.org/wikipedia/commons/1/1d/Button_italic.png",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://upload.wikimedia.org/wikipedia/commons/2/23/Button_code.png",
     "speedTip": "Code",
     "tagOpen": "<code>",
     "tagClose": "</code>",
...
//   mwCustomEditButtons[mwCustomEditButtons.length] = {
//     "imageFile": "https://upload.wikimedia.org/wikipedia/commons/6/6e/Small_caps.svg",
//     "speedTip": "Small caps",
...
//     "sampleText": "Small caps"};
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://upload.wikimedia.org/wikipedia/commons/7/72/Button_span_2.png",
     "speedTip": "Span",
     "tagOpen": "<span>",
     "tagClose": "</span>",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://upload.wikimedia.org/wikipedia/commons/d/d4/Button_div.png",
     "speedTip": "Div",
     "tagOpen": "<div>",
     "tagClose": "</div>",
     "sampleText": "Div Text"};
