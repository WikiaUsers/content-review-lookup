...
var chatTopic = Welcome to Magician's Crown! Shut Up during Chaos Casts.<a href="/wiki/Project:Chat" target="_blank" title="Project:Chat"><u></u></a>.'
 
//Switch to night button
var night_button = 'Chaos Casts';
 
//Switch to day button
var day_button = 'Regular';
...
//
  ...
  //Self text background color
    var selfTextColor = '#00FF00';
 
  //Chat background color
    var backgroundColor = '00FF00';
 
  //Chat foreground color
    var foregroundColor = '00FF00';
 
  //User stats foreground color
    var userStatsColor = '00FF00';
