...
/* Function copied from http://de.creepypasta.wikia.com/wiki/Deutsches_Creepypasta_Wiki */
addOnloadHook(function () {
    if ($.inArray("Crappypasta", wgCategories) > -1)
    ($.inArray("Crappindovinelli", wgCategories) > -1); {
        var pageName = 'Discussioni_template:' + wgPageName;
        disableEdit = false;
        var symbolInactive = new Image();
        symbolInactive.src = 'https://vignette.wikia.nocookie.net/crappypasta/images/9/9c/WertungsKuerbisInaktiv.png/revision/latest?cb=20170116150446&path-prefix=it';
        var symbolActive = new Image();
        symbolActive.src = 'https://vignette.wikia.nocookie.net/crappypasta/images/0/04/WertungsKuerbisAktiv.png/revision/latest?cb=20170116150521&path-prefix=it';
