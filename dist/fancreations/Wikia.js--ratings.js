 ...
 */
console.info("MediaWiki:Wikia.js/ratings.js loaded!"); // debugging
;( function ( $, mw ) {
    ...
    var conf = mw.config.get( [
        ...
        self = {
            init: function () {
                console.info("MediaWiki:Wikia.js/ratings.js - self.init - start exe!"); // debugging
                ...
                if ( conf.wgNamespaceNumber === 0 && conf.wgTitle !== conf.wgMainPageTitle ) {
                    ...
                    if ( $( '#WikiaRail > #WikiaRecentActivity' ).length ) {
                        console.log(document.querySelector("#WikiaRail").cloneNode(true)); // debugging
                        self.loadForm();
                    } else {
             ...
             */
            loadForm: function () {
                console.info("MediaWiki:Wikia.js/ratings.js - self.loadForm - start exe!"); // debugging
                console.log(document.querySelector("#WikiaRail").cloneNode(true)); // debugging
                var $form = $( '<section>' )
                    ...
                    .append(
                        ...
                        $( '<div>' )
                            .attr( 'id', 'ar-info' )
                            .append(
                                'For issues with advertisements, see ',
                                $( '<a>' )
                                    .attr( {
                                        href: mw.util.wikiGetlink( 'Project:Advertisements' ),
                                        title: 'Are advertisements obscuring this page? Click here.'
                                    } )
                                    .text( 'here' ),
                                '.'
                            )
                ...
                console.info("MediaWiki:Wikia.js/ratings.js - self.loadForm - end exe!"); // debugging
            },
            ...
            submitFeedback: function () {
                ...
                var rating = $( '#ar-rating' ).attr( 'data-rating' ) || '-1',
                    ...
                    params = {
                        action: 'edit',
                        title: 'Fan Creations:Feedback/' + mw.util.wikiUrlencode( conf.wgPageName ),
                        text: toSubmit,
