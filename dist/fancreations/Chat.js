...
var chatTopic = 'Welcome to the Fan Creations Wiki chat. <br>Please read <a href="Fan_Creations_Wiki/Policies#Chat_Policy" target="_blank">the rules</a> or <strike>die</strike> suffer the consequences.';

$(function() {
    $('#ChatHeader .public.wordmark').prepend('<divclass="chattopic" style="text-align:center;position:absolute;width:60%;z-index:0;font-size: 13px;color:#000000;font-weight:bold;line-height:1.6;margin-left:16%;">' + chatTopic + '</div>')
...
importArticles({
    ...
    articles: [
        ...
        'u:dev:ChatAnnouncements/code.js',  // Chat Announcements
    ]
});