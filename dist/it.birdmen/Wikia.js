...
PFD_templates = [
    ...
    {
        label:   "Immagine di Blackout",
        desc:    "== Fonte ==\nImmagine tratta dal [[capitolo #]].\n{{Fair use}}\n\n[[Categoria:Immagini di Blackout]]",
        tip: "Immagine che rappresenta un Blackout. Per favore, completa la fonte."
    },
    {
        label:   "Immagine di Whiteout",
        desc:    "== Fonte ==\nImmagine tratta dal [[capitolo #]].\n{{Fair use}}\n\n[[Categoria:Immagini di Whiteout]]",
        tip: "Immagine che rappresenta un Whiteout. Per favore, completa la fonte."
    },
    {
