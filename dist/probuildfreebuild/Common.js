...
$(document).ready(function() {
 $('.WikiHeaderRestyle > nav > ul > li:first-child > ul').append('<li><a class="subnav-2a" href="/wiki/Assassin%27s_Creed_Wiki:WikiPolicies">Wiki Rules</a></li><li><a class="subnav-2a" href="/wiki/Assassin%27s_Creed_Wiki:Maintenance">Maintenance</a></li><li><a class="subnav-2a" href="/wiki/Forum:Index">Forums</a></li>');
});
