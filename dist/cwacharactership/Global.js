...
$('#style').append('<style type="text/css">.ChatWindow{background-image:url(http://images3.wikia.nocookie.net/yuzura/images/8/85/Hell_background2.jpg) !important;}#ChatHeader,.ChatWindow #WikiaPage,.ChatWindow #Write,.ChatWindow #UserStatsMenu,.ChatWindow #UserStatsMenu .info,#partyMenu{}.ChatHeader:hover,.ChatWindow #Write:hover,.ChatWindow #UserStatsMenu:hover,#partyMenu:hover{}.ChatWindow .Write::after{background:rgba(89,44,1,.7);}.ChatWindow .Rail{border-left:1px solid rgba(89,44,1,.7) !important;}</style>'); }
...
$('#style').append('<style type="text/css">.ChatWindow{background-image:url(http://images3.wikia.nocookie.net/__cb20130210152827/yuzura/images/9/98/FGT_Ichigo_wallpaper.jpg) !important;}#ChatHeader,.ChatWindow #WikiaPage,.ChatWindow #Write,.ChatWindow #UserStatsMenu,.ChatWindow #UserStatsMenu .info,#partyMenu{}.ChatHeader:hover,.ChatWindow #Write:hover,.ChatWindow #UserStatsMenu:hover,#partyMenu:hover{}.ChatWindow .Write::after{background:rgba(1,2,89,.7);}.ChatWindow .Rail{border-left:1px solid rgba(1,2,89,.7) !important;}</style>'); }
...
$('#style').append('<style type="text/css">.ChatWindow{background-image:url(http://images4.wikia.nocookie.net/__cb20130210152826/yuzura/images/0/0c/Mortal_Kombat_background.jpg) !important;}#ChatHeader,.ChatWindow #WikiaPage,.ChatWindow #Write,.ChatWindow #UserStatsMenu,.ChatWindow #UserStatsMenu .info,#partyMenu{}.ChatHeader:hover,.ChatWindow #Write:hover,.ChatWindow #UserStatsMenu:hover,#partyMenu:hover{}.ChatWindow .Write::after{background:rgba(89,1,2,.7);}.ChatWindow .Rail{border-left:1px solid rgba(89,1,2,.7) !important;}</style>'); }

);

function skinDarkNexus() {

$('#style').append('<style type="text/css">.ChatWindow{}</style>');
