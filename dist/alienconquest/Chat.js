...
var chatTopic = 'Welcome to the Alien Conquest wiki!'
 
//Switch to night button
var night_button = 'Switch to ADU Theme';
 
//Switch to day button
var day_button = 'Switch to Alien Theme';
 
//
//Color scheme for Night Chat
//
  //Link color
    var linkColor = '#E1C700';
 
  //All text Color
    var textColor = '#11161A';
 
  //Self text background color
    var selfTextColor = '#9C9C9C';
 
  //Chat background color
    var backgroundColor = '#012545';
 
  //Chat foreground color
    var foregroundColor = '#0074AF';
 
  //User stats foreground color
    var userStatsColor = '#012545';
