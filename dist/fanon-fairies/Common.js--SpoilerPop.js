$(function () {
    ...
    window.SpoilerAlert = (function (my, console, Math) {
        ...
        my = $.extend({
            question: 'This article deals with some upcoming content, and may contain some spoilers. Are you sure you want to enter Senior Witch Institute?',
            yes: 'Yes',
            no: 'No, not now',
            isSpoiler: function () {
        ...
        '<table id="dialog" border="0" cellpadding="20" style="background-color: white; border-radius: 4px; border: 2px solid black;">' +
            '<tr>' +
                '<td colspan="2" style="padding: 20px 30px; border-style: none; text-align: center; color: aqua">' +
                    my.question +
                '</td>' +
            '</tr>' +
            '<tr>' +
