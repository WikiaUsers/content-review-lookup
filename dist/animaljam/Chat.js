...
importArticles({
    type: 'script',
    articles: [
        'u:dev:!kick/code.js', //Kicks specified user
        'u:dev:ChatOptions/code.js', //Allows for customization of chat
        'Mediawiki:StaffPings.js',
        'Mediawiki:ChatUserRights.js'
    ]
});

importScriptPage('MediaWiki:ChatTags/code.js', 'shining-armor'); //is this necessary
...
Widget.policyWarning.markup = '<div class=\"blackout\" id=\"policy-notice-blackout\" data-opacity=\"0.65\" style=\"z-index: 100; opacity: 0.65; display: block;\"></div>\n\
	...
	\t\t<p style=\"padding: 5px;\">\n\
	\t\t\tYou confirm that you have read <a href=\"/wiki/Animal Jam Wiki:Chat\" target="_new">the Chat Rules</a> and its <a href=\"/wiki/Animal Jam Wiki:Policy\" target="_new">General Policy.</a>.<br />\n\
