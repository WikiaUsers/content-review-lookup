...
window.SkinNotification = {
	...
	render: function() {
		...
		var sn = $('<div data-type="100"><a class="sprite close-notification"></a><B><a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'">Leer siempre las reglas antes de editar.</a></B></div>');
