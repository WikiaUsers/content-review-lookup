...
{id:'af', name:'Afrikaans',                      domain:'starwars.fandom.com',          path:'/af/',   interlang:true, installed_iws:[     'ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'ar', name:'العربية / Arabisch',             domain:'starwars.fandom.com',          path:'/ar/',   interlang:true, installed_iws:['af',     'bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'bg', name:'Български / Bulgarisch',         domain:'starwars.fandom.com',          path:'/bg/',   interlang:true, installed_iws:['af','ar',     'ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'ca', name:'Català / Katalanisch',           domain:'starwars.fandom.com',          path:'/ca/',   interlang:true, installed_iws:['af','ar','bg',     'chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'chr', name:'Cherokee',                      domain:'starwars.fandom.com',         path:'/chr/',   interlang:false,installed_iws:['eu','fo','gv','kl']},
{id:'cs', name:'Cesky / Tschechisch',            domain:'starwars.fandom.com',          path:'/cs/',   interlang:true, installed_iws:['af','ar','bg','ca','chr',     'cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'cu', name:'Altkirchenslawisch',             domain:'starwars.fandom.com',          path:'/cu/',   interlang:false,installed_iws:[]},
{id:'da', name:'Dansk / Dänisch',                domain:'starwars.fandom.com',          path:'/da/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu',     'de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'de', name:'Deutsch / Deutsch',              domain:'www.jedipedia.net',              path:'/w/', interlang:false,installed_iws:['af','ar','bg','ca','chr','cs','cu','da',     'el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gv','gsw','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'el', name:'Ελληνικά / Griechisch',          domain:'starwars.fandom.com',          path:'/el/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de',     'en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'en', name:'English / Englisch',             domain:'starwars.fandom.com',             path:'/',   interlang:true, installed_iws:[          'bg',           'cs',     'da','de','el',          'es',                    'fr',                                    'hr','hu','id',     'it','ja','ka','ko','la',                    'nl',     'no',     'pl','pt','ro','ru',           'sl',           'sr','sv',     'tr','uk'                ]},
{id:'eo', name:'Esperanto',                      domain:'starwars.fandom.com',          path:'/eo/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en',     'es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'es', name:'Español / Spanisch',             domain:'starwars.fandom.com',          path:'/es/',   interlang:true, installed_iws:[          'bg',           'cs',     'da','de','el','en',                              'fr',                                    'hr','hu','id',     'it','ja','ka',      'ko','la',                    'nl',     'no',     'pl','pt','ro','ru',           'sl',           'sr','sv',     'tr','uk',            'zh']},
{id:'eu', name:'Euskara / Baskisch',             domain:'starwars.fandom.com',          path:'/eu/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es',     'fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'fa', name:'فارسی / Persisch',               domain:'starwars.fandom.com',          path:'/fa/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu',     'fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'fi', name:'Suomi / Finnisch',               domain:'fi.starwars.shoutwiki.com',      path:'/w/', interlang:false,installed_iws:[          'bg','ca',      'cs',     'da','de','el','en',     'es',     'fa',          'fr','fy',                               'hr','hu','id',     'it','ja',          'ko','la',                    'nl','nn','no',     'pl','pt','ro','ru','sco','sk','sl',           'sr','sv',     'tr','uk',           'zh']},
{id:'fo', name:'Färöisch',                       domain:'starwars.fandom.com',          path:'/fo/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi',     'fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'fr', name:'Français / Französisch',         domain:'starwars.fandom.com',          path:'/fr/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo',     'fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'fy', name:'Friesisch',                      domain:'starwars.fandom.com',          path:'/fy/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr',     'ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'ga', name:'Gallisch',                       domain:'starwars.fandom.com',          path:'/ga/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy',     'gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'gd', name:'Schottisch-gälisch',             domain:'starwars.fandom.com',          path:'/gd/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga',     'gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'gl', name:'Galego / Galicisch',             domain:'starwars.fandom.com',          path:'/gl/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd',     'gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'gsw', name:'Alemannisch',                   domain:'starwars.fandom.com',         path:'/gsw/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl',      'gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'gv', name:'Manx-Gälisch',                   domain:'starwars.fandom.com',          path:'/gv/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw',     'he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'he', name:'עברית / Hebräisch',              domain:'starwars.fandom.com',          path:'/he/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv',     'hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'hr', name:'Hrvatski / Kroatisch',           domain:'starwars.fandom.com',          path:'/hr/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he',     'hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'hu', name:'Magyar / Ungarisch',             domain:'starwars.fandom.com',          path:'/hu/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr',     'id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'id', name:'Bahasa Indonesia / Indonesisch', domain:'starwars.fandom.com',          path:'/id/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu',     'is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'is', name:'Isländisch',                     domain:'starwars.fandom.com',         path:'/is/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id',     'it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'it', name:'Italiano / Italienisch',         domain:'starwars.fandom.com',          path:'/it/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is',     'ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'ja', name:'日本語 / Japanisch',               domain:'starwars.fandom.com',         path:'/ja/',   interlang:true,  installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it',     'ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'ka', name:'Georgisch',                      domain:'starwars.fandom.com',          path:'/ka/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja',     'kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'kl', name:'Gronländisch',                   domain:'starwars.fandom.com',          path:'/kl/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka',     'ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'ko', name:'한국어 / Koreanisch',               domain:'starwars.fandom.com',          path:'/ko/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl',     'la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'la', name:'Latina / Latein',                domain:'starwars.fandom.com',          path:'/la/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko',     'lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'lb', name:'Luxemburgisch',                  domain:'starwars.fandom.com',          path:'/lb/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la',     'mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'mi', name:'Māori',                          domain:'starwars.fandom.com',          path:'/mi/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb',     'mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'mk', name:'Македонски / Mazedonisch',       domain:'starwars.fandom.com',          path:'/mk/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi',     'mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'mn', name:'Монгол / Mongolisch',            domain:'starwars.fandom.com',          path:'/mn/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk',     'nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'nl', name:'Nederlands / Niederländisch',    domain:'starwars.fandom.com',          path:'/nl/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn',     'nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'nn', name:'Nynorsk',                        domain:'starwars.fandom.com',          path:'/nn/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl',     'no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'no', name:'Norsk (bokmål] / Norwegisch',    domain:'starwars.fandom.com',          path:'/no/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn',     'oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'oc', name:'Occitan / Okzitanisch',          domain:'starwars.fandom.com',          path:'/oc/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no',     'pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'pl', name:'Polski / Polnisch',              domain:'www.ossus.pl',                   path:'/',   interlang:false,installed_iws:[                          'cs',          'de',     'en',     'es',          'fi',     'fr',                                         'hu',          'it','ja',          'ko',                         'nl',                    'pt',     'ru'                                                                    ]},
{id:'pt', name:'Português / Portugiesisch',      domain:'starwars.fandom.com',          path:'/pt/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl',     'ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'ro', name:'Româna / Rumänisch',             domain:'starwars.fandom.com',          path:'/ro/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt',     'ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'ru', name:'Русский / Russisch',             domain:'starwars.fandom.com',          path:'/ru/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro',     'sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'sco', name:'Scots',                         domain:'starwars.fandom.com',         path:'/sco/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru',      'sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'sk', name:'Slovenčina / Slowakisch',        domain:'starwars.fandom.com',          path:'/sk/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco',     'sl','sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'sl', name:'Slovenšcina / Slowenisch',       domain:'starwars.fandom.com',          path:'/sl/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk',     'sli','sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'sli', name:'Schlesisch',                    domain:'starwars.fandom.com',         path:'/sli/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl',      'sq','sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'sq', name:'Shqip / Albanisch',              domain:'starwars.fandom.com',          path:'/sq/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli',     'sr','sv','th','tr','uk','vi','vmf','zh']},
{id:'sr', name:'Српски / Srpski / Serbisch',     domain:'starwars.fandom.com',          path:'/sr/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq',     'sv','th','tr','uk','vi','vmf','zh']},
{id:'sv', name:'Svenska / Schwedisch',           domain:'starwars.fandom.com',          path:'/sv/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr',     'th','tr','uk','vi','vmf','zh']},
{id:'th', name:'Thailändisch',                   domain:'starwars.fandom.com',          path:'/th/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv',     'tr','uk','vi','vmf','zh']},
{id:'tr', name:'Türkçe / Türkisch',              domain:'starwars.fandom.com',          path:'/tr/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th',     'uk','vi','vmf','zh']},
{id:'uk', name:'Українська / Ukrainisch',        domain:'starwars.fandom.com',          path:'/uk/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr',     'vi','vmf','zh']},
{id:'vi', name:'Tiếng Việt / Vietnamesisch',     domain:'starwars.fandom.com',          path:'/vi/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk',     'vmf','zh']},
{id:'vmf', name:'Fränkisch',                     domain:'starwars.fandom.com',         path:'/vmf/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi',      'zh']},
{id:'zh', name:'Chinesisch',                     domain:'starwars.fandom.com',          path:'/zh/',   interlang:true, installed_iws:['af','ar','bg','ca','chr','cs','cu','da','de','el','en','eo','es','eu','fa','fi','fo','fr','fy','ga','gd','gl','gsw','gv','he','hr','hu','id','is','it','ja','ka','kl','ko','la','lb','mi','mk','mn','nl','nn','no','oc','pl','pt','ro','ru','sco','sk','sl','sli','sq','sr','sv','th','tr','uk','vi','vmf'     ]}
];
...
hotcat.startinit = function () {
    ...
    $.ajax({
        url: 'https://starwars.fandom.com/fr/api.php',
        async: false,
        data: {
            action: 'parse',
            prop: 'wikitext',
    ...
    $.ajax({
    	...
    	$.ajax({
            ...
            data: {
                ...
                bot: true,
                nocreate: true,
                summary: '1.6 Ajout liens inter-langues (script)',
		...
		$.ajax({
        	...
        	$.ajax({
                ...
                data: {
                    ...
                    bot: true,
                    nocreate: true,
                    summary: 'Updating interlanguage links (script)',
                    token: mw.user.tokens.get('editToken')
                },
                xhrFields: { 
                    withCredentials: true 
