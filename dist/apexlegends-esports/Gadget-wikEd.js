...
wikEd.InitMediaWikiSkinIds = function () {
	wikEd.InitObject(wikEd.config.mediaWikiSkinIds, {
		...
		searchwiki: [ 'header-li-buttons', false, true, ['header', 'header-container', 'header-go-button', 'article-container', 'article', 'article-text'] ],
		oasis:       [ 'AccountNavigation', false, false, ['WikiHeader', 'WikiPage'], false ],
...
wikEd.TurnOn = function (scrollToEditFocus) {
	...
	// override insertAtCursor function in gamepedia.com MediaWiki:Functions.js, not Greasemonkey compatible
...
//   see https://en.mediawiki.org/w/api.php
//
...
//
// wikEd.InsertAtCursor: overrides the insertAtCursor function in gamepedia.com MediaWiki:Functions.js
//
