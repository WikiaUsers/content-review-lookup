...
importArticles({
    ...
    articles: [
        ...
        "w:c:dev:SignatureCheck/code.js",           // Checks for signatures on talk
        "w:c:dev:RevealAnonIP/code.js",             // Reveals Anonomous Users IP
        "w:c:dev:ShowHide/code.js",                 // Show - Hide button
        "w:c:dev:HeaderLinks/code.js",              // Links para Seções
...
// Display 12 hour time followed by day, month (full name) and year with "(UTC)" at the end
