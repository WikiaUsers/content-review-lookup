/* retrieve json file */
$.getJSON("https://discordapp.com/api/guilds/587624063069978632/widget.json", function(json) {
    ...
    /* 
    --- Admins IDs ---
    Addol:     379022635880677376
    W0lf:      281201917802315776
 
    --- Mods IDs ---

    */
 
    var adminsid = ["281201917802315776", "379022635880677376"];
    var modsid = [];
    ...
    if (json.members[j].hasOwnProperty('channel_id')) {
        if(json.members[j].channel_id == "591412414038278146") //check if channel_id of voice channell exist and increments voice users counter
        howmanyvoice++;
        isVoice = true;
        } else {
            isVoice = false;
