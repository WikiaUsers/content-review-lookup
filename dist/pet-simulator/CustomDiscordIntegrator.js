/*****
  ...
  # Original Authors: Soap Shadow and Speedit. Adapted by Americhino (Credit to Calvin and Hobbes Wikis)
  # Based on a script from the My Little Pony Wiki
  —————————————————————————————————————————————————————————————————————————
**/
$.getJSON("https://discordapp.com/api/guilds/479110736338092062/widget.json", function(json) {
// Get user's ids
    function getFounder() {return [
        /**
         * Founder
         * 
         * This function populates an array with the 
         * founder user id and returns the array.
         *
         * Amwright13                  264922969191612417
         */
        "264922969191612417"
        ];
    }
    function getCMod() {return [
        /**
         * Content Moderator
         * 
         * This function populates an array with the 
         * Content Moderator user ids and returns the array.
         *
         * JoeBob               383299265704755202 #3498db
         */
        "383299265704755202"
        ];
    }
    function getDMod() {return [
        /**
         * Content Moderator
         * 
         * This function populates an array with the 
         * Content Moderator user ids and returns the array.
         *
         * Applesauce               263403643661844490 #e91e63
         */
        "263403643661844490"
        ];
    }
    function getBureaus() {return [
        /**
         * Bureaucrats
         * 
         * This function populates an array with the
         * Bureaucrat user ids and returns the array.
         *
    ...
    function getAdmins() {return [
         ...
         * 
         * This function populates an array with the
         * Administrator user ids and returns the array.
         *
         * HoneyNutC18                 254723307788697602
         */
        "254723307788697602"
        ];
    }
    ...
    // Create container for Founder
    var $FounderOnlineContainer = document.createElement("div");
    $($FounderOnlineContainer).addClass("widget-role-container").appendTo
    ($widgetBodyUsers);
 
    var $FounderOnlineTitle = document.createElement("div");
    $($FounderOnlineTitle)
        .addClass("widget-role-name-founder")
        .text("Wiki Founder")
        .appendTo($FounderOnlineContainer);
 
    // Create container for Bureaucrats
    var $BureausOnlineContainer = document.createElement("div");
    $($BureausOnlineContainer).addClass("widget-role-container")
    .appendTo($widgetBodyUsers);
    var $BureausOnlineTitle = document.createElement("div");
    $($BureausOnlineTitle)
        .addClass("widget-role-name-bureaus")
        .text("Bureaucrats")
        .appendTo($BureausOnlineContainer);
 
    // Create container for Admins
    ...
    for (var i = 0; i < membersOnline; i++) {
        ...
        if (founder.includes(member.id)) {$(createWidgetMember(member))
        .appendTo($FounderOnlineContainer);} 
        else if (bureaus.includes(member.id)) {$(createWidgetMember(member))
        .appendTo($BureausOnlineContainer);} 
        else if (admin.includes(member.id)) {$(createWidgetMember(member))
        .appendTo($adminOnlineContainer);} 
    ...
    $($widgetFooterText)
        ...
        .append("Be sure to read through our <a href=\"https://pet-simulator.wikia.com/wiki/Guidelines\">policies</a> before joining.")
    ...
    function createWidgetMember(member) {
        ...
        $($railModuleTitle).append("Pet Simulator Wiki");
    ...
    $('.CustomDiscordIntegrator').each(function () {
        ...
        $($containerTitle).append("Pet Simulator Wiki");
