/* ChatTags */
importScriptPage('MediaWiki:ChatTags/code.beta.js', 'shining-armor');
...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; color:#000; font-size:120%; font-family:Comic Sans MS; margin-top: 6px; bottom:4px; padding-bottom:2px; width:40%;" align="center">Opções</div>'); // Prevent multiple buttons from being appended
}
