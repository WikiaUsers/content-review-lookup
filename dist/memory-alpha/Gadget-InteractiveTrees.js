...
$('.appear').each(function(index, currentTree){
	...
	var button = (numberOfSubLists === 0) ? '' : ' (<a href="#" id="' + currentButtonID + '" class="show-hide-button">' + buttonLabel + '</a>)';
	...
	$('#' + currentButtonID).click(function(e){
		e.preventDefault();
...
$('.appear li ul, .appear li ol').each(function(index, currentTree){
	...
	var button = '<a href="#" id="' + currentButtonID + '" class="show-hide-button">' + total + '</a>';
