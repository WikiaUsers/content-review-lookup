 ...
 // [[:de:MediaWiki:Gadget-revisionjumper-config.js]] – diese Zeile bitte mitkopieren
 ...
 if ( (UrlParameters["diff"] && !disabledisplayondiff) || (UrlParameters["oldid"] && !UrlParameters["action"] && !disabledisplayonpermalink) || (wgAction == 'view' && displayonview && !UrlParameters["oldid"]) || (wgAction == 'history' && displayonhistory) ) addOnloadHook(addrevisionjumper);
