/* Original code from [[w:c:dev:UTCClock]] with modifications 
 * for displaying Indochina Standard Time (ICT) in Vietnamese. */
...
( function( $, mw, window, Date ) { 
	...
	const UTCClock = { 
		defaults: Object.freeze( { 
			format: "%A, %H:%2M:%2S %2d%b%Y (UTC+7)", 
			location: "navigation",
			interval: 500,
			fontFamily: "Overpass, Rubik, Helvetica, Arial, sans-serif",
			fontSize: "13px",
			offset: 420, 
			hoverText: "Indochina Time (UTC+07:00)", 
			render: null
		} ),
		interval: null,
		killClock: function( ) { 
