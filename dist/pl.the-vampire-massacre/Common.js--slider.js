...
if (mediaWiki.config.get('wgAction') === 'view')  (function () {
    ...
    $(function () {
        ...
        $('head')
        .append('<link rel="stylesheet" href="http://code.jquery.com/ui/1.9.2/themes/base/jquery-ui.css" /><style type="text/css"> .ui-widget-header { background: transparent; border: none; } .scroll-bar-wrap{ width: 500px; margin: 0 auto; padding: 4px; background: transparent; border: none; } .ui-slider { border: 1px solid #000; box-shadow: 0 0 4px #000; background: transparent; } .scroll-bar-wrap .ui-slider-handle {background: #444614; border: 1px black; } .scroll-bar-wrap .ui-slider-handle:hover { background: none repeat scroll 0 0 #444614; border: 1px black; } .img-slider { overflow: hidden; white-space: nowrap; width: auto; } .img-slider * { margin: 0; padding: 0; } .img-slider figure { display: inline-block; }</style>');
