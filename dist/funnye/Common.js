...
mwCustomEditButtons[mwCustomEditButtons.length] = {
		"imageFile": "http://images1.wikia.nocookie.net/funnye/images/c/c5/Boxbutton.PNG",
		"speedTip": "Box (to put text in)",
		"tagOpen": "<!-- ",
		"tagClose": " -->",
		"sampleText": "
{| cellspacing="3" width=100%
|- valign="top"
| width="100%" class="MainPageBG" style=";-moz-border-radius:20px; border: 2px dotted #228B22; color: Black; background: -moz-linear-gradient(top,#98FB98,#90EE90); background:-webkit-linear-gradient(top,#98FB98,#90EE90);"|<center>default text</center>
|}"
	};