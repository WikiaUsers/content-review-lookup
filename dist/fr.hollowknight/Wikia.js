...
html = '<nowiki><nav style="border: 1px solid ' + borderColor + ';" class="wikia-menu-button secondary combined chooselanguage"><span class="drop"><img style="margin-top: 3px; margin-left: 2px; margin-right: 4px;" class="chevron" src="data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D"></nowiki><nowiki></span></nowiki><nowiki><ul style="min-width: 42px; margin-top: 1px; border: 1px solid ' + borderColor + '; border-top: none; text-align:center;" class="WikiaMenuElement" style="min-width:20px;"></ul></nowiki><nowiki></nav></nowiki>';

c = '<img class="';

    a = '"-image" style="width:20px; height:15px; border-radius:3px" src="<nowiki>http://lipis.github.io/flag-icon-css/flags/4x3/'</nowiki>;
...
$('.WikiaPageHeader .chooselanguage ul').append('<nowiki><a style="display: inline; padding: 0; height: 0; line-height: 0;" class="' + key + '-link" href="' + languages[key] + '"><li style="border-top: 1px solid ' + borderColor + '; padding-top: 3px; padding-bottom: 3px;" class="' + key + '">' + flags[key] + '</li></nowiki><nowiki></a></nowiki>');
...
/* Allow direct link to tabber content (<nowiki>https://community.fandom.com/wiki/Thread:790781)*/</nowiki>

//<nowiki><tabber> extension req</nowiki>

//v2.0, 2017, user:fngplg.

(function ($){

    var nstarget = window.location.hash.replace('#', <nowiki>''</nowiki>);

    if (nstarget === <nowiki>''</nowiki>) return;
...
    	$("#mw-content-text #mw-upload-form fieldset #mw-htmlform-description tbody .mw-htmlform-field-HTMLTextAreaField .mw-input #wpUploadDescription").html("<nowiki>{{infobox file\n|description = \n|source      = \n}}</nowiki>\n\n<nowiki>[[Category:]]</nowiki>");

    	$("#mw-upload-form fieldset table#mw-htmlform-description tbody tr.mw-htmlform-field-Licenses").hide();

    }<div></div>
MediaWiki:Tooltip.js', 'joeplayground