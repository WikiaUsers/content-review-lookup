/* Sebarang JavaScript di sini akan dimuatkan untuk semua pengguna di setiap halaman. */
/* Auto Refresh */
window.AjaxRCRefreshText = 'Segar semula auto';
window.AjaxRCRefreshHoverText = 'Menyegarkan semula laman sevara automatik';
window.ajaxPages = ["Special:RecentChanges","Special:WikiActivity"];
 
/* Pemboleh ubah sejagat */
var load_edittools = true;
 
/*Warnakan nama pengguna*/
highlight = {
    selectAll: false,
    SNN95: '#8B475D',
    Miyanlove: 'purple',
...
if (mwCustomEditButtons) {
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "//upload.wikimedia.org/wikipedia/ms/2/23/Button_code.png",
     "speedTip": "Teks kod",
     "tagOpen": "<code>",
     "tagClose": "</code>",
     "sampleText": "Teks kod"};
