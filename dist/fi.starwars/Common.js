...
// Removes the "Featured on:" line on File pages -- By [[wikia:User:Grunny]]
...
window.AjaxRCRefreshText = 'Automaattinen päivitys';
window.AjaxRCRefreshHoverText = 'Päivitä sivu automaattisesti';
window.ajaxPages = ["Toiminnot:Tuoreet_muutokset","Toiminnot:WikiActivity"];
...
InactiveUsers = { text: 'epäaktiivinen' }; 
