...
(function($, mw, jsSHA) {
	...
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/Vongola:_NG:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Vongola:_NG:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Vongola:_NG:Administradores">reversor</a>',
		asistente: '<a href="/wiki/Vongola:_NG:Administradores">asistente</a>',
		bot: '<a href="/wiki/Vongola:_NG:Administradores">bot</a>',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
