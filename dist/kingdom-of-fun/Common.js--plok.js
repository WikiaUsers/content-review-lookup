///////////////////////////////////////////////////////////////////////////
//Credits would at least go to [[User:Psychobilly2422]] from the Five    //
//Nights at Freddy's Wiki for the floating gif.                          //  
///////////////////////////////////////////////////////////////////////////
 

/////////////////////////////////////////////////////////////////////
// Current floating gif is two flying smileys carrying a heart.    //
/////////////////////////////////////////////////////////////////////

if (["view", "history"].indexOf(mw.config.get("wgAction")) > -1) {
$(function() {
	var url = "https://i.imgur.com/mbS8RnS.gif",
		junk = ["https://i.imgur.com/mbS8RnS.gif"], // Extra
		duration = 5,
		beauty = $('<figure id="timer-animation"><img src="' + url + '" /></figure>');
	$(beauty).on("contextmenu", function(e) {
