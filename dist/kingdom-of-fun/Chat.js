 ...
 var chatOptions = {
 	look: {
 		...
 		backgroundColor: getCookie("customisation", 0),
                 modalIcon: "https://openclipart.org/image/800px/svg_to_png/202775/gear-3d.png"
 	},
 	modules: {
 		chatHacks: {
 			element: "#chatHacks",
...
//Chat imports
importScriptPage('ChatAnnouncements/code.js','dev'); //This action may only be performed by users with chat moderator rights
importScriptPage('MediaWiki:ChatTags/code.js', 'shining-armor');
importScriptPage('MediaWiki:AjaxEmoticons/code.js', 'dev');
importScriptPage('MediaWiki:Emoticons.js', 'kocka');

//Get notified that you have been PMed
var blinkInterval = 1000; //Blink delay
var beepSound = 'http://soundbible.com/grab.php?id=1645&type=mp3'; //Notification sound
importScriptPage('MediaWiki:PrivateMessageAlert/code.js', 'dev');

//For the Emoticons Window
window.kockaEmoticons = {
    vocab: {
        close: "Close Emoticons Window"
    },
};