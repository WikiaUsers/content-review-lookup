/*
 * ChatHacks.js, by Monchoman45. Modified by Pinkgirl234 -- thanks to the geniusAWikiBoy521!
 * Version 7.0
 *
 * Features:
                        ...
                        for(var i = 0; i < pings.length; i++) {
                                if(text.toLowerCase().indexOf(pings[i].toLowerCase()) != -1 || this != mainRoom.viewDiscussion) {
                                        if(!window.hasFocus) { //Only annoy people if the window isn't focused
                                                document.getElementById('sound').innerHTML = '<audio src="https://vignette.wikia.nocookie.net/kingdom-of-fun/images/8/83/Fairy_Dust_Sound_Effect.ogg" autoplay=""></audio>';
