...
if (wgPageName == "Участник:Уиллозавр") {
    $('body').css('background', 'url(https://vignette.wikia.nocookie.net/deadspace/images/f/f5/DeadSpace2-Wallpaper.png/revision/latest?cb=20150313111549&path-prefix=ru) no-repeat center center fixed #000000');
}
