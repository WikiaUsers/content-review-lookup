...
function searchJavaScript() {
    ...
    function updateContent(elem) {
        ...
        conditions.forEach(function (condition) {
            ...
            if (n1 > 0) {
                ...
                if (number !== null && catList != null && number.value !== "") {
                    console.log("dpl: Found condition and number " + number.id + " " + catList.id + ", Number value is " + number.value);
        ...
        // Make Changes
        var text = '{{#dpl:uses = Template:Card Table';
    ...
    function addInput(_elem, container, cat) {
    ...
    function addCheckBox(_elem, container, cat) {
        if (container === null) return;
        container.setAttribute("class", "paddedCardSearchDiv");
    ...
    function addSelectList(_elem, container, cat) {
        if (container === null) return;
        container.setAttribute("class", "paddedCardSearchDiv");
    ...
    function addIntegerComparison(_elem, container, cat) {
        if (container === null) return;
        container.setAttribute("class", "paddedCardSearchDiv");
    ...
    function addItems(elem) {
        ...
        cContainer = document.getElementById("colorContainer");
        addCheckBox.bind(this, elem, cContainer, "Color")();
        cContainer = document.getElementById("iconContainer");
        addCheckBox.bind(this, elem, cContainer, "Icon")();
        cContainer = document.getElementById("abilityContainer");
        addCheckBox.bind(this, elem, cContainer, "Ability")();
        cContainer = document.getElementById("keywordContainer");
        addCheckBox.bind(this, elem, cContainer, "Keyword Ability")();
        cContainer = document.getElementById("keyword2Container");
        addCheckBox.bind(this, elem, cContainer, "Other Keyword")();
        cContainer = document.getElementById("otherContainer");
        addCheckBox.bind(this, elem, cContainer, "Other")();

        // Other
        cContainer = document.getElementById("matchNameContainer");
        addInput.bind(this, elem, cContainer, "matchName")();

        cContainer = document.getElementById("tribeContainer");
        addInput.bind(this, elem, cContainer, "Tribe")();
        cContainer = document.getElementById("tribe2Container");
        addInput.bind(this, elem, cContainer, "Tribe 2")();
        cContainer = document.getElementById("tribe3Container");
        addInput.bind(this, elem, cContainer, "Tribe 3")();
        cContainer = document.getElementById("tribe4Container");
        addInput.bind(this, elem, cContainer, "Tribe 4")();
        cContainer = document.getElementById("tribe5Container");
        addInput.bind(this, elem, cContainer, "Tribe 5")();
        ...
        // up to 5 additional category inputs can be added
        var i;
        for (i = 1; i <= 5; i++) {
        ...
        // up to 5 additional EXCLUDED category inputs can be added
        for (i = 1; i <= 5; i++) {
...
switch (mw.config.get('wgPageName')) {
    case "User:Aeris_Ventaile/Card_Search":
        searchJavaScript();
        break;
}