...
var editLinkPre = 'http://terraria.gamepedia.com/index.php?title=';
$('li[class^="mw-line"] a[href$="&action=history"]').each(function(){
	...
	if ($this.siblings('abbr.newpage').length < 1){
		...
		var receditUndoLink = '<a title="Undo this edit" href="' + receditUndo + '&action=edit">undo</a>';
	}
	var receditEditLink = '<a title="Edit '+ receditTitle +'" href="' + editLinkPre + receditTitle + '&action=edit">edit</a>';
