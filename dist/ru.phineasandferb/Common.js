...
// Please consider transfering this to ProfileTags.
// https://dev.wikia.com/wiki/ProfileTags
$(function() {
    var rights = {};

    //Участники, имеющие более одного статуса
    rights["Hiccupsf"] = ["АКТИВНЫЙ АДМИНИСТРАТОР", "БЮРОКРАТ"];
    rights["Хайнц"] = ["АКТИВНЫЙ АДМИНИСТРАТОР", "БЮРОКРАТ"];
    rights["Grubbbles"] = ["СОЗДАТЕЛЬ (УШЁЛ)"];
