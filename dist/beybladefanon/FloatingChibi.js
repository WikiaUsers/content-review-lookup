...
// this module should only be loaded on certain pages.
if (mw.config.get('wgCategories').includes('User:Keefe-makes-no-Sence-en')) {
    ...
    var chibiDisplay = {
        ...
        timer : null,
        // title of the page, which is also the character's name.
        ...
        // these are the pre-defined tags for the lines we slowly rotate through. change these eventually
        ...
        // loadQuotes scrapes the DOM for character quotes and stores them into contentMap.
        loadQuotes : function() {
        ...
        updateChibi : function(skinName) {
            ...
            document.getElementById('chibiviewerimage').setAttribute('src',
                'https://beybladefanon.fandom.com/wiki/Special:FilePath/Sprite-'
                + strrr + '.png');
        },
    };
