        ...
        self = {
                    ...
                    .append(
                            ...
                            .append(
                                $( '<div>' )
                                    ...
                                    .append(
                                        $( '<span>' )
                                            .addClass( 'star' )
                                            .text( 'https://vignette.wikia.nocookie.net/clashroyale/images/8/89/Combattant.png/revision/latest?cb=20160421020130&path-prefix=fr' ),
                                        $( '<span>' )
                                            .addClass( 'star' )
                                            .text( 'https://vignette.wikia.nocookie.net/clashroyale/images/8/89/Combattant.png/revision/latest?cb=20160421020130&path-prefix=fr' ),
                                        $( '<span>' )
                        ...
                        $( '<div>' )
                            ...
                            .append(
                                ...
                                $( '<a>' )
                                    .attr( {
                                        href: mw.util.wikiGetlink( 'RuneScape:Advertisements' ),
                                        title: 'RuneScape:Advertisements'
                                    } )
                                    .text( 'here' ),
                                '.'
                            )
            ...
            submitFeedback: function () {
                ...
                var rating = $( '#ar-rating' ).attr( 'data-rating' ) || '-1',
                    ...
                    params = {
                        action: 'edit',
                        title: 'Avis des utilisateurs/' + mw.util.wikiUrlencode( conf.wgPageName ),
                        text: toSubmit,
