...
( function ( window, $, mw, undefined ) {
	 ...
	 *
	 * wgPageContentLanguage string ContentLanguage | string PageLanguage | string 'en'
	 * wgUserVariant string variant | null
	 */
	 ...
	 * Shouldn't need updating unless there're language fallback chain changes to
	 * \languages\messages files in mediawiki/core.
	 *
	 * To generate this, use `$ grep -R "fallback =" /path/to/messages/`,
	 * pipe the result to a text file and format the result.
	 *
	 * FIXME: Need to update other parts to use the new fallback system
	 */
	fallbacks = {
		'ab': [ 'ru' ],
		'abs': [ 'id' ],
