...
;(function (mw, $) {
    ...
    function output (i, diff) {
        ...
        delta = diff % 60;
        parts.unshift(delta + ' ' + (delta === 1 ? 'second' : 'seconds'));
        diff = Math.floor(diff / 60);
        delta = diff % 60;
        parts.unshift(delta + ' ' + (delta === 1 ? 'minute' : 'minutes'));
        diff = Math.floor(diff / 60);
        delta = diff % 24;
        parts.unshift(delta + ' ' + (delta === 1 ? 'hour'   : 'hours'  ));
        diff = Math.floor(diff / 24);
        parts.unshift(diff  + ' ' + (diff  === 1 ? 'day'    : 'days'   ));
        result = parts.pop();
