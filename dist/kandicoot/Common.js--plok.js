...
/* code from  the lovely FNaF wiki. */
 
if (["view", "history"].indexOf(mw.config.get("wgAction")) > -1) {
$(function() {
	var url = "http://media.giphy.com/media/7DHc45sRZ8IEM/giphy.gif",
		junk = ["http://media.giphy.com/media/7DHc45sRZ8IEM/giphy.gif"], // Extras
		duration = 8,
