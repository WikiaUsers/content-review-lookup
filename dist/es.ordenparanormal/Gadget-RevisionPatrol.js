...
$( function() {
	var i18n = {
		autopatrolled: 'Autopatrullado',
		// $1 is the user, $2 is the timestamp
		patrolled: 'Patrullado por $1 ($2)',
		unpatrollable: 'No patrullaba',
		unpatrolled: 'No patrollado',
		autopatrolledLegend: 'edición autopatrullado',
		patrolledLegend: 'edición patrullado',
		unpatrollableLegend: 'edición no patrullaba',
		unpatrolledLegend: 'edición no patrullada',
		error: 'No se pudo recuperar la información de patrulla',
		rightsError: 'No se pudo recuperar los derechos de patrulla automática',
