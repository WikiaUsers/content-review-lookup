...
;(function ($, mw) {
    ...
    // add module for Big Ciy Greens Wiki
    function addModule() {
        $('<section>')
            .attr('id', 'rsw-discord')
            ...
            .append(
                $('<div>')
                    ...
                    .append(
                        $('<p>')
                            .append(
                                'Big City Greens Wiki has an official Discord server! Click the button below to join and chat with fellow fans and editors, or click',
                                $('<a>'
                        ...
                        $('<a>')
                            .attr('href', 'https://discordapp.com/invite/5SSeNd')
                            .addClass('wds-button')
                            .text('Connect')
                    )
          )
