...
ajaxPages = new Array("Special:WikiActivity", "Special:RecentChanges", "Special:Watchlist", "Special:Log", "Special:Contributions");
...
$(document).ready(function() {
	for (x in ajaxPages) {
		if (wgPageName == ajaxPages[x] && wgAction == "view" && (typeof(window.enableAjaxRC) == 'undefined' || window.enableAjaxRC)) preloadAJAXRC();
	}
});
