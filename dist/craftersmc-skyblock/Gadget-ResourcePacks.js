(function($){
	var SELECTED_CACHE_KEY = 'csw-resourcepacks-selected';
	...
	var packs = [
		...
		{
			id: 'crafters',
			name: "CraftersMC Originals",
			stylesheet: stylesheetPrefix+"MediaWiki:Gadget-ResourcePacks.js/CraftersMC.css",
			author: "CraftersMC",
			packsUrl: "https://craftersmc.net"
		},
	];

	var TOOLBAR_ICON = '<svg class="wds-icon wds-icon-small" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><rect class="csw-dd-brown" x="1" y="5" width="16" height="12" rx="2" ry="2" /><rect class="csw-dd-green" x="1" y="1" width="16" height="4" rx="2" ry="2" /><rect class="c" x="1" y="1" width="16" height="16" rx="2" ry="2" fill="none" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" /><polyline class="d" points="1 5 3.19 5 5 4.68 6.82 6.84 8.66 5 11.32 5 13.29 4.01 14.76 6 17 6" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>';
	...
	var CONTENT_ID = 'csw-resourcepack-dropdown';
	...
	function renderPacksList() {
		...
		$content.html("");
		// Add header
		$('<div class="csw-pack-header"><strong>Resource Pack Selector</strong></div>').appendTo($content);

		// Add list
		var $list = $("<ul>").addClass("csw-pack-list").appendTo($content);
	...
	var STYLESHEET_CLASS = "csw-resourcepack-stylesheet";
