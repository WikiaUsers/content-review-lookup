...
/** Zawartość **/
        $('<div class="fb-like-box" data-href="https://www.facebook.com/CzarodziejkiWiki" data-width="185" data-height="361" data-show-faces="true" data-stream="false" data-header="false"></div>').css({marginTop:"10px", marginLeft:"47px"}).appendTo("#FacebookWnd");
