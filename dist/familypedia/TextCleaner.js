...
/*
  ...
  Source:  Commons: http://commons.wikimedia.org/w/index.php?title=MediaWiki:TextCleaner.js
          ...
          case '[':
            {
              ...
              if (i+5 < s.length) {
                initial = s.substr (i, 6);
                if (initial.toLowerCase () != 'image:') {
                  initial = initial.substr (0, 5);
                  if (initial.toLowerCase () != 'file:') initial = null;
                }
              }
