...
var chatTopic = 'Welcome to the Glee Wiki Twerk Team Chat! Be sure to read the polices [[Glee Wiki Twerk Team Policies|here!]] '
 
//Switch to night button
var night_button = 'Switch to Sin City';
 
//Switch to day button
var day_button = 'Switch to Day Break';
...
//
  //Link color
    var linkColorDay = '#FE4EDA';
 
  //All text Color
    var textColorDay = '#FFFFFF';
 
  //Self text background color
    var selfTextColorDay = '#8904B1';
 
  //Chat background color
    var backgroundColorDay = '#FE4EDA';
 
  //Chat foreground color
    var foregroundColorDay = '##8B008B';
 
  //User stats foreground color
    var userStatsColorDay = '#8904B1';
