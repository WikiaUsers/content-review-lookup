if (mw.config.get('wgPageName') === 'Map1') {
    importArticle({ type: 'script', article: 'Map1.js' });
}
if (mw.config.get('wgPageName') === 'Map2') {
    importArticle({ type: 'script', article: 'Map2.js' });
}
...
mw.hook('wikipage.content').add(function() {
    ...
    mw.hook('leaflet').add(function (L) {
        ...
        * Карта
        */
        var imageUrl = 'https://i.imgur.com/9DlXWPN.png';
        ...
        */
        ...
        var iGrub = new HKIcon32x32({iconUrl: 'https://hollowknight.fandom.com/ru/wiki/Special:Filepath/Grubmap.png?width=32'}),
            ...
            igrib = new HKIcon32x32({iconUrl: 'https://hollowknight.fandom.com/ru/wiki/Special:Filepath/Cormap.png?width=32'}),
        ...
        var imothcloak = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Mothwing_Cloak_Icon.png',
            iconSize: [32, 29],
            iconAnchor: [16, 14]
        });
        var imantisclaw = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Mantis_Claw.png',
            iconSize: [32, 29],
            iconAnchor: [16, 14]
        });
        var icrystalheart = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Crystal_Heart_Icon.png',
            iconSize: [32, 29],
            iconAnchor: [16, 14]
        });
        var imonarchwings = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Monarch_Wings_Icon.png',
            iconSize: [32, 28],
            iconAnchor: [16, 14]
        });
        ...
        var ishadecloak = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Shade_Cloak_Icon.png',
            iconSize: [32, 30],
            iconAnchor: [16, 15]
        });
        var iismatear = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Isma%27s_Tear.png',
            iconSize: [29, 32],
            iconAnchor: [15, 16]
        });
        ...
        var ifireball1 = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Vengeful_Spirit_Icon.png',
            iconSize: [32, 20],
            iconAnchor: [16, 10]
        });
        var ifireball2 = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Shade_Soul_Icon.png',
            iconSize: [32, 20],
            iconAnchor: [16, 10]
        });
        var ishriek1 = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Howling_Wraiths_Icon.png',
            iconSize: [25, 32],
            iconAnchor: [12, 16]
        });
        var ishriek2 = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Abyss_Shriek_Icon.png',
            iconSize: [25, 32],
            iconAnchor: [12, 16]
        });
        var idive1 = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Desolate_Dive_Icon.png',
            iconSize: [32, 30],
            iconAnchor: [16, 15]
        });
        var idive2 = L.icon({
            iconUrl: 'https://hollowknight.fandom.com/ru/wiki/special:Filepath/Descending_Dark_Icon.png',
            iconSize: [32, 30],
            iconAnchor: [16, 15]
        });
        ...
        */
        var gBeast = L.layerGroup().addTo(map),
            ...
            gkingidol = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай2" target="_blank">Трамваи2</a>').addTo(map),
            garcegg = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай" target="_blank">Трамваи</a>').addTo(map),
            gseal = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай" target="_blank">Трамваи</a>').addTo(map),
            gjournal = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай" target="_blank">Трамваи</a>').addTo(map),
            ggrib = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай" target="_blank">Трамваи</a>').addTo(map),
            gcorn = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай" target="_blank">Трамваи</a>').addTo(map),
            gvesfrag = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай" target="_blank">Трамваи</a>').addTo(map),
            gmask = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай" target="_blank">Трамваи</a>').addTo(map),
            gore = L.featureGroup().bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Трамвай" target="_blank">Трамваи</a>').addTo(map);
        ...
        /* NPC */
        function mNPC() {
            L.marker([2183.0, 1769.0], {icon: iSly}).bindPopup('<a href="https://hollowknight.fandom.com/ru/wiki/Старейшина Ху">Старейшина Ху</a>').openPopup().addTo(gNPC);
        ...
        */
        L.control.layers(null, {
            '<img  src="https://hollowknight.fandom.com/wiki/Special:Filepath/Map_Pin_Black_Egg.png?width=32" /> Грезящие': gBeast,
            ...
            '<img  src="https://hollowknight.fandom.com/ru/wiki/special:Filepath/Focus_inventory.png?width=32" /> Заклинания': gZakl,
