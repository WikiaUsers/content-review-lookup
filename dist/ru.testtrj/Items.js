mw.hook('wikipage.content').add(function() {
    ...
    var searchDiv = document.getElementsByClassName('search')[1];
    ...
    var searchInput = document.getElementsByClassName('search-item')[0];
    ...
    function search(e) {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (itemText.toUpperCase().indexOf(input.toUpperCase()) > -1) {
    ...
    $('.sort-tid').click(function() {
        tinysort(items, {data:'tid'});
    });
    $('.sort-cid').click(function() {
        tinysort(items, {data:'cid'});
    });
    $('.sort-sid').click(function() {
        tinysort(items, {data:'sid'});
    });
});
