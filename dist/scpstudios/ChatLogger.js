...
$('form#Write').append('<a class="wikia-button" href="javascript:submitLog()" style="position:absolute; right:50px; top:0;" title="submit chat log">LOG</a>');
...
function submitLog(restart) {
	...
	callAPI({
		...
		'prop': 'info|revisions',
		'intoken': 'edit',
		'titles': 'Sonic_Fanon_Wiki:Chat/Logs/'+date,
		'rvprop': 'content',
		'rvlimit': '1',
		'indexpageids': 'true',
	}, 'GET', function(response) {
		...
		callAPI({
			'minor': 'yes',
			'bot': 'yes',
			'summary': 'Adding to chatlog',
			'action': 'edit',
			'title': 'Sonic_Fanon_Wiki:Chat/Logs/'+date,
