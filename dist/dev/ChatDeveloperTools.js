/* ChatDeveloperTools.js is a script made for active Wikia editors and coders.
 * It's planned to have all necessary and handy tools in one modal window.
 * Author: Lady Furude
 * 
...
$(function() {
    ...
    var ChatDeveloperTools = {
            ...
            return $("<a>", {
                href: (function() {
                    if (link.indexOf("global") !== -1) {
                        return "https://community.fandom.com/wiki/Special:MyPage/" + link;
                    } else if (link.indexOf("MediaWiki") !== -1) {
                        return mw.util.getUrl(link);
                    } else {
                        switch(link) {
                            case "User": return mw.util.getUrl("Special:MyPage");
                            case "Talk": return mw.util.getUrl("Special:MyTalk");
                            case "Contribs": return mw.util.getUrl("Special:Contributions");
                            case "UserActivity": return "https://community.fandom.com/wiki/Special:UserActivity";
                            case "SpecialPages":
                            case "WikiActivity":
                            case "RecentChanges":
                            case "Logs":
                            ...
                            case "UserRights":
                            case "ThemeDesigner":
                            case "Insights": return mw.util.getUrl("Special:" + link);
                            case "ScriptDoc": return "https://dev.fandom.com/wiki/ChatDeveloperTools";
                            case "ScriptCode": return "https://dev.fandom.com/wiki/MediaWiki:ChatDeveloperTools.js";
                            case "ScriptI18n": return "https://dev.fandom.com/wiki/MediaWiki:Custom-ChatDeveloperTools/i18n.json";
        ...
        createSectionsObject: function() {
            var sections = {
                userfiles: {
                    User: this.i18n.msg("profile").plain(),
                    Sandbox: this.i18n.msg("sandbox").plain(),
                    Talk: this.i18n.msg("talk").plain(),
                    Contribs: this.i18n.msg("contribs").plain(),
                    UserActivity: this.i18n.msg("activity").plain()
                },
                specialpages: {
                    SpecialPages: this.i18n.msg("allspecial").plain(),
                    WikiActivity: this.i18n.msg("wikiactivity").plain(),
                    RecentChanges: this.i18n.msg("recentchanges").plain(),
                    Logs: this.i18n.msg("logs").plain()
                },
                mwcommon: {
                    "MediaWiki:Common.js": "MW:Common JS",
                    "MediaWiki:Common.css": "MW:Common.CSS"
                },
                mwoasis: {
                    "MediaWiki:Wikia.js": "MW:Wikia JS",
                    "MediaWiki:Wikia.css": "MW:Wikia.CSS"
                },
                mwchat: {
                    "MediaWiki:Chat.js": "MW:Chat JS",
                    "MediaWiki:Chat.css": "MW:Chat.CSS"
                },
                usercommon: {
                    "common.js": "Common JS",
