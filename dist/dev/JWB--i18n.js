 ...
 * Licensed under GNU GPL 2. https://www.gnu.org/copyleft/gpl.html
 */
...
JWB.messages.tr = {
	// General interface
	'tab-setup':			'Kur',
	'tab-editing':			'Düzenleniyor',
	'tab-skip':				'Geç',
	'tab-other':			'Diğer',
	'tab-log':				'Giriş',
	'pagelist-caption':		'Sayfa listesini girin:',
	'editbox-caption':		'Alan düzenleme',
	'editbox-currentpage':	'<a href="/wiki/$2" target="_blank" title="$1">$1</a> düzenleniyorsunuz',
	'no-changes-made':		'Değişiklik yapılmadı. Listedeki bir sonraki sayfaya gitmek için atla düğmesine basın.',
	'page-not-exists':		'Sayfa mevcut değil, fark yapılamıyor.',
	
	// Stats
	'stat-pages':			'Listelenen sayfalar:',
	'stat-save':			'Kaydedilen listeler:',
	'stat-null':			'Boş-düzenlemeler:',
	'stat-skip':			'Atlanan sayfalar:',
	'stat-other':			'Diğer:',
	
	// Tab 1
	'label-pagelist':		'Sayfa listesi',
	'button-remove-dupes':	'Kopyaları kaldır',
	'button-sort':			'Çeşit',
	'preparse':				'Ayrıştırma öncesi modunu kullan',
	'tip-preparse':			'Listelenen sayfalara göz atın, yalnızca geçerli Atlama kurallarına göre atlanmayacak sayfalara filtre uygulayın.',
	'preparse-reset':		'sıfırla',
	'tip-preparse-reset':	'Sayfa listesinin tamamını yeniden ayrıştırmak için sayfa listesindeki #PRE-PARSE-STOP etiketini temizleyin',
	'pagelist-generate':	'Oluşturma',
	'label-settings':		'Ayarlar',
	'store-setup':			'Mağaza kurulumu',
	'tip-store-setup':		'Geçerli ayarları, daha sonra erişmek için açılır menüde saklayın. \n'+
							'Buna daha sonraki bir oturumda erişebilmek için wikiye kaydetmeniz veya indirmeniz gerekir.',
	'load-settings':		'Yükle:',
	'blank-setup':			'Boş kurulum',
	'delete-setup':			'Sil',
	'tip-delete-setup':		'Seçili olan ayarı silin.',
	'save-setup':			'Wikiye kaydet',
	'download-setup':		'İndir',
	'import-setup':			'İthalat',
	'tip-import-setup':		'Ayarlar dosyalarını (JSON dosya formatı) bilgisayarınızdan yükleyin.',
	'update-setup':			'Yenile',
	'tip-update-setup':		'/$1-settings.js sayfanızda depolanan ayarları yenileyin',
	
	// Tab 2
	'edit-summary':			'Özet:',
	'minor-edit':			'Küçük düzenleme',
	'tip-via-JWB':			'Özetinizin sonuna (JWB betiği ile) ekleyin',
	'watch-add':			'şimdi ekle',
	'watch-remove':			'şimdi kaldır',
	'watch-nochange':		'İzleme listesini değiştirmeyin',
	'watch-preferences':	'Tercihlere göre izle',
	'watch-watch':			'İzleme listesine sayfa ekle',
	'watch-unwatch':		'Sayfaları izleme listesinden çıkar',
	'auto-save':			'Otomatik kaydet',
	'save-interval':		'Her $1 saniye', //$1 represents the throttle/interval input element
	'tip-save-interval':	'Her düzenleme arasında duraklatılacak saniye miktarı',
	'editbutton-stop':		'Durdur',
	'editbutton-start':		'Başlat',
	'editbutton-save':		'Kaydet',
	'editbutton-preview':	'Ön izleme',
	'editbutton-skip':		'Atla', // This message is also used in tab 4
	'editbutton-diff':		'Fark',
	'button-open-popup':	'Daha fazla alan değiştir',
	'button-more-fields':	'Daha fazla alan ekle',
	'label-replace':		'Yerleştir:',
	'label-rwith':			'İle:',
	'label-useregex':		'Düzenli İfade',
	'label-regex-flags':	'bayraklar:',
	'tip-regex-flags':		'Normal ifadeler için herhangi bir bayrak, örneğin yoksaymak için i. \n'+
							'Bu JWB komut dosyasında _ bayrağı, alt çizgi ve boşluklara aynı varlık olarak davranır. Dikkatle kullanın.',
	'label-ignore-comment':	'Ayrıştırılmamış içeriği yoksay',
	'tip-ignore-comment':	'Nowiki, source, math veya pre tags içindeki yorumları ve metni yoksay.',
	'label-enable-RETF':	'$1 etkinleştir',
	'label-RETF':			'RegEx Typo Düzenleme',
	'tip-refresh-RETF':		'Yeni değişiklikler için yazım hataları listesini yenileyin.',
	
	// Tab 3
	'label-redirects':		'Yönlendirmeler:',
	'redirects-follow':		'Takip et',
	'tip-redirects-follow':	'Yönlendirmenin yol açtığı sayfayı düzenleyin',
	'redirects-skip':		'Atla',
	'tip-redirects-skip':	'Yönlendirmeyi atla',
	'redirects-edit':		'Düzenle',
	'tip-redirects-edit':	'Yönlendirmenin yönlendirildiği sayfa yerine kendisini düzenleyin',
	'label-skip-when':		'Ne zaman atlar:',
	'skip-no-change':		'hiç değişiklik yapılmadı',
	'skip-exists-yes':		'çıkmadı',
	'skip-exists-no':		'yok',
	'skip-exists-neither':	'hiçbiri',
	'skip-after-action':	'Taşıdıktan/koruduktan sonra düzenlemeyi atla',
	'skip-contains':		'Sayfa içerdiğinde:',
	'skip-not-contains':	'Sayfa içermediğinde:',
	
	// Tab 4
	'editbutton-move':		'Taşı',
	'editbutton-delete':	'Sil',
	'editbutton-protect':	'Koruma al',
	'move-header':			'Seçenekleri taşı',
	'move-redir-suppress':	'Yönlendirmeleri bastır',
	'move-also':			'Ayrıca taşı:',
	'move-talk-page':		'konuşma sayfası',
	'move-subpage':			'alt sayfalar',
	'move-new-name':		'Yeni sayfa adı:',
	'protect-header':		'Seçenekleri koruyun',
	'protect-edit':			'Düzenleme:',
	'protect-move':			'Taşı:',
	'protect-none':			'Koruma yok', // This is the default label. It should indicate that the dropdown menu is used for selecting protection levels
	'protect-autoconf':		'Otomatik onaylanma',
	'protect-sysop':		'Sadece sysop',
	'protect-expiry':		'Bitmesine:',

	//Dialog boxes
	'confirm-leave':		'Bu sekmeyi kapatmak, tüm ilerlemenizi kaybetmenize neden olur.',
	'alert-no-move':		'Lütfen taşımadan önce yeni sayfa adını girin.',
	'not-on-list':			'Kullanıcı adınız JWB kontrol listesinde bulunamadı. Lütfen bir yönetici ile iletişime geçerek erişim talep edin.',
	'verify-error':			'AutoWikiBrowser kontrol sayfası yüklenirken bir hata oluştu:',
	'new-message':			'Yeni mesajınız var. Bunları görüntülemek için bağlantılar için durum çubuğuna bakın.',
	'no-pages-listed':		'Lütfen başlamadan önce göz atmak için bazı makaleler girin.',
	'infinite-skip-notice':	"Hiçbir değiştirme kuralı belirtilmedi, JWB hiçbir değişiklik yapıldığında otomatik olarak atlayacak şekilde ayarlandı.\n"+
							"Lütfen bu ayarları 'İçerik' ve 'Atla' sekmelerinde inceleyin.",
	'autosave-error':		"Önceki sayfayı gönderirken bir sorun oluştu. Lütfen '$1' sekmesini kontrol edin ve önceki düzenlemelerin doğru gittiğini doğrulayın.",
	
	//Statuses
	'status-alt':			'yükleniyor...',
	'status-done':			'Bitti',
	'status-newmsg':		'Sizin $1 ($2) var',
	'status-talklink':		'yeni mesajlar',
	'status-difflink':		'son değişiklik',
	'status-load-page':		'Sayfa içeriğini alma',
	'status-submit':		'Düzenleme gönderilme',
	'status-preview':		'Önizleme alınma',
	'status-diff':			'Düzenleme farkını alınma',
	'status-move':			'Sayfa taşınmar',
	'status-delete':		'Sayfa silinme',
	'status-undelete':		'Sayfa silme',
	'status-protect':		'Sayfayı koruma',
	'status-watch':			'İzleme listesini değiştirme',
	'status-watch-added':	'İzleme listenize $1 eklendi.',
	'status-watch-removed':	'1$ izleme listenizden kaldırıldı',
	'status-regex-err':		'Regex hatası. Lütfen girilen <i>replace</i> normal ifadeyi değiştirin',
	'status-setup-load':	'JWB ayarlarının yüklenmesi',
	'status-setup-submit':	'Ayarları wikiye gönderme',
	'status-setup-dload':	'Ayarları indirme',
	'status-old-browser':	'Lütfen içe aktarmak için $1 kullanın.',
	'status-del-setup':		"'$1'silindi. 2$.",
	'status-del-default':	'Varsayılan ayarlarınız sıfırlandı. 1$.',
	'status-del-undo':		'Geri al',
	'status-pl-over-lim':	'Sunucu istek sınırına ulaşıldı.',
	'status-unexpected':	'Beklenmeyen hata. Teknik detaylar için geliştirici konsoluna bakınız.',

	//Setup
	'setup-prompt':			'Şu anki kurulumunuzu hangi adla $1 yapmak istiyorsunuz?',
	'setup-prompt-store':	'mağaza',
	'setup-prompt-save':	'kaydet',
	'setup-summary':		'JWB ayarlarının güncellenmesi /*yarı-otomati*/', //this is based on wgContentLanguage, not wgUserLanguage.
	'old-browser':			'Tarayıcınız dosya almayı desteklemiyor. Lütfen daha yeni bir tarayıcıya yükseltin veya dosyanın içeriğini wikiye yükleyin. Bağlantılar için durum çubuğuna bakın.',
	'not-json':				'Sadece JSON dosyaları alınabilir. Lütfen dosyanızın .json uzantısını kullandığından emin olun veya gerekirse dosya uzantısını değiştirin.',
	'json-err':				'JWB ayarlarınızda bir hata bulundu: \n$1\n Lütfen ayarlarınızı $2 inceleyin.',
	'json-err-upload':		'dosya',
	'json-err-page':		"'Special:MyPage/$1-settings.js adresine giderek'",
	'setup-delete-blank':	'Boş kurulumu silemezsiniz.',
	
	//Pagelist generating
	'namespace-main':		'ana sayfa',
	'label-ns-select':		'Ad alanı:',
	'tip-ns-select':		'Birden fazla ad alanı seçmek için Ctrl + tıklayın.',
	'legend-cm':			'Kategori',
	'label-cm':				'Kategoris:',
	'cm-include':			'Dahil:',
	'cm-include-pages':		'sayfalar',
	'cm-include-subcgs':	'alt kategoriler',
	'cm-include-files':		'dosyalar',
	'legend-linksto':		'Sayfaya bağlantılar',
	'label-linksto':		'İle olan bağlantılar:',
	'links-include':		'Dahil:',
	'links-include-links':	'wiki bağlantılar',
	'links-include-templ':	'eklenmeler',
	'links-include-files':	'dosya kullanımı',
	'links-redir':			'Yönlendirmeler:',
	'links-redir-redirs':	'yönlendirmeler',
	'links-redir-noredirs':	'olmayan yönlendirmeler',
	'links-redir-all':		'hepsi',
	'label-link-redir':		'Yönlendirme bağlantılarını dahil et',
	'tip-link-redir':		'Bu sayfanın yönlendirmelerinden birine yönlendirilmiş bağlantılar ekleyin',
	'legend-ps':			'Ön ekli sayfalar',
	'label-ps':				'Önek:',
	'legend-wr':			'İzlenme listesi',
	'label-wr':				'İzleme listesi içeriğini dahil et',
	'legend-pl':			'Sayfadaki bağlantılar',
	'label-pl':				'Sayfada:',
	'tip-pl':				'Sayfalardaki bağlantıların bir listesini getirin.\n | düşey çubuklar.',
};
JWB.messages.uk = {
	// General interface
