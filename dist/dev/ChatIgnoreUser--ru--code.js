(function($, mw) {
  ...
  if (!$("#ChatIgnoreButton").length) {
    $('.Rail').prepend('<span style="position: relative;left: 22px;margin: 2px;" class="ignore button">Игнорировать участника</span>');
  }
  ...
  $('body').on('click', '.ignore', function() {
    ...
    $.showCustomModal('Игнорировать участника', 'Введите имя участника, которого вы хотите игнорировать.<br /><textarea id="block2" autofocus="autofocus" style="height: 300px; width: 400px; resize: none;">' + bb + '</textarea>', {
      id: 'block3',
      buttons: [{
        message: 'Отмена',
        handler: function() {
