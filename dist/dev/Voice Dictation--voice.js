...
$( document ).ready(function () { 
    $("input[type='text']").wrap(function(){
        return "<div class='speech-input-wrapper'>" + $( this ).text() + "</div>";
    });
});

importArticle({
    type: 'style',
    article: 'u:dev:MediaWiki:Voice_Dictation.css'
});*/

/*global webkitSpeechRecognition */
/*This code was forked from https://github.com/Daniel-Hug/speech-input . Please backport any bugfixes or improvements.*/
/*
(function() {
	'use strict';
