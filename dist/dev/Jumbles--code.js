/**
 * Ideas from https://dev.wikia.com/wiki/!mods
 * By Dessamator
 * WikiJumbles
...
$(function () {
    if (mw.config.get('wgCanonicalSpecialPageName') === 'Chat') {
        ...
        function isServerCmd(sNewMsg) {
            ...
            if (bServerMsg) {
                ...
                if (!bGameOn) {
                    ...
                    sendPM("Ask an admin or chat moderator to start one before joining game or wait until the current one is finished.");
                }
            }
        }
        ...
        function getProfile() {
            ...
            if (groups.indexOf('sysop') > -1 || groups.indexOf('threadmoderator') > -1 || groups.indexOf('chatmod') > -1) { // check what groups user is apart of.
                return 0;
    ...
    window.onbeforeunload = function(){
        delete window.oJumblesInt;
        delete window.bGameOn;
    };
});