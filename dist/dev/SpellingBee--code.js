...
$(function() {
    ...
    var imgHeader = '<img src="https://images.wikia.nocookie.net/messaging/images/c/c1/Emoticon_mario.png" alt="Mario" height="20" width="20" />';
    ...
    function isServerCmd(sNewMsg) {
        ...
        if (bServerMsg) {
            ...
            if (!bGameOn) {
                ...
                sendPM("There is no game currently on, ask an admin or chat moderator to start one before joining.");
            }
        }
    }
