...
$(function () {
  ...
  SmoothGlobalNav.prototype.onScroll = function () {
    ...
    if (deltaScroll > 0 && this.transformPercentage <= -100) this.startPos = scroll - headerHeight;
 
    this.transformPercentage = -1 * Math.max(Math.min(deltaStart * 100 / headerHeight, 100), 0);
    $globalNav.css({
