/**
 * SpellCheckModule
 * Adds a Spell Check Module to right hand rails in edit mode
 * Script by Wuher Moseisley 
 * <nowiki>
 */
/*global jQuery, mediaWiki */
function addspCheck () {
    $('<div class="module module_spellcheck" data-id="spellcheck"><h3 onclick="SwitchRail();"><span>Spell Check</span><img src="data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D" class="chevron collapse"/></h3><div class="module_content" style="display: block; "><p style="text-align:justify;"><object data=https://www.jspell.com/public-spell-checker-embed2.html width="325" height="205"> <embed src=https://www.jspell.com/public-spell-checker-embed2.html width="325" height="205"> </embed> Error: Embedded data could not be displayed. </object></p></div></div>').insertAfter('.module_templates');
}
...
importArticle({
	type: 'style',
	article: 'u:dev:MediaWiki:SpellCheckModule.css'
});