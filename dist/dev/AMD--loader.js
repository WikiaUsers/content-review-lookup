    ...
    var NodeScriptLoader = /** @class */ (function () {
        ...
        NodeScriptLoader.prototype._createAndEvalScript = function (moduleManager, contents, options, callback, errorback) {
            ...
            if (receivedDefineCall) {
                ...
                errorback(new Error("Didn't receive define call in ".concat(options.filename, "!")));
            }
            return script;
        };
        NodeScriptLoader.prototype._getElectronRendererScriptPathOrUri = function (path) {
            ...
            if (driveLetterMatch) {
                // windows
                return "file:///".concat((driveLetterMatch[1].toUpperCase() + ':' + driveLetterMatch[2]).replace(/\\/g, '/'));
            }
            else {
                // nix
        ...
        NodeScriptLoader.prototype._getCachedDataPath = function (config, filename) {
            ...
            return this._path.join(config.path, "".concat(basename, "-").concat(hash, ".code"));
        };
        ...
        NodeScriptLoader.prototype._verifyCachedData = function (script, scriptSource, cachedDataPath, hashData, moduleManager) {
            ...
            setTimeout(function () {
                ...
                if (!hashData.equals(hashDataNow)) {
                    moduleManager.getConfig().onError(new Error("FAILED TO VERIFY CACHED DATA, deleting stale '".concat(cachedDataPath, "' now, but a RESTART IS REQUIRED")));
        ...
        ModuleManager.prototype._loadModule = function (moduleId) {
            ...
            var loadNextPath = function (err) {
                ...
                if (lastPathIndex >= paths.length) {
                    ...
                    recorder_1.record(10 /* LoaderEventType.BeginLoadingScript */, currentPath_1);
                    _this._scriptLoader.load(_this, currentPath_1, function () {
                        if (_this._config.isBuild()) {
                            _this._buildInfoPath[moduleId] = currentPath_1;
                        }
                        recorder_1.record(11 /* LoaderEventType.EndLoadingScriptOK */, currentPath_1);
                        _this._onLoad(moduleId);
                    }, function (err) {
                        recorder_1.record(12 /* LoaderEventType.EndLoadingScriptError */, currentPath_1);
                        loadNextPath(err);
                    });
                }
            };
