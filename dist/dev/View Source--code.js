...
(function (module, mw, $) {
    ...
    parserTags = {
        activityfeed: 'https://community.fandom.com/wiki/Help:Activityfeed',
        archiveorg: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        bambuser: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        'bambuser_channel': 'https://community.fandom.com/wiki/Help:EmbedVideo',
        beam: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        bing: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        blip: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        bloglist: 'https://community.fandom.com/wiki/Help:Blog_article/Bloglist',
        categorytree: 'https://community.fandom.com/wiki/Help:CategoryTree',
        ce: 'https://community.fandom.com/wiki/Help:Math',
        charinsert: 'https://www.mediawiki.org/wiki/Extension:CharInsert',
        chem: 'https://community.fandom.com/wiki/Help:Math',
        choose: 'https://community.fandom.com/wiki/Help:RandomSelection',
        collegehumor: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        createbox: 'https://community.fandom.com/wiki/Help:InputBox',
        dailymotion: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        discussions: 'https://community.fandom.com/wiki/Help:Discussions',
        divshare: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        dpl: 'https://community.fandom.com/wiki/Help:DynamicPageList',
        dynamicpagelist: 'https://community.fandom.com/wiki/Help:DynamicPageList',
        embedvideo: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        evlplayer: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        'facebook': 'https://community.fandom.com/wiki/Help:Social_media_integration#Adding_Facebook_widgets',
        'fb:follow': 'https://community.fandom.com/wiki/Help:Social_media_integration#Adding_Facebook_widgets',
        'fb:like-box': 'https://community.fandom.com/wiki/Help:Social_media_integration#Adding_Facebook_widgets',
        'fb:like': 'https://community.fandom.com/wiki/Help:Social_media_integration#Adding_Facebook_widgets',
        'fb:page': 'https://community.fandom.com/wiki/Help:Social_media_integration#Adding_Facebook_widgets',
        ...
        funnyordie: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        gallery: 'https://community.fandom.com/wiki/Help:Galleries',
        gfycat: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        ...
        imagemap: 'https://community.fandom.com/wiki/Help:ImageMap',
        ...
        inputbox: 'https://community.fandom.com/wiki/Help:InputBox',
        jwplayer: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        kickstarter: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        ...
        metacafe: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        nico: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        noinclude: 'https://www.mediawiki.org/wiki/Help:Templates#Control_template_inclusion',
        nowiki: 'https://www.mediawiki.org/wiki/Help:Wikitext_examples#Displaying_text_as_typed',
        onlyinclude: 'https://www.mediawiki.org/wiki/Help:Templates#Control_template_inclusion',
        poem: 'https://community.fandom.com/wiki/Help:Poem',
        poll: 'https://www.mediawiki.org/wiki/Extension:AJAXPoll',
        pre: 'https://www.mediawiki.org/wiki/Help:Wikitext_examples#Displaying_text_as_typed',
        randomimage: 'https://www.mediawiki.org/wiki/Extension:RandomImage',
        ref: 'https://community.fandom.com/wiki/Help:Cite',
        references: 'https://community.fandom.com/wiki/Help:Cite',
        rss: 'https://community.fandom.com/wiki/Help:RSS',
        rutube: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        section: 'https://www.mediawiki.org/wiki/Extension:Labeled_Section_Transclusion',
        smashcast: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        soundcloud: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        source: 'https://community.fandom.com/wiki/Help:Syntax_highlighting',
        spotify: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        spotifyalbum: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        spotifyartist: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        spotifytrack: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        staff: 'https://community.fandom.com/wiki/Community_Central:Staff',
        syntaxhighlight: 'https://community.fandom.com/wiki/Help:Syntax_highlighting',
        tabber: 'https://community.fandom.com/wiki/Help:Tabber',
        tabview: 'https://community.fandom.com/wiki/Help:Tab_view',
        teachertube: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        ted: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        templatedata: 'https://www.mediawiki.org/wiki/Extension:TemplateData',
        timeline: 'https://www.mediawiki.org/wiki/Extension:Timeline',
        tubitv: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        tudou: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        tvpot: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        twitch: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        twitchclip: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        twitchvod: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        twitter: 'https://community.fandom.com/wiki/Help:Twitter',
        verbatim: 'https://community.fandom.com/wiki/Help:Verbatim_tags',
        videomaten: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        vimeo: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        vine: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        vplayer: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        yahoo: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        youku: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        youtube: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        youtubeplaylist: 'https://community.fandom.com/wiki/Help:EmbedVideo',
        youtubevideolist: 'https://community.fandom.com/wiki/Help:EmbedVideo'
    },
