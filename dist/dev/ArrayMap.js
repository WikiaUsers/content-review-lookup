(function($){
    ...
    ArrayMap.prototype.replace = function(){
        var args = Array.prototype.slice.call(arguments),
            target = args[0], substitution = args[1];
        this.array = Array.prototype.map.call(this.array, function(){
            var _args = Array.prototype.slice.call(arguments),
                element = _args[0];
            return element.replace(target, substitution);
        });
        return this;
    };
    ...
    ArrayMap.prototype.some = function(){
        var args = Array.prototype.slice.call(arguments);
        return Array.prototype.some.apply(this.array, args);
    };
    ...
    ['add', 'append', 'concat', 'copy', 'copyWithin', 'deleteElement', 'each',
        ...
        'not', 'reduce', 'reduceRight', 'remove', 'removeDups', 'replace', 'slice',
