 ...
 * Originally written by Sovq
 * 
 * People who contributed - I am too lazy to add them herek, clicking History button won't hurt you */
...
(function($) {
    ...
    var translations = {
        ...
        bn: { //বাংলা
            ...
            rplBtn: 'রিপ্লে করুন',
            resultsHeader: 'ফল',
            noQuestionsHeader: 'কোনো প্রশ্ন দেওয়া হয়নি। অনুগ্রহ করে MediaWiki:Common.jsএ কিছু লাগান।'
        },
        de: { // Deutsch
            nxtBtn: 'Weiter',
            rplBtn: 'Wiederholen',
    ...
    $(function() {
        if ($('#quizQ').length > 0) {
            importArticle({
                type: 'style',
                article: 'u:dev:MediaWiki:ModernQuiz.css'
            });
            ...
            fetch({
                    noCache: 'true',
                    messages: ['Custom-QuizQ-quizName']
                }).then(function(quizName) {
