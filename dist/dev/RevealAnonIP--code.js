...
(function ($, mw, RevealAnonIP, ArticleComments, WikiActivity) {
    ...
    function revealIPs() {
        ...
        // .edited-by covers article comments and forum posts
        // .activity-module covers Recent Wiki Activity module
        ...
        .add('.activityfeed cite a, .activity-module .edit-info-user')
        .each(function () {
            var $this = $(this),
                href = $this.attr('href'),
