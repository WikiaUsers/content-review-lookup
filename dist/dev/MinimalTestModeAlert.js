/* Personal use only */
(function () {
    if (window.MinimalTestModeAlertLoaded || !mw.config.get('wgIsTestModeEnabled')) return;
    ...
    $('<a>', {
        ...
        title: mw.msg('content-review-module-test-mode-disable'),
        click: exitTestMode,
    ...
    }).insertAfter('.fandom-sticky-header .wiki-tools > .wds-button.wds-is-secondary:last, .fandom-community-header .wiki-tools > .wds-button.wds-is-secondary:last');
