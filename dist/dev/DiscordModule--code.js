...
mw.loader.using('mediawiki.util').done(function() {
    ...
    function rcallback (uiFactory, BannerNotification, Spinner) {
        ...
        var i18n = {
            // language list - start
            en: {
                description: "[https://discord.com/ Discord] is a free application for public discussions outside Fandom. " +
            ...
            be: {
                description: "[https://discord.com/ Discord] – дармовы дадатак для публічнага камунікавання па-за Фэндома. " +
            ...
            es: {
                description: "[https://discord.com/ Discord] es un aplicación gratis para discusiones públicas fuera de Fandom. " +
            ...
            fr: {
                description: "[https://discord.com/ Discord] est une application gratuite pour des discussions publiques en dehors de Fandom " +
            ...
            uk: {
                description: "[https://discord.com/ Discord] – безкоштовний додаток для публічного спілкування поза Фендому. " +
            ...
            zh: {
                description: "[https://discord.com/ Discord]是一款免费的应用程序，可以在Fandom之外进行公开讨论。" +
                             "[[wikipedia:zh:Discord|从维基百科了解更多信息]]",
                online: "在线：",
                join: "加入",
                onlinelist: "用户在线",
                instruction: "要获取服务器ID，您需要完成以下步骤（需要管理员权限）：<br>" +
                             "服务器设置 > 小工具 > 服务器ID<br/>" +
                             "同样，如果您希望用户访问您的服务器，您需要打开小工具并选择要邀请的频道。",
                descriptionForm: "模块说明",
                supportsWikitext: "支持wiki语法",
                placeholder: "默认情况下有关Discord的信息",
                useSvg: "使用自定义图片（需要更改CSS）",
                flags: "其他参数",
                showGuideline: "不显示自定义说明",
                showForAnonym: "不给匿名用户显示",
                showServerName: "不显示服务器名称",
                railPosition: "在右栏Rail下方的位置",
                generateHTML: "生成HTML",
                saveSettings: "保存",
                reset: "重置",
                successChange: '保存成功',
                ...
                refresh: '刷新',
                refreshTitle: '刷新',
                showRefresh: '隐藏“刷新”按钮',
                refreshClass: '“刷新”按钮的附加类'
            }
            // language list - stop
        };
