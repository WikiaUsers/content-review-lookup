$(function() {
    if (wgNamespaceNumber !== -1 && wgTitle  !== "PatrolPanel") {
        return;
    }
    var lis;
    var intro = "Howdy " + wgUserGroups[0] + "! Welcome to the hub for managing unpatrolled edits. Here, you can see all edits that have not been patrolled by an <span style=\"color:" +wgSassParams['color-buttons'] +"; font-weight: bold;\">administrator/content moderator</span>. This feed doesn't show edits by any of the afformentioned groups; and only shows edits within the main namespace.";
