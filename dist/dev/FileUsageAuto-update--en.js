LIR.i18n.en= {
	...
	manualModalDescription: 'Input the name of a file to update links for (it does not have to exist).  Links will be updated but <span style="font-weight: bold;">no</span> files will be moved.',
	...
	movePageInfo: [
		'Script updated',
		/* date */
		'More information about updates and functionality can be found <a href="//dev.wikia.com/wiki/FileUsageAuto-update">here</a>.  Please report bugs or missed replacements on the Talk Page in detail.'
	]
};