						...
						if (loopIndex < multipleArray.length) {
								...
								function (resolve) {
									...
									switch (multipleArray[loopIndex].rel) {
										case "change":
											...
											ma__list_item__size.setAttribute("data-wds-tooltip", i18n.msg("ma-v2-before").plain() + ": <b>" + multipleArray[loopIndex].oldlen.toLocaleString() + "</b>; " + i18n.msg("ma-v2-after").plain() + ": <b>" + multipleArray[loopIndex].newlen.toLocaleString()) + "</b>";
											...
											switch (multipleArray[loopIndex].type) {
												case "edit":
													...
													}).toString() + "'>" + i18n.msg("ma-v2-diff").plain() + "</a>)";
										...
										case "post":
											switch (multipleArray[loopIndex]._embedded.thread[0].containerType) {
												case "FORUM":
													switch (multipleArray[loopIndex].funnel) {
														case "POLL":
															...
															ma__list_item__subtitle.innerHTML = i18n.msg("ma-v2-type-forum-poll", subtitleLink_1, subtitleLink_2).parse() + " (<a href='" + mw.config.get("wgScriptPath") + "/f/p/" + multipleArray[loopIndex].threadId + "'>" + i18n.msg("ma-v2-view").plain() + "</a>)";
														...
														case "QUIZ":
															...
															ma__list_item__subtitle.innerHTML = i18n.msg("ma-v2-type-forum-quiz", "[[" + authorLink + "|" + author + "]]").parse() + " (<a href='" + mw.config.get("wgScriptPath") + "/f/p/" + multipleArray[loopIndex].threadId + "'>" + i18n.msg("ma-v2-view").plain() + "</a>)";
														...
														default:
															...
															ma__list_item__subtitle.innerHTML += " (<a href='" + mw.config.get("wgScriptPath") + "/f/p/" + multipleArray[loopIndex].threadId + (multipleArray[loopIndex].isReply ? "/r/" + multipleArray[loopIndex].id : "") + "'>" + i18n.msg("ma-v2-view").plain() + "</a>)"
												...
												case "WALL":
													...
													ma__list_item__subtitle.innerHTML += " (<a href='" + mw.util.getUrl(new mw.Title(targetWall, 1200).getPrefixedText()) + "?" + new URLSearchParams(urlParamsLink).toString() + (multipleArray[loopIndex].isReply ? "#" + multipleArray[loopIndex].id : "") + "'>" + i18n.msg("ma-v2-view").plain() + "</a>)"
													...
													$.ajax({
														...
														.then(
															function (comment) {
																...
																ma__list_item__subtitle.innerHTML += " (<a href='" + comment.articleNames[Object.keys(comment.articleNames)[0]].relativeUrl + "?" + new URLSearchParams(urlParamsLink).toString() + "'>" + i18n.msg("ma-v2-view").plain() + "</a>)"
															}
														);
							...
							function showTooltip(tooltip, element) {
								...
								switch (tooltipDirection) {
									case "right":
										element.style.left = tooltipPosition.right + 6 + "px", element.style.top = (tooltipPosition.bottom - tooltipPosition.top) / 2 + tooltipPosition.top + "px";
										break;
									case "top":
										element.style.top = tooltipPosition.top - 6 + "px", element.style.left = (tooltipPosition.right - tooltipPosition.left) / 2 + tooltipPosition.left + "px";
										break;
									case "bottom":
										element.style.top = tooltipPosition.bottom + 6 + "px", element.style.left = (tooltipPosition.right - tooltipPosition.left) / 2 + tooltipPosition.left + "px";
										break;
									case "left":
										element.style.left = tooltipPosition.left - 6 + "px", element.style.top = (tooltipPosition.bottom - tooltipPosition.top) / 2 + tooltipPosition.top + "px";
										break;
								}
						...
						if (paragraph.content[i].type == "text") {
							if (paragraph.content[i].marks) {
								switch (paragraph.content[i].marks[0].type) {
									case "link":
										paragraphArray.push(paragraph.content[i].text);
										break
									case "strong":
										paragraphArray.push("<strong>" + paragraph.content[i].text + "</strong>");
										break
									case "em":
										paragraphArray.push("<em>" + paragraph.content[i].text + "</em>");
										break
								}
								...
								if (paragraph.content[i].content[e].type == "paragraph") {
									...
									while (a < paragraph.content[i].content[e].content.length) {
										if (paragraph.content[i].content[e].content[a].type == "text") {
											paragraphArray.push(paragraph.content[i].content[e].content[a].text + " ");
										}
										a++
									}
								}
