...
mw.loader.using("mediawiki.api").then(function () {
    ...
    var ma_embed = document.getElementsByClassName("ma-feed")[0];
    var arrayLength = ma_embed ? 10 : 100;
    ...
    mw.hook("dev.i18n").add(function (i18n) {
        i18n.loadMessages("MultipleActivity").done(function (i18n) {
            ...
            function ma_getRecentChanges() {
                var params = {
                    ...
                    rcshow: "!bot",
                    rclimit: arrayLength.toString(),
                    format: "json"
                };

                return new Promise(function (resolve, reject) {
                    api.get(params).done(function (changes) {
            ...
            function ma_getLogEvents() {
                var params = {
                    action: "query",
                    list: "logevents",
                    lelimit: arrayLength.toString(),
                    format: "json"
                };

                return new Promise(function (resolve, reject) {
                    api.get(params).done(function (logs) {
            ...
            function ma_getCommunityCorner() {
                ...
                return new Promise(function (resolve, reject) {
                    api.get(params).done(function (parse) {
                        if (parse.parse) {
            ...
            function ma_getImages() {
                ...
                return new Promise(function (resolve, reject) {
                    api.get(params).done(function (images) {
            ...
            // do only if on the specified special page, or there is an embed element
            if (ma_embed || 
                (mw.config.get("wgCanonicalNamespace") === "Special" && mw.config.get("wgTitle") === title) ){
                ...
                // for the embedded version always false
                urlContainer.showrail = {};
                if (ma_embed) {
                	urlContainer.showrail.value = false;
                } else if (url.searchParams.get('showrail') != null) {
                ...
                // mainspace
                var ms = ma_embed ? ma_embed : document.getElementById("mw-content-text");
                ms.class += " multipleActivity";
                ...
                msContent.style.minHeight = ma_embed ? "100px" : "500px";
                            ...
                            function (posts) {
                                ...
                                ma_getLogEvents().then(
                                    function (logs) {
                                        ...
                                        function theLoopa() {
                                            if (i < arrayLength) {
                                                return new Promise(function (resolve) {
                                                    ...
                                                    contentSpace[i].style.padding = ma_embed ? "0" : "12px";
                                                    ...
                                                    contentSpace[i].style.marginTop = ma_embed ? "5px" : "10px";
                                                            ...
                                                            if (attachedImages.length > 0) {
                                                                ...
                                                                for (a in attachedImages) {
                                                                    if (attachedImages[a].mediaType == "image/png" || attachedImages[a].mediaType == "image/jpeg" || attachedImages[a].mediaType == "image/gif" || attachedImages[a].mediaType == null) {
                                                                        ...
                                                                        postImagesEach.style.marginTop = ma_embed ? "5px" : "10px";
                                                    ...
                                                    if (urlContainer.separate.value === true) {
                                                        ...
                                                        timeSeparator.style.marginTop = ma_embed ? "10px" : "30px";
                                                ...
                                                var elements = document.getElementsByClassName("ma-feed");
                                                Array.from(elements).forEach(function(e) {
                                                    e.innerHTML = ma_embed.innerHTML;
                                                });
                                        	}
                                        }
                                        theLoopa();
                                        ...
                                        /*
                                        if (window.multipleActivity.showImagesStories == true) {
                                            ma_getImages().then(
                                                function (images) {
                                                    var imagesPanel = document.createElement("div");
                                                    ...
                                                    imagesPanel.style.height = "150px";
                                                    imagesPanel.style.display = "flex";
                                                    imagesPanel.style.justifyContent = "space-between";
                                                    imagesPanel.style.padding = "0 25px";
                                                    imagesPanel.style.marginBottom = "20px";

                                                    e = 0;
                                                    while (e < images.length) {
                                                        var imagesEachAnchor = document.createElement("a");
                                                        imagesEachAnchor.href = mw.config.get("wgScriptPath") + images[e].title;

                                                        var imagesEach = document.createElement("div");

                                                        imagesEach.style.backgroundImage = "url(" + images[e].url + ")";
                                                        imagesEach.style.width = "100px";
                                                        imagesEach.style.height = "150px";
                                                        imagesEach.style.backgroundPosition = "center";
                                                        imagesEach.style.backgroundSize = "cover";
                                                        imagesEach.style.borderRadius = "5px";
                                                        imagesEach.style.boxShadow = "0px 0px 10px #5555";

                                                        imagesPanel.appendChild(imagesEachAnchor);
                                                        imagesEachAnchor.appendChild(imagesEach);

                                                        e++
                                                    }

                                                    contentSpace[0].before(imagesPanel);
                                                }
                                            )
                                        }
                                        */
