...
mw.loader.using('mediawiki.api').then(function() {
	...
	var i18n = {
		...
		fr: {
			...
			matching: 'Coincidences',
			generalMatching: "Général (sans tenir compte des catégories avec une barre verticale)",
			broadMatching: "Étendue (en tenant compte des catégories avec une barre verticale)",
			noInclude: "Ne pas inclure dans la transclusion (pour les modèles)",
			caseSensitive: "En prenant en compte les majuscules et minuscules (seulement pour d\'enlever et remplacer)",
			instructions: "Ajoutez sur des lignes séparées le nom de chaque page à catégoriser",
			outputInitial: "Toute erreur rencontrée sera affichée ci-dessous.",
			cancel: "Annuler",
			addCategoryContents: "Ajouter le contenu de la catégorie",
			initiate: "Commencer",
			categoryPrompt: "Veuillez insérer le nom de la catégorie (sans préfixe)",
			doesNotExist: "$1 n\'existe pas",
			failedToGetContents: "Erreur lors du chargement des contenus de $1",
			categoryAlert: "Veuillez insérer au moins une catégorie",
			warning: "Avertissement",
			closeModalWarning: "Êtes-vous sûr de vouloir fermer le module ?",
			close: "Fermer",
			finished: "Terminé",
			nothingLeftToDo: "La liste des pages ou la ligne suivante est vide",
			noCategoryToReplace: "Aucune $1 pour remplacer avec le nom demandé",
			pageNotExist: "La page $1 n\'existe pas",
			addSummary: "Ajout de $1 (automatique)",
			addFail: "Erreur lors de l\'ajout de la page $1 à $2",
			categoryAlready: "$1 contient déjà la catégorie $2 ou une autre erreur s'est produite ; ajout non effectué.",
			categoryCheckFail: "La vérification de catégories a échoué pour la page $1 et n\'a donc pas eu lieu.",
			removeNotFound: "$1 non trouvé sur la page $2",
			removeSummary: "Suppression de $1 (automatique)",
			removeFail: "Erreur lors de la suppression de $1 sur la page $2",
			replaceSummary: "Remplacement de $1 par $2 (automatique)",
			multiReplaceSummary: 'En train de remplacer les catégories : $1 (automatique)',
			removeSuccess: "$1 a été supprimé de la page $2 avec succès",
			replaceFail: "Erreur lors du remplacement de $1 sur la page $2",
			replaceSuccess: "Catégorie remplacée sur la page $1 avec succès",
			noCategoryReplace: "Aucune catégorie à remplacer",
		...
		tr: {
			...
			matching: "Eşleştirme",
			generalMatching: "Genel (pipo kategorilerini hesaba katmaz)",
			broadMatching: "Geniş (boru bağlantılarını önemser)",
			noInclude: "Eklemeye dahil etmeyin (şablonlar için)",
			caseSensitive: "Büyük/küçük harfe duyarlı (yalnızca kaldırma ve değiştirme)",
			instructions: "Kategorize etmek istediğiniz her sayfanın adını ayrı bir satıra koyun",
			outputInitial: "Karşılaşılan hatalar aşağıda görünecektir",
			cancel: "İptal",
			addCategoryContents: "Kategori içeriği ekle",
			initiate: "Başlat",
			categoryPrompt: "Lütfen kategori adını girin (kategori öneki yok)",
			doesNotExist: "$1 mevcut değil",
			failedToGetContents: "1$ içeriği alınamadı",
			categoryAlert: "Lütfen en az bir kategori girin",
			warning: "Uyarı",
			closeModalWarning: "Kalıcıyı bitirmeden kapatmak istediğinize emin misiniz?",
			close: "Kapat",
			finished: "Tamamlandı",
			nothingLeftToDo: "Yapacak hiçbir şey kalmadı veya bir sonraki satır boş",
			noCategoryToReplace: "Girilen ile değiştirilecek $1 yok",
			pageNotExist: "Sayfa $1 mevcut değil",
			addSummary: "1$ ekleme (otomatik)",
			addFail: "$1 ile $2 eklenemedi",
			categoryAlready: "$1 zaten $2 kategorisine sahip veya bir hatayla karşılaşıldı; atlandı",
			categoryCheckFail: "$1 için kategori kontrolü başarısız oldu; atlandı",
			removeNotFound: "1$, 2$'da bulunamadı",
			removeFail: "$1, $2'dan kaldırılamadı",
			removeSuccess: "$1 başarıyla $2’den kaldırıldı",
			removeSummary: "$1 kaldırılma (otomatik)",
			replaceFail: "$2 üzerindeki $1 değiştirilemedi",
			replaceSuccess: "Kategori başarıyla $1’de değiştirildi",
			replaceSummary: "$1'i $2 ile değiştirme (otomatik)",
			multiReplaceSummary: "Kategori değiştirme: $1 (otomatik)",
			noCategoryReplace: "Değiştirilecek kategori yok",
			automatic: "otomatik"
		},
		uk: {
		...
		zh: {
			...
			replaceWith: "替换为",
			matching: "匹配",
			generalMatching: "常规（不含管道链接（即[[链接页面|显示文本]]）的分类）",
			broadMatching: "广泛（处理管道链接（即[[链接页面|显示文本]]））",
			noInclude: "不含通过模板嵌入的分类",
			caseSensitive: "区分大小写（仅用于移除或替代）",
			instructions: "请逐行输入您想要分类的页面名称",
			outputInitial: "任何情况或错误的日志将在下行开始显示。",
			cancel: "取消",
			addCategoryContents: "添加分类内容",
			initiate: "开始",
			categoryPrompt: "请输入分类名称（不含分类前缀，即“Category:”或“分类:”）",
			doesNotExist: "$1不存在",
			failedToGetContents: "无法获取$1的内容",
			categoryAlert: "请输入至少一个分类",
			warning: "警告",
			closeModalWarning: "您确定要在尚未完成操作的情况下关闭此窗口吗？",
			close: "关闭",
			finished: "完成",
			nothingLeftToDo: "没有可分类页面或页面分类完成",
			noCategoryToReplace: "输入内容中找不到要替代内容$1",
			pageNotExist: "页面$1不存在",
			addSummary: "正在添加$1（自动）",
			addFail: "无法添加$1到$2",
			categoryAlready: "页面$1已经具有分类$1或遇到错误，已跳过",
			categoryCheckFail: "$1的分类检查失败，已跳过",
			removeNotFound: "在$2上找不到$1",
			removeFail: "无法从$2上移除$1",
			removeSuccess: "$1成功从$2上移除",
			removeSummary: "正在移除$1（自动）",
			replaceFail: "无法替换$2上的$1",
			replaceSuccess: "成功替换页面$1上的分类",
			replaceSummary: "正在$1替代为$2（自动）",
			multiReplaceSummary: "正在替换分类：$1（自动）",
			noCategoryReplace: "没有可替代的分类",
			automatic: "自动"
		},
		'zh-hans': {
			title: "批量分类",
