...
(function ($, mw) {
    ...
    if (
        ...
        !/content-moderator|content-volunteer|sysop|staff|helper|global-discussions-moderator|wiki-specialist|wiki-representative|soap/.test(config.wgUserGroups.join()) ||
