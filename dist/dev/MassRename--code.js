...
mw.loader.using('mediawiki.api', function () {
    if (
        ...
        !/sysop|content-moderator|bot|bot-global|staff|vstf|helper|wiki-manager|global-discussions-moderator|content-volunteer|content-team-member/.test(mw.config.get('wgUserGroups').join())
    ) {
        return;
    }
