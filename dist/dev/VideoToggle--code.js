...
var hvbutton = '<li><a style="color:white;" onclick="hideVideos()" class="wikia-button" id="hv">Hide videos</a></li>';
  if (wgNamespaceNumber === 0) {
      $(".wikia-bar > .toolbar > .tools").append(hvbutton);
        }
});
...
// 11/14/2014
/ Error on Firefox causing tools to show up on comment sections fixed
// 11/30/2014
/ Error on /chrome/ causing tools to show up on comment sections fixed.
// 
//