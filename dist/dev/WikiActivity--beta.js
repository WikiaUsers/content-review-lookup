...
( function( window, $, mw ) { 
    ...
    if ( window.UCP.WikiActivity ) return;
    ...
    function WikiActivity( o, i18n ) { 
        ...
        p.matchPage = function( ) { 
            ...
            return ( title === mainTitle ) && isSpecial;
        };
        ...
        u.render = function( ) { 
            u.rcButton = createElement( "div", { 
                ...
                children : [ { 
                    ...
                    text : p.msg( "recentchanges-text" ).escape( )
                } ]
            } );
