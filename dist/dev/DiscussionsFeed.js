...
function createDiscussionsFeed() {
    if(wgNamespaceNumber == -1 && wgTitle == "DiscussionsFeed") { //TODO: i18n make dictionary
        ...
        var canBlock = Boolean(wgUserGroups.indexOf('sysop') > -1 || wgUserGroups.indexOf('staff') > -1 || wgUserGroups.indexOf('wiki-representative') > -1 || wgUserGroups.indexOf('helper') > -1 || wgUserGroups.indexOf('soap') > -1 || wgUserGroups.indexOf('global-discussions-moderator') > -1),
