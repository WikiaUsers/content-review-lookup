(function () {
	...
	if (config.replaceLinks) {
		...
		$(".is-gamepedia .global-footer__header a, .is-gamepedia .global-navigation__logo").attr("href", "https://www.gamepedia.io");
		/// Fandom text to Gamepedia text and https://www.fandom.com to https://www.gamepedia.io
		$('.is-gamepedia .global-footer__link[data-tracking-label="explore.fandom"]').text('Gamepedia').attr("href", "https://www.gamepedia.io");
		...
		$('.is-gamepedia .global-footer__link[data-tracking-label="company-overview.about"]').attr("href", "https://www.gamepedia.io/about");
		...
		/// Remove Do Not Sell My Info label
		$('.is-gamepedia .global-footer__link[data-tracking-label="community.usp-do-not-sell"]').remove();
		...
		$('.is-gamepedia .global-footer__link[data-tracking-label="community.community-central"]').text("Wikiconnect").attr("href", "https://www.gamepedia.io/wikiconnect");
		...
		/// All Gamepedia Wikis are Game Wikis
