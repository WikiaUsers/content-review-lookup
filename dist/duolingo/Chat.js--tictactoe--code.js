...
$(function () {
    if (mw.config.get('wgCanonicalSpecialPageName') === 'Chat') {
        //user configuration
        var sPlayerImagesURL = ["https://vignette.wikia.nocookie.net/duolingo/images/0/05/Champagne.png/revision/latest?cb=20140411193459", "https://vignette.wikia.nocookie.net/duolingo/images/d/da/FormalAtire.png/revision/latest?cb=20140411193721"];
        var oPlayers = [
...
var sUserName=wgUserName.toLowerCase();
    ...
    if (sData.substr(0, 1) === ("!") && sLastUser.toLowerCase() === sUserName) {
        removeMsg();
