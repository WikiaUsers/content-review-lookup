...
function addPurgeButton () {
	...
	switch( skin ) {
		...
		case 'oasis':
		case 'wikia':
			$(((wgNamespaceNumber == 2 || wgNamespaceNumber == 3) ? '#WikiaUserPagesHeader' : '#WikiaPageHeader') + ' > ul.wikia-menu-button > li > ul').append('<li><a href="/index.php?title='+encodeURIComponent(wgPageName)+'&action=purge" title="Purge page">'+ theText + '</a></li>');
			break;
