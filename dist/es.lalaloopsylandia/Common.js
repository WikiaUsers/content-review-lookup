...
//Código relacionado a tags de usuarios. Extraído de Dev Wikia
	window.UserTagsJS = {
		modules: {
	// Condiciones para ser declarado inactivo
			inactive: { 
				...
				//Si no ha participadoen la wikia; no se pone.
	...
	tags: {
	autoconfirmed: { u: 'Recién fabricado', f: 'Recién fabricada' },
	inactive: { u: 'Buscando una ciudad' },
	newuser:  { u: 'Clase Little' },
		//Tag especial de adoptante
	adopter: { u: 'Adoptante', title:'El chico que lideró y salvó a Lalaloopsylandia' },
...
//Código para tabs animados. Extraído de Lalaloopsy Land Wiki
var Tabs = {
    switchDuration: 400,
