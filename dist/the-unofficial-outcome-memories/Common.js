...
$(document).ready(function(){$('head').append('<link href="https://fonts.googleapis.com/css2?family=Merriweather&display=swap" rel="stylesheet"><style>@keyframes cameraShakeLight{0%,100%{transform:translateY(0)}25%{transform:translateY(-0.5px)}50%{transform:translateY(0.5px)}75%{transform:translateY(-0.25px)}}@keyframes cameraShakeMedium{0%,100%{transform:translateY(0)}25%{transform:translateY(-1px)}50%{transform:translateY(1px)}75%{transform:translateY(-0.75px)}}@keyframes cameraShakeHeavy{0%,100%{transform:translateY(0)}25%{transform:translateY(-1.5px)}50%{transform:translateY(1.5px)}75%{transform:translateY(-1px)}}@keyframes cameraShakeExtreme{0%,100%{transform:translateY(0)}20%{transform:translateY(-2px)}40%{transform:translateY(2px)}60%{transform:translateY(-1.5px)}80%{transform:translateY(1.5px)}}.shake-light{animation:cameraShakeLight 0.15s ease-out}.shake-medium{animation:cameraShakeMedium 0.15s ease-out}.shake-heavy{animation:cameraShakeHeavy 0.2s ease-out}.shake-extreme{animation:cameraShakeExtreme 0.25s ease-out}#start-button-container{position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);z-index:10003;text-align:center;opacity:0;transition:opacity 0.5s ease-in-out;pointer-events:none}#start-button-container.visible{opacity:1;pointer-events:all}#start-button-text{font-family:"Merriweather",serif;font-size:24px;color:#4da6ff;text-shadow:0 0 10px rgba(77,166,255,0.8);margin-bottom:20px;font-weight:600}#start-button{font-family:"Merriweather",serif;font-size:32px;padding:20px 60px;background:linear-gradient(135deg,#0066cc,#4da6ff);border:3px solid #4da6ff;border-radius:15px;color:#fff;cursor:pointer;font-weight:700;text-shadow:2px 2px 4px rgba(0,0,0,0.5);box-shadow:0 0 20px rgba(77,166,255,0.6),0 0 40px rgba(77,166,255,0.4);transition:all 0.3s ease}#start-button:hover{transform:scale(1.1);box-shadow:0 0 30px rgba(77,166,255,0.8),0 0 60px rgba(77,166,255,0.6)}</style>');var u='https://files.catbox.moe/wcvzop.mp3',C=null,A=null,S=null,D=null,B=0,W=$('<div>').attr('id','visualizer-shake-wrapper').css({position:'fixed',top:'0',left:'0',width:'100%',height:'100%',pointerEvents:'none',zIndex:9997});$('body').append(W);var SBC=$('<div>').attr('id','start-button-container'),SBT=$('<div>').attr('id','start-button-text').text('click 4 effects'),SB=$('<button>').attr('id','start-button').text('START');SBC.append(SBT).append(SB);$('body').append(SBC);var TC=$('<canvas>').attr('id','top-visualizer').css({position:'fixed',top:'80px',left:'0',width:'100%',height:'100px',zIndex:10000,opacity:'0',transition:'opacity 0.5s ease-in-out',pointerEvents:'none'}),BC=$('<canvas>').attr('id','bottom-visualizer').css({position:'fixed',bottom:'80px',left:'0',width:'100%',height:'100px',zIndex:10000,opacity:'0',transition:'opacity 0.5s ease-in-out',pointerEvents:'none'}),TB=$('<div>').attr('id','top-border').css({position:'fixed',top:'-100px',left:'0',width:'100%',height:'80px',backgroundColor:'rgba(0, 0, 0, 0.7)',zIndex:9999,transition:'top 0.5s ease-in-out',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:"'Merriweather', serif",pointerEvents:'none'}),BB=$('<div>').attr('id','bottom-border').css({position:'fixed',bottom:'-100px',left:'0',width:'100%',height:'80px',backgroundColor:'rgba(0, 0, 0, 0.7)',zIndex:9999,transition:'bottom 0.5s ease-in-out',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:"'Merriweather', serif",pointerEvents:'none'}),CO=$('<div>').attr('id','cutscene-overlay').css({position:'fixed',top:'0',left:'0',width:'100%',height:'100%',zIndex:9996,opacity:'0',transition:'opacity 1s ease-in-out',pointerEvents:'none',display:'flex',alignItems:'center',justifyContent:'center',backgroundColor:'rgba(0, 0, 0, 0.3)'}),CG=$('<img>').attr('id','cutscene-gif').attr('src','https://static.wikia.nocookie.net/the-unofficial-outcome-memories/images/8/80/SonicCutscene.gif/revision/latest?cb=20251208023546').css({width:'100%',height:'100%',objectFit:'cover',opacity:'0.85'});CO.append(CG);var SC=$('<canvas>').attr('id','spectrum-canvas').css({position:'absolute',top:'0',left:'0',width:'100%',height:'100%',zIndex:1,pointerEvents:'none'}),LD=$('<div>').attr('id','lyric-display').css({fontSize:'32px',fontWeight:'400',whiteSpace:'pre-wrap',textShadow:'0 1px 0 rgba(0,0,0,0.05)',background:'linear-gradient(#4da6ff, #0066cc)','-webkit-background-clip':'text','-webkit-text-fill-color':'transparent','background-clip':'text',color:'transparent',padding:'0 20px',position:'relative',zIndex:2}).html(''),CD=$('<div>').attr('id','credits-display').css({position:'fixed',top:'50%',left:'50%',transform:'translate(-50%, -50%)',fontSize:'18px',fontWeight:'400',whiteSpace:'pre-line',textAlign:'center',textShadow:'2px 2px 4px rgba(0,0,0,0.8)',color:'#ffffff',padding:'20px 40px',zIndex:10001,opacity:'0',transition:'opacity 1s ease-in-out',maxWidth:'80%',lineHeight:'1.6',pointerEvents:'none',fontFamily:"'Merriweather', serif"}).html('CREDITS:\n\nMain Melody: @johntayjinf\nComposition / Mixing: @astranovayt @ThatGuyNamedPanther\nVocalist: @JohnnyGioeliOfficial\nSonic VA: @zestyra\nArtists: So2onic, SonicDaMAURICE\nLyricists: @SquandaliusScoundrel, SonicDaMAURICE, MadestLadd, @pn_cherryz870\nAnimators: @Palyoshi, _bluewazhere (on disc), @shipi7, @-mr.nam-4412');TB.append(SC);BB.append(LD);$('body').append(CO);$('body').append(CD);W.append(TC).append(BC).append(TB).append(BB);var iD=false,sD=false,fC=0,bT=0.15,lBT=0,bC=150,fDA=null,rAE=new WeakSet(),iS=false,iT=null,btnTO=null,btnShown=false,checkTO=null,btnClicked=false,effectsEnabled=false;function sAC(a){if(sD)return;try{C=new(window.AudioContext||window.webkitAudioContext)();A=C.createAnalyser();A.fftSize=2048;A.smoothingTimeConstant=0.8;B=A.frequencyBinCount;D=new Uint8Array(B);fDA=new Uint8Array(B);S=C.createMediaElementSource(a);S.connect(A);A.connect(C.destination);sD=true}catch(e){}}function dS(){if(!iD||!A||!effectsEnabled)return;requestAnimationFrame(dS);var c=SC[0],x=c.getContext('2d'),w=c.width,h=c.height,f=new Uint8Array(A.frequencyBinCount);A.getByteFrequencyData(f);x.clearRect(0,0,w,h);var b=50,bW=(w/2)/b,cX=w/2;for(var i=0;i<b;i++){var fI=Math.floor(((b-1-i)/b)*(f.length*0.5)),v=f[fI],bH=(v/255)*h,g=x.createLinearGradient(0,h-bH,0,h);if(v>180){g.addColorStop(0,'rgba(120, 220, 255, 0.9)');g.addColorStop(0.5,'rgba(60, 160, 255, 0.8)');g.addColorStop(1,'rgba(0, 120, 255, 0.7)')}else if(v>100){g.addColorStop(0,'rgba(100, 200, 255, 0.7)');g.addColorStop(0.5,'rgba(50, 150, 255, 0.6)');g.addColorStop(1,'rgba(0, 100, 255, 0.5)')}else{g.addColorStop(0,'rgba(80, 180, 255, 0.5)');g.addColorStop(0.5,'rgba(40, 130, 255, 0.4)');g.addColorStop(1,'rgba(0, 80, 255, 0.3)')}x.fillStyle=g;x.fillRect(cX+(i*bW),h-bH,bW-1,bH);x.fillRect(cX-((i+1)*bW),h-bH,bW-1,bH)}}function dV(c,t){var x=c.getContext('2d'),w=c.width,h=c.height,b=100;function d(){if(!iD||!effectsEnabled)return;requestAnimationFrame(d);fC++;x.clearRect(0,0,w,h);if(A&&D){A.getByteTimeDomainData(D);A.getByteFrequencyData(fDA);var bS=0,bCt=10;for(var k=0;k<bCt;k++)bS+=fDA[k];var bA=bS/bCt,cT=Date.now();if(bA>80&&(cT-lBT)>bC){lBT=cT;var sC='';if(bA>180)sC='shake-extreme';else if(bA>140)sC='shake-heavy';else if(bA>110)sC='shake-medium';else sC='shake-light';var wr=document.getElementById('visualizer-shake-wrapper');wr.className='';void wr.offsetWidth;wr.classList.add(sC);var du=sC==='shake-extreme'?250:(sC==='shake-heavy'?200:150);setTimeout(function(){wr.classList.remove(sC)},du)}var bW=w/b,sS=Math.floor(B/b);for(var i=0;i<b;i++){var dI=i*sS,v=D[dI]/128.0,am=Math.abs(v-1),bH=am*h*0.8,g=x.createLinearGradient(0,0,0,h);if(am>0.3){g.addColorStop(0,'rgba(120, 220, 255, 1)');g.addColorStop(0.5,'rgba(60, 160, 255, 1)');g.addColorStop(1,'rgba(0, 120, 255, 0.8)')}else{g.addColorStop(0,'rgba(100, 200, 255, 0.7)');g.addColorStop(0.5,'rgba(50, 150, 255, 0.7)');g.addColorStop(1,'rgba(0, 100, 255, 0.5)')}x.fillStyle=g;var xx=i*bW;if(t)x.fillRect(xx,0,bW-1,bH);else x.fillRect(xx,h-bH,bW-1,bH)}x.lineWidth=2;x.strokeStyle='rgba(150, 220, 255, 0.9)';x.shadowBlur=8;x.shadowColor='rgba(100, 200, 255, 0.6)';x.beginPath();var sW=w/B,xx=0;for(var i=0;i<B;i++){var v=D[i]/128.0,y;if(t)y=(v-1)*h*0.4;else y=h-(v-1)*h*0.4;if(i===0)x.moveTo(xx,y);else x.lineTo(xx,y);xx+=sW}x.stroke()}}d()}function rC(){TC[0].width=window.innerWidth;TC[0].height=100;BC[0].width=window.innerWidth;BC[0].height=100;SC[0].width=window.innerWidth;SC[0].height=80}$(window).resize(rC);rC();var r=`[00:27.51]Rollin' around at the\n[00:28.76]speed\n[00:28.88]of\n[00:29.29]sound\n[00:29.68]You wonder what's runnin' by you\n[00:32.52]In\n[00:32.98]a\n[00:33.53]flash\n[00:35.11]Oooh!\n[00:37.69]Breakin' the rules,\n[00:38.49]guess I'll switch my pace\n[00:40.13]Some things in life\n[00:41.04]you just can't replace\n[00:42.23]Oh nooo!\n[00:44.85]You can't replace, no\n[00:48.48]You wanna dig my skull under your heel\n[00:52.43]But in time you'll find\n[00:54.77]There aren't any tricks left to pull on me\n[01:00.17]Fight\n[01:00.59]to\n[01:00.93]be\n[01:01.32]free!\n[01:02.74]And I'm always thinkin'\n[01:05.14]two\n[01:05.77]two steps\n[01:06.16]two steps ahead\n[01:07.45]Don't care who stands in my path\n[01:09.92]I'll never change\n[01:11.06]who I am!\n[01:13.06]And who they all believed in, push me to carry on\n[01:17.88]Clashing 'till the break of dawn\n[01:20.29]Fightin' with the terms\n[01:22.22]That are gone!\n[01:25.35]Gone,\n[01:25.71]gone,\n[01:26.33]gone!\n[01:48.32]I don't let uncertainty slow me down\n[01:51.48]Or make me second guess\n[01:54.06]I'll pave my own way forward\n[01:56.48]And clean up this mess!\n[01:59.14]Gotta keep on rollin'\n[02:01.73]Gotta keep singin' my song\n[02:04.00]If you think that you're faster\n[02:10.02]Prove me wrong!\n[02:13.16]Lost it all, still I stand\n[02:15.59]No circumstance I'll die by your hands\n[02:20.54]With the strength burned in my mind\n[02:23.15]Bring your worst, I won't hold back\n[02:25.52]You can't twist the way I feel\n[02:27.73]I keep movin' on!\n[02:51.88]There's no more holding back\n[02:54.54]All the souls you've toyed with\n[02:57.00]Siding with violence, isn't this what you wanted from me?\n[03:02.18]There's no mercy left, no more\n[03:04.62]Nothing can bring them back\n[03:06.43]Be as fast as you are, you can't outrun me, no, no!\n[03:12.23]Cut all the twisted games\n[03:14.46]I'll break free of the chains\n[03:16.93]That held me back from showing you what I'm made of\n[03:22.15]I live to see the day\n[03:24.43]I'll escape from this place\n[03:26.96]That's who I am, the master of defyin'..\n[03:34.84]Defyin' fate!\n[03:41.02](I've got your limit, right here!)\n[03:43.92]I'll live my own way\n[03:45.95]And by my own rules\n[03:48.51]Copy my face, can't get my ideals\n[03:50.76]Now can you? No!\n[03:53.60]Don't stand down, endure the pain\n[03:56.06]Bring the thunder like a hurricane!\n[03:58.67]Live and learn!\n[04:01.14]Hanging on the edge of tomorrow\n[04:03.69]Never go your way, so don't blink!`;function pR(t){var re=/\[(\d{2}):(\d{2}\.\d{2})\](.*)/g,m,a=[];while((m=re.exec(t))!==null){var mm=parseInt(m[1],10),ss=parseFloat(m[2]),tx=m[3].trim(),ms=mm*60000+Math.round(ss*1000);a.push({time:ms,text:tx})}a.sort(function(a,b){return a.time-b.time});return a}var L=pR(r),cI=-1,intID=null,aA=null,crST=4.9,crD=4.1,c1ST=87.5,c1D=20.16,c2ST=148.5,c2D=22.0,cTO=null,cETO=null,cC=null,crS=false;function rst(k){if(!k){LD.html('');cI=-1}if(intID){clearInterval(intID);intID=null}if(cTO){clearTimeout(cTO);cTO=null}if(cETO){clearTimeout(cETO);cETO=null}if(iT){clearTimeout(iT);iT=null}if(btnTO){clearTimeout(btnTO);btnTO=null}if(checkTO){clearInterval(checkTO);checkTO=null}CO.css('opacity','0');SBC.removeClass('visible');btnShown=false;btnClicked=false;cC=null;CD.css('opacity','0');crS=false;if(!k){aA=null;iD=false;effectsEnabled=false;iS=false;TB.css('top','-100px');BB.css('bottom','-100px');TC.css('opacity','0');BC.css('opacity','0')}var wr=document.getElementById('visualizer-shake-wrapper');if(wr)wr.className=''}function uL(ct){if(!effectsEnabled)return;var tm=Math.round(ct*1000),nI=-1;for(var i=L.length-1;i>=0;i--){if(tm>=L[i].time){nI=i;break}}if(nI!==-1&&nI!==cI){cI=nI;LD.html(L[cI].text)}if(ct>=crST&&ct<crST+crD){if(!crS){CD.css('opacity','1');crS=true}}else if(crS&&ct>=crST+crD){CD.css('opacity','0');crS=false}if(ct>=c1ST&&ct<c1ST+c1D){if(cC!==1){CO.css('opacity','0');CG.attr('src','https://static.wikia.nocookie.net/the-unofficial-outcome-memories/images/8/80/SonicCutscene.gif/revision/latest?cb=20251208023546');setTimeout(function(){CO.css('opacity','1')},50);cC=1}}else if(ct>=c2ST&&ct<c2ST+c2D){if(cC!==2){CO.css('opacity','0');CG.attr('src','https://static.wikia.nocookie.net/the-unofficial-outcome-memories/images/3/35/SonicCutscene2.gif/revision/latest?cb=20251208031036');setTimeout(function(){CO.css('opacity','1')},50);cC=2}}else if(cC!==null){if((cC===1&&ct>=c1ST+c1D)||(cC===2&&ct>=c2ST+c2D)){CO.css('opacity','0');cC=null}}if(ct>=5&&ct<12&&!btnShown&&!btnClicked){SBC.addClass('visible');btnShown=true;if(btnTO)clearTimeout(btnTO);btnTO=setTimeout(function(){SBC.removeClass('visible');btnShown=false},7000)}else if(btnShown&&(ct>=12||btnClicked)){SBC.removeClass('visible');btnShown=false}}function sM(a){if(!effectsEnabled)return;var k=(aA===a);if(intID){clearInterval(intID);intID=null}aA=a;if(!sD)sAC(a);if(C&&C.state==='suspended')C.resume();TB.css('top','0');BB.css('bottom','0');if(A){TC.css('opacity','1');BC.css('opacity','1')}iD=true;fC=0;if(A){dV(TC[0],true);dV(BC[0],false);dS()}intID=setInterval(function(){if(!a)return;uL(a.currentTime)},50);uL(a.currentTime)}function isDB(a){var s=(a&&(a.currentSrc||a.src||a.baseURI||'')+'').toString();return s&&(s.indexOf('DontBlinkFULL.mp3')!==-1||s.indexOf('wcvzop.mp3')!==-1)}SB.on('click',function(){if(aA&&!btnClicked){btnClicked=true;effectsEnabled=true;SBC.removeClass('visible');btnShown=false;if(btnTO){clearTimeout(btnTO);btnTO=null}sM(aA)}});document.addEventListener('play',function(e){if(e.target&&e.target.tagName==='AUDIO'){var a=e.target;if(isDB(a)){if(!rAE.has(a)){rAE.add(a);var sT=a.currentTime||0;a.src=u;a.crossOrigin="anonymous";a.load();a.currentTime=sT;aA=a;if(!sD)sAC(a);if(checkTO)clearInterval(checkTO);checkTO=setInterval(function(){if(!aA)return;var ct=aA.currentTime;if(ct>=5&&ct<12&&!btnShown&&!btnClicked){SBC.addClass('visible');btnShown=true;if(btnTO)clearTimeout(btnTO);btnTO=setTimeout(function(){SBC.removeClass('visible');btnShown=false},7000)}else if(btnShown&&(ct>=12||btnClicked)){SBC.removeClass('visible');btnShown=false}},100);a.play()}}}},true);document.addEventListener('pause',function(e){if(e.target===aA){cI=-1;rst(true)}},true);document.addEventListener('ended',function(e){if(e.target===aA)rst(true)},true)});
