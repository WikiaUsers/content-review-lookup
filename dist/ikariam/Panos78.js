	...
	mw.hook('wikipage.content').add(function($content)
	{
		try
		{
			if($('#firstHeading').text().trim()=='Pirate Fortress')
			{
				...
				for(var y=0;y<12;y++)
				{
					bd += '<tr style="opacity:0.5"><td>'+(y+1)+'</td><td style="text-align:center"><label for="town'+y+'"><input type="checkbox" id="town'+y+'" name="town'+y+'"></label></td><td><label for="level'+y+'"><input type="number" id="level'+y+'" name="level'+y+'" min="0" max="160" value="0" step="1" style="width:45px" disabled></label></td><td id="safe'+y+'" style="width:45px">0</td>';
