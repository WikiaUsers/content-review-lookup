            ...
            if (testElem.tagName === 'DIV' && hasClass(testElem, 'speech-bubble-avatar')) {
               ...
               if (anchor.tagName === 'A' && anchor.href.length > 0) {
                  if (anchor.href.search('/wiki/User:') > -1)
                     var userName = anchor.href.split('/wiki/Benutzer:')[1];
                  else
                     var userName = anchor.href.split('/wiki/Nachrichtenseite:')[1];
...
$.get("/wiki/Most_Heroic_Contributors?action=raw").done(function(data) {
    ...
    var link = '[[' + wgPageName + '|' + wgPageName.split(':')[1] + ']]';
    link = link.replace('Nachrichtenseite:', 'Benutzer:');
 
    for (var i = 1; i < arrTbl.length; i ++) {
        if (arrTbl[i][recipient] === link)
        ...
        try {
            var usr  = username[0].split('Benutzer:')[1].split('|')[0];
 
            if (i === 1)
                createFlameElement(usr);
...
//    imgCenter.src = 'http://img2.wikia.nocookie.net/__cb20140527054106/clashofclans/images/4/47/GorillaMan.png';
    imgCenter.src = 'https://images.wikia.nocookie.net/__cb20131130030326/clashofclans/images/5/55/Clash_logo.png';
    ...
    imgCenter2.src = 'https://images.wikia.nocookie.net/__cb20140703180154/clashofclans/images/b/bc/Wiki.png';
    ...
    imgLeft.src = 'https://images.wikia.nocookie.net/__cb20140527060656/clashofclans/images/0/0e/Wizard_6.png';
    ...
    imgRight.src = 'https://images.wikia.nocookie.net/__cb20140527060656/clashofclans/images/0/0e/Wizard_6.png';
...
function createFlameElement(username) {
   ...
   addCSSRule(sheet, selector1, 'content: url("https://images.wikia.nocookie.net/__cb20140523183558/clashofclans/images/thumb/a/ae/Fireball.png/8px-Fireball.png")');
