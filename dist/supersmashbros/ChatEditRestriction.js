...
// Disable message (1 = enabled, 0 = disabled)
    ...
    window.chatRestr.undereditMessage = "Hi "+ wgUserName+"! Thanks for trying to use the Smashpedia chat. However, the chat room is only for active editors of the wiki, and you haven't yet made the minimum number of edits required to use it. We apologize for this inconvenience and hope to see you in the chat soon.";
...
var exceptionList = ["TheUltraman" , "TheUltraman"]; 
