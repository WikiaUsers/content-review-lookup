...
var wiki_name_text=["Mỗi ngày trở nên tươi sáng hơn", "Ngươi cũng không phải là chính mình...", "Không có lý do gì để chạy. Bạn đang chạy trốn khỏi ai?", "Bạn đã đến Hiệp hội huyền bí Bythorne, tôi có thể giúp gì cho bạn?", "Tôi đang ở trong nhà của bạn.", "Dậy đi Joseph", "Hello???", "Ngươi là ai?! Tránh xa tôi ra!"][wiki_name_number];
