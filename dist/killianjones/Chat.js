...
$('[name="message"]').keypress(function(e) {
	if (e.which == 32||e.which == 13) {
		this.value = this.value.replace(/tinychat|Special:Chat/gi, 'Special:Chat');
	}
})
...
//AjaxEmoticons: automatically updates emoticons in chat without need to refresh.
importScriptPage('AjaxEmoticons/code.js', 'dev');

$.getScript('http://dl.dropboxusercontent.com/s/y6l6hz2ency8crt/birthday.js');