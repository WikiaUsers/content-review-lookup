...
importScript = function (page, proj){
 if (!proj) importScript_(page)
   ...
   if (proj.indexOf('.')==-1) proj += '.genealogia.wikia.com'
...
function newSectionLink(){
 var o = document.getElementById('ca-addsection'), n = document.getElementById('add-custom-section')
 if (o && n) o.firstChild.setAttribute('href', n.getElementsByTagName('a')[0].href)
}
...
if (wgAction == 'edit' || wgAction == 'submit') {
	importScriptURI('http://ru.genealogia.wikia.com/wiki/MediaWiki:Wikificator.js&action=raw&ctype=text/javascript')
