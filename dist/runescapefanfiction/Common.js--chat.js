...
$(function() {
	if(skin == "oasis") {
		...
		var comboString = "<div style='margin-top:5px; align:center'><table style='width:100%'><td style='*'>You can now <a href='http://runescapefanfiction.wikia.com/wiki/Special:Chat' id='chatjs'>chat</a>with other fanfiction makers! Feel free to stop by and try it out.<br /></td><td style='text-align:right; padding-left:5px;'><a href='http://runescapefanfiction.wikia.com/wiki/Special:Chat' id='chatjs'><img src='https://images.wikia.nocookie.net/__cb50/runescapefanfiction/images/8/89/Wiki-wordmark.png' alt='Chat' border=0 /></a></td></tr></table></div>";
