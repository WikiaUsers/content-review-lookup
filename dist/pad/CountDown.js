var cdimg="<div style='background:url(https://images.wikia.nocookie.net/pad/zh/images/8/84/Digits.png) no-repeat;width:49px;height:76px;overflow:hidden;display:inline-block;border-radius:5px;padding:0 2px 0 2px'></div>";
function init_cd(){
