...
setInterval(function () {
    ...
    $('.comments li.message blockquote .MiniEditorWrapper .edited-by a:not(.subtle)').each(function () {
        ...
        if ($user.match(/202nd Skywalker|Normalhuman/g)) {
        ...
        if ($user.match(/Kaijusaurus-Rex|Csillagfény|Avatar Raava/g)) {
            $(this).addClass('admin');
        }
...
window.MessageWallUserTags = {
    ...
    users: {
        ...
        'Kaijusaurus-Rex': 'Administrator',
        'Csillagfény': 'Administrator',
        'Avatar_Raava': 'Administrator',
        'Blue_Pant.': 'Patroller',
        'Gameuser10': 'Patroller',
        'Villicus': 'Bot',
        '202nd_Skywalker': 'Chat moderator',
        'Normalhuman': 'Chat moderator'
    }
};
...
$(function() {
  ...
  // Songs in navigation
  $("nav.WikiNav ul.nav li.nav-item:nth-child(4)").before("\
    <li class='nav-item'>\
      <a href='/wiki/Song_Guide'>Songs</a>\
      <ul class='subnav-2 accent' style='display: none;'>\
        <li class='subnav-2-item'>\
          <a class='subnav-2a' href='/wiki/Song_Guide#Season_1'>Season 1</a>\
        </li>\
        <li class='subnav-2-item'>\
          <a class='subnav-2a' href='/wiki/Song_Guide#Season_2'>Season 2</a>\
        </li>\
        <li class='subnav-2-item'>\
          <a class='subnav-2a' href='/wiki/Song_Guide#Season_3'>Season 3</a>\
        </li>\
        <li class='subnav-2-item'>\
          <a class='subnav-2a' href='/wiki/Song_Guide#Season_4'>Season 4</a>\
        </li>\
        <li class='subnav-2-item'>\
          <a class='subnav-2a' href='/wiki/Song_Guide#Season_5'>Season 5</a>\
        </li>\
      </ul>\
    </li>\
  ");
  ...
  $("li.nav-item").mouseover(function() {
    if (!$(this).hasClass("marked")) {
      $("li.nav-item.marked").removeClass("marked").find("a.subnav-2a").css("display", "none");
      $(this).addClass("marked").find("a.subnav-2a").css("display", "block");
    }
  });
});