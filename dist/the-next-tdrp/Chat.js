	...
	modules: {
		...
		multiPM: {
			...
			load: function () {
                ...
                emoticonPanel: {
			element: "#emoticonPanel",
			enabled: isEnabled("emoticonPanel"),
			loaded: false,
			load: function () {
				importScriptPage("Chat.js/EmoticonPanel.js", "cod");
				this.loaded = true;
			}
		},
		searchBar: {
...
function openOptions() {
	...
	if (chatOptions.modules.multiPM.enabled)
        ...
        if (chatOptions.modules.chatHacks.enabled)
		$("#emoticonPanel").attr("checked",true);
...
function updateCookie() {
	...
	// Set the cookies
	setCookie("customisation", chatOptions.look.backgroundColor + ", " + chatOptions.look.fontColor + ", " + chatOptions.modules.chatHacks.enabled + ", " + chatOptions.look.fontFamily + ", " + chatOptions.modules.tabComplete.enabled + ", " +  chatOptions.modules.multiKick.enabled + ", " + chatOptions.modules.multiPM.enabled + ", " + chatOptions.look.emoticonPanel + ", " + chatOptions.modules.searchBar.enabled + ", " + chatOptions.modules.stopSideScroll.enabled + ", " + chatOptions.look.surroundColor + ", " + chatOptions.look.selfPostColor);
	updateChatSkin();
	cancelChanges();
