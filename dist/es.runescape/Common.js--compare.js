...
<table class="wikitable" id="cioItems"> \
    <thead> \
        ...
        <tr> \
            ...
            <th width="35"><span style="font-size:80%">Daño</span></th> \
            <th width="35"><span style="font-size:80%">Precisión</span></th> \
            <th width="35" title="Bonificación de armadura"><img src="http://images3.wikia.nocookie.net/runescape/images/thumb/d/d8/Defence-icon.png/18px-Defence-icon.png"" alt="Arm" /></th> \
            <th width="35" title="Puntos de vida"><img src="http://images3.wikia.nocookie.net/runescape/images/thumb/1/1d/Constitution-icon.png/21px-Constitution-icon.png" alt="Lif" /></th> \
            <th width="35" title="Modificador de plegaria"><img src="http://images4.wikia.nocookie.net/runescape/images/2/24/Prayer-icon.png" width="20" height="20" alt="Pra" /></th> \
            <th width="35" title="Daño crítico cuerpo a cuerpo"><img src="http://images1.wikia.nocookie.net/runescape/images/9/90/Stab_Attack_Style.png" width="11" height="20" alt="Dam" /></th> \
            <th width="35" title="Daño crítico de alcance"><img src="http://images3.wikia.nocookie.net/runescape/images/7/72/Ranged-icon.png" width="20" height="20" alt="Rng" /></th> \
            <th width="35" title="Daño crítico de magia"><img src="http://images2.wikia.nocookie.net/runescape/images/7/77/Magic-icon.png" width="20" height="19" alt="Mag" /></th> \
            <th title="Velocidad"><img src="http://images2.wikia.nocookie.net/runescape/images/a/a9/Energy.png" width="17" height="20" alt="Spd" /></th> \
            <th title="Peso (kg)"><img src="http://images4.wikia.nocookie.net/runescape/images/f/fc/Weight-icon.png" width="20" height="20" alt="Wgt" /></th> \
            <th title="Precio en el Gran Mercado"><img src="http://images3.wikia.nocookie.net/runescape/images/6/65/Coins_25.png" width="20" height="15" alt="GE" /></th> \
        </tr> \
    </thead> \
    <tbody> \
        <tr id="cioTotals"> \
...
function cioSubmit(itemName) {
		...
		if (pageId == null) {
			showError('No se pudo encontrar ese artículo.');
		} else {
