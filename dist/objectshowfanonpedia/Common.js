...
window.MessageBlock = {
	title: 'Blocked',
	message: 'Our staff members have determined that your behavior at the {{SITENAME}} has been in violation of our [[Project:Rules|rules]]. As a result, you have been blocked for $2 due to the following action: $1<br>If you wish to appeal, either use the {{t|Unblock}} template and type in your reason on why you want to be unblocked, or request the highly active administrators ([[User:MarcoJump|MarcoJump]], [[User:Kirana18|Kirana18]], [[User:SqaureCube|SqaureCube]], and [[User:YoshiFanon|YoshiFanon]]) on their Message Walls at [[w:Community Central|Community Central]].'
};
