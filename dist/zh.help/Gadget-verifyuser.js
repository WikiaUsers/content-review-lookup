// https://help-zh.gamepedia.com/Gamepedia%E5%B8%AE%E5%8A%A9Wiki:Discord%E9%AA%8C%E8%AF%81?user=<wiki-username>&discord=<discord-username>&tag=<discord-tag>
...
mw.loader.using(['site','mediawiki.ui.button','mediawiki.util','mediawiki.api']).then(function() {
	if ( mw.config.get('wgPageName') !== 'Gamepedia帮助Wiki:Discord验证' || mw.config.get('wgAction') !== 'view' ) return;
	var verifyUser = {
		i18n: {
			"en": {
				"loading": "Loading...",
	...
	verifyUser.i18n = verifyUser.i18n[( mw.config.get('wgUserLanguage') in verifyUser.i18n ? mw.config.get('wgUserLanguage') :'zh-hans' )];
