...
mcw.importScript = function( url ) { return mw.loader.load( '//minecraft-zh.gamepedia.com/index.php?title=' + url + '&action=raw&ctype=text/javascript' ); };
 ...
 * Revised toolbar
 *
 * modified the wikieditor so it is like the convenient classic toolbar, while maintaining some new features with it.
 */
mcw.importScript( 'MediaWiki:Toolbar.js' );