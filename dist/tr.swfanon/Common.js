...
function setupUploadForm(){
	...
	if ( wpLicense.length && window.location.search.indexOf('wpForReUpload=1') == -1){
		if (formstyle == "guided" || (formstyle == "" && window.location.search.indexOf('basic=true') == -1)){
			...
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Eser sahibi/Sanatçı:</td><td class="mw-input"><textarea id="artistBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
...
function verifySummary(){
	...
	strBuilder += '|esersahibi=' + document.getElementById('artistBox').value + '\r\n';
	strBuilder += '|dosyaözellikleri=' + document.getElementById('filespecsBox').value + '\r\n';
	strBuilder += '|lisanslama=' + wpLicense.options[wpLicense.selectedIndex].title + '\r\n';
	strBuilder += '|diğerversiyonlar=' + document.getElementById('versionsBox').value + '\r\n';
	strBuilder += '|kategori lisans sahibi=' + document.getElementById('catlicenseeBox').value + '\r\n';
	strBuilder += '|kategori konusu=' + document.getElementById('catsubjectBox').value + '\r\n';
	strBuilder += '|kategori türü=' + document.getElementById('cattypeBox').value + '\r\n';
	strBuilder += '}}';
