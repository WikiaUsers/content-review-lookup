...
/* Reglas del chat */
function ReglasChat() {
    $.showCustomModal( 'Normas del chat', '<h3>Reglas Generales</h3><ul><li>No se toleran los insultos entre usuarios o páginas.</li><li>Las ediciones realizadas en Diabolik Lovers Wiki se toman como buena fe siempre que no se demuestre lo contrario. No se toleran las ediciones vandálicas o abusivas.</li><li>No está permitido el spam ni tampoco el flood.</li><li>No se permite abusar de ediciones y categorías sólo para ganar logros.</li></ul><h3>Chat</h3><ul><li>No revelar datos personales tales como contraseñas, direcciones, teléfonos, números de tarjetas de crédito, etc.</li><li>Está permitido hablar en mayúsculas siempre y cuando no se exagere, ya que el abuso de estas se considera flood.</li><li>Molestar a los usuarios del chat continuamente puede ser considerado razón para un baneo.</li>', {
	    id: "normasChat",
	    width: 600,
	    buttons: [
		{
			id: "cancel",
		    message: "Reglas de Diabolik Lovers Wiki",
		    handler: function () {
				window.open('/wiki/Normas','_blank');
		    }
		},
		{
			defaultButton: true,
