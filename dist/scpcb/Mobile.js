         ...
         if ((childrn[k].tagName || "").toLowerCase()==="p") {
            ...
            for (var j=0; j<children.length;j++) {
               if ((children[j].tagName || "").toLowerCase()==="img") {
                  ...
                  if (newArea.innerHTML!="nan") {
                     newArea.innerHTML += "<area shape=\"rect\" coords=\""+children[j].innerHTML+"\" href=\"#\" onclick=\"document.getElementById('imgBox"+i+"').scrollTop="+(scroll-112)+"; return false;\" />";
                  }
