...
!(function () {
    ...
    var $content = $('<div>', { id: 'time-' + now }).append(
        ...
        $('<div>').append(
            ...
            conf.wgUserId ? $('<a>', { class: 'wds-button', target: '_blank', href: mw.util.getUrl('Special:Preferences'), text: wgUVS('更改我的内容语言变种首选项', '變更我的內容語言變體偏好設定'), style: 'margin-left: 1.5em' }) : ''
        ),
