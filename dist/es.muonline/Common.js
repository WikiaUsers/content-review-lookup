...
mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "speedTip": "Letra chica",
     "tagOpen": "<small>",
     "tagClose": "</small>",
     "sampleText": "Letra chica"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "http://upload.wikimedia.org/wikipedia/commons/5/56/Button_big.png",
     "speedTip": "Letra grande",
     "tagOpen": "<big>",
     "tagClose": "</big>",
     "sampleText": "Letra grande"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/es.gta/images/e/ee/BotonCentro.JPG",
     "speedTip": "Texto a centrar",
     "tagOpen": "<center>",
     "tagClose": "</center>",
     "sampleText": "Centrar"};
...
mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/es.gta/images/b/b8/BotonComentario.JPG",
     "speedTip": "Comentario",
     "tagOpen": "{{comentario|",
     "tagClose": "}}",
...
mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/es.gta/images/b/b9/BotonAfavor.JPG",
     "speedTip": "A favor",
     "tagOpen": "{{A favor|",
     "tagClose": "}}",
     "sampleText": "A favor"};
...
mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/es.gta/images/6/68/BotonEncontra.JPG",
     "speedTip": "En contra",
     "tagOpen": "{{En contra|",
     "tagClose": "}}",
     "sampleText": "En contra"};
   ...
   // open up the image upload popup window, and allow them to upload.
	...
	if (imageUploadDialog && imageUploadDialog.open && !imageUploadDialog.closed)
	  imageUploadDialog.close();
    	...
    	imageUploadDialog = window.open("http://" + domain + "/wiki/Special:MiniUpload",
          "upload_file",
