...
if ($('.page-User_Omega_natsu2').length != 0) {
 $("#WikiaRail").append('<div style="clear:both;" align="center"><img src="https://images.wikia.nocookie.net/fairytail/images/8/81/Kagura%27s_Working_Clothes.png" width="300"></div>');
}
