...
var chatTopic = 'Bem-vindo ao chat do Universo Ben 10.<br /><a href="/wiki/Universo_Ben_10:Regras_do_Chat" target="_blank" title="Universo Ben 10:Regras do Chat" style="position:relative;text-decoration:underline;">Política do Chat</a>'
 
$(function() {
	$('#ChatHeader .public.wordmark').prepend('<div class="chattopic" style="text-align:center;position:absolute;width:60%;z-index:0;font-size: 13px;color:#3A3A3A;font-weight:bold;line-height:1.6;margin-left:210px;">'+chatTopic+'</div>')
...
var chatOptions = {
	look: {
		...
		backgroundColor: getCookie("customisation", 0),
                modalIcon: "https://vignette.wikia.nocookie.net/ichidaisy/images/7/70/Ferramenta3.png/revision/latest?cb=20150207191253&path-prefix=pt-br"
	},
	modules: {
		chatHacks: {
			element: "#chatHacks",
...
$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin: auto; cursor: pointer; color: #318613; font-size: 147%; font-family: Oswald; text-transform: uppercase; margin-top: 6px; bottom: 4px; padding-bottom: 2px; border-bottom: solid 4px #038307; width: 92%; border: 5px solid rgb(23, 162, 9); border-left: 5px solid rgb(1, 94, 4); border-right: 5px solid rgb(1, 94, 4); background: transparent; border-radius: 23px;" align="center"><img src="' + chatOptions.look.modalIcon + '" width="25px"/>Opções</div>'); // Prevent multiple buttons from being appended
}
