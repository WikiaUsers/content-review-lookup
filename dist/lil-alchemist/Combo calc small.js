...
submit.onclick = function () {
    ...
    var baseAtt = Number(document.getElementById("bAtt").value);
    var baseDef = Number(document.getElementById("bDef").value);
    var baseRare = Number(document.getElementById("bRare").value);
