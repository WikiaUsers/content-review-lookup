...
/*Adds a refresh button to the edit menu to purge 
  the page and reload its cache.*/
importScriptPage('PurgeButton/code.js', 'dev');
PurgeButtonText = 'Refresh';

/*Adds a countdown clock feature (used on Sales 
  Pack pages)*/
importArticles({
    type: "script",
    articles: [
...
/*Allows TabView to be used on mobile devices*/
...
importScriptPage('User:Jgjake2/js/MobileDeviceJSLoader.js', 'deadisland');
