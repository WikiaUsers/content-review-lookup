...
window.pPreview.RegExp.noinclude = [".hide-from-preview", ".reference", ".references", ".caption", "h2", ".toc", "sup", "rt", ".wikia-slideshow-wrapper", ".nihongo", ".tabber", ".ruby", "small", ".wikia-slideshow" ];
