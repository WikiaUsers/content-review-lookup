...
window.pPreview.RegExp.noinclude = [".hide-from-preview", ".reference", ".references", ".caption", "h2", ".toc", ".tocright", ".tocleft", ".trigger-header", "sup", "rt", ".wikia-slideshow-wrapper", ".nihongo", ".tabber", ".quote", ".Quote", ".cquote", ".ruby", "small", ".notice", ".wikia-slideshow" ];
