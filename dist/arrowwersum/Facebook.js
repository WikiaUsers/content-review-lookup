	...
	$(document).ready(function() {
		...
		$('body').append(
			$('<div>', {
				...
				// Zawartość
				$('<iframe>', {
					src: '//facebook.com/plugins/page.php?href=https://facebook.com/Arrowwersum/&tabs=timeline&width=240&height=360&small_header=true&adapt_container_width=false&hide_cover=false&show_facepile=true&appId',
					width: 240,
					height: 360,
					scrolling: 'no',
					frameborder: 0,
