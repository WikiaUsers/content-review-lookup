...
var DOMTools = (function() {
    ...
    return {
        ...
        parseHTML: function(html, fragment) {
            ...
            return node.childNodes.length > 1 ? slice.call(node.childNodes) : node.childNodes[0];
        },
        ...
        addClass: function(element) {
            ...
            for (var i = 0, len = args.length; i < len; i++) element.classList.add(args[i]);
        ...
        removeClass: function(element) {
            ...
            for (var i = 0, len = args.length; i < len; i++) {
                if (element.classList.contains(args[i])) element.classList.remove(args[i]);
            }
        ...
        next: function(element, selector) {
            ...
            var index = siblings.findIndex(function(i) { return element === i; });
            var next = siblings.slice(index + 1);
            return next.find(function(i) { return i.matches && i.matches(selector); });
        },
        ...
        off: function(element, event, delegate, callback) {
            ...
            if (namespace) return this.__offAll(element, event);
        ...
        __offAll: function(event, element) {
            ...
            var matchFilter = function(l) {
                ...
                defaultFilter = function(_) { return _; };
        ...
        deepClone: function(value) {
            ...
            var mapFn = (function(i) { return this.deepClone(i); }).bind(this);
...
Object.defineProperties(DOMTools, {
    ...
    'valueOf': {
        enumerable: false,
        configurable: false,
        value: function() { return DOMTools.toString(); }
    }
});
