...
;(function() {
    ...
    var I18nEdit = window.dev.I18nEdit = {
        ...
        initTranslationPicker: function() {
            ...
            this._loadCounter = 2;
            window.dev.i18n.loadMessages('u:pl.quentum:MediaWiki:Custom-' + this.page + '/i18n.json', { noCache: true }).done($.proxy(this.cbMessagesLoad, this));
            this.api.get({
                action: 'query',
                meta: 'siteinfo',
                siprop: 'languages'
        ...
        initMetadataEditor: function() {
            ...
            window.dev.i18n.loadMessages('u:pl.quentum:MediaWiki:Custom-' + this.page + '/i18n.json', { noCache: true }).done($.proxy(this.cbMessagesLoad3, this));
        },
        /**
        ...
        initTranslationEditor: function() {
            ...
            window.dev.i18n.loadMessages('u:pl.quentum:MediaWiki:Custom-' + this.page + '/i18n.json', { noCache: true }).done($.proxy(this.cbMessagesLoad2, this));
        },
        /**
