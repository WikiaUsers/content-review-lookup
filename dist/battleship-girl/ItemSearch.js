...
var attr = 'aa bb cc dd ee'.split(' ');
var racial = '驅逐 輕巡 航巡 重巡 雷巡 戰巡 戰列 航戰 輕母 航母 水母 潛艦 潛母 重炮 其他'.split(' ');
var buttons = $('.queryButton');
var display = $('#displayArea');
var 	Data = $('#ItemAllData');
...
ItemAllData.children('div').css('display', 'inline').css('margin', '3px');
...
buttons.click(function(e){
	...
	var tmpData = ItemAllData.children().clone();
