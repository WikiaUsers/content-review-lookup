...
function wwUserTags(user, isInactive) {
  ...
  users["Macrophager"] = ["Administrator", "Expert", "Mounts"],
  users["Pecoes"] = ["Administrator", "Expert", "CSS"],
  users["Servian"] = ["Administrator", "Wannabe Fixer of Worlds"],
  users["Sitb"] = ["Administrator", "Expert", "Guild achiever"],
  users["Tankingmage"] = ["Administrator", "Expert", "Warcraft lore"],
