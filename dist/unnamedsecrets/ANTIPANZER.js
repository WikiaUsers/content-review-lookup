...
chatags.tags = {
    ...
    'cxngys':     function (s,t) {
                 if (t.charAt(0) === '/') {
                     s = s.replace('[/cxngys]', '</span>');
                 } else {
                     s = s.replace('[cxngys]', '<span style="font-size:50pt;font-weight:bold>');
                 }
                 return s;
             },
    'sc':   function (s,t) {
                 ...
                 if (t.charAt(0) !== '/') {
                     try {
                         t = t.split('="');
                         t[1] = t[1].replace('"', '');
                         s = s.replace('[yt="' + t[1] + '"]', '<iframe width="420" height="315" src="hhttps://soundcloud.com/' + mw.html.escape(t[1]) + '" frameborder="0" allowfullscreen></iframe>');
                     } catch(e) { console.log(e) }
                 }
                 return s;
             },
