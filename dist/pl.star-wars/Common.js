...
function setupUploadForm(){
	...
	if ( wpLicense.length && window.location.search.indexOf('wpForReUpload=1') == -1){
		if (formstyle == "guided" || (formstyle == "" && window.location.search.indexOf('basic=true') == -1)){
			...
			$("#uploadtext").prepend('<div style="float: right;" id="uploadBasicLinkJS"><a href="http://pl.star-wars.wikia.com/index.php?title=Special:Upload&basic=true" onclick="javascript:localStorage.setItem(\'uploadform\', \'basic\')">Edytor kodu źródłowego </a></div>');
			...
			rows.eq(1).after('<tr><td class="mw-label" style="width: 125px;">Źródło:</td><td class="mw-input"><textarea id="sourceBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			$('#mw-htmlform-description').append('<tbody class="hidable-content"></tbody>');
			var tbody1 = $('#mw-htmlform-description').children('tbody').eq(0);
			tbody1.append('<tr><td class="mw-label" style="width: 125px;">Opis:</td><td class="mw-input"><textarea id="descriptionBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			tbody1.append('<tr><td colspan="2" style="text-align: center;">Pola nieobowiązkowe<span class="hidable-button"></span></td></tr>');

			// Add new optional rows
			var tbody2 = $('#mw-htmlform-description').children('tbody').eq(1);
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Uwagi:</td><td class="mw-input"><textarea id="attentionBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Autor:</td><td class="mw-input"><textarea id="artistBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Informacje o naniesionych zmianach:</td><td class="mw-input"><textarea id="filespecsBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Inne wersje obrazu:</td><td class="mw-input"><textarea id="versionsBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Kategorie według autorów:</td><td class="mw-input"><textarea id="catartistBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Kategorie według licencji:</td><td class="mw-input"><textarea id="catlicenseeBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Kategorie według obiektu:</td><td class="mw-input"><textarea id="catsubjectBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
			tbody2.append('<tr><td class="mw-label" style="width: 125px;">Kategorie według typu:</td><td class="mw-input"><textarea id="cattypeBox" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
		} else {
			// [[Szablon:Informacje]] - umieszczenie w plikach
			$('#wpUploadDescription').val('==Opis==\r\n{{Informacje\r\n|uwaga=\r\n|opis=\r\n|źródło=\r\n|artysta=\r\n|specyfikacja=\r\n|licencja=\r\n|inne wersje=\r\n|kat artysta=\r\n|kat licencja=\r\n|kat obiekt=\r\n|kat typ=\r\n}}');

			// Add link to guided form
			$("#uploadtext").prepend('<div style="float: right;" id="uploadBasicLinkJS"><a href="http://pl.star-wars.wikia.com/index.php?title=Special:Upload" onclick="javascript:localStorage.setItem(\'uploadform\', \'guided\')">Edytor wizualny (VisualEditor)</a></div>');
...
function verifySummary(){
	...
	// Check for licensing
	if ( wpLicense.value == "" ){
		alert('Uzupełnij rubrykę licencja.');
		return false;
	}

	// Check for source
	if ( document.getElementById('sourceBox').value == "" ){
		alert('Uzupełnij rubrykę źródło.');
		return false;
	}
	...
	var strBuilder = '==Opis==\r\n{{Informacje\r\n';
	strBuilder += '|uwagi=' + document.getElementById('attentionBox').value + '\r\n';
	strBuilder += '|opis=' + document.getElementById('descriptionBox').value + '\r\n';
	strBuilder += '|źródło=' + document.getElementById('sourceBox').value + '\r\n';
	strBuilder += '|artysta=' + document.getElementById('artistBox').value + '\r\n';
	strBuilder += '|specyfikacja=' + document.getElementById('filespecsBox').value + '\r\n';
	strBuilder += '|licencja=' + wpLicense.options[wpLicense.selectedIndex].title + '\r\n';
	strBuilder += '|inne wersje=' + document.getElementById('versionsBox').value + '\r\n';
	strBuilder += '|kat artysta=' + document.getElementById('catartistBox').value + '\r\n';
	strBuilder += '|kat licencja=' + document.getElementById('catlicenseeBox').value + '\r\n';
	strBuilder += '|kat obiekt=' + document.getElementById('catsubjectBox').value + '\r\n';
	strBuilder += '|kat typ=' + document.getElementById('cattypeBox').value + '\r\n';
	strBuilder += '}}';
...
( function ( window, $, mw, Wikia ) {
	...
	function preloadAJAXRL() {
		// monobook
		var $checkbox= $( '.firstHeading' ).length ? $( '.firstHeading' ) :
			// most oasis pages
