...
window.SkinNotification = {
	...
	render: function() {
		...
		var sn = $('<div data-type="100"><a class="sprite close-notification"></a>Necesitamos más gente en el wiki<a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'"> Ayuda,invita y más</a>.</div>');
