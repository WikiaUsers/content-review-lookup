$(function() {
	if(skin == "oasis") {
		...
		var comboString = "<div style='margin-top:5px; align:center'><table style='width:100%'><td style='*'>ILOŚĆ WIZYT OD<br />24 STYCZNIA 2012</td><td style='text-align:right'><a href='http://sm8.sitemeter.com/stats.asp?site=sm8MiszczGW' target='_top'><img src='http://sm8.sitemeter.com/meter.asp?site=sm8MiszczGW' alt='SiteMeter' border=0 /></a></td></tr></table></div>";
 
		$sidebar.html($sidebar.html() + comboString);
	} else if(skin == "monobook") {
		var $sidebar = $('#p-wikicities-nav');
		var comboString = "<div style='margin:5px'></div><h5>licznik wizyt</h5><div class='pBody'><div style='margin-top:2px; margin-bottom:5px'><table style='width:100%; text-align:center'><tr><td style='font-size:85%'>Ilość wizyt od<br />24 stycznia 2012</td></tr><tr><td><a href='http://sm8.sitemeter.com/stats.asp?site=sm8MiszczGW' target='_top'><img src='http://sm8.sitemeter.com/meter.asp?site=sm8MiszczGW' alt='SiteMeter' border=0 /></a></td></tr></table></div></div>";
		$sidebar.html($sidebar.html() + comboString);
	}
});
