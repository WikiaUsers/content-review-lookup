...
function initClock() {
  ...
  $('<section id="wiki-custom" class="module">' +
        ...
        '<div class="clock" style="float: right;">' +
            '<b>Japon</b> <br/>' +
            '<span id="clockUTC9" style="font-size:20px;">' + 
            '</span>'+
        '</div>' +
...
function clock()
{
        ...
        dateUTC9 = new Date().toLocaleString('fr', { timeZone: 'Asia/Tokyo' });
        arrayDateUTC9 = dateUTC9.split(" à ");
        document.getElementById("clockUTC9").innerHTML = arrayDateUTC9[1] + '<br/>' + arrayDateUTC9[0];
