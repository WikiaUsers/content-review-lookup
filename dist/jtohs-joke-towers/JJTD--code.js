...
// Default settings
        medalDefaultSettings: function() {
            default_cfg = JSON.stringify({dataUser:{}, dataMedal: {}, module_title: 'User\'s reward', module_more: 'Show more', module_count_info: 'Amounts of this currency', module_info: '', module_info_title: '', border: { top_left: 'https://images.wikia.nocookie.net/siegenax/ru/images/1/13/Medal_Border_corner.png', top_right: 'https://images.wikia.nocookie.net/siegenax/ru/images/d/de/Medal_Border_corner_right.png' }});
...
// Main function
        medalMainFunction: function() {
            ...
            $('.MedalMore').click(function() {
                showCustomModal2( mw.html.escape(MedalSettings.module_title + ' ' + user), medalModalForm, {width: 400});
            });
        },
...
// Settings function
        medalSettingsFunction: function() {
            ...
            $('#MedalSettings').click(function() {
                showCustomModal2('Settings', medalModalFormCompleted, {
