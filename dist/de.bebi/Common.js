...
function InformationTemplate() {
	if (wgPageName != ('Spezial:Hochladen' || 'Spezial:Mehrere Dateien hochladen')) { return; }
	if (wgPageQuery.match(/(?=wpForReUpload%3D1)/)) { return; }
	document.getElementById('wpUploadDescription').innerHTML = '{{Dateiinfo\n|Beschreibung=\n|Datum=\n|Autor=\n|Quelle=\n|Lizenz=Siehe unten\n|Sonstiges=\n}}';
}
