mw.loader.using('mediawiki.api').then(function() {
	...
	function processData() {
		...
		var gridOutput = "";
		var urlBase = '/index.php?title=Служебная%3AВклад&contribs=user&target='+encodeURIComponent(user.replace(/ /g,'_'))+'&start=';
		for (d=0;d<dateContribs.length;d++) {
			...
			var bgColor = "#5D8AA833";
			if (da.contribs > 0) bgColor = "#FFA72527";
			if (da.contribs > 10) bgColor = "#FFA72577";
			if (da.contribs > 20) bgColor = "#FFA72599";
			if (da.contribs > 30) bgColor = "#FFA725";
	...
	function getData(uccontinue) {
		if ($("#gridOutput").length == 0) $(".UserProfileActivityModeration").after('<div class="contribution-grid section"><h3>Столбница вкладов</h3><div id="gridOutput" style="width:100%; height:120px;">Загрузка...</div></div>');
