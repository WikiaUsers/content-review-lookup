...
var addSigText = '<div style="border:1px #ccc solid; width:95%; padding:10px;"> ' +
    'Lorsque vous avez terminer d\'écrire votre commentaire, ' + 
    ...
    'qui se transformera automatiquement en votre nom et la date lorsque vous cliquez sur le boutton &quot;enregistrer&quot;.</span></div>';
