...
// Appending to window
$(function() {
    VKlike.init({apiId: 5216652, onlyWidgets: true});
 
    if ($('#WikiaPageHeader > .talk').length) {
        var to_append = '#WikiaPageHeader > .talk';
    } else {
        var to_append = '#WikiaPageHeader > .comments';
    }
 
    $('<div id="vk_like" style="display: inline-block !important;"></div><script type="text/javascript">VK.Widgets.Like("vk_like", {type: "button"});</script>').insertAfter(to_append); 
});