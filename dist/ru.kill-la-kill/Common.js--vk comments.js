...
window.onload = function() {
    VK.init({apiId: 5216652, onlyWidgets: true});
 
    if ($(".CategorySelect.articlePage").length) {
        $(".CategorySelect.articlePage").after('<div id="vk_comments" style="display: inline-block !important;"></div><script type="text/javascript">VK.Widgets.Comments("vk_comments", {limit: 5, width: "704", attach: "*"});</script>');
    }
};