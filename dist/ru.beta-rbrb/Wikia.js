(function ($, wikificator) {
    ...
    p.addVEToolbarButton = function () {
	        $('<div>')
	            .addClass('oo-ui-tool oo-ui-tool-link')
	            .attr('alt', p.t.wikificator)
	            .attr('title', p.t.wikificatorx)
	            .css({
	                'width': '38px',
	                'backgroundImage': 'url(https://upload.wikimedia.org/wikipedia/commons/0/06/Wikify-toolbutton.png)',
	            ...
	            .insertAfter(".ve-ui-toolbar-group-features")
	            .on('click', p.click);
    };
