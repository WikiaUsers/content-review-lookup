;(function($,mw) {
    ...
    $('.WikiaMenuElement').find('a[data-id="move"]').parent().after(
        '<li>' +
                ...
                handler: function() { 
                    $.post('/api.php', {
                        ...
                        if (typeof data.error === 'undefined') {
                            $('.rename_result').empty().append('<center><span style="color:green;">Thành công!</span></center>');
                        } else {
                            $('.rename_result').empty().append('<center><span style="color:red;">Ô, có lỗi rồi!</span></center>');
                        }
                    });
                }
            }]
