if (mw.config.get('wgUserName') !== null) {
    $('.wikia-menu-button > ul.WikiaMenuElement > li:first-of-type').after('<li><a onclick="TogetherLauncher(); return false;" id="togetherjs">Edit Together!</a></li>');
    ...
    importScriptPage('MediaWiki:Together.js/i18n.js', 'higashi');
    ...
    function TogetherLauncher() {
        ...
        if (!$('#ca-viewsource').length) {
            $('#WikiaArticle').html('<p style="text-align: center"><img src="http://i.imgur.com/Y5seQcB.gif"><br />Đang tải...</p>');
    ...
    function SpeedrawEditor() {
        importStylesheetPage('MediaWiki:Together.css', 'higashi');
