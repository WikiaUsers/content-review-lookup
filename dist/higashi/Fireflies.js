    ...
    function jSnow(){
        ...
        var defaults = {
            ...
            flake = function(_el, _size, _speed)
            {
                ...
                }else if(defaults.imageArray){
                    var rand = Math.floor( Math.random() * (defaults.imageArray.length) ) ;
                    flakeObj = new Image();
                    flakeObj.src = defaults.imageArray[rand];
                }else{
                ...
                setStyle(flakeObj, {'width' : this.size, 'height' : this.size, 'position' : defaults.flakePosition, 'top' : 0, 'left' : 0, 'will-change': 'transform', 'fontSize' : 0, 'pointer-events' : 'none', 'zIndex' : defaults.flakeIndex});
                ...
                this.reset = function(){
                    this.y = elHeight;
                    this.x = random(widthOffset, elWidth - widthOffset);
                    this.stepSize = random(1,10) / 100000;
...
$(window).on('load', function() {
    snowFall.snow($(".WikiaSiteWrapper"), {
        deviceorientation: !0,
        flakeCount: 25,
        imageArray: [
            "http://higashi.wikia.com/wiki/Special:FilePath?file=Bg_light_1.jpg", "http://higashi.wikia.com/wiki/Special:FilePath?file=Bg_light_2.jpg", "http://higashi.wikia.com/wiki/Special:FilePath?file=Bg_light_3.jpg", "http://higashi.wikia.com/wiki/Special:FilePath?file=Bg_light_4.jpg"
        ],
        maxSize: 30,
        maxSpeed: 1.5,
        minSize: 30,
