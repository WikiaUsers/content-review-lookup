...
window.pPreview.noimage = 'https://static.wikia.nocookie.net/gotww/images/3/3c/NoImageAvailable.png/revision/latest?cb=20260121012646';
...
(function ($) {
    var mwc = mw.config.get(['wgCanonicalSpecialPageName']);
    if (mwc.wgCanonicalSpecialPageName !== 'Newpages') return;
