...
(function () {
  ...
  var twitter =
  '<p id="sw-twitter-1">' +
    '<a href="https://twitter.com/DAWikiFandom" class="twitter-follow-button" data-size="large" data-lang="en" data-show-count="true">Follow @DAWikiFandom</a>' +
  '</p>';
  var getFacebook = function (height, width) {
    return '<p id="sw-facebook">' +
        '<iframe style="border: 0; height: ' + height + 'px; margin: 0; overflow: hidden; width: ' + width + 'px;" src="https://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fhttps://www.facebook.com/DAWikiFandom&amp;height=' + height + '&amp;show_faces=false&amp;small_header=true&amp;stream=true&amp;width=' + width + '" scrolling="yes"></iframe>' +
      '</p>';
  };
  var instagram =
    '<p id="sw-instagram">' +
  ...
  if (cfg.wgIsMainPage !== true) { // If it's not the homepage
    ...
    if ($.inArray('Spoilers', window.mw.config.get('wgCategories')) > -1) {
      twitter =
        '<p id="sw-twitter-2">' +
          '<a class="twitter-timeline" data-width="270" data-height="200" data-lang="en" data-chrome="noheader|nofooter" href="https://twitter.com/DAWikiFandom">Tweets by @DAWikiFandom</a>' +
        '</p>';
    ...
    var sidebarModule =
      '<section class="module" id="discord-widget">' +
        '<a href="https://discord.gg/x2wSrJNcHf" title="Join the Demon Accords Wiki Discord server!">Join the Demon Accords Discord server!</a>' +
      '</section>' +
