...
$(function() {
	var nick = (wgUserName == null) ? ('LUW-Visitor-' + Math.floor(Math.random() * 10)) : wgUserName.replace(/ /g, '_'); 
	$('#NSMAPReplace').html('<iframe src="http://www.wix.com/luwiki1234/test/" width="1100" height="680" style="border:0;"></iframe>');
});
...
var PhrasesEnglish = 
        new Array('the', 'dude', 'hacker',
                  ...
                  'what the heck', 'elite', 'for the win', 
                  'loser', 'good game', 'sucks',
                  'sucker', 'is', 'rocks', 'winner', 'LEGO', 'LEGO');
    var PhrasesLeet = 
        new Array('teh', 'dood', 'haxxor', 'hax', 'u',
                  '1337', 'zomg', 'ph43', 'powwah', 'pwn', 
                  'wth', 'leet', 'ftw', 'n00b', 'gg',
                  'sux', 'suxxor', 'iz', 'rox', 'pwnster', 'lego', 'Lego');
...
var t = '<div id="luwiki_legal">LEGO&reg; is a trademark of the LEGO Group. LEGO Universe Wiki is not owned or operated by the LEGO Group.</div>';
document.getElementById("wikia_page").innerHTML += t;
