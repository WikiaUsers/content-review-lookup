/**
 * Created by Soap Shadow and improved by MasterSlenderTR
 * Version 1.2.0
 *
 * 
...
$.getJSON("https://discordapp.com/api/guilds/381893485810286602/widget.json", function (json) {

    function populateAdmins() {
        /**
         * The Glitchtale Wiki Crew
         * 
         * This function populates an array with the 
         * admin user ids and returns the array.
         *
         * Ownslo        381893143957733398
         */
        return [
            '381893143957733398'
        ];
    ...
    function populateHS() {
         ...
         * 
         * This function populates an array with the
         * High Society user ids and returns the array.
         *
         */
        return [
            '109349103149834240',
    ...
    $($widgetHeaderMembersOnline)
        ...
        .html("<strong>" + membersOnline + "</strong> Souls Online")
        .appendTo($widgetHeader);
    ...
    $($adminsOnlineTitle)
        ...
        .text("The Glitchtale Wiki Crew")
        .appendTo($adminsOnlineContainer);

    // Create container to hold discord High Society which are online.
    var $hsOnlineContainer = document.createElement("div");
    $($hsOnlineContainer)
        .addClass("widget-role-container")
        .appendTo($widgetBodyUsers);
        

    // Add discord High Society online title.
    var $hsOnlineTitle = document.createElement("div");
    $($hsOnlineTitle)
        .addClass("widget-role-name-hs")
        .text("High Society")
        .appendTo($hsOnlineContainer);
    ...
    $($widgetFooterText)
        ...
        .append("By joining, you agree to the <a href=\"https://glitchtale.wikia.com/wiki/Glitchtale_Wiki:Glitchtale_Discord\">server guidelines</a>")
    ...
    function addToRail() {
        ...
        railModuleTitleIconPath.style.fill = "#ffffff";
    ...
    $('.CustomDiscordIntegrator').each(function () {
        ...
        $($containerTitle)
            .addClass("title has-icon")
            .appendTo($containerTitleSection);
