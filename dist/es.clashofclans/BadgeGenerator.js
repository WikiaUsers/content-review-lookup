/*
	* Generador de escudos del clan - tomado de la comunidad inglesa de Clash of Clans (con permiso de los creadores)
	* ----
...
!function( $ ) {
    ...
    $( '#canvas-body' ).append(
        ...
        '<center>' +
            '<a href="#" class="button" id="dwn-clanbadge" download="clan-badge.png">Descargar</a>' +
        '</center>'
    );
