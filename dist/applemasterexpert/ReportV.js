...
console.log('Saving...');
    ...
    if ( url.match( /(\/| |%20|_)/ ) ) {
        alert('Incorrectly entered the Wiki URL. Please do NOT copy/paste the URL, but just type in the suddomain (e.g. VSTF in http://vstf.wikia.com/wiki/Report:Spam_filter_problems) Do NOT use spaces, use dashes (-) instead');
        return;
    }
