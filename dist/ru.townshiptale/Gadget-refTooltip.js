...
$( function() {
	...
	var i18n = {
		cancelButton: 'Отмена',
		doneButton: 'Готово',
		enableLabel: 'Включить всплывающие описания примечаний',
		optionsButtonTitle: 'Изменить настройки всплывающих описаний примечаний',
		referencesSectionName: 'Примечания',
		saveFailedStorageFull: "Заполнено ли локальное хранилище вашего браузера?",
