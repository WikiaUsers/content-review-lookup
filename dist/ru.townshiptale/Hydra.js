...
/******************************************/
/* Moves #mainAboveSearch and #mainBelowSearch above and below the search box, respectively */
$( 'body.page-A_Township_Tale_Wiki.ns-0.action-view' ).append( $( '#mainAboveSearch' ) );
$( 'body.page-A_Township_Tale_Wiki.ns-0.action-view' ).append( $( '#mainBelowSearch' ) );
$( 'body.page-A_Township_Tale_Wiki.ns-0.action-view #mainAboveSearch' ).show();
$( 'body.page-A_Township_Tale_Wiki.ns-0.action-view #mainBelowSearch' ).show();

//Can remove this second section, was only for testing...
/* Moves #mainAboveSearch and #mainBelowSearch above and below the search box, respectively */
$( 'body.page-A_Township_Tale_Wiki_test.ns-0.action-view' ).append( $( '#mainAboveSearch' ) );
$( 'body.page-A_Township_Tale_Wiki_test.ns-0.action-view' ).append( $( '#mainBelowSearch' ) );
$( 'body.page-A_Township_Tale_Wiki_test.ns-0.action-view #mainAboveSearch' ).show();
$( 'body.page-A_Township_Tale_Wiki_test.ns-0.action-view #mainBelowSearch' ).show();
