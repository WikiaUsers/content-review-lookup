...
window.SkinNotification = {
	article: 'Usuario_Blog:Jccm19/Dudas_o_Sugerencias_para_la_wikia',
	key: 'NfSkin',
	init: function() {
	...
	render: function() {
		...
		var sn = $('<div data-type="100"><a class="sprite close-notification"></a>Bienvenid@ a Harvest Moon Wiki en español donde tú puedes ayudar <a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'"> editando</a>.</div>');
...
function agregarEnlaceSkin() {
	...
	$('#WikiaFooter').children('div.toolbar').eq(0).children('ul.tools').eq(0).append('<li><a href="'+surl+'"><img width="15" height="15" class="monobook-icon" src="'+stylepath+'/common/blank.gif"/></a> <a href="'+surl+'" id="ca-changeskin" title="Ver Harvest Moon Wiki con la piel Monobook">Cambiar la apariencia a Monobook</a></li>');
...
function Harvest_Moon_WikiaSkinLoad() {
	var ug = '';
