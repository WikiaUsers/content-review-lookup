...
var cond="";
function moveModule(){
	if($("#LatestPhotosModule").length>0){
		$("#LatestPhotosModule").before($(".move"));
	}
}
//
	...
	$("table.filterable").each(function(){
		...
		$(this).find("tr:first-child th, tr:first-child td").each(function(){
			if (!$(this).hasClass("unfilterable")){
				...
				$(this).append($('<div class="filterMenu hidden" style="position:absolute;top:'+$(this).height()+'px;left:0;width:'+(22+l*7)+'px;text-align:left;padding:5px;border:1px #000 solid;background:#ddd;z-index:1"></div>'));
				for (j=0; j<cols.length; j++){
