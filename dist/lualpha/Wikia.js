...
/** Change "admin" to newGroup **/
if((wgPageName == 'User:Wattz2000') || (wgPageName == 'User_talk:Wattz2000') || (wgPageName == 'Special:Contributions/Wattz2000')) {
  var newGroup;
  switch(Math.floor(Math.random()*11)) {
    case 0: newGroup = 'blocked'; break;
    case 1: newGroup = 'bannedfromchat'; break;
