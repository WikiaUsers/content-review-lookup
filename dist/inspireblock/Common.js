function toggle_visibility('WikiaRecentActivity') {
  // Get the DOM reference
  var contentId = document.getElementById("WikiaRecentActivity");
  // Toggle 
  contentId.style.display == "block" ? contentId.style.display = "none" : 
contentId.style.display = "none"; 
}

function toggleContent('LatestPhotosModule') {
  // Get the DOM reference
  var contentId = document.getElementById("LatestPhotosModule");
  // Toggle 
  contentId.style.display == "block" ? contentId.style.display = "none" : 
contentId.style.display = "none"; 
}
