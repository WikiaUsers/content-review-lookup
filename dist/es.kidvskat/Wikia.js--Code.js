...
window.SkinNotification = {
	article: 'KVKCA 2° (Kid vs Kat Choice Awards) Articulos Destacados',
	key: 'NfSkin',
	init: function() {
	...
	render: function() {
		...
		var sn = $('<li><div data-type="100"><a class="sprite close-notification"></a>Han comenzado las nominaciones de los articulos destacados. <a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'">nomina ya al tuyo</a>.</div></li>');
		nf.append(sn);
