...
window.snowStorm = {
	...
	snowColor: '#2DFF0D',		// Don't eat (or use?) yellow snow.
	snowCharacter: 'feshe',	// &bull; = bullet, &middot; is square on some systems etc.
	...
	vMaxX: 3,			// Maximum X velocity range for snow
	vMaxY: 2,			// Maximum Y velocity range for snow
