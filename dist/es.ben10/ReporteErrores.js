...
if(des.namespace === 0) {
    if(des.groups.indexOf("sysop") > -1) {
        $('#WikiaArticleCategories').after('<div style="text-align:right;"><a href="/wiki/Ben_10_Wiki:Reporte_de_errores"><img style="vertical-align:-3px;" src="' + des.img + '" /> Lista de reportes (admin)</a></div>');
    } else {
