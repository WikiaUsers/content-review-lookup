/* copied from https://dev.fandom.com/wiki/MediaWiki:Countdown/code.js
   added data-options=no-seconds
   Ferretwings <https://c.fandom.com/wiki/User:Ferretwings>
*/
// __NOWYSIWYG__
/**
 * Countdown
...
;(function (module, mw, $, undefined) {
	...
	function init() {
		var countdown = $('.countdown-RE:not(.handled)');
