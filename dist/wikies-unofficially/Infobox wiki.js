/**
  ...
  * @author: Wildream
  * taken: https://wikies.fandom.com/wiki/MediaWiki:Infobox_wiki.js
  * Written for http://wikies-unofficially.fandom.com
  ...
  * Output will  be returned to elements with following class names:
  * * wiki-infobox-wordmark
  * * wiki-infobox-edits
  * * wiki-infobox-articles
  * * wiki-infobox-pages
  * * wiki-infobox-active-users
  * * wiki-infobox-images
  * * wiki-infobox-admins
  * * wiki-infobox-lang
  * * wiki-infobox-hub
  * * wiki-infobox-creation_date
  *
  * Rewritten on 25.06.17
  * Missing:
  * * wiki-infobox-videos
  * * wiki-infobox-wam-score
  * * wiki-infobox-top-users
  * * wiki-infobox-description
  * * wiki-infobox-topic
  * * wiki-infobox-headline
  */
...
(function ($) {
    ...
    f.update = function (targets, d) {
                ...
                $target.each(function () {
                    ...
                    if ($this.data('newplural') !== undefined) {
                        ...
                        if (second === '1') {
                            ...
                            pages = ($this.data('newplural') !== 0) ? 'article' : 'article';
        ...
        */
        ...
        if (wordmark.match('video151')) { // If the logo doesn't exist
