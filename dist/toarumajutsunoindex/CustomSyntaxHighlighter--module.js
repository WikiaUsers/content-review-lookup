 ...
 * 
 * Original Script from https://github.com/Wikia/app/blob/dev/extensions/wikia/EditPageLayout/js/plugins/WikitextSyntaxHighlighter.js
				...
				case '{':
					if (match[0].charAt(1) === '{') {
						...
						|| /(L|l)ink\scolor/.test(text.substring(parserLocation, parserLocation + 10))) {
						    // Template:Nihongo or Template:Link color
