...
(function () {
  ...
  var CONFIG = {
    ...
    cardId: "leader-card-usa",

    /* --- Leader (colonne droite) --- */
    leader: {
      nom:         "Ronan 'Ron' Carter",
      role:        "Titre · Pays",
      desc:        "Courte description sous le nom du leader.",
      avatar:      "Leadertest.png",   /* fichier uploadé sur le wiki, ou "" pour icône */
      tag:         "",             /* "OTAN", "BRICS", "Non-aligné", "" pour masquer */
      tagIcon:     "",        /* ti-shield, ti-star, ti-world, ti-flame… */
