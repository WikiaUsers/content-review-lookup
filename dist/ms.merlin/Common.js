...
function hotspotsheader() {
     $('.HotSpotsModule').prepend('<div align="center"><img src="https://images.wikia.nocookie.net/merlin1/images/9/93/Hot_Spots.png"></div>');
}

$(hotspotsheader);

function communityheader() {
     $('.CommunityCornerModule').prepend('<div align="center"><img src="https://images.wikia.nocookie.net/merlin1/images/c/c5/Community_Messages.png"></div>');
}
...
jQuery(function($) {
        ...
        window.RW_Async_Init = function(){
            RW.init("4893AEDA8BA1095BEEA0C43249CDD374",
            {
                advanced: {
                    star: {
                        stars: 10
...
/* Replaces {{USERNAME}} with the name of the user browsing the page.
   Requires copying Templat:USERNAME. */
