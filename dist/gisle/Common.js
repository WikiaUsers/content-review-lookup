...
function replaceSearchIcon()
{
    ...
    loader.send('/index.php?title=Template:Searchicon&action=raw');
}
...
// Add edit buttons
 ...
 if (mwCustomEditButtons) {
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "#REDIRECT [[",
     "tagClose": "]]",
     "sampleText": "Page to redirect to"};

   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/gisle/images/4/4a/Button_welcome.png",
     "speedTip": "Welcome",
     "tagOpen": "{{" + "welcome|",
     "tagClose": "|~~" + "~~}}",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/central/images/8/8e/Button_stub.png",
     "speedTip": "Stub",
     "tagOpen": "{{" + "stub}}",
     "tagClose": "",
     "sampleText": ""}
