...
function createMorphObjects(a) {
    $(".morphcontainer", a).each(function() {
        ...
        var j = k.filter(".morphlink"),
            ...
            h = g.children(".morphlink_hilight").size() ? g.children(".morphlink_hilight").eq(0).attr("style") : "color: #fe642e; height: 150%; width: 150%; font-size:15px",
            l = g.children(".morphlink_default").size() ? g.children(".morphlink_default").eq(0).attr("style") : "color: #b14620;",
