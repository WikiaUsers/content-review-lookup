(function ($, window, mw) {
    ...
    var kevinWBGenII = {
        loadGUIElements: function($this) {
            ...
            if ($($this).find(".username").children("div:nth-child(2)").children("a:not(.new)").length === 2) {
                ...
                $.nirvana.getJson("UserProfilePage", "renderUserIdentityBox", {
                    ...
                    if (data.user.edits !== -1 && data.user.name == username) {
                        ...
                        $($this).find(".user-card:nth-of-type(2)").children(".card-text").text(memberSince);
                    }
                });
            ...
            } else if ($($this).find(".username").children("div:nth-child(2)").children("a.new").length === 2) {
                $($this).find(".user-card").children(".card-text").text("User Not Found");
            } else {
                $($this).find(".user-card").children(".card-text").text("...");
            }
        },
        ...
        setEventHandlers: function($this) {
            $(".menu-interface-toggle").on("click", function(event) {
                ...
                if (!$(this).closest(".andromeda-ui").find(".menu-interface").is(":animated") && parseInt($(this).closest(".andromeda-ui").find(".user-info-interface").css("left"), 0) - $(this).closest(".andromeda-ui").width() <= 1) {
                    $(this).closest(".andromeda-ui").find(".menu-interface").animate({
                        ...
                        duration: 500,
                        complete: function() {
                            $(this).closest(".andromeda-ui").children(".character-image-mask").hide();
                ...
                if (!$(this).closest(".andromeda-ui").find(".info-interface").hasClass("active-interface")) {
                    ...
                    if ($(this).closest(".andromeda-ui").find(".andromeda-ui-right-sector").css("borderTopLeftRadius") === "0px") {
                        if ($(this).closest(".andromeda-ui").data("info-background").indexOf("{{{") === -1 && $(this).closest(".andromeda-ui").data("info-background").indexOf("http") !== -1 && ($(this).closest(".andromeda-ui").data("info-background").indexOf(".jpg") !== -1 || $(this).closest(".andromeda-ui").data("info-background").indexOf(".png") !== -1)) {
                            ...
                            $(this).closest(".andromeda-ui").find(".sector-container").css("background-image", "linear-gradient(rgba(0, 0, 0, 0.15) 0%, rgba(0, 0, 0, 0.15) 100%), url('https://i.imgur.com/bzDiGhX.jpg')");
                        }
                ...
                if (!$(this).closest(".andromeda-ui").find(".image-interface").hasClass("active-interface")) {
                    ...
                    if ($(this).closest(".andromeda-ui").find(".andromeda-ui-right-sector").css("borderTopLeftRadius") === "0px") {
                        if ($(this).closest(".andromeda-ui").data("images-background").indexOf("http") !== -1 && ($(this).closest(".andromeda-ui").data("images-background").indexOf(".jpg") !== -1 || $(this).closest(".andromeda-ui").data("images-background").indexOf(".png") !== -1)) {
                            ...
                            $(this).closest(".andromeda-ui").find(".sector-container").css("background-image", "linear-gradient(rgba(0, 0, 0, 0.15) 0%, rgba(0, 0, 0, 0.15) 100%), url('https://f.fwallpapers.com/images/beautiful-space.jpg')");
                        }
                ...
                if (!$(this).closest(".andromeda-ui").find(".powers-interface").hasClass("active-interface")) {
                    ...
                    if ($(this).closest(".andromeda-ui").find(".andromeda-ui-right-sector").css("borderTopLeftRadius") === "0px") {
                        if ($(this).closest(".andromeda-ui").data("powers-background").indexOf("http") !== -1 && ($(this).closest(".andromeda-ui").data("powers-background").indexOf(".jpg") !== -1 || $(this).closest(".andromeda-ui").data("powers-background").indexOf(".png") !== -1)) {
                            ...
                            $(this).closest(".andromeda-ui").find(".sector-container").css("background-image", "linear-gradient(rgba(0, 0, 0, 0.15) 0%, rgba(0, 0, 0, 0.15) 100%), url('https://i.imgur.com/L2Gm2Yf.jpg')");
                        }
            ...
            $(".menu-interface-close").on("click", function() {
                if (!$(this).closest(".menu-interface").is(":animated")) {
                    $(this).closest(".andromeda-ui").children(".character-image-mask").show();

                    if ($(this).closest(".andromeda-ui").find(".image-interface").hasClass("active-interface")) {
                        $(this).closest(".andromeda-ui").find(".slideshow-progress").removeAttr("style");
                    }
            ...
            $(".ui-collapse-toggle").on("click", function(event) {
                event.stopImmediatePropagation();

                var characterFirstName = $(this).closest(".andromeda-ui").find(".capsule:first").find("a").text().split(" ").length <= 2 ? $(this).closest(".andromeda-ui").find(".capsule:first").find("a").text().split(" ")[0] !== "" ? $(this).closest(".andromeda-ui").find(".capsule:first").find("a").text().split(" ")[0] : "Character Name" : $(this).closest(".andromeda-ui").find(".capsule:first").find("a").text() !== "" ? $(this).closest(".andromeda-ui").find(".capsule:first").find("a").text() : "Character Name",
                    roleplayText = $(this).closest(".andromeda-ui").find(".roleplay-text").text().indexOf("{{{1}}}") === -1 ? $(this).closest(".andromeda-ui").find(".roleplay-text").html() : "<i>Roleplay text.</i>";

                $(this).closest(".andromeda-ui").find(".menu-interface-toggle").hide();
                $(this).parent(".sector-four").children(".menu-interface-close").click();

                $(this).closest(".andromeda-ui").children(".character-image-mask").css({
                    "transition-delay": "0.5s",
                    "transition-duration": "0.25s"
                });

                $(this).closest(".andromeda-ui").addClass("collapsed");

                $('<div class="andromeda-ui-collapsed-roleplay-text"><b>' + characterFirstName + ':</b> ' + roleplayText + '</div>').insertAfter($(this).closest(".andromeda-ui")).hide().delay(1250).fadeIn(250);
            });

            $(".ui-expand-toggle").on("click", function() {
                ...
                var menuInterfaceToggle = $(this).parent().find(".menu-interface-toggle");

                setTimeout(function() {
                    menuInterfaceToggle.show();
                }, 750);
            });
            ...
            $(".user-info-interface-toggle").on("click", function() {
                if (!$(this).closest(".andromeda-ui").find(".user-info-interface").is(":animated") && !$(this).closest(".menu-interface").is(":animated")) {
                    ...
                    $(this).closest(".andromeda-ui").children(".andromeda-ui-left-sector, .andromeda-ui-right-sector").css("pointer-events", "none");
                }
            });
            ...
            $(".andromeda-ui").on("click", function(event) {
                if (!$(event.target).closest(".user-info-interface").length && parseInt($(this).find(".user-info-interface").css("left"), 0) - parseInt($(this).closest(".andromeda-ui").width(), 0) < 0) {
                    ...
                    $(this).find(".user-info-interface").animate({
                        ...
                        duration: 500,
                        complete: function() {
                            if ($(this).find(".user-card-container").css("top") === "0px") {
                                $(this).find(".user-card").click();
                            }
                        }
                    });

                    $(this).children(".andromeda-ui-left-sector, .andromeda-ui-right-sector").css("pointer-events", "");
                    $(this).find(".slideshow-progress").removeAttr("style");
                }
            });
        },
        ...
        characterImageMaskIntegrity: function($this) {
            if ($($this).find(".image-one").children("img").length) {
                $($this).children(".character-image-mask").css("background-image", "linear-gradient(rgba(0, 0, 0, 0.15) 0%, rgba(0, 0, 0, 0.15) 100%), url('" + $($this).find(".image-one").children("img").attr("src") + "')");   
            } 
        },
        ...
        init: function($this) {
            ...
            kevinWBGenII.characterImageMaskIntegrity($this);
        },
