...
(function($){
	...
	var stylesheetPrefix = "https://kpop-demon-hunters-experimental.fandom.com/index.php?action=raw&ctype=text/css&title=";
	var themes = [
		{
			id: 'default',
			name: 'Default',
			note: 'Light & Dark',
                        image: "https://static.wikia.nocookie.net/kpop-demon-huntersfanon/images/b/b5/Site-background-light/revision/latest?cb=20250724170010"         
		},
		{
			id: 'rumi',
			name: "Rumi",
			note: 'Light & Dark',
			stylesheet: stylesheetPrefix+"Import Themes/Rumi.css",
			image: "https://static.wikia.nocookie.net/kpop-demon-hunters-experimental/images/4/4f/Rumi_Background_4.png/revision/latest?cb=20250924031651"
		},
		{
			id: 'zoey',
			name: 'Zoey',
			note: 'Light & Dark',
			stylesheet: stylesheetPrefix+"Import Themes/Zoey.css",
			image: "https://static.wikia.nocookie.net/kpop-demon-hunters-experimental/images/6/6e/Zoey_Background_Light.png/revision/latest?cb=20250926233754"
		},
		{
			id: 'mira',
			name: "Mira",
			note: 'Light & Dark',
			stylesheet: stylesheetPrefix+"Import Themes/Mira.css",
			image: "https://static.wikia.nocookie.net/kpop-demon-hunters-experimental/images/e/ed/Mira_3.jpg/revision/latest?cb=20250927155250"
		},
		{
			id: 'jinu',
			name: "Jinu",
	...
	function initDropdownHtml() {
		...
		var $toggle = $("<a>").addClass("wds-dropdown__toggle").attr("title", "Theme Selector").html(TOOLBAR_ICON).appendTo($dropdown);
	...
	function renderThemesList() {
		...
		$content.html("");
		// Add header
		$('<div class="hsw-theme-header"><strong>Theme Selector</strong></div>').appendTo($content);
