...
/* Keep this here and adapt for gem calcs
	$("span#expLevel2Harness").html('<input type="text" value="0" id="expLevel2" style="text-align: right; width: 40px; background-color:white;"></input>' + 'M' + '<input type="text" value="0" id="expLevel2" style="text-align: right; width: 40px; background-color:white;"></input>' + 'S'); */
