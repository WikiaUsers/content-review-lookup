...
var chatOptions = {
	look: {
		...
		backgroundColor: getCookie("customisation", 0),
                modalIcon: "https://images.wikia.nocookie.net/operation-neogenesis/images/d/d8/Chat_Edit_Icon.png"
	},
	modules: {
		chatHacks: {
			element: "#chatHacks",
...
function openOptions() {
	...
	var optionsWindowHTML = '<code><section style="left:50%; top: 50px; width: 600px; z-index: 2000000002; margin-left:-300px;" class="modalWrapper" id="optionsWindow"><button class="close wikia-chiclet-button" onclick="cancelChanges()"><img src="https://images.wikia.nocookie.net/__cb57523/common/skins/oasis/images/icon_close.png"></button><h1>Chat Theme Options</h1><section class="modalContent"><div><form method="" name="" class="WikiaForm "><fieldset><div style="text-align:justify; font-size:90%; width:265px; padding:5px; -moz-border-radius: 0.5em; font-family:Verdana; color:#FFFFFF; background: rgba(0, 0, 0, 0.3) !important; border: 1px solid #2ca5c5 !important;"><font face="Tahoma, Geneva, sans-serif" color="#2ca5c5" size="3"><b>Chat Colours</b></font><br/><p style="font-size:80%; font-style:italic;">Enter a <a href="http://www.w3schools.com/html/html_colornames.asp" target="_blank">colour name</a> or <a href="http://html-color-codes.info/" target="_blank">colour hex</a> into the fields to change the colour of the chat.</p><table cellspacing="0" cellpadding="0" width="100%" height="100%"><tr><td width="100"><font size="0.1"><div align="left">Chat Background:</div></font></td><td width="10"></td><td width="155"><div align="right"><input type="text" name="backgroundColourinput" id="backgroundColourinput" value="' + chatOptions.look.backgroundColor + '"/></div></td></tr><tr height="5"><td height="5"></td></tr><tr><td width="100"><font size="0.1"><div align="left">Post Background:</div></font></td><td width="10"></td><td width="155"><div align="right"><input type="text" name="selfPostColourinput" id="selfPostColourinput" value="' + chatOptions.look.selfPostColor + '"/></div></td></tr><tr height="5"><td height="5"></td></tr><tr><td width="100"><font size="0.1"><div align="left">Chat Surround:</div></font></td><td width="10"></td><td width="155"><div align="right"><input type="text" name="surroundColourinput" id="surroundColourinput" value="' + chatOptions.look.surroundColor + '"/></div></td></tr></table></div>
<p style="font-size:120%; font-weight:bold; font-style:italic;">Change Chat Colors</p><p style="font-size:80%;">Enter a <a href="http://www.w3schools.com/html/html_colornames.asp" target="_blank">colour name</a> or <a href="http://html-color-codes.info/" target="_blank">colour hex</a><p>Chat background&nbsp;<input type="text" name="backgroundColourinput" id="backgroundColourinput" value="' + chatOptions.look.backgroundColor + '"/></p><br/><p>Self-post background&nbsp;<input type="text" name="selfPostColourinput" id="selfPostColourinput" value="' + chatOptions.look.selfPostColor + '"/></p><br/><p>Surround&nbsp;<input type="text" name="surroundColourinput" id="surroundColourinput" value="' + chatOptions.look.surroundColor + '"/></p><br/><p>Font colour&nbsp;<input type="text" name="fontColourinput" id="fontColourinput" value="' + chatOptions.look.fontColor + '"/></p><br/><p style="font-size:120%; font-weight:bold; font-style:italic;">Change Chat Font</p><p>Font family <select id="fontList"><option value="arial" style="font-family:arial;">Arial</option><option value="courier new" style="font-family:courier new;">Courier new</option><option value="georgia" style="font-family:georgia;">Georgia</option><option value="palatino linotype" style="font-family:palatino linotype;">Palatino linotype</option><option value="Comic Sans MS" style="font-family:Comic Sans MS;">Comic sans</option><option value="tahoma" style="font-family:tahoma;">Tahoma</option><option value="Trebuchet MS" style="font-family:Trebuchet MS;">Trebuchet MS</option><option value="Verdana" style="font-family:Verdana;">Verdana</option><option value="Lucida Console" style="font-family:Lucida Console;">Lucida Console</option></select></p><br/><p style="font-size:120%; font-weight:bold; font-style:italic;">Enable Chat Scripts</p><input type="checkbox" name="chatHacks" value="chatHacks" id="chatHacks"/> Enable <a href="http://c.wikia.com/wiki/User:Monchoman45/ChatHacks.js" target="_blank">chathacks</a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="multiPM" value="multiPM" id="multiPM"/> Enable <a href="http://callofduty.wikia.com/wiki/User:Madnessfan34537/multipm.js" target="_blank">multi PM</a><br/><input type="checkbox" name="tabComplete" value="tabComplete" id="tabComplete"/>Enable <a href="http://runescape.wikia.com/wiki/User:Joeytje50/tabinsert.js" target="_blank">tab complete</a>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="searchBar" value="searchBar" id="searchBar"/>Enable <a href="http://callofduty.wikia.com/wiki/MediaWiki:Chat.js/searchbar.js" target="_blank">search bar</a><br/><input type="checkbox" name="multiKick" value="multiKick" id="multiKick" />Enable <a href="http://callofduty.wikia.com/wiki/User:Madnessfan34537/multikick.js" target="_blank">multi-kick</a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stopSideScroll" value="stopSideScroll" id="stopSideScroll"/>Stop auto scroll</fieldset></form><div style="float:right;"><a onclick="updateCookie()" class="wikia-button">Update!</a>&nbsp;<a onclick="cancelChanges();" id="cancel" class="wikia-button secondary">Cancel</a></div></section></section></code>
';
