...
function addWebsiteReference() {
	...
	var WebsitePublisherInput = document.getElementById("WebsitePublisher").value;
		var dayValue = $("#publishDay").val();
		var monthValue = $("#publishMonth").val();
		var yearValue = $("#publishYear").val();
	var WebsiteDateInput = yearValue+'-'+monthValue+'-'+dayValue
	$("#referenceWebsite").closeModal();
	if (editorVersion == 'Source') {
		$("textarea.cke_source").insertAtCaret("<ref name=\"" +WebsiteWebsiteInput+ ": " +WebsiteTitleInput+ " - " +WebsitePublisherInput+ "\">{{RefWebsite |website=" + WebsiteWebsiteInput + " |year=" + WebsiteTitleInput + " |url=" + WebsiteURLInput + " |title=" + WebsitePublisherInput + " |publisher=" + WebsiteDateInput + " |accessed=" + date + "}}</ref>");
		$("#editform, #toolbar, #wpTextbox1").insertAtCaret("<ref name=\"" +WebsiteWebsiteInput+ ": " +WebsiteTitleInput+ " - " +WebsitePublisherInput+ "\">{{RefWebsite |website=" + WebsiteWebsiteInput + " |year=" + WebsiteTitleInput + " |url=" + WebsiteURLInput + " |title=" + WebsitePublisherInput + " |publisher=" + WebsiteDateInput + " |accessed=" + date + "}}</ref>");
	} else if  (editorVersion == 'Visual') {
		pasteHtmlAtCaret("&lt;ref name=\"" +WebsiteWebsiteInput+ ": " +WebsiteTitleInput+ " - " +WebsitePublisherInput+ "\"&gt;{{RefWebsite |website=" + WebsiteWebsiteInput + " |year=" + WebsiteTitleInput + " |url=" + WebsiteURLInput + " |title=" + WebsitePublisherInput + " |publisher=" + WebsiteDateInput + " |accessed=" + date + "}}&lt;/ref&gt;",iframeWindow);
	}
}
