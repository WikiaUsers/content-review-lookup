// Adds 3 additional buttons onto the local nav to change themes without having to reload the page
// Añade 3 botones adicionales en la navegación local para cambiar de tema claro a oscuro sin tener que recargar la página
// If the code is rejected by JSR, please let us know through the talk page of this code. Thank you!
        ...
        mw.hook("dev.wds").add(
            function (wds) {
                ...
                mw.util.addCSS(
                    ...
                    ".nkch-theme-toggler__pointer-wrapper { align-items: center; animation: anim-theme-toggler-jump-in .5s ease; display: flex; height: 28px; justify-content: center; position: absolute; top: 0; transition: .3s; width: 28px; z-index: 1; will-change: transform, z-index ;}" +
