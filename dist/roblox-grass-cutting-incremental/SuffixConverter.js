...
function addSuffixConverter() {
    if (document.getElementById('SuffixConverter') !== null) {
        ...
        document.getElementById('SuffixConverter').innerHTML = "<div id='SuffixConverterContainer'><div class='templatedesktop' style='padding:0.5em;width:80%;margin:auto'><p style='font-size:24px;font-weight:bold;text-align:center'>Suffix Converter</p><p><input id='SuffixConverterInputField' style='width:25%' placeholder='Input any notation...'></input></p><button id='SuffixConverterCalculateButton'>Calculate</button><p><hr/><b>Results:</b><br>Scientific: <span id='SuffixConverterScientificOutput'></span><br>Suffix: <span id='SuffixConverterSuffixOutput'></span><br>English name of highest suffix: <span id='SuffixConverterEnglishNameOutput'></span></p></div></div>";
        ...
        function updateResults() {
            ...
            } else if (toScientific(document.getElementById('SuffixConverterInputField').value).greaterThanOrEqualTo(1e306) || toScientific(document.getElementById('SuffixConverterInputField').value).lessThan(-1e306) || toScientific(document.getElementById('SuffixConverterInputField').value).equals(-1e306)) {
                tooHigh = true;
            } else if (toScientific(document.getElementById('SuffixConverterInputField').value).lessThan(0)) {
                var input = new Decimal(toScientific(document.getElementById('SuffixConverterInputField').value)).abs();
                negative = true;
            } else {
