...
if (window.location.pathname.match(/[/]User:[a-z]*\d*[/]/gi) && mw.config.get('wgAction') === "view") {
const pagename = window.location.pathname.replace(/[/]wiki[/]/g, "").replace(/[_]/g, " ");
...
// If current page is not a sub-page of a 'User' namespace page, return null.
else {
null;
}