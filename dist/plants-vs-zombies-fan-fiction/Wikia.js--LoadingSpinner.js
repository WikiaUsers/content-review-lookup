//Change the loading animation to Android Lollipop spinner.
(function (factory) {
...
/**
 * Material loading-throbber @ 0.0.9
 * @author Lei Lei
 * MIT License
 */
...
var loading-throbber = (function () {
  function loading-throbber(element, options) {
    _classCallCheck(this, loading-throbber);
  ...
  return loading-throbber;
})();

loading-throbber.VERSION = '0.0.1';

loading-throbber.DEFAULTS = {
  radius: 25,
  strokeWidth: 5,
  duration: 2,
  color: '#3f88f8'
...
function Plugin(option) {
  ...
  return this.each(function () {
    var $this = $(_this);
    var options = $.extend({}, loading-throbber.DEFAULTS, option);

    if (!$this.data('loading-throbberHandler')) {
      $this.data('loading-throbberHandler', new loading-throbber(_this, options));
    }
  });
}

$.fn.loading-throbber = Plugin;
$.fn.loading-throbber.Constructor = loading-throbber;

// Register data api
$(window).on('load', function () {
  $('[data-loading-throbber]').each(function () {
    var $this = $(this);
    var option = $this.data('loading-throbber');
    if (!$this.data('loading-throbberHandler')) {
