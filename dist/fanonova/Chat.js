...
$('[name="message"]').keypress(function(e) {
    if (e.which == 13 && !e.shiftKey) {
        ...
        if (/60484617|kat\.cr|theworldofstevenuniverse\.blogspot\.com|kisscartoon\.me|watchonlinecartoons\.net|madridista-4-life\.tumblr\.com|madridista-forever\.tumblr\.com/i.test(message) && mainRoom.active === true) {
            e.preventDefault();
