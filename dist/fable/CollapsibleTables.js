...
function CollapsibleTables ()
{
  ...
  function initialize ()
  {
    ...
    var docContent    = document.getElementById( 'bodyContent' ) || document.getElementById( 'article' ) || document.getElementById( 'mw_contentholder' ) || document.getElementById( 'WikiaArticle' );
