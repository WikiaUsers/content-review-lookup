...
$(function () {
    ...
    const arrayCharacters = [
        ...
        //Itou
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Kashitarou_Itou"]'),
        ...
        //Shiranui
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Kyou_Shiranui"]'),
        ...
        //Amagiri
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Kyuuju_Amagiri"]'),
        ...
        //Senhime
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Senhime"]'),
        ...
        //Koudou
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Koudou_Yukimura"]'),
        ...
        //Kaoru
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Kaoru_Nagumo"]'),
        ...
        //Kimigiku
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Kimigiku"]'),
        ...
        //Ryuunosuke
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Ryuunosuke_Ibuki"]'),
