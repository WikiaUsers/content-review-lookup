...
$(function () {
    ...
    const arrayCharacters = [
    	//Chizuru
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Chizuru_Yukimura"], .page__main a[href$="/wiki/Chizuru_Yukimura_(Visual_Novel)"]'),
            tooltip: '<div id="tooltip" class="none"><img src="https://static.wikia.nocookie.net/hakuouki/images/c/c3/Yukimura.Chizuru.full.2978401.png/revision/latest?cb=20221211115156&format=original"><br><b>Chizuru Yukimura</b> is the main female character.</div>'
        }, 
	    // Hijikata
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Toshizou_Hijikata"], .page__main a[href$="/wiki/Toshizou_Hijikata_(Visual_Novel)"]'),
	        tooltip: '<div id="tooltip" class="none"><img src="https://static.wikia.nocookie.net/hakuouki/images/c/c1/Hijikata.Toshizou.%28Hakuouki%29.full.2982101.png/revision/latest?cb=20230102173613&format=original"><br><b>Toshizou Hijikata</b> is the Vice-Commander of the Shinsengumi.</div>'
	    },
	    // Okita
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Souji_Okita"], .page__main a[href$="/wiki/Souji_Okita_(Visual_Novel)"]'),
	        tooltip: '<div id="tooltip" class="none"><img src="https://static.wikia.nocookie.net/hakuouki/images/5/51/Okita.Souji.%28Hakuouki%29.full.2982108.png/revision/latest?cb=20230102173902&format=original"><br><b>Souji Okita</b> is the Captain of the 1st Division of the Shinsengumi.</div>'
	    },
	    // Saitou
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Hajime_Saitou"], .page__main a[href$="/wiki/Hajime_Saitou_(Visual_Novel)"]'),
	    ...
	    // Heisuke
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Heisuke_Toudou"], .page__main a[href$="/wiki/Heisuke_Toudou_(Visual_Novel)"]'),
	    ...
	    // Sano
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Sanosuke_Harada"], .page__main a[href$="/wiki/Sanosuke_Harada_(Visual_Novel)"]'),
	    ...
	    // Kondou
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Isami_Kondou"], .page__main a[href$="/wiki/Isami_Kondou_(Visual_Novel)"]'),
	    ...
	    // Sannan
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Keisuke_Sannan"], .page__main a[href$="/wiki/Keisuke_Sannan_(Visual_Novel)"]'),
	    ...
	    // Shinpachi
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Shinpachi_Nagakura"], .page__main a[href$="/wiki/Shinpachi_Nagakura_(Visual_Novel)"]'),
	    ...
	    // Inoue
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Genzaburou_Inoue"], .page__main a[href$="/wiki/Genzaburou_Inoue_(Visual_Novel)"]'),
	    ...
	    // Yamazaki
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Susumu_Yamazaki"], .page__main a[href$="/wiki/Susumu_Yamazaki_(Visual_Novel)"]'),
	    ...
	    // Shimada
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Kai_Shimada"], .page__main a[href$="/wiki/Kai_Shimada_(Visual_Novel)"]'),
	    ...
	    // Kazama
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Chikage_Kazama"], .page__main a[href$="/wiki/Chikage_Kazama_(Visual_Novel)"]'),
	    ...
	    // Itou
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Kashitarou_Itou"], .page__main a[href$="/wiki/Kashitarou_Itou_(Visual_Novel)"]'),
	    ...
	    // Shiranui
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Kyou_Shiranui"], .page__main a[href$="/wiki/Kyou_Shiranui_(Visual_Novel)"]'),
	    ...
	    // Amagiri
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Kyuuju_Amagiri"], .page__main a[href$="/wiki/Kyuuju_Amagiri_(Visual_Novel)"]'),
	    ...
	    // Senhime
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Senhime"], .page__main a[href$="/wiki/Senhime_(Visual_Novel)"]'),
	    ...
	    // Koudou
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Koudou_Yukimura"], .page__main a[href$="/wiki/Koudou_Yukimura_(Visual_Novel)"]'),
	    ...
	    // Kaoru
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Kaoru_Nagumo"], .page__main a[href$="/wiki/Kaoru_Nagumo_(Visual_Novel)"]'),
	    ...
	    // Kimigiku
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Kimigiku"], .page__main a[href$="/wiki/Kimigiku_(Visual_Novel)"]'),
	    ...
	    // Ryuunosuke
	    {
	        link: document.querySelectorAll('.page__main a[href$="/wiki/Ryuunosuke_Ibuki"], .page__main a[href$="/wiki/Ryuunosuke_Ibuki_(Visual_Novel)"]'),
        ...
        //Serizawa
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Kamo_Serizawa"]'),
        ...
        //Iba
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Hachirou_Iba"]'),
        ...
        //Sakamoto
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Ryouma_Sakamoto"]'),
        ...
        //Souma
        {
            link: document.querySelectorAll('.page__main a[href$="/wiki/Kazue_Souma"]'),
