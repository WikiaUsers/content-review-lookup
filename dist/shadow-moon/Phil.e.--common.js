...
if (document.title.indexOf('User:Editcount/editcount.js') != -1) {
  document.write('<script type="text/javascript" src="' 
    + 'http://halo.wikia.com/wiki/index.php?title=User:Editcount/editcount.js' 
    + '&action=raw&ctype=text/javascript&dontcountme=s"></script>'); }
 
//[[User:Guesty-Persony-Thingy/editcount.js]]
if (document.title.indexOf('User:Guesty-Persony-Thingy/editcount.js') != -1) {
  document.write('<script type="text/javascript" src="' 
    + 'http://halo.wikia.com/wiki/index.php?title=User:Guesty-Persony-Thingy/editcount.js' 
    + '&action=raw&ctype=text/javascript&dontcountme=s"></script>'); }
