/* =============================================================================
 * LƯU Ý: Xem hướng dẫn update him.js: [[Thảo luận MediaWiki:Him.js#Notes on upgrading him.js]].
 * =============================================================================
 */
...
va="wpUserEmail".split(',') //Put the ID of the fields you DON'T want to let users type Vietnamese in, multiple fields allowed, separated by a comma (,)
method=0 //Default input method, 0=Auto, 1=Telex, 2=VNI, 3=VIQR, 4=VIQR*
on_off=0 //Start AVIM off
...
function onKeyPress(e) {
	...
	if(((el.type!='textarea')&&(el.type!='text')&&(el.type!='search'))||checkCode(code)) return
