// This code was adopted from the Pilgrammed Wiki
var dialogues = {};
...
function createDialogue(dialogue, dialogueID) {
    ...
    clickSounds[dialogueID] = newSound('https://static.wikia.nocookie.net/tgia/images/4/4d/Click.ogg', dialogueID);
    startSounds[dialogueID] = newSound('', dialogueID);
    textSounds[dialogueID] = newSound('https://static.wikia.nocookie.net/tgia/images/d/d1/Dialog.ogg/revision/latest?cb=20251227103537&format=original', dialogueID, true);
