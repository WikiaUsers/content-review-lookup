$(function () {
	...
	var loadingDefault = '<img src="https://www.superiorlawncareusa.com/wp-content/uploads/2020/05/loading-gif-png-5.gif" width="25px" style="vertical-align: baseline;" border="0" /> Đang tải...';
	...
	var refRevision = {
		...
		initEdit: function () {
			var wrapper = 
				'<div tabindex="0" role="button" aria-expanded="true" class="mw-brokenRefsExplanation mw-editfooter-toggler mw-icon-arrow-collapsed">' +
					'<p>Chú thích lỗi trong trang này:</p>' +
				'</div>' +
				'<small class="mw-editfooter-list brokenRefsResetter-wrapper" style="display: none;"><i>Nhấn <a class="brokenRefsResetter" href="#brokenRefs">vào đây</a> để làm mới</i></small>' +
							...
							'<div class="wds-collapsible-panel__content" id="collapsible-content-references">' +
								'<nav id="articleReferences" class="article-references">' +
									'<div id="reflinks" class="reflinks" data-mw="interface"><div id="mw-normal-reflinks" class="mw-normal-reflinks">' +
										'<small class="brokenRefsResetter-wrapper"><i>Nhấn <a class="brokenRefsResetter" href="#brokenRefs">vào đây</a> để làm mới</i></small>' +
		...
		renderList: function () {
			...
			if (list == '') {
				list = 'Không phát hiện chú thích lỗi nào cả. Làm tốt lắm!';
			}
