...
// Written by Foodbandlt for Sonic News Network
    ...
    window.chatRestr.undereditMessage = "Hi "+ wgUserName+"! Welcome to the Nerf Blaster Wiki Wiki chat! We are so excited to have you here, however, the chat room is only available for active editors of the wiki, and you have not yet made the minimum number of edits required to use it. Our chat policy (which can be found at http://nerfipedia.wikia.com/wiki/Nerfipedia:Chat_Guidelines) requires that you make at least 25 edits to be able to enter the chat. We apologize for this inconvenience and hope to see you in the chat soon.";

    // Enable redirect (1 = enabled, 0 = disabled)
    window.chatRestr.enableRedirect = 1;

    // Page to redirect to 
    window.chatRestr.redirectPage = "Nerf Blaster Wiki";
