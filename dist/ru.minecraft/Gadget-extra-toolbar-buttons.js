...
var buttons = [
	...
	[
		'//static.wikia.nocookie.net/minecraft_ru_gamepedia/images/0/0f/Button_vq.png',
		'Цветной текст',
		'{{цвет|*Цвет текста*|',
		'}}',
		'Текст',
	...
	[
		'//static.wikia.nocookie.net/minecraft_ru_gamepedia/images/3/3a/Button_crafting.png',
	...
	[
		'//static.wikia.nocookie.net/minecraft_ru_gamepedia/images/e/e7/Button_smelting.png',
	...
	[
		'//static.wikia.nocookie.net/minecraft_ru_gamepedia/images/3/30/Button_brewing.png',
...
console.log('MediaWiki:Gadget-extra-toolbar-buttons.js — extra-toolbar-buttons worked');