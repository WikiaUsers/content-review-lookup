 ...
 * 
 * @author Noreplyz
 *Script is taken from the Fandom Developers Wiki and altered to make the command output be compatable with Wiki-Bot. All credit goes to Noreplyz.
 */
;(function(window, $, mw, Mustache) {
    ...
    templates.complete =
        ...
        '<input value="!wiki verify {{username}}" onClick="this.select();" style="padding:8px; width:350px;font-family:\'Rubik\';font-size:20px" readonly/> ' +
        '</div>';
