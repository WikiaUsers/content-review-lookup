...
(function ($, mw) {
    ...
    var lang = mw.config.get('wgUserLanguage').toUpperCase(),
        ...
        adoption_modal = '<form class="WikiaForm" method="" name=""><fieldset><span>' + i18n[lang].adopt_name + ' </span><br /><input type="text" id="cc-form-name" style="width: 500px;" placeholder="Community Central" /><br /><span>' + i18n[lang].adopt_edits + ' </span><br/><input type="text" id="cc-adopt-edits" style="width: 500px;" placeholder="0"/><br /><span>' + i18n[lang].adopt_contribute + ' </span><br/><input type="text" id="cc-adopt-duration" style="width: 500px;" placeholder="30 Days"/><br /><input type="text" id="cc-adopt-admin" style="width: 500px;" placeholder="Jonnie, February 7, 1527"/><br /><span>' + i18n[lang].adopt_info + ' </span><br/><textarea rows="10" cols="75" id="cc-adopt-other" placeholder="..."></textarea></fieldset></form>';
