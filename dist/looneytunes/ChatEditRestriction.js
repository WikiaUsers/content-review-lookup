...
// Written by Lazaro Nightfury2 for Looney Tunes Wiki
// ********************************************
...
// Disable message (1 = enabled, 0 = disabled)
    ...
    undereditMessage: "Hi "+ wgUserName+"! Thanks for trying to use the Looney Tunes Wiki chat room. However, the chat is only for active editors of Looney Tunes Wiki, and you haven't yet made the minimum number of edits required to use it. Our chat rules (which can be found at http://looneytunes.wikia.com/wiki/Looney_Tunes_Wiki:Chat_Policy) require that you make at least 30 edits in our mainspace (that is, on the wiki articles that make up the main content of the encyclopedia). We apologize for this inconvenience and hope to see you in the chat soon!",
    ...
    // Page to redirect to 
    redirectPage: "Looney Tunes Wiki:Chat Policy"
}
...
var exceptionList = ["Lazaro Nightfury2", "Teleram"]; 
...
if (exceptionList.indexOf(userObject.name) == -1 && userObject.groups.indexOf("vstf") == -1 && userObject.groups.indexOf("staff") == -1){
    $.get("/wiki/Special:Editcount/"+userObject.name, function(result){
      ...
      var mainCountRestriction = 30;
      var totalCountRestriction = 30;
