...
function showAdmMessage() {
    if (hasGroup('sysop')) {
        $('.WikiaRail .WikiaSearch').after('<section id="MenuAdministrativo" class="module"><h1>Menú administrativo</h1><ul><li><img width="20" height="20" src="data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D" class="sprite move" /><em><a href="http://es.kirby.wikia.com/wiki/Categoría:Borrar">Categoría:Borrar</a></em><div class="descripcion">Lista de artículos marcados para borrarse</div></li><li><img width="20" height="20" src="data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D" class="sprite move" /><em><a href="http://es.kirby.wikia.com/wiki/Kirbypedia:Pol%C3%ADticas">Reglas @ Kirbypedia</a></em><div class="descripcion">Listado de normas del wiki</div></li></ul><div id="fastdelete"></div></section>');
