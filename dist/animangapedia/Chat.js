// ############################## //
// ### Код чату Аніманґапедія ### //
// ### Version 1.0            ### //
// ############################## //
/* Верхня частина чату */
var headline_styles = 'display: inline-block; width: 300px; font-size: 12px; text-align: center; line-height: 14px; padding: 7px 0; font-weight: bold; color: #3A3A3A; position: absolute; right: 160px;';  
var headline_bar = '<div style="' + headline_styles + '">Ласкаво просимо до чату Аніманґапедії!</br><a href="/wiki/Аніманґапедія:Правила_чату" target="_blank">Правила</a> — <a href="/wiki/MediaWiki:Emoticons" target="_blank">Смайли</a></div>';;
$('.ChatHeader > .wordmark').append(headline_bar);
 
/* Смайли */
// SpeedEmoticon.js
// Code: KORNiUX
// Additional help: Wildream, Set440
