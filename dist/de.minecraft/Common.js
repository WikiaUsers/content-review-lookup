/* Synchronized with revision 1233377 on EN wiki */
...
/**
 * Pause animations on mouseover of a designated container
 *
...
( function() {
	...
	}, '.minetip, .invslot-item, .item' ); // TODO: Remove .item when grid has been replaced by invslot
}() );
...
if ( mw.config.get( 'wgPageName' ).indexOf( 'Spezial:Verschieben/' ) != -1
  ...
  && ( document.querySelector ('.oo-ui-inputWidget-input' ).value % 2 == 1 
    || document.querySelector( '.oo-ui-inputWidget-input' ).value == 6 )
