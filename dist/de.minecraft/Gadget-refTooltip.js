...
$( function() {
	var i18n = {
		...
		doneButton: 'Fertig',
		enableLabel: 'Verweis-Tooltips aktivieren',
		optionsButtonTitle: 'Verweis-Tooltip-Einstellungen',
		referencesSectionName: 'Einzelnachweise',
		saveFailedStorageFull: "Ist der lokale Speicher deines Browsers voll?",
		saveFailedTitle: 'Speichern der Einstellungen fehlgeschlagen'
	};
