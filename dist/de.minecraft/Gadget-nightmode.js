var i18n = {
	activate: 'Aktivieren',
	activateTitle: 'Nachtmodus aktivieren',
	activatedLabel: 'Nachtmodus aktiviert',
...
function changeSkin() {
	...
	if ( $('.skin-hydra').length ) {
		...
		$('<link/>', {rel: 'stylesheet', id: 'hydradark-skin-file', href: '/load.php?lang=de&modules=skins.z.hydra.dark.styles%7Cskins.z.hydra.dark.syntaxhighlight.monokai.styles&only=styles&skin=hydradark'}).insertAfter('#hydra-skin-file');
	}
