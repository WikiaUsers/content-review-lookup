...
if ($.inArray(wgNamespaceNumber, [ 0, 1, 4, 5, 6, 7, 14, 15, 110, 111, 400, 401, 500, 502, 503, -1 ] ) !== -1) {
    ...
    }).text('Le Secret d’Henri est un jeu du studio de création Beemoov. Le wikia Le Secret d’Henri est un site indépendant non sponsorisé par le groupe Beemoov. Les images proviennent en majorité du jeu.')
