...
$(document).ready(function() {
	...
	while(i <= length) {
		$("span#LevelBox-"+i).html('<input onClick="this.select();" type="text" value="20" class="Level" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		
		$("span#HPUPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="HPUP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#HPTPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="HPTP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
    
		$("span#EnergyUPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="EnergyUP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#EnergyTPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="EnergyTP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#EnergyPersonalityBox-"+i).html('<select class="EnergyPersonality" style="background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"><option value="1">No effect</option><option value="0.9">Dull</option><option value="1.1">Hyper</option></select>');
    
		$("span#MAtkUPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="MAtkUP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#MAtkTPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="MAtkTP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#MAtkPersonalityBox-"+i).html('<select class="MAtkPersonality" style="background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"><option value="1">No effect</option><option value="0.8">Very Frail</option><option value="0.9">Frail</option><option value="1.1">Brawny</option><option value="1.2">Very Brawny</option></select>');
    
		$("span#RAtkUPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="RAtkUP" style="text-align: right; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#RAtkTPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="RAtkTP" style="text-align: right; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#RAtkPersonalityBox-"+i).html('<select class="RAtkPersonality" style="background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"><option value="1">No effect</option><option value="0.8">Very Clumsy</option><option value="0.9">Clumsy</option><option value="1.1">Smart</option><option value="1.2">Very Smart</option></select>');
    
		$("span#MDefUPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="MDefUP" style="text-align: right; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#MDefTPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="MDefTP" style="text-align: right; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#MDefPersonalityBox-"+i).html('<select class="MDefPersonality" style="background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"><option value="1">No effect</option><option value="0.8">Very Tender</option><option value="0.9">Tender</option><option value="1.1">Robust</option><option value="1.2">Very Robust</option></select>');
    
		$("span#RDefUPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="RDefUP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#RDefTPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="RDefTP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#RDefPersonalityBox-"+i).html('<select class="RDefPersonality" style="background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"><option value="1">No effect</option><option value="0.8">Very Foolish</option><option value="0.9">Foolish</option><option value="1.1">Clever</option><option value="1.2">Very Clever</option></select>');

		$("span#SpeedUPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="SpeedUP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#SpeedTPBox-"+i).html('<input onClick="this.select();" type="text" value="0" class="SpeedTP" style="text-align: right; font-family: rubik,helvetica,arial,sans-serif; width: 30px; background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; border: 1px solid var(--theme-border-color); border-radius: 5px;"></input>');
		$("span#SpeedPersonalityBox-"+i).html('<select class="SpeedPersonality" style="background-color:var(--theme-page-background-color--secondary,hsl(var(--page-background--dark))); color:white; font-family: rubik,helvetica,arial,sans-serif; border: 1px solid var(--theme-border-color); border-radius: 5px;"><option value="1">No effect</option><option value="0.8">Very Sluggish</option><option value="0.9">Sluggish</option><option value="1.1">Nimble</option><option value="1.2">Very Nimble</option></select>');
		i++;
	}
