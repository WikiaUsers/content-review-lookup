...
if (mwCustomEditButtons) {
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
    ...
    mwCustomEditButtons[mwCustomEditButtons.length] = {
        "imageFile": "https://vignette.wikia.nocookie.net/d__/images/e/e1/O_Accent_Button.png/revision/latest?cb=20161122230533&path-prefix=darkerthanblack",
...
// BEGINNING: JavaScript for placing the fair use rationale template inside the summary box on [[Special:Upload]]. Code by "[[wikipedia:User:Pinky49]]", created and coded specifically for [[wikia:c:cdnmilitary|Duty & Valour]]. Modified by Yyp for use on Darker than Black Wiki.
