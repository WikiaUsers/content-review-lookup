...
(function (ns) {
    ...
    var defaultModuleNames = {
        WikiaPagesOnWikiModule : "Создать страницу", 
        WikiaActivityModule : "Последние действия",
        RelatedVideosModule : "Связанные видео",
        LatestPhotosModule : "Свежие изображения",
        WikiaBlogListingBox : "Популярные блоги",
        ChatModule : "Чат",
        HotSpotsModule : "Горячие точки",
        CommunityCornerModule : "Сообщения сообщества",
        UserAchievements : "Достижения пользователя",
        MoreAchievements : "Больше достижений",
        FollowedPagesModule : "Отслеживаемые страницы",
        WikiaLatestEarnedBadgesModule : "Недавно заработанные значки"
    };
