...
(function (ns) {
    ...
    var noFriendsMessage = '<p id="railgun-no-friends-message">'
            + 'Похоже, что вы пока что не добавили своих друзей.'
            + 'Что бы добавить друга с этот список, посетите их профиль. '
            + 'В верхнем правом углу появляется иконка этого модуля, '
            + 'нажмите на неё что бы добавить участника в друзья.'
            + 'Этим же способом вы можете удалить их из списка.';
