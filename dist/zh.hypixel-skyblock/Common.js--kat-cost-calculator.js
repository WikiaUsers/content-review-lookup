...
$(function() {
    ...
    var $label = $('<label for="pet-level">Your pet’s level:</label>');
    ...
    $label = $('<label for="cost-base-price">Base price according to the table below</label>');
    ...
    $label = $('<label for="cost-cost">Kat’s cost:</label>');
...
$(function() {
    ...
    var $label = $('<label for="base-pet-level">Your pet’s level:</label>');
    ...
    $label = $('<label for="base-cost">Kat’s cost:</label>');
    ...
    $label = $('<label for="cost">Base price:</label>');
