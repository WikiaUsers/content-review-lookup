...
(function(){
	function main() {
		$(".skydate-timestamp").each(function(){
			...
			cont.html( skyDate.toDate().toLocaleString("en-US", { year: 'numeric', month: 'long', day: 'numeric', hour:'numeric', minute:'numeric' }) );
		});
	...
	SkyDate.getFullMonthName = function(month){
		switch(month) {
		case MONTH.ESP: return "Early Spring";
		case MONTH.SP: return "Spring";
		case MONTH.LSP: return "Late Spring";
 
		case MONTH.ESU: return "Early Summer";
		case MONTH.SU: return "Summer";
		case MONTH.LSU: return "Late Summer";
 
		case MONTH.EAU: return "Early Autumn";
		case MONTH.AU: return "Autumn";
		case MONTH.LAU: return "Late Autumn";
 
		case MONTH.EWI: return "Early Winter";
		case MONTH.WI: return "Winter";
		case MONTH.LWI: return "Late Winter";
		}
		return null;
	}
