...
// Tłumaczenie - [[User:PiotrekD]]
(function($) {
	
	var _tmpl = '<div class="useravatar"><a title="Avatar użytkownika {U}"><img src="https://images.wikia.nocookie.net/__cb20081128203240/messaging/images/thumb/1/19/Avatar.jpg/50px-Avatar.jpg" width="100" height="100" alt="Avatar" /></a></div>' +
	'<span class="userlink"><a title="Strona użytkownika">Użytkownik {U}</a></span> &bull; <span class="talklink"><a title="Strona dyskusji">Strona dyskusji</a> <a href="/index.php?title=User_talk:{u}&amp;action=edit&amp;section=new" title="Dejar un nuevo mensaje en la página de discusión">[+]</a></span>{email} &bull; <span class="contribslink"><a title="Wkład użytkownika">Wkład</a></span>{group}'+
	'<div class="contribdetails"></div>',
 _emailtmpl = ' &bull; <span class="emaillink"><a href="/wiki/Special:EmailUser/{u}" title="Wyślij użytkownikowi E-maila">Wyślij E-maila</a></span>',
 _contrtmpl = '{U} dokonał {c} edycji począwszy od {fe}<br /><span class="contenteditcount"><a href="/wiki/Special:Editcount/{U}" title="{cu} ediciones (el {r}% del total) se han hecho en artículos, categorías, imágenes y plantillas. Ver estadísticas avanzadas."><span class="psmax"><span class="psact pslvl{l}" style="width:{r}%;"></span></span></a></span>',
 _grouptmpl = ' &bull; <span class="usergroups" title="Grupy, do których należy ten użytkownik">Grupy: {g}</span>',
 _nosuchuser = 'Nie ma takiego użytkownika.',
 _editavatar = 'Edytuj avatar',
 ...
 _previewsaveavatar = 'To jest obraz, który zostanie wgrany jako Twój avatar. Pamiętaj, że przez krótki czas w Twojej przeglądarce może się wyświetlać ten stary, jest to spowodowane działaniem pamięci podręcznej.',
 _saveavatar = 'Zapisz avatara',
 _datefm = '{d}/{m}/{y}',
 _months = ['styczeń', 'luty', 'marzec', 'kwiecień', 'maj', 'czerwiec', 'lipiec', 'sierpień', 'wrzesień', 'październik', 'listopad', 'grudzień'],
 _groupseparator = ', ',
 _groups = {
	 bureaucrat: '<a href="/wiki/Linux_Wiki:Administratorzy">biurokrata</a>',
 sysop: '<a href="/wiki/Linux_Wiki:Administratorzy">administrator</a>',
 rollback: 'rollback',
 bot: 'bot',
 'fb-user': false,
 '*': false,
