...
function initSummaryButtons( mode ) {
	...
	var buttons = mode !== 'visual' ?
		...
		'пункт|уация', 'ответ', 'комм|ентарий', 'вопрос', 'кат|егория', 'шабл|онизация',
 		'илл|юстрирование', 'доп|олнение', 'уточ|нение', 'обнов|ление данных', 'интер|вики'
		] :
		...
		[
		'викиф|икация', 'оформл|ение', 'стил|евые правки', 'орфогр|афия',
		'пункт|уация', 'кат|егория', 'шабл|онизация',
 		'илл|юстрирование', 'доп|олнение', 'уточ|нение', 'обнов|ление данных', 'интер|вики'
		];
