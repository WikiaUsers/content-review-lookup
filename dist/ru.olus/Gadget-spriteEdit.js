...
var i18n = {
	blockedNotice: 'Вы не можете редактировать этот спрайт, так как вы заблокированы.',
	blockedReason: 'Причина: $1',
	browserActionNotSupported: 'Не поддерживается вашим браузером.',
	changesSavedNotice: 'Ваши изменения сохранены.',
	controlNewName: 'Новое название',
	ctxDeleteImage: 'Удалить изображение',
	ctxDownloadImage: 'Скачать изображение',
	ctxReplaceImage: 'Заменить изображение',
	diffError: 'Не удалось получить разницу версий',
	diffErrorMissingPage: 'Не удалось получить страницу',
	dupeName: 'Это название уже существует.',
	dupeNamesNotice: 'В спрайте есть названия-дубликаты, которые нужно исправить, прежде чем записать изменения.',
	errorApi: 'Ошибка API',
	errorConnection: 'Ошибка связи',
	errorConnectionText: 'Проверьте подключение к Интернету',
	errorGeneric: 'Ошибка',
	errorHttp: 'Ошибка HTTP',
	genericError: 'Что-то пошло не так',
	luaKeyDeprecated: 'устарел',
	luaKeyId: 'ID',
	luaKeyIds: 'IDы',
	luaKeyName: 'назв',
	luaKeyPos: 'поз',
	luaKeySection: 'раздел',
	luaKeySections: 'разделы',
	luaKeySettings: 'настройки',
	luaKeySettingsHeight: 'высота',
	luaKeySettingsPos: 'поз',
	luaKeySettingsSize: 'разм',
	luaKeySettingsSpacing: 'spacing',
	luaKeySettingsUrl: 'url',
	luaKeySettingsWidth: 'ширина',
	namePlaceholder: 'Введите название',
	noPermissionNotice: 'Ваши права доступа не позволяют редактировать этот спрайт.',
	panelChangesIdTitle: 'Изменения данных',
	panelChangesNoDiffFromCur: 'Относительно текущей версии изменений нет.',
	panelChangesSheetTitle: 'Изменения таблицы спрайтов',
	panelChangesTitle: 'Проверьте свои изменения',
	panelCloseTip: 'Закрыть',
	panelConflictCurText: 'Текущий текст',
	panelConflictReview: 'Проверьте изменения',
	panelConflictSave: 'Сохранить',
	panelConflictText: 'Произошёл конфликт редактирования, который не удалось разрешить автоматически.',
	panelConflictTitle: 'Конфликт редактирования',
	panelConflictYourText: 'Ваш текст',
	panelDiscardContinue: 'Продолжить редактирование',
	panelDiscardDiscard: 'Закрыть без изменений',
	panelDiscardText: 'Вы уверены, что не хотите сохранить свои изменения?',
	panelDiscardTitle: 'Несохранённые изменения',
	panelEcchangesReturn: 'Вернуться к разрешению конфликта редактирования',
	panelEcchangesTitle: 'Проверьте свои собственноручные изменения',
	sectionPlaceholder: 'Введите название раздела',
	sectionUncategorized: 'Некатегоризованные',
	titleEditing: 'Редактирование спрайта $1',
	toolbarHelp: 'Справка',
	toolbarHelpPage: 'Справка:Редактор спрайтов',
	toolbarNewImage: 'Новое изображение',
	toolbarNewSection: 'Новый раздел',
	toolbarRedo: 'Вернуть',
	toolbarReviewChanges: 'Проверить изменения',
	toolbarSave: 'Сохранить',
	toolbarSummaryLabelTip: 'Осталось байт',
	toolbarSummaryPlaceholder: 'Вкратце опишите ваши изменения',
	toolbarToolDeprecate: 'Депрекация',
	toolbarToolDeprecateTip: 'Отметить названия как устаревшие',
