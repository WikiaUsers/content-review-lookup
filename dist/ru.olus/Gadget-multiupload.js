mw.loader.using('site').then(function() {
	i18n = {
		multiupload: "Загрузить несколько файлов:",
		yes: "Да",
		no: "Нет",
		sourcefiles: "Исходные файлы:",
		uploadfiles: "Загрузить файлы",
		nofiles: "Пожалуйста, сначала выберите несколько файлов.",
		nolicense: "Пожалуйста, сначала выберите действительную лицензию.",
	...
	if (mw.config.get("wgCanonicalSpecialPageName")!=="Загрузка") return;	
