...
newFieldBuffer += genExtDBOption("http://hu.wow.wikia.com/","WoWWiki HUN (default)");
...
if (wgServer == "http://hu.wow.wikia.com") ttBgStyle = "background: transparent url(https://images.wikia.nocookie.net/wowwiki/images/thumb/c/c0/Ttbackground.svg/275px-Ttbackground.svg.png);";
...
tempName = ttLink.getAttribute("href").replace("http://","").replace("hu.wow.","").replace("wikia.com","").replace("/index.php?title=", "").replace("&amp;action=edit", "").replace("/","").replace(/_/g," ");
} else {
...
itemname = ttLink.getAttribute("href").replace("http://","").replace("hu.wow.","").replace("wikia.com","").replace("/index.php?title=", "").replace("&amp;action=edit", "").replace("/","").replace(/_/g," ");
getInfo(itemname, 1);
}
}
...
// quest tooltips
if (wgServer == "http://hu.wow.wikia.com") {
...
Span.setAttribute("title", "");
if (ttLink.getAttribute("title")) ttLink.setAttribute("title", "");
achname = ttLink.getAttribute("href").replace("http://","").replace("hu.wow.","").replace("wikia.com","").replace("/index.php?title=", "").replace("&amp;action=edit", "").replace("/","").replace(/_/g," ");
getInfo(achname, 10);
}
}
...
if (getCookie("extDB") != "http://hu.wow.wikia.com/") {
