...
/*
var chatTopic = 'Welcome to the Fortran's Pizzeria! Please read the [Five Nights at Fortran's Wiki:Rules|Rules] before chatting!
 //Working as intended, contact SnkEydKrisice before editing
/**
 * ChatOptions
 ...
 var chatOptions = {
 	look: {
 		...
 		backgroundColor: getCookie("customisation", 0),
                 modalIcon: "http://images.clipshrine.com/download/wheel/large-gear-metallic-teeth-66.6-12777.png" //edit "medalicon:" to change options icon; discuss with community before carrying out decision
 	},
 	modules: {
 		chatHacks: {
 			element: "#chatHacks",
