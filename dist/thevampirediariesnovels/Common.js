...
UserTagsJS.modules.mwGroups = ['Master bureaucrat', 'chatmoderator', 'patroller', 'rollback', 'sysop', 'bannedfromchat', 'bot', 'bot-global'];
UserTagsJS.modules.metafilter = {
	sysop: ['Master bureaucrat'],
	bureaucrat: ['founder'],
	chatmoderator: ['sysop', 'Master bureaucrat'],
	rollback: ['sysop', 'Master bureaucrat']
};
