// Toggle
$('.toggle .expand-button').click(function() {
    console.log('expand/collapse element');
    content = $(this).parent().find('.expand-content');
    state = content.attr('data-collapsed');
    content.attr('data-collapsed',(state == 'collapsed' ? 'expanded' : 'collapsed'));
});
...
window.UserTagsJS = {
        ...
        tags: {
                ...
                bureaucrat: { u:'Die Räte', link:'Hilfe:Bürokraten', order: 2 },
                sysop: { u:'Warehouse-Verwalter', link:'Hilfe:Administratoren', order: 3 },
                rollback: { u:'Artefakte-Zähler', link:'Hilfe:Zurücksetzen', order: 4 },
                bot: { u:'Warehousebetriebssystem', link:'Hilfe:Bots', order: 5 },
                user: { u:'Warehouse-Agent', link:'Spezial:Benutzer', order: 6 },
                inactive: { u:'Inaktiv', order: 7 }
   }
};

UserTagsJS.modules.mwGroups = ['bureaucrat', 'sysop', 'rollback', 'bannedfromchat', 'chatmoderator', 'user', 'bot', 'newuser'];
...
var resultsTextArray = [ 
	"Leider kennst du dich Warehouse 13 Wiki nicht so gut aus.",
	"Nicht zu gut ,aber auch nicht zu schlecht vielleicht kannst du dich ja noch bessern.",
	"Super du kennst dich mit dem Warehouse 13 Wiki aus." 
	];
var questions = [
 
	["Wer ist die Warehouse 13 Verwalterin ?",
	"Irene Frederic",
	"Artie Nielsen",
	"Claudia Donavan",
	"H.G. Wells"], 
 
	["Wo wohnen die Agenten von Warehouse 13 ?",
	"In Lena's Bed&Breakfast",
	"Im Warehouse",
	"oder in Nashville"],
 
	["Ist Steve Jinks gestorben ?",
	"Ja",
	"Nein"]
