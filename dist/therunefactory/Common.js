...
/* 
    ...
    each operation is a two element array, the first being the type, the 
    second a class name or array of elements operation types are strings 
    like "_reset" or "" for the default toggle operation
*/
...
function toggleInit() {
    ...
    var page = document.getElementById("WikiaArticle");
...
$(function preloadUploadDesc() {
    ...
    document.getElementById('wpUploadDescription').appendChild(document.createTextNode("{{Fair Use Rationale| Description       = \r| Source            = \r| Portion           = \r| Purpose           = \r| Resolution        = \r| Replaceable       = \r| Other Information = \r}}"));
});
