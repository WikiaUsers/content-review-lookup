var	ajaxIndicator = 'https://images.wikia.nocookie.net/dev/images/8/82/Facebook_throbber.gif',
	...
	doRefresh = true,
	ajaxBC = ($('#WikiaArticle').length ) ? '#WikiaArticle' : '#bodyContent';;
...
function preloadAJAXRL() {
	...
	$( '#ajaxLoadProgress' ).ajaxSend( function ( event, xhr, settings ) {
		...
		if ( location.href == settings.url ) {
			...
			// Fix for advanced recent changes bug in MediaWiki 1.19
			// Taken from http://fallout.wikia.com/wiki/MediaWiki:Common.js
