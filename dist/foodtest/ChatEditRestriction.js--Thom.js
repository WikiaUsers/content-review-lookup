...
// Disable message (1 = enabled, 0 = disabled)
    ...
    window.chatRestr.undereditMessage = "Hi "+ wgUserName+"! Thanks for trying to use the Thomas the Tank Engine Wikia chat room. However, the chat room is only for active editors of the TTTE wiki, and you haven't yet made the minimum number of edits required to use it. Our chat rules (which can be found at http://ttte.wikia.com/wiki/Thomas_the_Tank_Engine_Wikia:Rules#Chat_Rules) requires that you make at least 50 edits in our mainspace (that is, on the wiki articles that make up the main content of the encyclopedia). We apologize for this inconvenience and hope to see you in the chat soon.";
    ...
    // Page to redirect to 
    window.chatRestr.redirectPage = "Thomas the Tank Engine Wikia:Rules#Chat Rules";
