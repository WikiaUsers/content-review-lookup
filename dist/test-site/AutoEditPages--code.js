//<source lang="javascript">
    //Code from http://dev.wikia.com/wiki/MediaWiki:AutoEditPages/code.js
    //Inspired from http://dev.wikia.com/wiki/MassNullEdit and http://dev.wikia.com/wiki/CategoryRenameAuto-update
    if (mw.config.get('skin') === 'monobook') {
          mw.util.addPortletLink('creates', '#', 'AutoEditPages', 'creates');
       } else {
             if ($('.creates').length === 0) {
