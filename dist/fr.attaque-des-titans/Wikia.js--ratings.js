    ...
    var conf = mw.config.get( [
        ...
        self = {
                                ...
                                $( '<div>' )
                                    ...
                                    .append(
                                        $( '<textarea>' )
                                            .attr( {
                                                'id': 'ar-comment',
                                                'placeholder': 'Ajoute un commentaire ou une suggestion ici !.',
                                                'maxlength': 2000
                                            } ),
                                        $( '<input>' )
                                            .attr( {
            ...
            submitFeedback: function () {
                ...
                var rating = $( '#ar-rating' ).attr( 'data-rating' ),
                    comment = $( '#ar-comment' ).val(),
                    ...
                    params = {
                        action: 'edit',
                        title: 'Project:Feedback/' + mw.util.wikiUrlencode( conf.wgPageName ),
                        text: toSubmit,
