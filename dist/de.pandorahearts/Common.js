...
/***$( function () {
  if ( !document.getElementById( 'ca-skins' ) ) {
    if ( skin === 'oasis' || skin === 'wikia' ) {
      $( '<li id="ca-skins"><a href="/index.php?title=' + encodeURIComponent( wgPageName ) + '&useskin=monobook"><small>MB</small></a></li>' ).appendTo( '#AccountNavigation' ); $( '<li id="ca-skins"><a href="/index.php?title=' + encodeURIComponent( wgPageName ) + '&useskin=wikiamobile"><small>Mobile</small></a></li>' ).appendTo( '#AccountNavigation' );
    } else {
