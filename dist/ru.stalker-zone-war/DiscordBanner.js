window.DiscordBannerSettings = {
   bannerStyle: '4',
   inviteLink: '6NMvfNeUrE', // Fandom Developers, EXAMPLE CONFIGURATION
   prependToRail: false
};
...
mw.loader.using('mediawiki.api').then(function () {
    var FANDOM_DEVELOPERS_SERVER_ID = '804662632631107614', FANDOM_DEVELOPERS_INVITE_CODE = '6NMvfNeUrE';
