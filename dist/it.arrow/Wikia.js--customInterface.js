...
$(window).load(function() {
    ...
    //=================================
    if ( (wgPageName != 'Nanatsu_no_Taizai_Wiki_Italia') && ( wgNamespaceNumber === 0 || wgNamespaceNumber === 4 || wgNamespaceNumber === 6 || wgNamespaceNumber === 14 || wgNamespaceNumber === 112 || wgNamespaceNumber === 114 || wgNamespaceNumber === 500 || wgNamespaceNumber === 1201) ) { 
        $('#WikiaPage #WikiaFooter').before(
            '<footer id="social-footer">' +
                '<table>' +
                    '<tr>' +
                        '<th>Seguici su:</th>' +
                        '<td><div class="fb-like" data-href="https://www.facebook.com/Nanatsu-no-Taizai-Wiki-Italia-966091976925042" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div></td>' +
                    '</tr>' +
                '</table>' +
            '</footer>'
        );
