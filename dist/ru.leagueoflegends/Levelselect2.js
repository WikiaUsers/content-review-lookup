...
$( document ).ready( function(){
    ...
    $( ".lvlselect" ).each( function(){
        champ = $( this ).html();
        stat = function( i ){ return "[id='" +stats[ i ] +"_" +champ; };
        statb = function( i ){ return stat( i ) +"']"; };
        ...
        //Prepare functions
        base = function( i ){ return parseFloat( data[ champ ][ i ][ 0 ]); };
        plus = function( i ){ return parseFloat( data[ champ ][ i ][ 1 ]); };
