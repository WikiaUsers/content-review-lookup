...
/* Код взят с The Binding of Isaac Wiki */
...
function initDiscordModule() {
    ...
    var discordJSON = "https://discordapp.com/api/guilds/463273408386564126/embed.json";
    ...
    $('<section class="ChatModule module">' +
        '<table>' +
            '<tbody>' +
                '<tr>' +
                    ...
                    '</td>' +
                      '<td style="vertical-align:middle; width:90px;">' +
                        '<center>' +
                            '<img alt="Discord" src="https://vignette.wikia.nocookie.net/saltandsanctuary/images/1/1e/Salt_and_sanctuary_ps41.jpg/revision/latest?cb=20180702183016&path-prefix=ru" class="discord-icon">' +
                ...
                '<tr>' +
                    '<td colspan="2">' +
                        '<div style=" font-size=90%; width:100%; box-shadow:0 0 1px 1px #4c596e; "></div>' +
