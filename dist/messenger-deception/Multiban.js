...
/******************************************************/
/* Multiban w/tab insert                             */
/* Idea by TheKorraFanatic  
/* Molded by Messenger of Heaven
/* Code by Madnessfan34537, Joeytje50 and Callofduty4 */
/******************************************************/
 
//Multibanner
//Written by Madnessfan34537, Callofduty4, TheKorraFanatic, Messenger of Heaven
 
function showPopup() {
        $('body').append('<section style="left: 50%; top: 50px; width: 434px; z-index: 2000000002; margin-left: -222px;" class="modalWrapper" id="massbanner"><button class="close wikia-chiclet-button" onclick="cancelBan()"><img src="https://images.wikia.nocookie.net/__cb57523/common/skins/oasis/images/icon_close.png"></button><h1>Mass-ban</h1><section class="modalContent"><div><form method="" name="" class="WikiaForm "><fieldset><p>Enter usernames here, separated by a comma and a space. Tab insert works.</p><input type="text" name="multibaninput" id="multibaninput" /></fieldset></form><div style="float:right;"><a onclick="banUsers()" class="wikia-button">Ban!</a>&nbsp;<a onclick="cancelBan()" id="cancel" class="wikia-button secondary">Cancel</a></div></section></section><div style="height: 100%; width: 100%; z-index: 2000000001; opacity: 0.65; display: block;" data-opacity="0.65" class="blackout"></div>');
}
...
$('<a id= "multibannerButton" class="wikia-button" href="javascript:showPopup()" style="position:absolute; right:55px; top:22px;">Multiban</a>').appendTo('.Write');
...
$('#multibaninput').after('<span style="display:none;" id="autofilldata">[0,"","",0,null]</span>');
$('#multibaninput').keydown(function(e) {
	if (e.keyCode == 9) {
		e.preventDefault();
