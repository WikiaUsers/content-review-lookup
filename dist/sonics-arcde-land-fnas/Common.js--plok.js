...
$(function() {
	var url = "http://fc01.deviantart.net/fs70/f/2012/028/b/b/unificacion_caos_sprite_by_darkest5-d4nwcea.gif",
		junk = ["http://fc01.deviantart.net/fs70/f/2012/028/b/b/unificacion_caos_sprite_by_darkest5-d4nwcea.gif"], // Extras
		duration = 8,
		el = $('<figure id="timer-animation"><img src="' + url + '" height="56px" /></figure>');
