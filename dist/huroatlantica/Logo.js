...
(function($) {
    for (var name in messageWallUserTags) {
        $('a.subtle[href$="Message_Wall:' + name + '"]').after('<img src="https://images.wikia.nocookie.net/__cb20140612022953/huroatlantica/images/0/03/NFOR-Coat2_%281%29Trans.png" alt="HuroAtlanticaWiki ' + messageWallUserTags[name] + '">');
    }
}(jQuery));
//</syntaxhighlight>