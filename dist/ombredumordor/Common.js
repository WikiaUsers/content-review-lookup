...
/* Makes the text with class "rouge" appear in red */
var user      = mw.config.get('wgUserName');
$(document).ready(function(){
    if( user === "Hulothe" || user === "Wyz" || user === "Avatar" || user === "ElBosso" )
    $('.rouge').addClass("rouge_vrai");
});
...
importArticles({
	...
	articles: [
		"u:dev:DynamicImages/code.js",
                "w:c:shadowofmordor:MediaWiki:Common.js/tooltip"
	]
});