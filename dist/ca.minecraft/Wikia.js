...
//// Usuaris inactius (etiqueta al seu perfil) ////
InactiveUsers = { 
//    months: 2, // mesos per considerar inactiu un usuari.
//    gone: ['Gebruiker1', 'Gebruiker2'], // Especifica els usuaris
    text: 'inactiu' // Configura el text
};
