...
// Add Options button
$('.Rail').prepend('<div onclick="openOptions()" style="margin:auto; cursor: pointer; font-size:150%; bottom:4px; padding-bottom:2px; border-bottom: 1px solid #CCCCCC; width:90%;" align="center"><img src="http://images.wikia.com/piratesonline/images/d/da/ChatOptions.png" width="18px"/>&nbsp;Options</div>');
