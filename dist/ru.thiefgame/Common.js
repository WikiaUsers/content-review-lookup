...
mwCustomEditButtons[mwCustomEditButtons.length] = {
  ...
  mwCustomEditButtons[mwCustomEditButtons.length] = {
    ...
    mwCustomEditButtons[mwCustomEditButtons.length] = {
    "imageFile": "https://vignette.wikia.nocookie.net/thiefgame/images/1/1f/TH_KS_button.png/revision/latest?cb=20200206235505&path-prefix=ru",
    "speedTip": "Шаблон красной строки",
    "tagOpen": "{{КС|",
    "tagClose": "}}",
    "sampleText": ""
};
...
window.pPreview = $.extend(true, window.pPreview, {
    ...
    noimage: 'https://vignette.wikia.nocookie.net/thiefgame/images/f/f0/LostImage.jpg/revision/latest?cb=20200419133047&path-prefix=ru',
        RegExp: {
        iimages: [/Gear\.png/]
