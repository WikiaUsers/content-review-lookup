...
var chatOptions = {
	...
	modules: {
		...
		messageBlock: {
			...
			enabled: isEnabled("messageBlock"),
			loaded: false,
			load: function () {
...
function openOptions() {
	...
	if (chatOptions.modules.messageBlock.enabled)
		$("#messageBlock").attr("checked",true);
...
function updateCookie() {
	...
	// Set the cookies
	setCookie("customisation", chatOptions.look.backgroundColor + ", " + chatOptions.look.fontColor + ", " + chatOptions.modules.chatHacks.enabled + ", " + chatOptions.look.fontFamily + ", " + chatOptions.modules.messageBlock.enabled + ", " +  chatOptions.modules.multiKick.enabled + ", " + chatOptions.modules.multiPM.enabled + ", " + chatOptions.modules.searchBar.enabled + ", " + chatOptions.modules.ignoreURL.enabled + ", " + chatOptions.modules.stopSideScroll.enabled + ", " + chatOptions.look.surroundColor + ", " + chatOptions.look.selfPostColor);
	updateChatSkin();
	cancelChanges();
}
