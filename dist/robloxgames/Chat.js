...
/*Mark site administrators*/
setInterval(function() {
	$('#Rail .User.chat-mod:not(.admin) .username').each(function() {
		if (!this.innerHTML.match(/Tiff or Nick/)) { 
...
importScriptPage("MediaWiki:Chat.js/today.js");