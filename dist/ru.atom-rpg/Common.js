...
function setupModule(data) {
    ...
    $('<section class="ChatModule module">' +
        '<h2 class="discord-header">' +
            '<img alt="Discord" src="https://static.wikia.nocookie.net/atom-rpg/images/f/f6/Discord_chat_logo.svg/revision/latest?cb=20250911064106&format=original&path-prefix=ru" class="discord-icon">' + 
            '<span>Discord</span>' + 
        '</h2>' +
        '<table>' +
            '<tbody>' +
