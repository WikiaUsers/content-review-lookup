...
function ReglasChat() {
    $.showCustomModal( 'Reglas del chat', '<h3>Reglas Generales</h3><ul><li>No se toleran los insultos entre usuarios o páginas.</li><li>Las ediciones realizadas en Amor wiki se toman como buena fe siempre que no se demuestre lo contrario. No se toleran las ediciones vandálicas o abusivas.</li><li>No se permiten en páginas o imágenes cosas como pornografía, hentai, satanismo, etc.</li><li>No está permitido el spam ni tampoco el flood.</li><li>No se permite abusar de ediciones y categorías sólo para ganar logros.</li><li>En caso de pasar un archivo descargable, obligatoriamente se debe adjuntar un enlace hacia virustotal.com en donde se muestra que el archivo no contiene virus ni ningún tipo de software espía.</li></ul><h3>Chat</h3><ul><li>No revelar datos personales tales como contraseñas, direcciones, teléfonos, números de tarjetas de crédito, etc.</li><li>Está permitido hablar en mayúsculas siempre y cuando no se exagere, ya que el abuso de estas se considera flood.</li><li>Molestar a los usuarios del chat continuamente puede ser considerado razón para un baneo.</li>', {
	    ...
	    buttons: [
		{
		    ...
		    message: "Mas Reglas",
		    handler: function () {
				window.open('/wiki/Wiki_Amor_del:Reglas del Chat','_blank');
		    }
		},
		{
			defaultButton: true,
...
// Sonidos de notificación
	...
	$('#ChatHeader').append('<audio id="notificacion" preload="auto"><source src="https://images.wikia.nocookie.net/dragonfansz/es/images/b/bc/Chat.ogg"></source></audio>');
