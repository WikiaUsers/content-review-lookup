...
mw.loader.using(['mediawiki.api','mediawiki.ForeignApi']).then(function() {
	mw.trackSubscribe( 'timing.MediaWiki.echo.overlay.ooui',function() {
	    ...
	    $(".mw-echo-ui-notificationBadgeButtonPopupWidget-popup").find(".oo-ui-popupWidget-head").prepend('<span style="float:right;font-size: 1em;margin-top: 0.3em;" class="oo-ui-labelElement-label">Clear all notifications<img class="cgn-clear" src="/media/d/db/Icon_delete.png" style="cursor:pointer;height: 20px;width: 45px;"></span>'); 
