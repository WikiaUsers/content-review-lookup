...
function fBox() {
	$('#fbox').append('<iframe src="http://www.facebook.com/plugins/likebox.php?href=http://www.facebook.com/pages/Himym-Wiki-Italia/407661785963317?ref=hl;width=292&amp;colorscheme=light&amp;connections=0&amp;stream=false&amp;header=true&amp;height=62" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:292px; height:62px;" allowTransparency="true"></iframe>');
}
...
/** ========================================================
 *  SITEMETER
 *  Taken from the MediaWiki:Common.js page at the RuneScape Wiki
 *  ========================================================
 */
...
function updatetimer(i) {
  ...
  if(diff > 0) left = (diff%60) + ' minuti e ' + left;
    diff=Math.floor(diff/60);
  if(diff > 0) left = (diff%24) + ' ore, ' + left;
    diff=Math.floor(diff/24);
  if(diff > 0) left = diff + ' giorni, ' + left
