...
/* Código sacado de Ben10 Wiki, de forma temporal para alarmar varias causas que hay que arreglar en la wiki hasta que se borren todos los desperfectos de las páginas anteriores al día 32/06/2014 */
...
function openReportForm() {
    $.showCustomModal('Reportar un error', 'Es una lástima que hayas quedado inconforme con algún artículo de esta wikia, pero te recuerdo que si hay algún desperfecto, puedes ayudarnos a arreglarlo editando el mismo, pero como hay ciertos desperfectos con respecto al estilo y la originalidad de las páginas, te agradecemos que nos avises! :) <form class="WikiaForm" method="" name="" id="reporteError"><fieldset><span style="font-family:Arial"><span style="font-weight:bold">Nombre del artículo</span><br><input id="pagename" disabled="" type="text" value="' + des.pagename +'" style="width:400px"/><br><span style="font-weight:bold">Problema encontrado</span><br><textarea name="" id="comment" style="height: 100px; width: 100%;" placeholder="Escribe aquí el problema encontrado"></textarea><br><span id="br2" /></fieldset></form>', {
        id: "requestWindow",
        width: 650,
        buttons: [{
            id: "cancel",
        ...
        {
            id: "editar",
            message: "Puedo arreglarlo por mi cuenta",
            handler: function () {
                $("#requestWindow").closeModal();
