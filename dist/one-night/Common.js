...
window.UserTagsJS = {
	modules: {},
	tags: {
        'rollback': { u:'Curator',link:'Project:Tags#Staff_Tags'},
        'chatmoderator': {u:'Prince', link:'Project:Tags#Staff_Tags'},
        ...
        'newuser': { u:'Alien', link:'Project:Tags#User_Tags'},
        ...
        'illegal': { u:'Troublemaker', link:'Project:Tags#Title_Tags'},
        'dnt': { u:'Robber', link:'Project:Tags#Title_Tags'},
...
highlight = {
    ...
    rollback: 'peach',
    chatmoderator: 'gold',
    threadmoderator: 'brown',
    'content-moderator': 'lightgray',
    sysop: 'gray',
