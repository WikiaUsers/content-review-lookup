...
importScriptPage("MediaWiki:chat.js/Draggable.js", "clubpenguin"); //allows creating draggable elements
...
var JLAPI = {
    ...
    message: {
        ...
        replace: function(regex, modifiers, replacewith, jumpto) {
            var a = new RegExp(regex, modifiers);
    ...
    mostRecentMessage: {
        message: function() {
            var id = JLAPI.mostRecentMessage.cid(),
                a, b, c;
