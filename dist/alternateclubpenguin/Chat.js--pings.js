...
window.openPingsUI = (function(window, $, mw) {
    var _configuration,
        _i18n,
        _defaultSettings;
    _i18n = {
    ...
    function resetSettings() {
        setConfiguration(_defaultSettings);
    }
    ...
    function openUI() {
            ...
            '<form class="WikiaForm" method="" name=""> \
                 <fieldset> \
                     <table> \
                         ...
                         <tr> \
                             <td colspan="2"> \
                                 Messed something up? <a href="#" id="user-pings-reset">Click Here</a> to restore the defaults.\
                             </td> \
                         </tr> \
                     </table> \
                 </fieldset> \
        ...
        $("#user-pings-reset").click(function() {
            resetSettings();
            $('#notifications-ui').closeModal();
        });
    }
