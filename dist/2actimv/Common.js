...
$('.tools').prepend('<li><a id="NoInfobox-link" style="cursor: pointer;">NoInfobox</a></li>');
...
$('.tools').prepend('<li><a id="NoContentInInfobox-link" style="cursor: pointer;">NoContentInInfobox</a></li>');
