...
/* --- Disable photo upload popup, redirect to Special:Upload --- */

$("#page-header-add-new-photo").on("click", function() {
    window.location = 'https://marvels-spider-man.wikia.com/wiki/Special:Upload';
});
