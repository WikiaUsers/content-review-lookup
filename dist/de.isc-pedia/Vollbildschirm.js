/* Code von: http://musik.wikia.com/wiki/MediaWiki:Common.js */
...
\*********************************************************/
/* ACHTUNG !
   Diese Funktion existiert bereits in [[MediaWiki:Spoiler.js]] 
   und ist deshalb hier auskommentiert. 
...
function ExpandContent(headerWidth, contentWidth, catlinksWidth, chgCookie) {
  ...
  $('span#resizeButton').replaceWith('<span class="twdSpoilerKnopf" id="resizeButton" style="'+ExpandStyle+'" onclick="CompressContent(' + headerWidth + ', ' + contentWidth + ', ' + catlinksWidth + ', true);" data-id="resizeButton" title="Rechte Leiste wieder einblenden."> - </span>');
...
function CompressContent(headerWidth, contentWidth, catlinksWidth, chgCookie) {
  ...
  $('span#resizeButton').replaceWith('<span class="twdSpoilerKnopf" id="resizeButton" style="'+ExpandStyle+'"  onclick="ExpandContent(' + headerWidth + ', ' + contentWidth + ', ' + catlinksWidth + ', true);" data-id="resizeButton" title="Volle Artikelbreite zur besseren Darstellung der Tabellen."> + </span>');
}