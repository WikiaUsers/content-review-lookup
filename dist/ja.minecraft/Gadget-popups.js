// <nowiki>
// Imported from https://en.wikipedia.org/wiki/MediaWiki:Gadget-popups.js
// JS for navigation popups gadget: Article previews and editing functions pop up when hovering over links
/* eslint-env browser  */
...
pg.string = {
	...
	'new': '新しい話題',
	'new topic': '新しい話題',
	'newSectionHint': '%sに新しい話題を投稿します',
	'null edit': '空の編集',
	'nullEditHint': '%sに空の編集を投稿します',
	'hist': '履歴',			   ///// history, diffs, editors, related
	'history': '履歴',
	'historyHint': '%sの編集履歴を表示します',
	'last': '<NOBR>差分</NOBR>', // For labelling the previous revision in history pages; the key is "last" for backwards compatibility
	'lastEdit': '最終編集',
	...
	'purge': 'キャッシュ削除',
	'purgeHint': 'キャッシュを削除して%sの最新の状態を表示します',
	'raw': 'ソース',
	'rawHint': '%sのソースを表示します',
	'render': 'シンプル',
	'renderHint': '%sをプレーンHTMLで表示します',
	...
	'defaultpopupExtendedRevertSummary': '$2による$1の版へ差し戻し 旧版$3 ([[WP:POP|ポップアップ]]使用)',
	'defaultpopupRevertToPreviousSummary': 'rv：%sのひとつ前の版へ差し戻し ([[WP:POP|ポップアップ]]使用)',
	'defaultpopupRevertSummary': '%sを取り消し ([[WP:POP|ポップアップ]]使用)',
	'defaultpopupQueriedRevertToPreviousSummary': '[[特別:投稿記録/$3|$3]]([[利用者・トーク:$3|トーク]])による ID:$1 の版を取り消し ([[WP:POP|ポップアップ]]使用)',
	'defaultpopupQueriedRevertSummary': '[[特別:投稿記録/$3|$3]]([[利用者・トーク:$3|トーク]])による ID:$1 の版へ差し戻し ([[WP:POP|ポップアップ]]使用)',
	...
	'user&nbsp;page': '利用者',
	'user talk': 'トークページ',
	'edit user talk': 'トークページを編集',
	'leave comment': '新しいトピック',
	'email': 'メール',
	'email user': 'メールを送信',
	'EmailuserHint': '%s にウィキメールを送信します',
	'space': 'サブページ', // short form for userSpace link
	'PrefixIndexHint': '%s の利用者サブページの一覧を表示します',
	'count': 'カウント',			 ///// contributions, log
	'edit counter': '編集カウンタ',
	'editCounterLinkHint': '%s の投稿回数を表示します',
	'contribs': '投稿記録',
	'contributions': '投稿記録',
	'deletedContribs': '削除された投稿',
	'DeletedcontributionsHint': '%s による投稿で削除されたものの記録を表示します',
	'ContributionsHint': '%s の投稿記録を表示します',
	'log': 'ログ',
	'user log': '利用者ログ',
	'userLogHint': '%s のユーザーログを表示します',
	'arin': 'ARIN lookup',			 ///// ARIN lookup, block user or IP
	'Look up %s in ARIN whois database': '%s を ARIN whois データベースで検索します',
	'unblockShort': '解除',
	'block': 'ブロック',
	'block user': 'ブロック',
