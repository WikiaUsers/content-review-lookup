...
$( function() {
	var i18n = {
		cancelButton: 'キャンセル',
		doneButton: '完了',
		enableLabel: '脚注のツールチップを有効化',
		optionsButtonTitle: '脚注のツールチップ設定を変更します',
		referencesSectionName: '脚注',
		saveFailedStorageFull: "使用しているブラウザのローカルストレージがいっぱいになっていないことを確認してください",
