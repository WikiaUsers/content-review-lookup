...
var i18n = {
	blockedNotice: 'あなたはブロックされているため、スプライトを編集できません',
	blockedReason: '理由: $1',
	browserActionNotSupported: '使用中のブラウザではご利用できません',
	changesSavedNotice: '保存が完了しました',
	controlNewName: '新しい名前',
	ctxDeleteImage: '削除',
	ctxDownloadImage: 'ダウンロード',
	ctxReplaceImage: '置き換える',
	diffError: 'ページ差分の取得に失敗しました',
	diffErrorMissingPage: 'ページの取得に失敗しました',
	dupeName: 'その名前は既に存在しています',
	dupeNamesNotice: '名前が重複している箇所があるため保存できません',
	errorApi: 'API エラー',
	errorConnection: '接続エラー',
	errorConnectionText: 'インターネット接続を確認してください',
	errorGeneric: 'エラー',
	errorHttp: 'HTTP エラー',
	genericError: '何かしらの不具合が発生しました',
	luaKeyDeprecated: '廃止予定',
	luaKeyId: 'id',
	luaKeyIds: 'ids',
	luaKeyName: 'name',
	luaKeyPos: 'pos',
	...
	noPermissionNotice: 'あなたにはこのスプライトを編集する権限がありません',
	panelChangesIdTitle: '変更点',
	panelChangesNoDiffFromCur: '現在のバージョンとの変更点はありません',
	panelChangesSheetTitle: 'Spritesheet changes',
	panelChangesTitle: '変更点',
	panelCloseTip: '閉じる',
	panelConflictCurText: 'Current text',
	panelConflictReview: '変更点を見る',
	...
	sectionPlaceholder: '新しい節の名前',
	sectionUncategorized: 'Uncategorized',
	titleEditing: 'スプライトを編集中: $1',
	toolbarHelp: 'ヘルプ',
	toolbarHelpPage: 'Help:Sprite editor',
	toolbarNewImage: '新しい画像',
	toolbarNewSection: '新しい節',
	toolbarRedo: 'やり直す',
	toolbarReviewChanges: '変更点を見る',
	toolbarSave: '保存',
	toolbarSummaryLabelTip: 'The number of bytes remaining',
	toolbarSummaryPlaceholder: 'Summarize the changes you made',
	toolbarToolDeprecate: '廃止予定にする',
	toolbarToolDeprecateTip: '廃止予定に変更する',
	toolbarTools: 'ツール',
	toolbarUndo: '戻す',
};
