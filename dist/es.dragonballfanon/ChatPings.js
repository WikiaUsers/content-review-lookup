/* (Gracias a Steven Universe Wikia por la traducción a español) */
...
self = {
		init: function() {
			...
			$('.ChatHeader').first().append('<div class="seccion3"><a class="social-icon social-icon--boton" target="_blank"><div class="social-icon social-icon--boton" id="button-chatheader"><span id="btn-pings"> <i class="fa fa-bell" aria-hidden="true"></i> <div class="tooltip"><span>Pings</span></div></span> </div></a></div>');
