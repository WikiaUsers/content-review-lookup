            ...
            const methods = {
                initListeners() {
                    ...
                    document.body.addEventListener('focus', (event) => {
                        if (event.target.closest && event.target.closest('.ProseMirror')) {
                            observer.disconnect();
                            observer.observe(event.target.closest('.ProseMirror'), { subtree: true, characterData: true, childList: true });
                        }
                    }, true);
                    ...
                    document.body.addEventListener('click', (event) => {
                        if (event.target.closest && event.target.closest('.rich-text-editor__content')) {
                            checkMessageDebounced();
                        }
                    });
