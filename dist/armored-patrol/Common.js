...
if (mwCustomEditButtons.length) {
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		...
		"speedTip": "Rare",
		"tagOpen": "{{Color-RealKingdomOrder}}",
		"tagClose": "",
		"sampleText": ""
	};
	mwCustomEditButtons[mwCustomEditButtons.length] = {
...
(function() {
    if(mw.config.get('wgPageName') !== 'Testpage1') {
        return;
    }
    var loaded;
