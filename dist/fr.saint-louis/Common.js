...
addCustomButton('http://images.wikia.com//central/images//8/80/Button_upper_letter.png','Exposant','<sup>','</sup>','');
 
addCustomButton('http://images.wikia.com//central/images//4/4b/Button_nbsp.png','Espace insécable','&nbsp\;','','');
 
addCustomButton('http://images.wikia.com//central/images//8/8e/Button_shifting.png', 'Insérer un retrait',':','','' );
 
addCustomButton('http://images.wikia.com//central/images//e/ea/Button_align_left.png','Aligner un texte à gauche','<div style="text-align: left; direction: ltr; margin-left: 1em;">','</div>','texte aligné à gauche');
 
addCustomButton('http://images.wikia.com//central/images//5/5f/Button_center.png','Centrer un texte','<div style="text-align: center;">','</div>','texte centré');
 
addCustomButton('http://images.wikia.com//central/images//a/a5/Button_align_right.png','Texte aligné à droite','<div style="text-align: right; direction: ltr; margin-left: 1em;">','</div>','texte aligné à droite');
...
addCustomButton('http://images.wikia.com//central/images//5/59/Button_paint.png','Texte coloré','<span style="color: #Nom de la couleur;">','</span>','texte à colorer');
 
addCustomButton('http://images.wikia.com//central/images//1/1c/Button_advanced_image.png','Image avancée','[[Image:','|thumb|right|px|Légende]]','nom de la photo');
...
addCustomButton('http://images.wikia.com//central/images///c/cb/Button_wikipedia.png','Citation Wikipédia','<nowiki>{{OrigineWikipedia}}</nowiki>','');
 
addCustomButton('http://images.wikia.com//central/images//c/ce/Button_no_include.png','Ne pas inclure','<noinclude>','</noinclude>','');
 
addCustomButton('http://images.wikia.com//central/images//7/79/Button_include.png','Inclure seulement','<includeonly>','</includeonly>','');
