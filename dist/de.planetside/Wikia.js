...
var extDB = "http://de.planetside.wikia.com/";
...
// AJAX tooltips
function showTip(e) {
$().log( 'starting showTip' );
$t=$(this);
$p=$t.parent();
if ($p.hasClass("selflink")==false) {
$t.removeAttr("title");
$p.removeAttr("title");
$tfb.load($t.data("tt").replace(/ /g,"_").replace(/\?/g,"%3F")+"?action=render .tooltip-content",function () {
...
if (extDB != "http://de.planetside.wikia.com") { 
