...
$(function () {
    ...
    window.SpoilerAlert = (function (my, console, Math) {
        ...
        my = $.extend({
            question: 'Ten artykuł zawiera informacje o nadchodzących wydarzeniach, a więc jest spoilerem. Czy chcesz kontynuować?',
            yes: 'Tak',
            no: 'Nie',
            isSpoiler: function () {
        ...
        var dialog =
        '<table id="dialog" border="0" cellpadding="20" style="background-color: black; border-radius: 4px; border: 2px solid black;">' +
            '<tr>' +
                '<td colspan="2" style="padding: 20px 30px; border-style: none; text-align: center; color: white">' +
                    my.question +
                '</td>' +
            '</tr>' +
            '<tr>' +
