importArticles({
    type: 'script',
    articles: [
        'FactionsLeaderboard.js',
    ]
});
/*
function ExternalImageLoader() {
    $('#tdd-infobox-image #ExternalImageStock').html('<img width="250" src="' + $('#tdd-infobox-image #ExternalImageStock a').html() + '"/>');
};

function DisplayDemigodLinks(Username) {
	//Ajout de l'onglet demi-dieu dans le bandeau
	$ ('#WikiaUserPagesHeader .tabs-container .tabs li[data-id="profile"]').after('<li data-id="demidieu"><a href="/fr/wiki/Utilisateur:' + Username + '/Demi-dieu" title="Demi-dieu">Demi-dieu</a></li>') ;
};
...
function DisplayUserHeader(Username) {
	...
	//Ajout de l'onglet demi-dieu dans le bandeau
	$ ('#WikiaUserPagesHeader .tabs-container li[data-id="profile"]').after('<li data-id="demidieu"><a href="/fr/wiki/Utilisateur:' + Username + '/Demi-dieu" title="Demi-dieu">Demi-dieu</a></li>') ;
...
function DemigodCreationPanel() {
    ...
    $('#tdd-cadre-infobox').load(
        '/fr/wiki/Modèle:Demi-dieu/Modèle #tdd-infobox', 
        function() {
            ExternalImageLoader();
            $('#tdd-cadre-bio').load(
                '/fr/wiki/Modèle:Demi-dieu/Modèle #tdd-bio', 
                function() {
                    DemigodEdition() ;
...
if ( wgCategories.indexOf("Demi-dieu d\'utilisateur") != -1 && wgNamespaceNumber==2) {
	...
	$('#PageHeader_Stock').load('/fr/wiki/Utilisateur:' + UserpageName + ' #WikiaUserPagesHeader', function() {DisplayUserHeader(UserpageName)});
...
if ((wgNamespaceNumber == 2 && wgPageName.indexOf("/") == -1) || wgNamespaceNumber == 1200  || wgNamespaceNumber == 500 || wgPageName.substring(wgPageName.indexOf(":")+1) == "Following" || wgPageName.substring(wgPageName.indexOf(":")+1, 	wgPageName.indexOf("/")) == "Contributions") {
    ...
    $.get( "/fr/wiki/User:"+ UserpageName +"/Demi-dieu")
    	.done(function() {
    	    //Le demi-dieu existe
