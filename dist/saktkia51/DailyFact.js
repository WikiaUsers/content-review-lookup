...
// Check for 'DailyFact' ID and whether the current page is the main page, cancelling the script if both are false.
...
console.log("[Daily Fact] [LOG]: 'DailyFact' ID has been located, but current page is not the main page. Cancelling script.");
} else {
...
// Function for adding a leading zero to numbers of days or months if its value is a single digit.
...
// Change the monthDay variable to a string where both the month and the day are two-digit values.
monthDay = addLeadingZero(month).toString() + addLeadingZero(day).toString();

// Function for randomising the placeholder text if the current date does not match a case in the switch in the subsequent block.
...
// Switch for determining the current day of a particular month and setting the outputText variable's value.
switch(monthDay) {
case "0211":
outputText = "<a href='https://saktkia51.fandom.com/wiki/Eyeless_Jack'>Eyeless Jack</a> was added to the game on 11 February 2016.";
break;
case "0217":
outputText = "<a href='https://saktkia51.fandom.com/wiki/Jane_the_Killer'>Jane the Killer</a> and <a href='https://saktkia51.fandom.com/wiki/Leatherface'>Leatherface</a> were added to the game on 17 February 2016.";
break;
case "0226":
...
break;
case "0401":
outputText = "On April Fools' Day 2022, the SAKTKIA51 Official Discord Server changed its <a href='https://saktkia51.fandom.com/wiki/File:SAKTKIA51_Official_Server_April_Fools_2022_icon.png'>icon</a> and <a href='https://saktkia51.fandom.com/wiki/File:SAKTKIA51_Official_Server_April_Fools_2022_banner.png'>banner</a> to commemorate the date, lasting approximately 24 hours.";
break;
case "0429":
outputText = "The game's place was created on 29 April 2014.";
break;
case "0518":
...
// Apply the day, month and year variables in a dd mm yyyy format, suffixed with 'UTC'.
