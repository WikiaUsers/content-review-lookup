/* Page is loaded by mobile devices */
// JavaScript Document
// Changes some content of the Router Poll page to customize the polls and tables. 
// Last edited 2015-01-25 by SouthpawKB (support mobile devices)

if(wgPageName == 'Republic%20Wireless%20and%20Your%20Wi-Fi%20Router') {
pollCustomize();
}
if(wgPageName == 'Republic_Wireless_and_Your_Wi-Fi_Router') {
pollCustomize();
}
if(wgPageName == 'Republic_Wireless_and_Your_Wi-Fi_Router?useskin=wikiamobile') {
pollCustomize();
}

function pollCustomize(){
