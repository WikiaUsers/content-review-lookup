...
if($('.discussion_categories').exists()) {
    getCategories(function(categories) {
        var list = $('<dl />').appendTo($('.discussion_categories').empty());
...
function getGuidelines(callback) {
    $.getJSON('https://services.wikia.com/site-attribute/site/' + mw.config.get('wgCityId') + '/attr/guidelines', function(data) {
        callback(data);
    });
}

function getCategories(callback) {
    $.getJSON('https://services.wikia.com/discussion/' + mw.config.get('wgCityId') + '/forums/', function(data) {
...
function getFollowedThreads(userid, callback) {
    $.getJSON('https://services.wikia.com/discussion/' + mw.config.get('wgCityId') + '/threads/followed-by/' + userid,function(data) {
        callback(data._embedded.threads); 
    });
}

discuURL = 'https://services.wikia.com/discussion/' + mw.config.get('wgCityId') + '/';
