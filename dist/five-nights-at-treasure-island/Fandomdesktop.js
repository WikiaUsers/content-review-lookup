...
function addMastheadTags() {
 ...
 rights["Cutupuss"] = ["Founder"];
  rights["Polymeric"] = ["Bureaucrat","Administrator", "Coder", "Event Maker"];
  rights["ClockworkSpirit2343"] = ["Bureaucrat", "Administrator"];
  rights["Amir999990"] = ["Bureaucrat", "Administrator"];
  rights["BlackAntoITA"] = ["Administrator"];
  rights["Master Peridot"] = ["Administrator"];
  rights["TheMurzik120k"] = ["Content Moderator", "CSS Helper"];
  rights["FateForWindows"] = ["Thread Moderator"];
  rights["Dragonspiller"] = ["Thread Moderator"];
  rights["Simplenoise8"] = ["Thread Moderator"];
  rights["Freddy Fazwolf7"] = ["Thread Moderator"];
  rights["Gametime8889"] = ["Thread Moderator"];
  rights["WyattMars the FNARI Developer"] = ["Thread Moderator"];
  rights["GJ Fredbear"] = ["Thread Moderator"];
  rights["Officialtheface"] = ["Thread Moderator"];
  rights["Offline4Now"] = ["Rollback"];
  rights["AnArt1996 Matthew Phoenix Rodriguez"] = ["Game Developer", "Voice Actor"];
  rights["Groot1"] = ["Game Developer", "Voice Actor"];
