;(function() {
	'use strict';
	var main = document.getElementById('maray_maze_solver');
	if (!main) return;
	var html = '<div id="leftDiv" style="float:left">' +
		'<div id="mainDiv"></div>' +
		'<div id="pathDiv">' +
	...
	var rotateIconAlreadyClicked, swapIconAlreadyClicked, swapSphere0Selected, finalCanvas, finalCanvasCenter, finalCanvasThird, baseCanvas, baseCanvasCenter, baseDiameter, baseRadius, insertRadius, insertDistance, baseAngle, insertAngle, insertDiameter, base, path, rotateIconX, rotateIconY, rotateIconWidth, rotateIconHeight, swapIconX, swapIconY, swapIconWidth, swapIconHeight, lineWidthValue, rotateIcon, swapIcon, swapSphere0, swapSphere1, ctx, stepNumber, resFinal, currentInstruction, stepImage;
	var insertCanvas = [];
	var insert = [];
	var locale = [];
	var absoluteLocale = [];
	...
	leftPathDiv.addEventListener('click', drawCanvases);
	middlePathDiv.addEventListener('click', drawCanvases);
	rightPathDiv.addEventListener('click', drawCanvases);
	...
	function cleanCanvas(num) {
		...
		document.getElementById("mainDiv").appendChild(insertCanvas[num]);
	...
	function drawGraphics() {
		...
		for (var i = 0; i < 50; i++) {
			...
			var images = {
				rotateMazeClockwise: '0/0e/MarayMazeBaseC.png',
				rotateMazeCounterclockwise: '7/7b/MarayMazeBaseCC.png',
				rotateMaze2Times: '1/12/MarayMazeBase2.png',
				swapToHunrath: 'c/c9/MarayMazeInsertH.png',
				swapToMaray: 'e/ee/MarayMazeInsertM.png',
				rotateInsertClockwise: '9/99/MarayMazeInsertC.png',
				rotateInsertCounterclockwise: '1/19/MarayMazeInsertCC.png',
				rotateInsert2Times: '5/59/MarayMazeInsert2.png',
				tripleSwapToMaray: '9/9e/MarayMazeTripleM.png',
				tripleSwapToHunrath: '4/4c/MarayMazeTripleH.png'
			};
	...
	function removeSingleRotations(item) {
		var value = document.getElementById("solutionarea").value;
		if (value == item + "\n" || value == item + "\n\n" || value == item + "\n\n\n") {
			document.getElementById("solutionarea").value = "";
		}
	}
