...
$('[name="message"]').keypress(function(e) {
    if (e.which == 13 && !e.shiftKey) {
        ...
        if (/60484617|54176365|kat\.cr|thepiratebay|toonget|animeflavor|kisscartoon|gogoanimetoonova|watchonlinecartoons/i.test(message) && mainRoom.active === true) {
            e.preventDefault();
