...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; font-size:135%; bottom:4px; padding-bottom:2px; border-bottom: 1px solid #00000; width:90%;" align="center"><img src="' + chatOptions.look.modalIcon + '" width="18px"/>&nbsp;Menu</div>'); // Prevent multiple buttons from being appended
}
