...
//[[Portada]] JS transform. Originally from [[Wikipedia:MediaWiki:Monobook.js]]/[[Wikipedia:MediaWiki:Common.js]] and may be further modified for local use.
...
//Contador de ediciones ([[Usuario:Dreyesbo/editcount.js]]) de [[Wikipedia:User:Interiot/Tool2/code.js]] y modificado para uso local.
if (document.title.indexOf('Usuario:Dreyesbo/editcount.js') != -1) {
  document.write('<script type="text/javascript" src="' 
    + 'http://es.inheritance.wikia.com/index.php?title=Usuario:Dreyesbo/editcount.js' 
