...
importArticle({
    type: "script",
    article: "w:c:dev:Standard_Edit_Summary/code.js"
});
	...
	$(".vtip").unbind().hover(    
		...
		this.top = (e.pageY + yOffset); this.left = (e.pageX + xOffset);
 		...
 		$('body').append( '<p id="vtip"><img id="vtipArrow" />' +this.t+ '</p>' );
  		...
  		$('p#vtip #vtipArrow').attr("src", 'https://images.wikia.nocookie.net/metalgear/ko/images/5/5d/Vtip.png');
...
///////////////////////////////////////////////////////
// Enable changing DisplayName of pages
...
///////////////////////////////////////////////////////
// jScrollPane - v2.0.0beta12 (c) 2010 Kelvin Luck
...
///////////////////////////////////////////////////////
// jQuery Mousewheel support (c) 2011 Brandon Aaron 3.0.6 (Requires: 1.2.2+)
...
///////////////////////////////////////////////////////
// Twitter Widget
var tweetUsers = ['Kojima_Hideo','Kojima_Pro'];
var buildString = "";
...
function TweetTick(ob){
	...
	$(ob.results).each(function(el){
		...
		var str = '	<div class="tweet">\
					...
					<span class="time">'+relativeTime(this.created_at)+'</span></div>\
					<p class="txt">'+formatTwitString(this.text)+'</p>\
					</div>';
