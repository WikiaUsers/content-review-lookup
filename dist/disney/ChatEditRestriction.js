// ********************************************
    ...
    // Disable message (1 = enabled, 0 = disabled)
        ...
        window.chatRestr.undereditMessage = "Hi "+ wgUserName+"! Thanks for trying to use the Gravity Falls chat room. However, the chat room is only for active editors of the Gravity Falls wiki, and you haven't yet made the minimum number of edits required to use it. Our chat policy requires that you make at least 1 edit. We apologize for this inconvenience and hope to see you in the chat soon.";
