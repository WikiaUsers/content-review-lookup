...
/** Dynamic Navigation Bars (experimental) *************************************
  ...
  */
  ...
  function toggleNavigationBar(indexNavigationBar, bForceShowHide)
  {
     ...
     if (bForceShowHide != undefined) {
       NavToggle.firstChild.data == bForceShowHide ? NavigationBarHide : NavigationBarShow;
     }
  ...
  function createNavigationBarToggleButton()
  {
     ...
     for(var i = 0; NavFrame = divs[i]; i++) {
         ...
         if (hasClass(NavFrame, "NavFrame")) {
             ...
             if (hasClass(NavFrame, "NavHideByDefault")) {
               toggleNavigationBar(indexNavigationBar, false);
             }
         }
     }
...
/** NSFW Gallery Items (experimental) *************************************
  *
  *  Description: none, see Parser.php and ImageGallery.php for "$nsfw" hack.
  *  Maintainers: [[User:drdaeman]]
  */
  ...
  function processNSFWGalleryItems() {
    var divs = document.getElementsByTagName("div");
    for(var i = 0; item = divs[i]; i++) {
      if (item.hasChildNodes() && hasClass(item, "nsfw-gallery-item")) {
        toggleChildVisibility(item, 'hidden');
        item.style.background = 'url(/skins/common/images/nsfw.png) no-repeat center center';
        item.style.cursor = 'pointer';
        item.onclick = function (e) {
          var target = (e.target) ? e.target : (window.event && event.srcElement) ? event.srcElement : false;
          if (target && hasClass(target, "nsfw-gallery-item")) {
            target.style.background = 'none';
            target.style.cursor = 'default';
            toggleChildVisibility(target, 'visible');
            target.className = target.className.replace("nsfw-gallery-item", "");
  ...
  addOnloadHook(processNSFWGalleryItems);
//[edit] zero section
