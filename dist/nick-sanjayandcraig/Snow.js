...
window.snowStorm = {
	...
	flakesMax: 10,			// Limit total amount of snow made (falling + sticking)
	flakesMaxActive: 10,		// Limit amount of snow falling at once (less = lower CPU use)
	...
	snowColor: 'green',		// Don't eat (or use?) yellow snow.
