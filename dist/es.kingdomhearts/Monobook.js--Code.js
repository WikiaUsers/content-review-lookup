/* El código JS de esta página proviene de WikiDex. */
{{:MediaWiki:Common.js/Code.js}}
window.wgIRCUrl = '{{:MediaWiki:Irc-url}}';
/* MediaWiki:Monobook.js v2.29 <pre> */
...
function PosicionaElementosToolbox() {
	...
	$('#n-activityfeed').children('a').eq(0).text('Actividad reciente').attr('href','/wiki/Especial:CambiosRecientes');
	$('#p-lang').before($('#p-wikicities-nav'));
	
	// Wall
	$('#pt-wall-notifications').insertBefore('#pt-logout');
}
