    ...
    case 'Заявки набора в команду вики':
        $('#adoption').click(function () {
            var requestForm =
                ...
                '      <p class="request-field must-be-filled"><b><span style="color:red">*</span>Ваше ия(ник) :</b> <span class="unfilled-warning" style="color:red;display:none">Вы должны заполнить это поле.</span></p><input type="text" style="align:center;height:20px; width:300px" id="Name" placeholder="Например : Гарри Поттер "/>' +
                '      <p class="request-field must-be-filled"><b><span style="color:red">*</span>Предполагаемая должность :</b> <span class="unfilled-warning" style="color:red;display:none">Вы должны заполнить это поле.</span></p> http://<input type="text" style="align:center;height:20px; width:300px" id="Link" placeholder="Например : Искатель"/>.wikia.com' +
                '      <p class="request-field must-be-filled"><b><span style="color:red">*</span>КОцените своё знание мульт сериала Клуб Винкс(0-10) :</b> <span class="unfilled-warning" style="color:red;display:none">Вы должны заполнить это поле.</span></p>' +
