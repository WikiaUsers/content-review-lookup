...
/*
    This file is a collection of reusable functions from Jackass wiki.
*/

/*
    This global variable specifies if client-side persistent storage is available. Currently, only Firefox 2 supports this specification. On Jackass Wiki, this global storage is used to store information about which infoboxes are hidden.
*/
...
/*
    Replaces {{УЧАСТНИК}} with the name of the user browsing the page.
    Requires copying Шаблон:УЧАСТНИК.
*/
