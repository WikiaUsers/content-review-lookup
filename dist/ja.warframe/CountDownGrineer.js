var cdimg="<div style='background:url(https://images.wikia.nocookie.net/warframe/images/f/f5/DigitsGrineer.png) no-repeat;width:49px;height:75px;overflow:hidden;display:inline-block;border-radius:6px'></div>";
function init_cd(){
	$(".countdowngrineer").each(function(){
	...
	if ($(".countdowngrineer").length){
		cd=setInterval(countdowngrineer, 1000);
	}
}
function countdowngrineer(){
	$(".countdowngrineer").each(function(){
		$(this).show();
