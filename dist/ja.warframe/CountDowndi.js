var cdimg="<div style='background:url(https://images.wikia.nocookie.net/warframe/images/9/91/Digits2.png) no-repeat;width:49px;height:76px;overflow:hidden;display:inline-block;border-radius:6px'></div>";
function init_cd(){
