...
function FVwDplTableSort() {
 ...
 return null;
} addOnloadHook(FVwDplTableSort);

/*** IRC thing ***/
$(function() {
	var nick = (wgUserName == null) ? ('FVW-Visitor-' + Math.floor(Math.random() * 10)) : wgUserName.replace(/ /g, '_'); 
	$('#IRCReplace').html('<iframe src="http://webchat.freenode.net/?nick=' + nick + '&channels=#wikia-farmville&prompt=true&uio=OT10cnVlJjExPTUxJjEyPXRydWU37" width="1000" height="400" style="border:0;"></iframe>');
});
