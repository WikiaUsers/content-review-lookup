...
<nowiki>*</nowiki> This 'MediaWiki:Common.js' will be loaded via imported '/site' file, at the *top*

of page in '<head>'. Will load immediately before Wikia.js.

<nowiki>*</nowiki> The 'MediaWiki:Wikia.js' will be loaded via imported '/site' file, at the *top*

of page in '<head>'. Will load immediately after Common.js and before importArticles.

<nowiki>*</nowiki> Common 'importArticles' files will be loaded together via dynamic import as

'/load.php' file, separately appearing at the *bottom* of the page.

<nowiki>*</nowiki> All files will be checked and minified nearly the same.

<nowiki>*</nowiki> 'Common' files are supposed to be theme agnostic, and 'Wikia' files are supposed
...
var ajaxIndicator = '<nowiki>https://images.wikia.nocookie.net/__cb1/wowwiki/images/0/0e/Progressbar.gif'</nowiki>;
...
// Simply wrap the link (<nowiki>[[Link|Alt]]</nowiki>) in span tags with the "wikia-wowhead-tooltip class, and the "data-rel" attribute which holds the rel the anchor would normally hold. For instance, <nowiki><span data-rel="gems=23121&amp;amp;ench=2647&amp;amp;pcs=25695:25696:25697" class="wikia-wowhead-tooltip">[[Link|Alt]]</nowiki><nowiki></span></nowiki>
...
// See <nowiki>[[Help:Tooltips]]</nowiki>
...
//var extDB = "<nowiki>https://www.wowwiki.com/</nowiki>";
