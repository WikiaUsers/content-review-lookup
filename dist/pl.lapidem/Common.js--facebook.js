...
$(document).ready(function(){
	...
	//Zawartość
	$('<fb:like-box href="http://www.facebook.com/pages/MaceD/487135204677399" height="361" width="185" colorscheme="light" border_color="#000000" show_faces="false" stream="true" header="false"></fb:like-box>').css({marginTop:"10px", marginLeft:"47px"}).appendTo("#FacebookWnd");
