...
if (mwCustomEditButtons) {
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Character Template\r| Image                   = ",
     "tagClose": "\r| RealName                = \r| MainAlias               = \r| Tier                    = \r| Aliases                 = \r| Identity                = \r| Alignment               = \r| Affiliation             = \r| Relatives               = \r| Universe                = \r| BaseOfOperations        = \r\r| Age                     = \r| Gender                  = \r| Height                  = \r| Weight                  = \r| Eyes                    = \r| Hair                    = \r| UnusualFeatures         = \r\r| Citizenship             = \r| MaritalStatus           = \r| Occupation              = \r\r| Creators                = \r| First                   = \r\r| Quotation               = \r| Speaker                 = \r| QuoteSource             = \r\r| Overview                = \r| HistoryText             = \r\r| Tier             = \r\r| Powers                = \r| Abilities                 = \r| Stats             = \r| Weaknesses              = \r\r| Equipment               = \r| Transportation          = \r| Weapons                 = \r\r| Notes                   = \r| Trivia                  = \r| Recommended             = \r| Links                     = \r}}",
     "sampleText": ""};

   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/marveldatabase/images/3/3a/Comic_Button.png",
     "speedTip": "Insert comic Template",
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Comic Template\r| Title               = \r| Image               = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Team Template\r| Image                   = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Location Template\r| Image                   = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki: Vehicle Template\r| Image                   = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Item Template\r| Image                   = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Gallery Template\r| GalleryType             = \r| GalleryData             = \r<gallery widths=120 captionalign=center>\r",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Image Template\r| License                 = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Volume Template\r| LogoImage               = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Race Template\r| Image                   = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Reality Template\r| Image                   = ",
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     ...
     "tagOpen": "{{DC Universe Hierarchy & Power Rankings Wiki:Staff Template\r| Image                   = ",
