...
if(window.wgUserName){$(function(){$(".insertusername").html(wgUserName);});}
...
importScriptPage('MediaWiki:Common.js/IFrame.js', 'legouniverse');
importScriptPage('MediaWiki:Common.js/IFrame2.js', 'legouniverse');
importScriptPage('MediaWiki:Common.js/Game.js', 'legouniverse');
