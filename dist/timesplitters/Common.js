...
$('.fandom-community-header__community-name-wrapper').append(
	...
	.attr('src', 'https://static.wikia.nocookie.net/timesplitters/images/c/c4/Wikibadge.png'));
...
function loadsearchstuff() {
  ...
  var searchicon = "<a href='/wiki/" + xmlDoc.getElementsByTagName("name")[randindex].childNodes[0].nodeValue + "'><img src='" + xmlDoc.getElementsByTagName("url")[randindex].childNodes[0].nodeValue + "' style='margin-left: -15px; margin-top:-6px;' /></a>";
  var searchbox = document.getElementById('searchBody');

  // Throwing all the various fragments together.
  var searchfieldentry = document.getElementById('searchInput');
  if(searchfieldentry == null) return;
  searchfieldentry = searchfieldentry.value;
...
// This is a modified version of the WoWWiki site version, in that it is designed for global.js use. The modified version was edited by Bluerfn of the FFWiki.
