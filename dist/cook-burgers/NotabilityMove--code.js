    ...
    ;(function($, mw) {
      ...
      $('#ca-ncu').click(function() {
        ...
        api.post({
          ...
          to:   newPageName,
          noredirect: '',
          reason: '[[CBW:NCU|Does not meet notability policies]]. ([[Help:Why was the page I created deleted?|why?]])',
          token: token
        }).done(function(d) {
