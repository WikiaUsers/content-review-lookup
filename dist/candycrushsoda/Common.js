...
window.MessageWallUserTags = {
    ...
    glowColor: '#FFFFFF',
    users: {
        'Milos_Ivanis': 'Founder • Bureaucrat',
        'Marisa1980': 'Bureaucrat',
        'Blueeighthnote': 'Administrator',
        'Booking3569': 'Administrator',
        'DoCheonGong': 'Administrator',
        'Fzs1904': 'Administrator',
        'Olaf-Tiffi-Odus2711': 'Administrator',
        'TokihikoH11': 'Administrator',
        'Iceice33': 'Content moderator',
        'Laverock': 'Content moderator',
        'Amy50632': 'Rollback',
        'AlaynaCat': 'Rollback',
        'BLISB99': 'Rollback',
        'Bp101697': 'Rollback',
        'DoccocaubaiCAN': 'Rollback',
        'HM100': 'Rollback',
        'LucasH181': 'Rollback',
        'Magenta_Antoid': 'Rollback',
        'Overloadxyz': 'Rollback',
        'AIDCG': 'Bot',
        'Bureaucrat_Bot': 'Bot'
    }
};
