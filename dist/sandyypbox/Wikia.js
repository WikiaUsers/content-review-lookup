...
if (wgPageName === 'User_blog:Yyp/Test_-_poll_of_everything') {
	challengers = {};
 	//Espada Images
	challengers['Coyote Starrk'] = 'http://http://vignette3.wikia.nocookie.net/sandyypbox/images/f/fe/Misuzu_Oyama_Profile.gif';
	challengers['Baraggan Louisenbairn'] = 'http://http://vignette2.wikia.nocookie.net/sandyypbox/images/1/1c/Yin_and_doll_spectres_ep14.jpg';
	challengers['Tier Harribel'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/1/1f/ARX-160.png';
	challengers['Ulquiorra Cifer'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/7/74/HBRa3.png';
	challengers['Nnoitra Gilga'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/b/b1/IMR.png';
	challengers['Grimmjow Jaegerjaquez'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/7/74/HBRa3.png';
	challengers['Zommari Rureaux'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/7/74/HBRa3.png';
	challengers['Szayelaporro Granz'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/7/74/HBRa3.png';
	challengers['Aaroniero Arruruerie'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/7/74/HBRa3.png';
	challengers['Yammy Llargo'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/7/74/HBRa3.png';
	challengers['Luppi Antenor'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/7/74/HBRa3.png';
	challengers['Nelliel Tu Odelschwanck'] = 'https://vignette.wikia.nocookie.net/bluerogues/images/7/74/HBRa3.png';
 	//Campaign Images
