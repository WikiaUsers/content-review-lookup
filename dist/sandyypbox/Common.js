...
//Link to answers
$('ul.tools li:first-child').after('<li><a href="http://bleach.answers.wikia.com/">Got a question about Bleach?</a></li>');
...
/*** Right Rail Icon Box - source Final Fantasy Wiki*************************
 * Creates and displays article info box (if page has something to display)
 * Adds sideicons in the given order. In conjunction with Template:sideicon
 ****************************************************************************/
$(function(){
