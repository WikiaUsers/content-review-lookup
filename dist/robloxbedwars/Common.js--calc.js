...
/*global mediaWiki, bwiki, importArticle, console */
window.bwiki = window.bwiki || {};

(function ($, mw, bwiki, undefined) {
    'use strict';
    if (bwiki.calculatorLoaded) {
        return;
    }
    bwiki.calculatorLoaded = true;
    ...
    bwiki.calc = {};
    bwiki.calc.lookup = lookupCalc;

}(jQuery, mediaWiki, bwiki));