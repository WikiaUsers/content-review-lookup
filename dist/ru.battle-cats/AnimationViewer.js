...
mw.loader.using('mediawiki.api').then(function () {
	...
	$("#input-form-div").append('<select class="input-element" name="Form" id="select-form" title="Показать форму юнита"><option id="option-normal" value="f">Обычная</option><option id="option-evolved" value="c">Эволюция</option><option id="option-true" value="s">Истинная</option><option id="option-ultra" value="u">Ultra</option></select>');
