...
mw.loader.using('mediawiki.api').then(function () {
	...
	// insert UI elements
	$("#animation-toggle-div").append('<label class="switch" title="Переключить анимацию"><input type="checkbox" id="animation-toggle"><span class="slider round"><span class="animation-off" style="color: #000; user-select: none;">Выкл</span><span class="animation-on" style="color: #000; opacity: 0; user-select: none;">Вкл</span></span></label>');
	...
	$("#input-form-div").append('<select class="input-element" name="Form" id="select-form" title="Показать форму юнита"><option id="option-normal" value="f">Обычная</option><option id="option-evolved" value="c">Эволюция</option><option id="option-true" value="s">Истинная</option><option id="option-ultra" value="u">Ультра</option></select>');
	$("#input-mode-div").append('<select class="input-element" name="Mode" id="select-mode" title="Показать вид анимации"><option value="00">Походка</option><option value="01">Простой</option><option value="02" id="option-attack">Атака</option><option value="03" id="option-knockback">Отскок</option></select>');
	$("#input-frame-div").append('<input class="input-element" type="number" id="input-frame" value="0" min="0" title="Введите фрейм">');
	$("#animation-button-div").append('<button id="animation-button-attack" type="button" title="Показать атаку" style="display: none;">Атака</button>');
	$("#animation-button-div").append('<button id="animation-button-knockback" type="button" title="Показать изображение отскока" style="display: none;">Отскок</button>');
