...
if (old > 30) {
$('#article-comm').attr('disabled','disabled').text('This blog post hasn\'t been commented on for over 30 days, and is now locked.');
...
importScriptPage('MediaWiki:Wikia.js/XX.js', 'apps')