...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; color:white; font-size:120%; font-family:Comic Sans MS; margin-top: 6px; bottom:4px; padding-bottom:2px; border-bottom: solid 4px #E5BF00; width:40%;" align="center">Opções</div>'); // Prevent multiple buttons from being appended
}
