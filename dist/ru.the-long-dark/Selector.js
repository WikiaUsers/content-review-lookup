//My script is modified so it is not a copy from the dev wiki, multiple selector support

mw.loader.using('mediawiki.util').then(function () {

function zselector($content) {
    // Находим все контейнеры с атрибутом data-tab-group
    ...
    // Для обратной совместимости: если нет data-tab-group, обрабатываем весь $content как одну группу
    ...
    function initGroup($container, groupId) {
        ...
        // Обработка кликов по кнопкам с классом cc-*
        ...
        // Обработка наведения на кнопки hh-*
        ...
        // Храним ActiveID для каждой группы отдельно
        var activeStates = {};
