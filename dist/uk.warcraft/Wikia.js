...
var extDB = "http://uk.wow.wikia.com/";
...
dbs = new Array("http://us.battle.net/wow/en/search?q=","https://www.wowhead.com/database=","http://db.mmo-champion.com/search/all/");
...
if (extDB != "http://ru.wow.wikia.com/wiki/") { 
...
$("#stl" + tableNum).html('[<a href="/'+tablePage+'?action=edit">правити</a>]&nbsp;[<a href="javascript:;" id="htl' + tableNum + '" onClick="hideTable(' + tableNum + ');">приховати</a>]');
ttMouseOver(0);
}
});
}
