...
// credit to PortulTrademark of backrooms wiki fame //
mw.loader.using(['mediawiki.api'], function() {
	if(mw.config.get('wgNamespaceNumber') == 0) {
		$('#p-views').append`<div id="ratingparent" style="position: absolute; top:103px; right:35px; background:rgba(var(--theme-page-background-color--rgb),0.7); z-index:3; height:40px; width:190px; padding:5px; text-align:center; vertical-align:center; color:white; border: 2px solid white; font-size:12px; font-family:Arial; border-radius:5px;">
		<big>
