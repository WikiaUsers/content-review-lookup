...
// Temporal
$('body').append('<style>.WikiaForm ul { list-style:none; } .WikiaForm li { margin:0; padding:3px; display:block; width:100%; box-sizing:border-box; } .WikiaForm li strong { width:30%; padding:0 3px; display:inline-block; font-weight:bold } .WikiaForm input { display:inline; padding:5px; }</style>');
