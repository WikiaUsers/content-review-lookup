...
$(function() {
    ...
    $('body').append(
        '<div id="GameResults" style="width:100px; height:100px; text-align:center; color:black; background-color:white; z-index:4000; border:1px solid black; font-size:120%; position:fixed; top:' + (height - 130) + 'px; left:' + (width - 105) + 'px; display:none;">' +
