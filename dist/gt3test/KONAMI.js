...
(function (window, document, $) {
    ...
    $(function () {
        ...
        $(document).keydown(function (e) {
          ...
          konami_style();
	  $("h1.wordmark").find("img").attr("src", "https://images.wikia.nocookie.net/gt3test/images/9/9c/Ponies.png");
...
function konami_style() { $("head").append("<link>");
var css = $("head").children(":last");
css.attr({
      rel:  "stylesheet",
      type: "text/css",
      href: "http://gt3test.wikia.com/load.php?mode=articles&only=styles&articles=MediaWiki:KONAMI.css"
});
}
...
$('span.message').text('You just lost the game');
              $('.Chat').css({'background': 'url(https://images.wikia.nocookie.net/icarly/images/5/58/Rickroll.gif)'});
