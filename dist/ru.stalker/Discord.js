...
(function() {
    ...
    // empty footer fix
    var footer = document.querySelector('.widget-footer');
	var footerButton = document.createElement('a');
	footerButton.classList.add('widget-btn-connect');
	footerButton.href = 'https://discord.gg/GJVGMu5';
	footerButton.target = '_blank';
	footerButton.innerHTML = 'Присоединиться';
