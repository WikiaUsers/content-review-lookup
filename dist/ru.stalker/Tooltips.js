// Reference tooltips
// Original code: https://www.mediawiki.org/wiki/Reference_Tooltips
// Source: https://nkch.fandom.com/wiki/MediaWiki:ReferenceTooltips.js
$(function() {
  mw.loader.using(["mediawiki.cookie"], function () {
    ...
    mw.messages.set({
        "rt-settings": "Настройки всплывающих примечаний",
        "rt-enable-footer": "Включить всплывающие примечания",
        "rt-settings-title": "Всплывающие примечания",
        "rt-save": "Сохранить",
        "rt-cancel": "Отмена",
        "rt-enable": "Включить",
        "rt-disable": "Отключить",
    ...
    function rt($content) {
        ...
        function setSettingsCookie() {
            var cookieValue = Number(enabled) + "|" + delay + "|" + Number(activatedByClick) + "|" + Number(tooltipsForComments),
                cookiePath = "/";
        
            if (mw.config.get("wgScriptPath") !== "") cookiePath = mw.config.get("wgScriptPath");
            else cookiePath = "/wiki";

            mw.cookie.set(
                "RTsettings", cookieValue, {
                    path: cookiePath,
        ...
        function addEnableLink() {
            var $footer = $(".license-description");
            ...
            $footer.before(
                ...
                .append(
                    $("<a>")
                    .addClass("wds-button wds-is-text")
        ...
        function TooltippedElement($element) {
            ...
            function onStartEvent(e) {
                ...
                if (activatedByClick && te.type !== "commentedText" && e.type !== "contextmenu") e.preventDefault();
            ...
            if (this.$element.is(REF_LINK_SELECTOR)) {
                if (this.$element.prop("tagName") === "SUP") this.type = "supRef";
                else this.type = "harvardRef";
            } else {
            ...
            this.hideRef = function (immediately) {
                ...
                if (this.type === "commentedText") this.$element.attr("title", this.comment);
                ...
                if (this.tooltip && this.tooltip.isPresent) {
                    ...
                    if (activatedByClick) $body.off("click.rt touchstart.rt", this.onBodyClick);
                }
            };
            ...
            this.showRef = function ($element, ePageX, ePageY) {
                ...
                if (this.tooltip && !this.tooltip.$content.length) return;
                ...
                function reallyShow() {
                    ...
                    if (!te.tooltip) {
                        ...
                        if (!te.tooltip.$content.length) return;
                    }
            ...
            this.onBodyClick = function (e) {
                if (!te.tooltip && !(te.$ref && te.$ref.hasClass("rt-target"))) return;
        ...
        function Tooltip(te) {
            function openSettingsDialog() {
                ...
                SettingsDialog.prototype.initialize = function () {
                    ...
                    this.activationMethodSelect.on("choose", function (item) {
                        if (item === dialog.clickOption) dialog.delayInput.setDisabled(true);
                        else dialog.delayInput.setDisabled(dialog.clickOption.isSelected());
                    });
                ...
                SettingsDialog.prototype.getActionProcess = function (action) {
                    ...
                    if (action === "save") {
                        return new OO.ui.Process(function () {
                            ...
                            if (newDelay >= 0 && newDelay <= 5000) delay = newDelay;
                ...
                tooltip.upToTopParent(function adjustRightAndHide() {
                    if (this.isPresent) {
                        if (this.$element[0].style.right) this.$element.css("right", "+=" + (window.innerWidth - $window.width()));
            ...
            if (this.insideWindow) this.$element.addClass("rt-tooltip-insideWindow");
            ...
            if (!this.insideWindow) {
                $("<div>")
                    ...
                    .click(function () {
                        if (settingsDialogOpening) return;

                        settingsDialogOpening = true;

                        if (mw.loader.getState("oojs-ui") !== "ready") {
                            if (cursorWaitCss) cursorWaitCss.disabled = false;
                            else cursorWaitCss = mw.util.addCSS("body { cursor: wait; }");
                        }
            ...
            this.show = function () {
                ...
                if (!this.isPresent) $body.append(this.$element);
            ...
            this.calculatePosition = function (ePageX, ePageY) {
                ...
                if (!teOffset) teOffset = teElement.getClientRects && teElement.getClientRects()[0] || teElement.getBoundingClientRect();
                ...
                if (!tooltipTailOffsetX) tooltipTailOffsetX = (teOffset.left * 2 + teOffset.width) / 2;
                ...
                if (teOffset.top < this.$element.outerHeight() + $window.scrollTop() + 6) {
                    ...
                    if (tooltipTailLeft) this.$tail.css("left", (tooltipTailLeft + 12) + "px");
                } else {
                    this.$element
                    ...
                    if (tooltipTailLeft) this.$tail.css("left", tooltipTailLeft + "px");
                }
            };
            ...
            this.upToTopParent = function (func, parameters, stopAtTrue) {
                ...
                if (stopAtTrue) return returnValue;
            };
        }
        ...
        if (tooltipsForComments) teSelector += ", " + COMMENTED_TEXT_SELECTOR;
    ...
    if (settingsString) {
        ...
        tooltipsForComments = settings[3] === undefined ? IS_TOUCHSCREEN && IS_MOBILE : Boolean(Number(settings[3]));
    } else {
        enabled = true;
        delay = 200;
    ...
    importArticles({
        type: "style",
        article: "MediaWiki:ReferenceTooltips.css"
    });
  });
});