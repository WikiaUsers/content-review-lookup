...
var wb$badPages = new Array(
  "Tarna Ilu Wiki:Сообщения об ошибках",
  "Заглавная страница"
)
...
function wb$popWikibug()
{
  ...
  var link_tocreate = window.wgArticlePath.replace(/\$1/, 'Tarna Ilu Wiki:К_созданию')
  var link_bebold = window.wgArticlePath.replace(/\$1/, 'Tarna Ilu Wiki:Правьте_смело')
  var link_buglist = window.wgArticlePath.replace(/\$1/, 'Википедия:Сообщения_об_ошибках')
 
  wb$popBugBoth("Tarna Ilu Wiki:Сообщения об ошибках", '\
...
function wb$goToEditPage()
{
  ...
  var edit_href = window.wgArticlePath.replace(/\$1/, 'Tarna Ilu Wiki:Сообщения_об_ошибках')
  if (edit_el)
