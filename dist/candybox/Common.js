importArticles({
   ...
   articles: [
        ...
        /*####################################*/
		// Marks inactive users' profile with an "Inactive" tag
	...
	'w:c:rhf:MediaWiki:Wikia.js/editCount.js',
		// Adds "about us" to Wiki Navigation in the "On the Wiki" section
	'w:c:rhf:MediaWiki:Wikia.js/aboutus.js',
	...
	'w:c:avatar:MediaWiki:Common.js/wallgreetingbutton.js',
        ...
        /*####################################*/
		// Adds Ajax RC
	'MediaWiki:Common.js/ajax.js',
		// Makes profiles compatible for Statustop2
...
if ( mw.config.get( 'wgPageName' ) === 'Special:Play' ) {
var xhr = new XMLHttpRequest();
 
xhr.open( 'GET', mw.util.wikiScript() + '?title=MediaWiki:CandyBox&action=raw' );
xhr.onload = function () {
