...
'prop': 'info|revisions',
'intoken': 'edit',
'titles': 'Project:Chat/Inregistrari/'+date,
'rvprop': 'content',
'rvlimit': '1',
'indexpageids': 'true',
}, 'GET', function(response) {
...
'minor': 'yes',
'bot': 'yes',
'summary': 'Adaugare la inregistrari cu ajutorul scriptului ChatLogger.',
'action': 'edit',
'title': 'Project:Chat/Inregistrari/'+date,
