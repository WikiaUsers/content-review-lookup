mw.loader.using(['site']).then(function() {
	i18n = {
		multiupload: "Birden fazla dosya yükle:",
		yes: "Evet",
		no: "Hayır",
		sourcefiles: "Kaynak dosyaları:",
		uploadfiles: "Dosya yükle",
		nofiles: "Lütfen önce bazı dosyaları seçin.",
		nolicense: "Lütfen önce geçerli bir lisans seçin.",
		summary: "Özet",
		license: "Lisans",
