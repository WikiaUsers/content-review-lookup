...
if ($('.page-User_-_Fate Kage').length != 0) {
 $("#WikiaRail").append('<div style="clear:both;" align="center"><img src="https://images.wikia.nocookie.net/__cb20120821221928/hunterxhunter/images/c/ce/Blind_kurapika.png" width="300"></div>');
}

if ($('.page-User_talk_-_Fate Kage').length != 0) {
 $("#WikiaRail").append('<div style="clear:both;" align="center"><img src="https://images.wikia.nocookie.net/__cb20121110063929/hunterxhunter/images/6/67/Hisoka_PR_Movie.png" width="250"></div>');
}
