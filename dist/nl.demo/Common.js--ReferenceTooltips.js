 ...
 * Modified by Tjcool007 (Removed settings)
 */
...
window.pg || $(document).ready( function($) {
    ...
    $('#WikiHeader nav ul li:first-child ul').prepend('<li style="float:right"><a href="/wiki/Professor_Layton_Wiki:Reference Tooltips">Ref Tooltip Options</a></li>');
