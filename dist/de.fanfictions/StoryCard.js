$body = $("body");
if ( $body.hasClass("ns--1") || $body.hasClass("ns-14") || $body.hasClass("ns-120") || $body.hasClass("mainpage") || $body.hasClass("ns-0") || $body.hasClass("ns-2") || $body.hasClass("ns-4") ) {
