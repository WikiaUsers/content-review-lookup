...
// "2d context" attributes used for highlighting.
		, areaHighLighting = {fillStyle: 'rgba(255, 0, 0,0.7)', strokeStyle: 'rgba(255, 0, 0,0.2)', lineJoin: 'round', lineWidth: 2}
...
// specifically for wikis - redlinks tooltip adds this message
		...
		, expandLegend = he ? 'הצגת מקרא' : 'Pokaż legendę'
		, collapseLegend = he ? 'הסתרת המקרא' : 'Ukryj legendę'
		;
	...
	function init() {
		mw.util.addCSS('li.' + myClassName + '{white-space:nowrap;}\n' + //css for li element
					'li.' + liHighlightClass + '{background-color:rgba(204, 34, 0,0.5);}\n' + //css for highlighted li element.
