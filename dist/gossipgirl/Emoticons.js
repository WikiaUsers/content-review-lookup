$(function()
{
    ...
    button.onclick = function()
    {
        ...
        $("#kockaEmoticonsModalMain").append("<span class='kockaEmoticonsHelp'>" + (typeof obj.help === 'undefined' ? "Choose an emoticon by clicking on it. To request your own emoji, click [http://pretty-little-liars.wikia.com/wiki/Talk:Emoticons?action=edit&section=new&preload=Template:EmojiRequest here].": obj.help) + "<br/></span>");
