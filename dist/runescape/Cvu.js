			...
			$div.empty().append($form);
                ...
                $("span").each(function() {
                    ...
                    if(this.id == 'cvu_remove' && this.className != 'insert vandal') {
                        var $img1 = $("<img>").attr('src', 'http://images4.wikia.nocookie.net/__cb20100503233735/runescape/images/f/fb/Yes_check.svg');
                        ...
                        var $img2 = $("<img>").attr('src', 'http://images3.wikia.nocookie.net/__cb20100514174733/runescape/images/a/a2/X_mark.svg')
