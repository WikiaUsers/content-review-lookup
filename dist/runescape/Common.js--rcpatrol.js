/* rcpatrol.js
 *
 * Script for [[RuneScape:RC Patrol]] written by Suppa Chuppa
 * Original http://runescape.wikia.com/wiki/User:Suppa_chuppa/rcpatrol.js
 */
$(function() {
			...
			$.post( wgServer + '/api.php',
				{
					...
					'appendtext': '\n{{subst:' + $('#warn-templates').val() + '}} {{User:TyA/sig}} 19:46, September 8, 2015 (UTC)',
					'token': edittoken,
					'minor': 'yes',
