        ...
        */
        ...
        addTalkheader: {
            ...
            exec: function () {
                ...
                $('a.new').attr('data-uncrawlable-url', function (_, attr) {
                    if (!attr) {
                        return;
                    }
                    var attrDecoded = atob(attr);
                    if (
                        (
                            attrDecoded.indexOf('Talk:') > -1 ||
                            attrDecoded.indexOf('_talk') > -1
                        ) &&
                        // User_talk doesn't get the template
                        attrDecoded.indexOf('User_talk:') === -1
                    ) {
                        return btoa(attrDecoded + params);
                    }
                });
         ...
         * Embeds .ogg files
         * 
         * Remarked out, since Common.js/embedding.js now deleted
