$(document).ready(function() {
    function TerrorLootChartTropical(StatueStatRR) {
        ...
        title: {
            text: 'Ресурси, отримані під час події тропічного доктора Т'
        },
        subtitle: {
                text: document.ontouchstart === undefined ?
                        'Натисніть і перетягніть область графіка, щоб збільшити масштаб. Використовуйте легенду, щоб приховати етапи.' : 'Використовуйте два пальці, щоб збільшити масштаб. Використовуйте легенду, щоб приховати етапи.'
        },
        xAxis: {
            categories: ['Золото', 'Дерево', 'Камінь', 'Залізо']
        },
        yAxis: {
            min: 0,
            title: {
        ...
        tooltip: {
            ...
            pointFormat: '{series.name}: {point.y}<br/>Загалом: {point.stackTotal:,.0f}'
        },
        plotOptions: {
            column: {
                stacking: 'normal',
    ...
    function TerrorLootChartVolcano(StatueStatRR) {
        ...
        title: {
            text: 'Ресурси, отримані в події вулканічного доктора Т'
        },
        subtitle: {
                text: document.ontouchstart === undefined ?
                        'Натисніть і перетягніть область графіка, щоб збільшити масштаб. Використовуйте легенду, щоб приховати етапи.' : 'Використовуйте два пальці, щоб збільшити масштаб. Використовуйте легенду, щоб приховати етапи.'
