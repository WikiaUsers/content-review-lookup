...
var text = {
	...
	nextEvent: {
		...
		volcano: 'Наступна подія: ВУЛКАНІЧНИЙ ДОК. Т',
		gearheart: 'Наступна подія: ФАБРИКА ВІЙНИ',
		hammerman: 'Наступна подія: ФЛОТ ХАММЕРМАНА',
		imitation: 'Наступна подія: ГРА В ІМІТАЦІЮ'
	},
	activeEvent: {
		drt: 'ТРОПІЧНИЙ ДОК. Т АКТИВНИЙ',
		volcano: 'ВУЛКАНІЧНИЙ ДОК. Т АКТИВНИЙ',
		gearheart: 'ФАБРИКА ВІЙНИ АКТИВНА',
		hammerman: 'ФЛОТ ХАММЕРМАНА АКТИВНИЙ',
		imitation: 'ГРА В ІМІТАЦІЮ АКТИВНА'
	},
	intel: {
