//Grab image URLs and set to variables
 ...
 $('#slider1').click(function(){
 	...
 	if ($('#slider1').hasClass('closed') && $('#slider2').hasClass('opened') && $('#slider3').hasClass('opened')) {
 		...
 		$('#slider1').removeClass('closed').addClass('animated').animate({ width: "700px" }, "normal", "linear", function() {
 		...
 		$('#slider2').removeClass('closed').addClass('animated').animate({ width: "700px" }, "normal", "linear", function() {
 		...
 		$('#slider3').removeClass('closed').addClass('animated').animate({ width: "700px" }, "normal", "linear", function() {
