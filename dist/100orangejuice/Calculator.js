;(function(mw) {
	...
	function init() {
		...
		'<tr class="crc-mixer">' +
			'<th>First mixer</th>' +
			'<td>' +
				'<input type="radio" id="crc-positive1" name="mixer1" value="positive" checked>' +
				'<label for="crc-positive1">None/Positive</label>' +
				'<input type="radio" id="crc-neutral1" name="mixer1" value="neutral">' +
				'<label for="crc-neutral1">Neutral</label>' +
				'<input type="radio" id="crc-negative1" name="mixer1" value="negative">' +
				'<label for="crc-negative1">Negative</label>' +
			'</td>' +
		'</tr>' +
		'<tr class="crc-mixer">' +
			'<th>Second mixer</th>' +
			'<td>' +
				'<input type="radio" id="crc-positive2" name="mixer2" value="positive" checked>' +
				'<label for="crc-positive2">None/Positive</label>' +
				'<input type="radio" id="crc-neutral2" name="mixer2" value="neutral">' +
				'<label for="crc-neutral2">Neutral</label>' +
				'<input type="radio" id="crc-negative2" name="mixer2" value="negative">' +
				'<label for="crc-negative2">Negative</label>' +
			'</td>' +
		'</tr>' +
		'<tr class="crc-mixer">' +
			'<th>Third mixer</th>' +
			'<td><input type="radio" id="crc-positive3" name="mixer3" value="positive" checked>' +
				'<label for="crc-positive3">None/Positive</label>' +
				'<input type="radio" id="crc-neutral3" name="mixer3" value="neutral">' +
				'<label for="crc-neutral3">Neutral</label>' +
				'<input type="radio" id="crc-negative3" name="mixer3" value="negative">' +
				'<label for="crc-negative3">Negative</label>' +
			'</td>' +
		'</tr>' +
		'<tr>' +
			'<th></th>' +
