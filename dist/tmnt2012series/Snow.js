...
window.snowStorm = {
	...
	flakesMax: 900,			// Limit total amount of snow made (falling + sticking)
	flakesMaxActive: 550,		// Limit amount of snow falling at once (less = lower CPU use)
	animationInterval: 50,		// Theoretical "miliseconds per frame" measurement. 900 = fast + smooth, but high CPU use. 900 = more conservative, but faster
	...
	usePositionFixed: true,		// false = snow does not shift vertically when scrolling. May increase CPU load, disabled by default - if enabled, used only where supported
