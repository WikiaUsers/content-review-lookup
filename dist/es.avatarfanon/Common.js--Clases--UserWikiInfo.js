 ...
 *
 * Several functions taken from Paul Johnson, code obtained by Ben 10 Wiki in Spanish
 */
...
/*
* UserWikiInfo v1.4: Una colección de enlaces útiles relacionados con el usuario que aparece en contribuciones, página de usuario y discusión, con recuento de ediciones y avatar, para Monobook
* 
...
var UserWikiInfo = {
	...
	datefm: '{d} de {m} de {y}',
	editavatar: '<a class="editavatar" href="/wiki/Usuario:{u}?useskin=wikia">Cambiar avatar</a>',
	months: ['enero', 'febrero', 'marzo', 'abril', 'mayo', 'junio', 'julio', 'agosto', 'septiembre', 'octubre', 'noviembre', 'diciembre'],
	groupseparator: ', ',
	groups: {
		bureaucrat: '<a href="/wiki/Ben 10 Wiki:Burócratas">burócrata</a>',
		sysop: '<a href="/wiki/Ben 10 Wiki:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Ben 10 Wiki:Reversores">reversor</a>',
		'fb-user': false,
                bot: '<a href="/wiki/Ben 10 Wiki:Bots">Bot</a>'
                staff: '<a href="http://es.wikia.com/wiki/Staff_de_Wikia"><img src="https://images.wikia.nocookie.net/wikia/images/e/e9/WikiaStaff.png" /></a>',
                helper: '<a href="/wiki/Ayuda:Helpers">Helper</a>',
                chatmoderator: false,
