...
window.UserTagsJS = {
	...
	tags: {
        ...
        bureaucrat: { u:'In Charge', link:'Project:Bureaucrats' },
        chatmoderator: { u:'Spokesman of Games', link:'Project:Custodians' },
        "content-moderator": { u:'Checker', link:'Project:Custodians'},
        inactive: { u:'Please play again' },
        rollback: { u:'Control Z Master', link:'Project:Rollback' },
        custodian: { u:'Custodian', link:'Project:Custodians' },
        sysop: { u:'Admin', link:'Project:Administrators' },
        threadmoderator: { u:'Mod for threads', link:'Project:Custodians' },
	}
};
