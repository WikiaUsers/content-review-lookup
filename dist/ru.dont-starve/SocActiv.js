(function (window, mw) {
  ...
  function modifyActivityList() {
    var activityList = document.querySelectorAll("#mw-content-text > ul.social-activity-list li");
  ...
  function parseElementsStructure(elementsStructure) {
    ...
    elementsStructure.elements.forEach(function (element) {
      ...
      imageLink.href = wikiUrl + langPrefix + '/wiki/User:' + element.username;
