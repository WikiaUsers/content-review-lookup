...
function addMastheadTags() {
  ...
  // BEGIN List of Accounts Given Extra User Rights Icons - Must list all tags
    ...
    rights["NinjaFatGuy"] = ["Head Admin"];
    rights["DoubleDeeEddBoy"] = ["Head Admin"];
    rights["Jackninja5DipperGravityFalls"] = ["Head Admin"];
    rights["Nintendogeek5999"] = ["Head Admin"];
    rights["Skand_and_Jonny_Fan"] = ["Head Admin"];
    rights["Skeleton3"] = ["Head Admin"];
    rights["OishiLover75"] = ["Bureaucrat"];
    rights["DiscoDuck"] = ["Bureaucrat"];
