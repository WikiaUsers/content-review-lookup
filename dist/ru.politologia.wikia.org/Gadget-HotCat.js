...
window.HotCat = {
  ...
  messages :
    { cat_removed  : 'удалена [[Category:$1]]'
     ,template_removed  : 'удалена {{[[Category:$1]]}}'
     ,cat_added    : 'добавлена [[Category:$1]]'
     ,cat_keychange: 'новый ключ для [[Category:$1]]: "$2"' // $2 является новым ключом
     ,cat_notFound : 'Category "$1" не найдена'
     ,cat_exists   : 'Category "$1" уже существует, не добавлена.'
     ,cat_resolved : ' (перенаправление [[Category:$1]] создано)'
     ,uncat_removed: 'удалена {{uncategorized}}'
     ,separator    : '; '
     ,prefix       : ""
        // Some text to prefix to the edit summary.
     ,using        : ' с помощью [[Политология вики:Гаджеты/Gadget-HotCat|HotCat]]'
