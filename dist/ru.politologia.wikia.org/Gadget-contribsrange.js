...
function prefixContribsInit() {
 ...
 sm.innerHTML = 'Включён гаджет диапазонов 0.2. Вы можете ввести IP <a href="http://www.mediawiki.org/wiki/Help:Range_blocks#Technical_explanation">CIDR диапазон</a> или добавить * в конце слова.' 
 fls.appendChild(sm)
