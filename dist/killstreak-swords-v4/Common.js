...
/*Credits to the Coding Help Wikia for the helpful code*
...
*/
// Noglista background
if (mw.config.get('wgPageName') === 'User:Noglista' && mw.config.get('wgAction') !== 'edit') {
    importArticles({
        type: 'script',
        articles: [
...
// Author       : Vastmine1029/Moonwatcher x Qibli (I don't take credit for this. These two are the real goats for this code 🙏)
...
window.UserTagsJS = {
    ...
    tags: {
		...
		gog: { u:'God of Gods', order: -5 },
		lc: { u:'Leading Contributor', order: -4 },
		owner: { u:'Owner', order: -3 },
		cowner: { u:'Co-Owner', order: -2 },
		manager: { u:'Manager', order: -1 },
...
window.MessageWallUserTags = {
    ...
    txtSize: '10px',
    users: {
        'Jaddy0000980': 'Founder, Bureaucrat, Administrator',
        'Noglista': 'Owner, Manager, Bureaucrat, Administrator',
        'Acidicmushroom': 'Manager, Bureaucrat, Administrator',
        'Enderman958': 'Administrator',
    }
};
