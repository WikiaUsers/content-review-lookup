...
autoStart: true,		// Whether the snow should start automatically or not.
	...
	animationInterval: 10,		// Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
	...
	snowColor: '#ADD8E6',		// Don't eat (or use?) yellow snow.
