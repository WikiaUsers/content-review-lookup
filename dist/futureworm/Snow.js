...
window.snowStorm = {
	...
	flakesMax: 70,			// Limit total amount of snow made (falling + sticking)
	flakesMaxActive: 50,		// Limit amount of snow falling at once (less = lower CPU use)
	animationInterval: 15,		// Theoretical "miliseconds per frame" measurement. 20 = fast + smooth, but high CPU use. 50 = more conservative, but slower
	...
	flakeLeftOffset: 1,		// Left margin/gutter space on edge of container (eg. browser window.) Bump up these values if seeing horizontal scrollbars.
	flakeRightOffset: 1,		// Right margin/gutter space on edge of container
...
snowStorm.SnowFlake = function(type, x, y) {
	...
	this.o.style.fontFamily = 'Molengo';
