...
function addMastheadTags() {
    ...
    rights["Dimas535"] = ["БЮРОКРАТ", "АДМИНИСТРАТОР", "TECHNICAL"],
    rights["Bear - X 191"] = ["БОТ"];
...
// ############################################################################# //
/*
  <span class="countdowndate">Month Day Year Hour:Minute:Second TimeZone</span>

  Example: November 20 2013 10:00:00 UTC+11
*/
...
function updatetimer(i) {
    ...
    if (diff > 0) {
        if ((diff % 60) == 1) {
            left = (diff % 60) + ' минута, ' + left;
        } else {
            left = (diff % 60) + ' минут, ' + left;
        }
    }
