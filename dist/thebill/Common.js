...
function mainPageRenameNamespaceTab() {
	try {
		...
		if ( Node.textContent ) {      // Per DOM Level 3
			Node.textContent = 'PNC';
		} else if ( Node.innerText ) { // IE doesn't handle .textContent
			Node.innerText = 'PNC';
		} else {                       // Fallback
			Node.replaceChild( Node.firstChild, document.createTextNode( 'PNC' ) ); 
		}
	} catch(e) {
		// bailing out!
	}
...
if ( wgTitle == 'The Bill Wiki' && ( wgNamespaceNumber == 0 || wgNamespaceNumber == 1 ) ) {
...
// *************************************************************************************************************
// ********* Code Source: Memory Alpha - http://memory-alpha.org/wiki/User:Bp/interactive_tree_script **********
// *************************************************************************************************************
...
var smallTreeCount = 5; // less leaves than this, the tree will be open at first
