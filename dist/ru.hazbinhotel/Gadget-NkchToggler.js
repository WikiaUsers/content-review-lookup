...
if (!nkch.tt.isActive) {
    ...
    mw.loader.using(["mediawiki.api", "mediawiki.util"], function () {
        ...
        mw.hook("dev.wds").add(function (wds) {
            ...
            mw.util.addCSS(
                /* ~ basic ~ */
                ".nkch-theme-toggler__wrapper { background-color: var(--theme-page-background-color--rgb); border: 1px solid var(--theme-community-header-color); border-radius: 15px; display: flex; height: 30px; justify-content: center; margin-inline-end: 6px; position: relative; width: 86px; }" +
                ...
                /* ~ sticky header ~ */
                ".fandom-sticky-header .nkch-theme-toggler__wrapper { background-color: var(--theme-page-background-color--rgb); border-color: var(--theme-sticky-nav-text-color); margin-inline-start: auto; }" +
