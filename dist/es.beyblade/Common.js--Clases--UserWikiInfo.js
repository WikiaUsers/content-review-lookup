...
(function($, mw, jsSHA) {
	...
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/Beyblade Wiki:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Beyblade Wiki:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Beyblade Wiki:Reversores">reversor</a>',
		asistente: '<a href="/wiki/Beyblade Wiki:Asistentes">asistente</a>',
		bot: '<a href="/wiki/Beyblade Wiki:Bots">bot</a>',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
