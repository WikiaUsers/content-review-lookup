...
function initDiscordModule() {
    ...
    var discordJSON = "https://discordapp.com/api/servers/630707109851299840/embed.json";
            ...
            '<tbody>' +
                '<tr>' +
                    '<td style="vertical-align:middle; width:100%;">' +
                        '<p class="chat-name">' +
                            '<a href="https://ru.wikipedia.org/wiki/Discord" target="_blank">Discord</a> – бесплатный мессенджер для публичного общения вне Фэндома. <b>Открыть в <a href="https://discordapp.com/channels/630707109851299840/630707109851299842" target="_blank">браузере</a></b>' +
                        '</p>' +
                    '</td>' +
                      '<td style="vertical-align:middle; width:90px;">' +
                        '<center>' +
                            '<img alt="Discord" src="https://vignette.wikia.nocookie.net/diceydungeons/images/5/56/Discord_DD_Logo.png/revision/latest?cb=20191107164436&path-prefix=ru" class="discord-icon">' +
