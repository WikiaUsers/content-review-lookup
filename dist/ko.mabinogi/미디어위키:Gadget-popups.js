var popupVersion="Sat Mar 3 20:18:00 UTC 2008 en:MediaWiki:Gadget-popups.js";
// STARTFILE: main.js
// **********************************************************************
...
function setNamespaceList() {
	...
	var nsLists = {
//<NOLITE>
		"ko": [m, "특수기능", "토론", "사용자", "사용자토론", "마비노기 위키아", "마비노기 위키아토론", "그림", "그림토론", "분류", "분류토론", "MediaWiki", "MediaWiki talk", "틀", "틀토론", "도움말", "도움말토론"],
//</NOLITE>
	};
...
function kateLink(l) {
	...
	var url;
	var defaultToolUrl='http://tools.wikimedia.de/~$3/cgi-bin/Tool1/wannabe_kate?username=$1&site=en.wikipedia.org&$2';
