 ...
 * Modifed by Megakott for http://ru.youtube.wikia.com and http://ru.figure.wikia.com
 */
...
$(function () {
    ...
    case 'Фигурное_катание_вики:К_удалению':
        ...
        break;
        case 'Фигурное_катание_вики:К_переименованию':
        $('#request').click(function () {
            var requestForm =
                '<form method="" name="" class="WikiaForm">' +
                  '<fieldset>' +
        ...
        break;
    case 'Фигурное_катание_вики:К_восстановлению':
        $('#request').click(function () {
            var requestForm =
                '<form method="" name="" class="WikiaForm">' +
                  '<fieldset>' +
