...
if (wgNamespaceNumber === 500 && wgTitle != 'Sovq/O tłumaczeniach słów kilka') {
	(function ($, mw, LockOldBlogs, ArticleComments) {
		...
		if (typeof LockOldBlogs.expiryMessage !== "string") {
			LockOldBlogs.expiryMessage = "Ten blog nie był komentowany przez ponad <expiryDays> dni. Nie ma potrzeby dodawać nowych komentarzy.";
		}
