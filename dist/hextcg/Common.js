 ...
 * Image dots
 */
$('.image-dots-container').on('click', '.image-dots', function(event){
	$(this).parents('.image-dots-container').children('.image-dots-image').hide();
	$(this).parent().children('.image-dots').removeClass("image-dots-active");
	$(this).parents('.image-dots-container').children('.image-dots-image-'+$(this).attr('id')).show();
	$(this).addClass("image-dots-active");
});
