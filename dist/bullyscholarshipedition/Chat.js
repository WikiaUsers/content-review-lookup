...
var chatTopic = 'Welcome to the Camp Half-Blood wiki chat.';
...
var night_button = 'Roman';
 
//Switch to day button
var day_button = 'Greek';
...
//
  //Link color
    var linkColorDay = '#fce300';
 
  //All text Color
    var textColorDay = '#FFFFFF';
 
  //Self text background color
    var selfTextColorDay = '#2B2B2B';
 
  //Chat background color
    var backgroundColorDay = '#FF983D';
 
  //Chat foreground color
    var foregroundColorDay = '#171717';
...
//
  //Link color
    var linkColor = '#fce300';

  //All text Color
    var textColor = '#FFFFFF';

  //Self text background color
    var selfTextColor = '#2B2B2B';

  //Chat background color
    var backgroundColor = '#8404B3';

  //Chat foreground color
    var foregroundColor = '#171717';
