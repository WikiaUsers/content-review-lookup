...
var chatags = {
    images: false, //The images are too small to be seen. What's their point?
    videos: true
};
...
importArticles({
    ...
    articles: [
        ...
        'u:dev:ChatBlockButton/code3.js',
...
$('<a id= "multiKickerButton" class="wikia-button" href="javascript:showPopup'+
'()" style="position:absolute; right:55px; top:22px;">Multikick</a>')
    .appendTo('.Write');