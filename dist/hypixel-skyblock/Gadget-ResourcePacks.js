(function($){
	...
	function main() {
		...
		var $toggle = $("<a>").addClass("wds-dropdown__toggle").attr("title", "Resource Packs").html("🎨").css({ fontSize:"13px" }).appendTo($dropdown);
	...
	function renderPacksList() {
		...
		$content.html("");
		// Add header
		$('<div class="hsw-pack-header"><strong>Resource Pack Selector</strong></div>').appendTo($content);
