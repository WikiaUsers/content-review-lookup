...
function OpenPrintWindow() {
    var printwindow = window.open('?useskin=monobook&printable=yes', '_blank', "width=800, height=600");
	setTimeout(function(){ printwindow.print(); }, 3000); // 3000 steht für 3000ms = 3 sec
}
if (document.getElementById('WikiaRandomWiki')) {
