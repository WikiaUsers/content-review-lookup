...
window.SkinNotification = {
	article: 'Pokémonpedia Wiki:Ayudas',
	key: 'NfSkin',
	init: function() {
	...
	render: function() {
		...
		var sn = $('<div data-type="100"><a class="sprite close-notification"></a>Se están llevando a cabo proyectos para sacar adelante el wiki. <a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'">Más información</a>.</div>');
...
function agregarEnlaceSkin() {
	...
	$('#WikiaFooter').children('div.toolbar').eq(0).children('ul.tools').eq(0).append('<li><a href="'+surl+'"><img width="15" height="15" class="monobook-icon" src="'+stylepath+'/common/blank.gif"/></a> <a href="'+surl+'" id="ca-changeskin" title="Ver Pokémonpedia con la piel Monobook">Cambiar la apariencia a Monobook</a></li>');
	
	$('#ca-changeskin').click(function(){
		alert('Esta es una herramienta para previsualizar la piel Monobook en los artículos. Para ver de nuevo la página con la piel normal, deberás quitar el "?useskin=monobook" del URL de la página en la que uses esta herramienta.');
	});
}

function Yugioh_WikiaSkinLoad() {
	var ug = '';
...
if (mwCustomEditButtons) {
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/4/49/Botón_plantilla.png",
     "speedTip": "Plantilla",
     "tagOpen": "\{\{",
     "tagClose": "\}\}",
     "sampleText": "Inserta aquí la plantilla"};

   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/7/7c/Link_a_user.png",
     "speedTip": "Link a usuario",
     "tagOpen": "\[[Usuario:",
     "tagClose": "\]]",
     "sampleText": "Nombre de usuario aquí"};

   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/c/c6/Boton_cat.png",
     "speedTip": "Agregar categoría",
     "tagOpen": "\[[Categoría:",
     "tagClose": "\|Texto alternativo]]",
     "sampleText": "Aquí el nombre de la categoría"};

   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/b/b1/Button_a_borrar.png",
     "speedTip": "Agregar plantilla a borrar",
     "tagOpen": "\{{A borrar|",
     "tagClose": "Razón del borrado\",
     "sampleText": "Razón del borrado"};

   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/5/56/Button_big.png",
     "speedTip": "Aumentar tamaño",
     "tagOpen": "\<big>",
     "tagClose": "Texto aumentado",
     "sampleText": "</big>"};

   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/1/1e/Button_colour.png",
     "speedTip": "Añadir color",
     "tagOpen": "<span style="color: nombre del color;">",
     "tagClose": "Texto con otro color",
     "sampleText": "</span>"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/4/43/Button_comentario_oculto.png",
     "speedTip": "Ocultar texto",
     "tagOpen": "<!-------------",
     "tagClose": "Texto oculto",
     "sampleText": "-------------->"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/5/52/Button_redirection.png",
     "speedTip": "Redirección",
     "tagOpen": "#REDIRECTION [[",
     "tagClose": "Nombre del artículo a redireccionar",
     "sampleText": "]]"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/superpokemon/es/images/c/c4/Button_ref.png",
     "speedTip": "Añadir referencia",
     "tagOpen": "<ref>",
     "tagClose": "Texto con referencia, recuerda añadir <references /> al final de la pagina",
     "sampleText": "</ref>"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/__cb20101127164051/superpokemon/es/images/5/58/Button_small.png",
     "speedTip": "Tamaño pequeño",
     "tagOpen": "<small>",
     "tagClose": "Texto pequeño",
     "sampleText": "</small>"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/__cb20101127164051/superpokemon/es/images/1/1e/Button_subindice.png",
     "speedTip": "Subíndice",
     "tagOpen": "<sub>",
     "tagClose": "Texto con subindice",
     "sampleText": "</sub>"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/__cb20101127164051/superpokemon/es/images/4/4f/Button_superindice.png",
     "speedTip": "Superíndice",
     "tagOpen": "<sup>",
     "tagClose": "Texto con superindice",
     "sampleText": "</sup>"};

mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/__cb20101127164052/superpokemon/es/images/3/3d/Button_tachar.png",
     "speedTip": "Texto tachado",
     "tagOpen": "<s>",
     "tagClose": "Texto tachado",
     "sampleText": "</s>"};
}
}
