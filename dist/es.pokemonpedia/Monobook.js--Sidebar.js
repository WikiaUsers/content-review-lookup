...
*/
wgSidebar['Proyectos'] = [
        'Proyecto:Fakémon|Proyecto Fakémon',
        'Proyecto:Sprites|Proyecto Sprites',
        'Proyecto:Noticias|Proyecto Noticias',
        'PW:PD|Pokémon Destacado',
];
wgSidebar['Reversores'] = [
        'Usuario:Andrea444|Andrea444',
];
