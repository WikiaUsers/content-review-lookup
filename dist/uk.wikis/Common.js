...
var ajaxPages = ["Спеціальна:Watchlist","Спеціальна:Contributions","Спеціальна:WikiActivity","Спеціальна:RecentChanges"]; //
var AjaxRCRefreshText = 'Автооновлення'; //
var AjaxRCRefreshHoverText = 'Включити автооновлення сторінки'; //

/* ################################################## */
/* ### Вставка імені користувача ### */
/* ################################################## */
...
/* Сторінка свіжих правок з декількох вікі */
importArticles({
    type: "script",
    articles: [
...
//Імпорт EditIntroButton
EditIntroButtonText = 'Редагувати преамбулу';
