...
if (mw.config.get('wgCanonicalSpecialPageName') === 'Upload') {
	$(function ($) {
		...
		if (!(/(?:^\?|&)wpForReUpload=(?:[^0&]|0[^&])/).test(window.location.search)) {
			...
			rows.eq(1).after('<tr><td class="mw-label" style="width: 125px;">Source:</td><td class="mw-input"><textarea id="sourceBox" placeholder="Where this is from, the exact chapter or episode number." required="true" cols="60" rows="2" style="overflow: auto;"></textarea></td></tr>');
