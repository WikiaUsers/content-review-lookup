...
var UserWikiInfo = {
	tmpl: '<div id="UserWikiInfo"><div class="useravatar"><a href="/wiki/Usuario:{u}" title="Avatar de {U}"><img src="https://images.wikia.nocookie.net/__cb20081128203240/messaging/images/thumb/1/19/Avatar.jpg/50px-Avatar.jpg" width="75" height="75" alt="Avatar" /></a>{editavatar}</div>' +
		'<span class="userlink"><a href="/wiki/Usuario:{u}" title="{u}">{U}</a></span> &#124; <span class="talklink"><a href="/wiki/Usuario_Discusión:{u}" title="Discusión de {u}">Discusión</a> <a href="/index.php?title=Usuario_Discusión:{u}&amp;action=edit&amp;section=new" title="Dejar un nuevo mensaje en la página de discusión">[+]</a></span> &#124; <span class="bloglink"><a href="/wiki/Usuario_Blog:{u}" title="Blog de {u}">Blog</a></span>{email} &#124; <span class="contribslink"><a href="/wiki/Especial:Contribuciones/{u}" title="Contribuciones de usuario">Contribuciones</a></span>{group}'+
		'<div class="contribdetails"></div></div>',
	emailtmpl: ' &#124; <span class="emaillink"><a href="/wiki/Especial:MandarEmailUsuario/{u}" title="Enviar correo electrónico a usuario">Email</a></span>',
	...
	groupseparator: ', ',
	groups: {
		bureaucrat: '<a href="/wiki/Vocaloid Wiki:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Vocaloid Wiki:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Vocaloid Wiki:Reversores">reversor</a>',
		asistente: '<a href="/wiki/Vocaloid Wiki:Asistentes">asistente</a>'
	},
