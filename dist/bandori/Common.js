...
window.UserTagsJS = {
	...
	tags: {
		fuee: 'Fuee Fuee Time',
		chooco: 'Gazumi',
		autoconfirmed: 'BanG Dreamer',
		newuser: 'New BanG Dreamer',
...
UserTagsJS.modules.custom = {
	...
	'Choocolatiah': ['chooco'],
	'Isovas': ['transcripter'],
	'NikkiBunny816': ['transcripter', 'unordinary'],
};
...
window.MessageWallUserTags = {
    ...
    users: {
        'Suichune': 'Founder',
        'Choocolatiah': 'Administrator',
        'Kagerou98': 'Administrator',
        'SharingIiiisCaring': 'Administrator',
        'Airujou': 'Content Moderator',
        'Tinoke97': 'Content Moderator',
        'Happ1nessN0te': 'Content Moderator',
        'Isovas': 'Content Moderator',
        'Aceticke': 'Content Moderator',
    }
};
...
// source and all audio file params are optional
