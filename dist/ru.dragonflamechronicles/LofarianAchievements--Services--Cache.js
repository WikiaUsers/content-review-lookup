...
Страница Fandom: MediaWiki:LofarianAchievements/Services/Cache.js

НАЗНАЧЕНИЕ ЭТОГО ФАЙЛА
Общее состояние runtime и техническое клиентское кэширование для уменьшения повторных вычислений.

ДАННЫЕ / I/O
Клиентский кэш не является доверенным источником официальных достижений.
...
(function (root) {
    ...
    if (!I) { throw new Error('[Lofarian Achievements] Runtime отсутствует: Services/Cache'); }
    I.state = {
        catalogCache: null,
        segmentCache: {},
        userResolveCache: {},
        ...
        progressSegmentCache: {},
        editorStatsCache: {},
        discussionStatsCache: {},
        globalRecentChangesCache: null,
        globalRecentChangesCacheAt: 0,
        ...
        currentOfficialProgress: null,
        currentProgressReady: null,
        readingTrackerStarted: false,
        currentProgressSyncPromise: null,
        currentHallRankAwardSyncPromise: null,
        currentGivenLikeSyncPromise: null,
        pendingGivenLikeIncrements: 0,
        pendingGivenLikeBootstrap: false
    };
    I.registerModule('Services/Cache', { stateKeys: Object.keys(I.state) });
})(window);