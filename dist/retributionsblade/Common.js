...
// Display 12 hour time followed by day, month (English, short name)
// and year with "(UTC)" at the end
window.DisplayClockJS = {
    format: '%2d %b %Y %2I:%2M:%2S%p',
    location: 'header',
    hoverText: 'Click to purge page from the server cache',
    interval: 500, /* How often the timer updates in milliseconds (1000=1second) */
    monofonts: 'Lucida Console, Consolas, monospace' /* The font the clock uses by default */
};
