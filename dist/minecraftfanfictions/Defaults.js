...
//======================================================================  
// Apester Polls (based on VideoIntegrator script by Deadcoder)
//======================================================================
...
(function() {
    if (window.FacebookLikeBoxLoaded) {
        return;
    }
    window.FacebookLikeBoxLoaded = true;
    importScriptURI('https://connect.facebook.net/en_GB/all.js');
})();