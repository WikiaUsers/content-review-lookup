...
/** Variables "globales" (preservadas entre sesiones de edición) **/
var i18n = {
	blockedNotice: 'No puedes editar este sprite porque has sido bloqueado.',
	blockedReason: 'Motivo: $1',
	browserActionNotSupported: 'No soportado por tu navegador.',
	changesSavedNotice: 'Tus cambios fueron guardados.',
	controlNewName: 'Nuevo nombre',
	ctxDeleteImage: 'Borrar',
	ctxDownloadImage: 'Descargar',
	ctxReplaceImage: 'Reemplazar',
	diffError: 'No se pudo cargar la diferencia',
	diffErrorMissingPage: 'No se pudo cargar la página',
	dupeName: 'Este nombre ya existe.',
	dupeNamesNotice: 'Hay nombres duplicados que deben corregirse antes de guardar.',
	errorApi: 'Error de API',
	errorConnection: 'Error de conexión',
	errorConnectionText: 'Comprueba tu conexión a internet',
	errorGeneric: 'Error',
	errorHttp: 'Error de HTTP',
	...
	noPermissionNotice: 'No tienes permiso para editar este sprite.',
	panelChangesIdTitle: 'Cambios de datos',
	panelChangesNoDiffFromCur: 'Sin cambios desde la revisión actual.',
	panelChangesSheetTitle: 'Cambios en la hoja de sprites',
	panelChangesTitle: 'Revisa tus cambios',
	panelCloseTip: 'Cerrar',
	panelConflictCurText: 'Texto actual',
	panelConflictReview: 'Revisar cambios',
	panelConflictSave: 'Guardar',
	panelConflictText: 'Se produjo un conflicto de edición y no se pudo resolver automáticamente.',
	panelConflictTitle: 'Conflicto de edición',
	panelConflictYourText: 'Tu texto',
	panelDiscardContinue: 'Continúa editando',
	panelDiscardDiscard: 'Descartar cambios',
	panelDiscardText: '¿Estás seguro de que deseas descartar tus cambios?',
	panelDiscardTitle: 'Cambios sin guardar',
	panelEcchangesReturn: 'Volver al formulario de edición de conflictos',
	panelEcchangesTitle: 'Revisa tus cambios manuales',
	sectionPlaceholder: 'Ingresa un nombre de sección',
	sectionUncategorized: 'Sin categorizar',
	titleEditing: 'Edición de sprite de «$1»',
	toolbarHelp: 'Ayuda',
	toolbarHelpPage: 'Ayuda:Editor de sprites',
	toolbarNewImage: 'Imagen',
	toolbarNewSection: 'Sección',
	toolbarRedo: 'Rehacer',
	toolbarReviewChanges: 'Mostrar cambios',
	toolbarSave: 'Guardar',
	toolbarSummaryLabelTip: 'El número de bytes restantes',
	toolbarSummaryPlaceholder: 'Resume los cambios que hiciste',
	toolbarToolDeprecate: 'Descontinuar nombre',
	toolbarToolDeprecateTip: 'Marca un nombre de sprite como obsoleto y descontinúa su uso',
