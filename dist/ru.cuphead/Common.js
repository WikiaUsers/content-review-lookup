/*Скрипт альтернативного виджета Discord*/
$(function () {
                ...
                '<tr>' +
                    ...
                    '</td>' +
                      '<td style="vertical-align:middle; width:90px;">' +
                        '<center>' +
                            '<img alt="Discord" src="https://vignette.wikia.nocookie.net/cuphead/images/4/4f/Casino.png/revision/latest?cb=20190220200803&path-prefix=ru" class="discord-icon">' +
                            '<span>В сети: <span id="discord-counter">?</span></span>' +
                            '<button class="discord-joined">Войти в казино Дьявола</button>' +
                        '</center>' +
                      '</td>' +
                '</tr>' +
                '<tr>' +
