$(function() {
    ...
    var lis;
    var intro = "Howdy " + wgUserName + "! Welcome to the hub for managing unpatrolled edits. Here, you can see all edits that have not been patrolled by an administrator or content moderator. This feed doesn't show edits by any of the afformentioned groups; and only shows edits within the main namespace.";
    ...
    function updateTable() {
        $.getJSON(request).done(function(data) {
            ...
            lis.append('<tr><th colspan="5" style="font-size:9px;">Version 0.1 &middot; Original Authority & Fngplg &middot; <a href=\"http://originalauthortiy.wikia.com/wiki/User_talk:Original_Authority\">Suggest Changes</a></th></tr>');
