...
window.UserTagsJS = {
    ...
    tags: {
        ...
        bureaucrat: { u: 'Red Dust Immortal', order: 2 },
        'former-bureaucrat': { u: 'Retired Bureaucrat', order: 3 },
        sysop: { u: 'Great Emperor', order: 4 },
        'former-sysop': { u: 'Retired Administrator', order: 5 },
        'bot-global': { u: 'Global Bot', order: 6 },
        bot: { u: 'Bot', order: 7 },
        'content-moderator': { u: 'Content Moderator', order: 10 },
        threadmoderator: { u: 'Thread Moderator', order: 11 },
