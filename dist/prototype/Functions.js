...
/*
    ...
    from Wookieepedia, largely created by [[starwars:user:Sikon]].  
    See [[starwars:user talk:Sikon/Archive3#How can I implement your Preload system at the Christian Music Wiki]] 
    for more information.  Though paced here mainly for
    its functionality with respect to preloads, 
     it can do much more than that.
*/

/*
    This global variable specifies if 
    client-side persistent storage is available. 
    Currently, only Firefox 2 supports this specification. 
    On Wookieepedia, this global storage is used 
    to store information about which infoboxes are hidden.
*/
...
/*
    Searches an array for an element and 
    returns its index, or -1 if it's not in the array.
*/
...
/*
    ...
    element in an array, if it is there.
*/
...
/*
    Returns the parameter as it appears in the 
    query string. Equivalent to $_GET[p] in PHP.
*/
...
/*
    Dynamically load a combobox's content by 
    pagename (e. g. Template:Stdsummaries)
...
/*
    Loads the current source of the page 
   "pagename" (as stored in the database)
...
/*
    Returns the element's nearest parent 
...
/*
    Makes the image on the search form, 
    if one is present, point to the search page
