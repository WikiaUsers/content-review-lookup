...
window.ajaxPages = ["Special:NewPages", "Special:ListFiles", "Sonako_New_Pages", "Sonako_Real-Time_Feed"];
...
importArticles({
    ...
    articles: [
        ...
        'u:sonako:MediaWiki:Common.js/Skin_Switch_Button.js',
        ...
        'u:sonako:MediaWiki:PowerPageMaker.js',
...
if (mediaWiki.config.get('wgPageName') === 'ko_co_gi') {
    impart('MediaWiki:Rss.js');
}
if (mediaWiki.config.get('wgPageName') === 'PW_Statistics') {
