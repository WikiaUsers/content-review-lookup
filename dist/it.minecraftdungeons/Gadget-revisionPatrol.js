...
$( function() {
	var i18n = {
		autopatrolled: 'Autopattugliata',
		// $1 is the user, $2 is the timestamp
		patrolled: 'Pattugliata da $1 ($2)',
		unpatrollable: 'Non pattugliabile',
		unpatrolled: 'Spattugliata',
		autopatrolledLegend: 'modifica autopattugliata',
		patrolledLegend: 'modifica pattugliata',
		unpatrollableLegend: 'modifica non pattugliabile',
		unpatrolledLegend: 'modifica spattugliata',
		error: 'Impossibile ricevere informazioni sul pattugliamento',
		rightsError: 'Impossibile ricevere diritti di autopattugliamento',
		errorTitle: 'Pattugliamento revisioni',
	};
