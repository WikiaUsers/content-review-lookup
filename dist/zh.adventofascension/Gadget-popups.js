...
// **                Chinese translator: Angrydog001                   **
// **                                                                  **
// **********************************************************************
/* eslint-env browser  */
...
function popupFilterLastModified(data,download) {
	...
	if (lastmod && getValueOf('popupLastModified')) {
		return (tprintf('%s前编辑', [formatAge(age)])).replace(RegExp(' ','g'), '&nbsp;');
	}
	return '';
}
...
function APIcategoryPreviewHTML(article, download) {
	try{
		...
		ret = '<h2>' + tprintf('分类页面 (共%s条)', [ret.length]) + '</h2>' +linkList(ret);
...
pg.string = {
	...
	'weeks': '周',
	'search': '搜索',
	'SearchHint': '查找含有%s的英语维基百科条目',
	'web': '站点',
	'global': '全域',
	'globalSearchHint': '以不同语言在维基百科上搜索%s',
	'googleSearchHint': '用Google搜索%s',
	/////////////////////////////////////
	// article-related actions and info
	// (some actions also apply to user pages)
	/////////////////////////////////////
	'actions': '操作',		 ///// view articles and view talk
	'popupsMenu': 'Popups',
	...
	'more...': '更多……',
	'disable': '禁用Popups',
	'disablePopupsHint': '在此页面禁用Popups。重新载入会重新启用Popups。',
	'historyfeedHint': '最近对此页面修改的RSS源',
	'purgePopupsHint': '重置Popups，清除所有Popups的缓存数据。',
	'PopupsHint': '重置Popups，清除所有Popups的缓存数据。',
	'spacebar': '空格',
	'view': '查看',
	'view article': '查看条目',
	'viewHint': '前往%s',
	...
	'Revision %s of %s': '页面$2的修订版本$1',
	'the revision prior to revision %s of %s': '前于页面$2的修订版本$1的修订版本',
	'Toggle image size': '点击切换图片大小',
	'del': '删',				 ///// delete, protect, move
	'delete': '删除',
	'deleteHint': '删除%s',
	'undeleteShort': '反',
	'UndeleteHint': '显示%s的删除历史',
	'protect': '保护',
	'protectHint': '编辑权限限制为%s',
	'unprotectShort': '解',
	'unprotectHint': '允许%s能被所有人编辑',
	'send thanks': '发送感谢',
	'ThanksHint': '向用户发送感谢通知',
	'move': '移动',
	'move page': '移动页面',
	...
	'new': '新',
	'new topic': '新话题',
	'newSectionHint': '在%s开始新章节',
	'null edit': '空编辑',
	'nullEditHint': '做出一次对%s的空编辑',
	'hist': '史',			   ///// history, diffs, editors, related
	'history': '历史',
	'historyHint': '%s的修订历史',
	'last': '之前', // For labelling the previous revision in history pages; the key is "last" for backwards compatibility
	'lastEdit': '最近更改',
	'mark patrolled': '标记编辑已巡查',
	'markpatrolledHint': '标记编辑已巡查',
	'Could not marked this edit as patrolled': '未能标记此编辑为已巡查',
	'show last edit': '最近一次更改',
	'Show the last edit': '显示最近一次更改的差异',
	'lastContrib': '最近编辑',
	'last set of edits': '最近编辑',
	'lastContribHint': '显示由最后一位编者造成的差异',
	'cur': '当前',
	'diffCur': '与当前版本的差异',
	'Show changes since revision %s': '显示从修订版本%s开始的更改',
	'%s old': '%s之前', // as in 4 weeks old
	'oldEdit': 'oldEdit',
	'purge': '刷新',
	...
	'sinceMe': 'sinceMe',
	'changes since mine': '我的编辑差异',
	'sinceMeHint': '显示自我上次修改以来的差异',
	'Couldn\'t find an edit by %s\nin the last %s edits to\n%s': '在$3最近$2次编辑中找不到$1做出的修改',
	'eds': '编辑',
	'editors': '编者',
	'editorListHint': '列出编辑%s的用户',
	'related': '相关',
	'relatedChanges': '相关更改',
	'related changes': '相关更改',
	'RecentchangeslinkedHint': '显示%s条目的相关更改',
	'editOld': 'editOld',		  ///// edit old version, or revert
	'rv': '退',
	'revert': '回退',
	'revertHint': '回退到%s',
	'defaultpopupReviewedSummary': '导航Popup：Accepted by reviewing the [[Special:diff/%s/%s|difference]] between this version and previously accepted version',
	'defaultpopupRedlinkSummary': '导航Popup：移除空页面的链接[[%s]]',
	'defaultpopupFixDabsSummary': '导航Popup：对[[%s]]消歧义到[[%s]]',
	'defaultpopupFixRedirsSummary': '导航Popup：忽略从[[%s]]到[[%s]]的重定向',
	'defaultpopupExtendedRevertSummary': '导航Popup：回退到于%s由%s做出的oldid为%s修订版本',
	'defaultpopupRevertToPreviousSummary': '导航Popup：回退到前于%s的修订版本',
	'defaultpopupRevertSummary': '导航Popup：回退到修订版本%s',
	'defaultpopupQueriedRevertToPreviousSummary': '导航Popup：回退到由$3于$2做出的前于$1的修订版本',
	'defaultpopupQueriedRevertSummary': '导航Popup：回退到由$3于$2做出的修订版本$1',
	'defaultpopupRmDabLinkSummary': '导航Popup：移除到消歧义页[[%s]]的链接',
	'Redirects': '重定向', // as in Redirects to ...
	' to ': '至',		   // as in Redirects to ...
	'Bypass redirect': '忽略重定向',
	'Fix this redirect': '修复重定向',
	'disambig': '消歧义',		  ///// add or remove dab etc.
	'disambigHint': '对此链接消歧义至[[%s]]',
	'Click to disambiguate this link to:': '点击以消歧义这个链接到：',
	'remove this link': '移除链接',
	'remove all links to this page from this article': '移除此条目到此页面的所有链接',
	'remove all links to this disambig page from this article': '移除此条目到此消歧义页的所有链接',
	'mainlink': '主链接',		  ///// links, watch, unwatch
	'wikiLink': '链接',
	'wikiLinks': '链接',
	'links here': '链入',
	'whatLinksHere': '链入页面',
	...
	'watchHint': '加入%s到我的监视列表',
	'unwatchHint': '从我的监视列表移除%s',
	'Only found one editor: %s made %s edits': '仅找到一位编者：%s做出了%s次编辑',
	'%s seems to be the last editor to the page %s': '%s看上去是%s页面的最后一位编者',
	'rss': 'RSS',
	/////////////////////////////////////
	// diff previews
	/////////////////////////////////////
	'Diff truncated for performance reasons': '因性能原因缩短差异',
	'Old revision': '旧版本',
	'New revision': '新版本',
	'Something went wrong :-(': '情况不妙 :-(',
	'Empty revision, maybe non-existent': '空白版本，或许不存在',
	'Unknown date': '未知日期',
	/////////////////////////////////////
	// other special previews
	/////////////////////////////////////
	'Empty category': '空分类',
	'Category members (%s shown)': '分类成员（已显示%s）',
	'No image links found': '图像链接未找到',
	'File links': '链入页面',
	'No image found': '图像未找到',
	'Image from Commons': '来自共享资源的图像',
	'Description page': '描述页面',
	'Alt text:': 'Alt文本：',
	'revdel':'隐藏版本',
	/////////////////////////////////////
	...
	'user&nbsp;page': '用户页',
	'user talk': '用户讨论页',
	'edit user talk': '编辑用户讨论页',
	'leave comment': '留言',
	'email': '电邮',
	'email user': '电邮联络用户',
	'EmailUserHint': '向%s发送电子邮件',
	'space': 'space', // short form for userSpace link
	'PrefixIndexHint': '显示%s的用户空间页面',
	'count': '总共',			 ///// contributions, log
	'edit counter': '编辑数',
	'editCounterLinkHint': '统计%s的用户贡献',
	'contribs': '贡献',
	'contributions': '贡献',
	'deletedContribs': '被删除的用户贡献',
	'DeletedcontributionsHint': '列出%s的被删除编辑',
	'ContributionsHint': '列出%s的用户贡献',
	'log': '日志',
	'user log': '用户日志',
	'userLogHint': '显示%s用户日志',
	'arin': 'ARIN查找',			 ///// ARIN lookup, block user or IP
	...
	'pageLogHint': '显示%s的页面日志',
	'deleteLogHint': '显示%s的删除日志',
	'Invalid %s %s': '%s为无效选项：%s',
	'No backlinks found': '反向链接未找到',
	' and more': '及更多',
	'undo': '撤销',
	'undoHint': '撤销编辑',
	'Download preview data': '下载预览数据',
	'Invalid or IP user': '无效的IP地址用户',
	'Not a registered username': '未注册用户名',
	'BLOCKED': '已封禁',
	' edits since: ': ' 编辑自：',
	'last edit on ': '最近编辑于：',
	/////////////////////////////////////
