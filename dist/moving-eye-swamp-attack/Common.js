...
$(function() {
    if ($('#awwbadgeform').length) {
        $('#awwbadgeform').html('<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSew5BnteAXcdXblOGecxcMukoCyIIy7uh8kkssT61n-5ZMyzA/viewform?embedded=true" width="760" height="1105" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>');
    }
});