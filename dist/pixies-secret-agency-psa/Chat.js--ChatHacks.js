...
/*
 * ChatHacks.js, by Monchoman45. Modified by AWikiBoy521.
 * Version 7.0
 *
 * Features:
 ...
 *   Pings, with the coin sound from Plants vs. Zombies, when someone mentions your name or any other specified phrases
 */
                        ...
                        for(var i = 0; i < pings.length; i++) {
                                if(text.toLowerCase().indexOf(pings[i].toLowerCase()) != -1 || this != mainRoom.viewDiscussion) {
                                        if(!window.hasFocus) { //Only annoy people if the window isn't focused
                                                document.getElementById('sound').innerHTML = '<audio src="https://vignette.wikia.nocookie.net/pixies-secret-agency-psa/images/4/4d/Treasure_chestpingsound.ogg/revision/latest?cb=20160103204435" autoplay=""></audio>';
