    ...
    '</div>';
        ...
        var fullSliderHtml = styleHtml +
            ...
            '<div class="cyber-slider-container" style="position: relative; width: 100%; overflow: hidden; background: #0c0d12; border: 2px solid var(--slider-accent); margin: 15px 0; box-shadow: 0 0 15px rgba(var(--slider-accent-rgb), 0.15); font-family: sans-serif; transition: border-color 0.3s ease, box-shadow 0.3s ease;">' +
                ...
                '<div class="slider-bottom-bar" style="position: absolute; bottom: 0; left: 0; width: 100%; background: rgba(7, 8, 12, 0.9); border-top: 2px solid var(--slider-accent); display: flex; justify-content: space-between; align-items: center; padding: 52px 20px; box-sizing: border-box; z-index: 10; gap: 20px; transition: border-color 0.3s ease;">' +

                    '<div class="caption-text" style="flex: 1; min-width: 0;">' +

                        '<h4 style="margin: 10 0 3px 0; color: #ffffff; font-size: 16px; font-weight: bold; letter-spacing: 0.5px; text-transform: uppercase;">' + mw.html.escape(initialPage.title.toUpperCase()) + '</h4>' +

                        '<p style="margin: 10 0 4px 0; color: #cbd5e1; font-size: 13px; line-height: 1.4; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">' + mw.html.escape(initialPage.desc) + '</p>' +
