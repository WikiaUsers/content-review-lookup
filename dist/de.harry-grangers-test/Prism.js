/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript&plugins=toolbar+highlight-keywords+copy-to-clipboard */
            ...
            e: for (var l in t)
                if (t.hasOwnProperty(l) && t[l]) {
                    ...
                    for (var s = 0; s < o.length; ++s) {
                        ...
                        u = u.pattern || u;
                        for (var m = 0, y = 0; m < r.length; y += r[m].length,
                        ++m) {
                            var v = r[m];
                            ...
                            if (!(v instanceof a)) {
                                ...
                                if (!b && h && m != r.length - 1) {
                                    ...
                                    !b)
                                        break;
                                    for (var w = b.index + (c ? b[1].length : 0), _ = b.index + b[0].length, A = m, P = y, j = r.length; j > A && _ > P; ++A)
                                        P += r[A].length,
                                        w >= P && (++m,
                                        y = P);
...
!function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        if (!o) {
            ...
            ,
            t.src = "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.5.8/clipboard.min.js",
            n.appendChild(t)
        }
