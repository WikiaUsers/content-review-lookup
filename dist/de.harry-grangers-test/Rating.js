/*********************************************************\
  Rating system
  This javascript allows you to use simple ratings in your
  wiki. With it the user is able to just click on an item
  or text to provide opinion.
 
  (c) 2015-2016 - 20M61 (TWD-Wikia)
  idea: http://de.community.wikia.com/wiki/Diskussionsfaden:64256
\*********************************************************/
 
/* util functions */
/** JSON utils **/
/**
* @param q {object} data to send with this request
* @param fn {function} callback function on success
*/
...
/**
* @param page {object} current page name (`wgPageName`)
* @param fn {function} callback function on success
*/
