...
$(function() {
    ...
    catnav.data = {
        ...
        selectedPage: null,
        storage: {
            url: "https://kenrori.fandom.com/vi", // url to the wiki that hosts your imports
    ...
    catnav.data.markup.html = '<nav id="catnav">\n' +
        ...
        '\t\t\t\t<option value="Idle Projects" title="Tập hợp các Project trên Kenrori đã không được cập nhật trong 3 tháng qua.">Idle Projects</option>\n' +
        '\t\t\t\t<option value="Stalled Projects" title="Tập hợp các Project trên Kenrori đã không được cập nhật trong 6 tháng qua.">Stalled Projects</option>\n' +
        '\t\t\t\t<option value="Inactive Projects" title="Tập hợp các Project trên Kenrori đã không được cập nhật trong hơn 12 tháng qua.">Inactive Projects</option>\n' +
        ...
        '\t\t\t\t<option value="Full Text" title="Tập hợp các trang Toàn tập (dịch/viết trọn vẹn 1 tập) của các bộ Light Novel trên Kenrori.">Full Text</option>\n' +
        '\t\t\t\t<option value="Minh họa" title="Tập hợp các trang minh họa trên Kenrori Wiki.">Minh họa</option>\n' +
        '\t\t</select>\n' +
        ...
        '\t\t\t\t<option value="Mature content" title="Tập hợp các trang có thể có nội dung nhạy cảm.">Mature content</option>\n' +
        '\t\t\t\t<option value="Full Text" title="Tập hợp các trang Toàn tập (dịch/viết trọn vẹn 1 tập) của các bộ Light Novel trên Kenrori.">Full Text</option>\n' +
        '\t\t\t\t<option value="Minh họa" title="Tập hợp các trang minh họa trên Kenrori Light Novel Wiki.">Minh họa</option>\n' +
        '\t\t</select>\n' +
    ...
    if (mw.config.get("wgNamespaceNumber") === -1 && mw.config.get("wgTitle") == "CatNav") {
        ...
        $("body").append(
            ...
            '\t\t\tTrong trường hợp bạn đã tạo trang Lưu thể loại yêu thích của mình trước đó, bạn có thể bỏ qua dòng chữ @kenrori phía dưới, chỉ cần sao chép lại những dòng thể loại muốn lưu ở sau.\n' +
            '\t\t</p>\n' +
        ...
        $("head title").html("Tìm Kiếm Nâng Cao | Kenrori Wiki");
