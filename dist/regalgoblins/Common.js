    ...
    window.formatGoogleCalendar = function () {
        var e, t = function (e, t) {
                ...
                n = e.items.filter(function (e) {
                    return e && e.hasOwnProperty("status") && "cancelled" !== e.status
                }).sort(l).reverse();
                var r, a = 0,
                    o = 0,
                    u = [],
                    ...
                    d = document.querySelector(t.pastSelector); - 1 === t.pastTopN && (t.pastTopN = n.length), -1 === t.upcomingTopN && (t.upcomingTopN = n.length), !1 === t.past && (t.pastTopN = 0), !1 === t.upcoming && (t.upcomingTopN = 0);
                for (r in n) s(n[r].end.dateTime || n[r].end.date) ? a < t.pastTopN && (u.push(n[r]), a++) : m.push(n[r]);
                m.reverse();
                for (r in m) o < t.upcomingTopN && (c.push(m[r]), o++);
                for (r in u) d.insertAdjacentHTML("beforeend", i(u[r], t.itemsTagName, t.format));
                for (r in c) p.insertAdjacentHTML("beforeend", i(c[r], t.itemsTagName, t.format));
                p.firstChild && p.insertAdjacentHTML("beforebegin", t.upcomingHeading), d.firstChild && d.insertAdjacentHTML("beforebegin", t.pastHeading)
            },
            n = function (n) {
                e = n;
                var r = n.calendarUrl;
                n.recurringEvents && (r = r.concat("&singleEvents=true&orderBy=starttime")), n.timeMin && (r = r.concat("&timeMin=" + n.timeMin)), n.timeMax && (r = r.concat("&timeMax=" + n.timeMax));
            ...
            a = function (e, t) {
                for (var n = g(t), r = !0, a = 0; a < 3; a++) e[a] !== n[a] && (r = !1);
                return r
            },
            o = function (e, t) {
                for (var n = !0, r = 0; r < 3; r++) e[r] !== t[r] && (n = !1);
                return n
            },
            i = function (t, n, r) {
            ...
            u = function (e) {
                return e = new Date(e), [e.getDate(), e.getMonth(), e.getFullYear(), e.getHours(), e.getMinutes(), 0, 0]
            },
            c = function (e) {
            ...
            v = function (t, n, r, a, o) {
                var i = "",
                    s = "";
                return r && (s = d(t)), !e.sameDayTimes || a || o || (i = " from " + N(t) + " - " + N(n)), s + c(t[1]) + " " + t[0] + ", " + t[2] + i
            },
            T = function (e, t, n) {
                var r = "",
                    a = "";
                return n && (r = d(e), a = d(t)), r + c(e[1]) + " " + e[0] + "-" + a + t[0] + ", " + e[2]
            },
            y = function (e, t, n) {
                var r = "",
                    a = "";
                return n && (r = d(e), a = d(t)), r + c(e[1]) + " " + e[0] + "-" + a + c(t[1]) + " " + t[0] + ", " + e[2]
            },
            M = function (e, t, n) {
                var r = "",
                    a = "";
                return n && (r = d(e), a = d(t)), r + c(e[1]) + " " + e[0] + ", " + e[2] + "-" + a + c(t[1]) + " " + t[0] + ", " + t[2]
            },
            h = function (e, t, n, r, a) {
                return e[0] === t[0] ? e[1] === t[1] ? e[2] === t[2] ? v(e, t, n, r, a) : M(e, t, n) : e[2] === t[2] ? y(e, t, n) : M(e, t, n) : e[1] === t[1] ? e[2] === t[2] ? T(e, t, n) : M(e, t, n) : e[2] === t[2] ? y(e, t, n) : M(e, t, n)
            },
            N = function (e) {
                var t = "AM",
                    n = e[3],
                    r = e[4];
                return n >= 12 && (t = "PM", n >= 13 && (n -= 12)), 0 === n && (n = 12), r = (r < 10 ? "0" : "") + r, n + ":" + r + t
            };
        return {
            init: function (e) {
                var t = {
...
//START - GOOGLE CALENDAR - INITIALISATION & PARAMETERS
if ($('body').hasClass('skin-fandomdesktop')) {
    formatGoogleCalendar.init({
        calendarUrl: 'https://www.googleapis.com/calendar/v3/calendars/llul38k76a4issdc2rqf8g2unc@group.calendar.google.com/events?key=AIzaSyBADUV8x9CWpF-KxCaF2GynEsNLlHJiieE',
        past: false,
        upcoming: true,
        pastTopN: 20,
        upcomingTopN: 20,
        ...
        upcomingHeading: '',
        pastHeading: '',
        format: ['<strong>', '*date*', '</strong>: ', '*summary*', ' &mdash; ', '*description*', ' in ', '*location*']
    });
}
//START - GOOGLE CALENDAR - INITIALISATION & PARAMETERS