...
window.lastEdited = {
    ...
    pages: ["The_Caster_Chronicles_Wiki"]
};
// END Last edit details on articles

//// Additional customization for LastEdited
addOnloadHook(function() {
  ...
  span.filter(':contains("Current size")').prependTo(".lastEdited").css('display','block');
});
//// Engineered by User:Ohmystar
