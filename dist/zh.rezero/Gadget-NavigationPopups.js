(function($, mw) {
    ...
    window.popupStrings = {
        ...
        /////////////////////////////////////
        'actions': wgULS('操作', '操作'), ///// view articles and view talk
        ...
        'last': wgULS('最近', '最近'),
        'lastEdit': wgULS('最近更改', '近期變更'),
        'show last edit': wgULS('最近一次更改', '最新變更'),
        'Show the last edit': wgULS('显示最近一次更改的差异', '顯示最新變更的差異'),
        ...
        '%s old': wgULS('%s 前的最后版本', '%s 前的最後版本'), // as in 4 weeks old
        ...
        'related': wgULS('相关', '相關'),
        'relatedChanges': wgULS('相关更改', '相關變更'),
        'related changes': wgULS('相关更改', '相關變更'),
        ...
        'defaultpopupFixRedirsSummary': wgULS('忽略从[[%s]]到[[%s]]的重定向', '忽略從[[%s]]到[[%s]]的重新導向'),
        ...
        'PrefixindexHint': wgULS('显示 %s 的用户页子页面', '顯示 %s 的使用者頁面子頁面'),
        ...
        'Look up %s in ARIN whois database': wgULS('在 ARIN Whois 数据库中查询 %s', '在 ARIN Whois 資料庫中查詢 %s'),
        'unblockShort': wgULS('解除', '解除'),
        'block': wgULS('封禁', '封鎖'),
        'block user': wgULS('封禁用户', '封鎖使用者'),
        ...
        "Image from Commons": wgULS("来自维基共享的图片", "來自維基共享的圖片"),
        "Description page": wgULS("图片描述页", "圖片描述頁"),
        "Alt text:": wgULS("替换文本（Alt）：", "替代文字（Alt）："),
        ...
        "Invalid user": wgULS("非法用户名", "無效使用者名稱"),
        "diff": wgULS("差异", "差異"),
        " to ": wgULS("至", "至"),
    ...
    $(function() {
        // mw.loader.load('//rezero.fandom.com/zh/wiki/index.php?title=MediaWiki:Gadget-popups-main.js&action=raw&ctype=text/javascript');
    });
})(jQuery, mediaWiki);

/* Gadget-popups-main.js */
/*
