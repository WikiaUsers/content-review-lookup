...
for( key in localizedMainPageTitles )
{
...
if (wgNamespaceNumber < 2 && localizedMainPageTitles[wgTitle])
{
 ...
 {
  appendCSS("#firstHeading, #t-ajaxquickdelete, #siteNotice { display: none; }");
 }
}
...
function suggestMainpageLang()
{
 ...
 if( mwb )
 {
  ...
  {
   mwb.innerHTML += '<br/><img src="http://bits.wikimedia.org/skins-1.5/common/images/redirectltr.png">'
                  + '<span class="redirectText"><a href="/wiki/' + page + '">' + page +'</a></span>';
  }
 }
}
