...
// Get user's ids
    ...
    function getContentMods() {return [
        /**
         * Bots
         * 
         * This function populates an array with the
    ...
    var $contentModsOnlineContainer = document.createElement("div");
    $($contentModsOnlineContainer)
        .addClass("widget-role-container")
        .appendTo($widgetBodyUsers);
 
    var $contentModsOnlineTitle = document.createElement("div");
    $($contentModsOnlineTitle)
        .addClass("widget-role-name-contentmods")
        .text("Content Moderators")
        .appendTo($contentModsOnlineContainer);
    ...
    var contentmods = getContentMods();
    ...
    for (var i = 0; i < membersOnline; i++) {
        ...
        .appendTo($bureausOnlineContainer);} 
        else if (admins.includes(member.id)) {$(createWidgetMember(member))
        .appendTo($adminsOnlineContainer);}
        else if (contentmods.includes(member.id)) {$(createWidgetMember(member))
        .appendTo($contentModsOnlineContainer);} 
    ...
    $($widgetFooterText)
        ...
        .append("Be sure to read the #rules before participating in the server.")
    ...
    function createWidgetMember(member) {
        ...
        else {$rail.append($railModuleSection);}}
    ...
    $('.CustomDiscordIntegrator').each(function () {
        ...
        $($containerTitle).append("Pet Simulator");
