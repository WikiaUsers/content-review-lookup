...
$(document).ready(function() {
    /* Create inputs */
	$("span#builderBoostHarness").html('<div id="builderBoostInput">Ускорение Построек: <select name="builderBoost" id="builderBoost"> <option value="0">0</option> <option value="10">10</option> <option value="15">15</option> <option value="20">20</option> </select> %</div>');
	$("span#trainingBoostHarness").html('<div id="trainingBoostInput">Ускорение Тренировок: <select name="trainingBoost" id="trainingBoost"> <option value="0">0</option> <option value="10">10</option> <option value="15">15</option> <option value="20">20</option> <option value="30">30</option> </select> %</div>');
	$("span#researchBoostHarness").html('<div id="researchBoostInput">Ускорение Улучшений: <select name="researchBoost" id="researchBoost"> <option value="0">0</option> <option value="10">10</option> <option value="15">15</option> <option value="20">20</option> <option value="30">30</option> </select> %</div>');
	$("span#armyBoostHarness").html('<div id="armyBoostInput">Активировать ускорение армии? <input type="checkbox" name="armyBoost" id="armyBoost"></input></div>');
	$("span#freezeHarness").html('<div id="freezeInput">Активировать заморозку? <input type="checkbox" name="freezeBoost" id="freezeBoost"></input></div>');
	$("span#normalAbilityHarness").html('<div id="normalAbilityInput">Активировать способность? <input type="checkbox" name="normalAbilityBoost" id="normalAbilityBoost"></input></div>');
	$("span#heroAbilityHarness").html('<div id="heroAbilityInput">Активировать способность Героя? <input type="checkbox" name="heroAbilityBoost" id="heroAbilityBoost"></input></div>');
	$("span#rageSpellHarness").html('<div id="rageSpellInput">Уровень Заклинания Ярости: <select name="rageSpellLevel" id="rageSpellLevel"> <option value="0">0</option> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5</option> <option value="6">6</option> </select></div>');
	$("span#hasteSpellHarness").html('<div id="hasteSpellInput">Уровень Спешного Заклинания: <select name="hasteSpellLevel" id="hasteSpellLevel"> <option value="0">0</option> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5</option> </select></div>');
	$("span#poisonSpellHarness").html('<div id="poisonSpellInput">Уровень Ядовитого Заклинания: <select name="poisonSpellLevel" id="poisonSpellLevel"> <option value="0">0</option> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5</option> <option value="6">6</option> <option value="7">7</option> </select></div>');
	$("span#lifeAuraHarness").html('<div id="lifeAuraInput">Уровень Ауры Жизни (Герой Хранитель): <select name="lifeAuraLevel" id="lifeAuraLevel"> <option value="0">0</option> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5</option> <option value="6">6</option> <option value="7">7</option> <option value="8">8</option> <option value="9">9</option> <option value="10">10</option> <option value="11">11</option> <option value="12">12</option> <option value="13">13</option> <option value="14">14</option> <option value="15">15</option> <option value="16">16</option> <option value="17">17</option> <option value="18">18</option> <option value="19">19</option> <option value="20">20</option> <option value="21">21</option> <option value="22">22</option> <option value="23">23</option> <option value="24">24</option> <option value="25">25</option> <option value="26">26</option> <option value="27">27</option> <option value="28">28</option> <option value="29">29</option> <option value="30">30</option> <option value="31">31</option> <option value="32">32</option> <option value="33">33</option> <option value="34">34</option> <option value="35">35</option> <option value="36">36</option> <option value="37">37</option> <option value="38">38</option> <option value="39">39</option> <option value="40">40</option></select></div>');
      ...
      $(".bCost").each(function() {
	   ...
	   $(".bTime").each(function() {
		...
		newbuildTimes.push(newtimeSeconds);
  		...
  		if (reducedDays != 0) {
  			var outputDay = reducedDays + "д ";
  		} else {
  			var outputDay = "";
  		}
  		if (reducedHours != 0) {
  			var outputHour = reducedHours + "ч ";
  		} else {
  			var outputHour = "";
  		}
  		if (reducedMinutes != 0) {
  			var outputMinute = reducedMinutes + "м ";
  		} else {
  			var outputMinute = "";
  		}
  		if (reducedSeconds != 0) {
  			var outputSecond = reducedSeconds + "с ";
  		} else {
  			var outputSecond = "";
  		}
		...
		// Read training time
		if (str.includes("м") == true) {
  			var minutesIndex = str.indexOf("м");
		...
		if (reducedMinutes != 0) {
			var outputMinutes = reducedMinutes + "м ";
		} else {
			var outputMinutes = "";
		}
		if (reducedSeconds != 0) {
			var outputSeconds = reducedSeconds + "с ";
		} else {
			var outputSeconds = "";
		}
