...
/* Imagebox during uploads */
function preloadUploadDesc() {
if (wgPageName.toLowerCase() != 'special:upload') {
return;
}
 
document.getElementById('wpUploadDescription').appendChild(document.createTextNode("{{Imagebox\r| description = \r| media       = \r| volume      = \r| chapter     = \r| season      = \r| episode     = \r| source      = \r| origin      = \r| warning     = \r| cats        = \r}}"));
