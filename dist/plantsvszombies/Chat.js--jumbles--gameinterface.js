...
<ul>"; for (var sCmd in tGameInt.oUserCmds) { sHelp += '<li>' + sPrefix + sCmd + ' - ' + tGameInt.oUserCmds[sCmd][1]+'</li><li>'; } sHelp +="</li></ul>";
                if (sUser) {
...
<ul>"; var arrPlayers = tGameInt.oFuncs.getPlayerList(); for (sUser in arrPlayers) { sPlayers += '<li>'+ sUser + ' - ' + tGameInt.oFuncs.getScore(sUser)+'</li>'; sPlayers +='</ul>';
