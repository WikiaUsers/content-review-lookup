...
if (mwCustomEditButtons) {  
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		"imageFile": "http://images.wikia.com/clubpenguin/images/3/31/HighlightButton.png",
		"speedTip": "Highlight",
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		"imageFile": "http://images.wikia.com/central/images/5/56/Button_big.png",
		"speedTip": "Large Text",
		"tagOpen": "<big>",
		"tagClose": "</big>",
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		"imageFile": "http://images.wikia.com/central/images/5/58/Button_small.png",
		"speedTip": "Small Text",
		"tagOpen": "<small>",
		"tagClose": "</small>",
		"sampleText": "Insert Text Here"
	...
	mwCustomEditButtons[mwCustomEditButtons.length] = {
		"imageFile": "http://images.wikia.com/central/images/f/fd/Button_underline.png",
...
$cp.card.fn.newCard = function(obj) {
	var canvas = document.createElement("canvas"),
		_sizes = [60, 88, 95, 300, 1500], // sorted from in an ascending order (!!!)
		size = undefined,
		srcSize = undefined;
...
$cp.card.fn.clear = function(node) {
	node.getContext("2d").clearRect(0, 0, 1500, 1500); // since 600 is the maximum possible width, no need to get the dimensions
}
	// add item
...
(function() {
	function foo() {
		$("span.player-card-image").each(function() {
			...
			if (a.id != "undefined") {
				$(this).replaceWith(
					'<img src="http://cdn.avatar.clubpenguin.com/%7B' + a.id + '%7D/cp?size=1500&language=' + a.lang + '&photo=' + a.bg + '&flag=' + a.pin + '" width="' + b + '" height="' + b + '" />'
				);
			} else {
...
$(function() {
	if ($(".article-tags").length == 1 && mw.config.get("wgNamespaceNumber") == 0) {
		...
		var data = {
			faweek: {
				image: "http://images.wikia.com/clubpenguin/images/6/61/MiniFeature.png",
				url: "http://clubpenguin.wikia.com/wiki/Club_Penguin_Wiki:Featured_Article_of_The_Week",
				title: "This is a featured article."
			},
			fa: {
				image: "http://images.wikia.com/clubpenguin/images/thumb/0/04/7119_icon.png/20px-7119_icon.png",
				url: "http://clubpenguin.wikia.com/wiki/Club_Penguin_Wiki:Featured_Article",
				title: "This is a featured article."
			},
			fi: {
				image: "http://images.wikia.com/clubpenguin/images/thumb/2/29/Yellow_Hoodie.PNG/20px-Yellow_Hoodie.PNG",
...
$(function() {
	if ([4].indexOf(mw.config.get("wgNamespaceNumber")) > -1) {
		...
		$(".pc-generator").replaceWith('<div class="pc-generator" style="width: 400px; margin: auto; border: 1px solid #ccc; background: white; text-align: center;">\n' +
			...
			'\t<span style="display: inline-block; zoom: 0.5;"><span class="player-card-gen" style="width: 1500px; height: 1500px;" data-size="1500"></span></span>\n' +
		...
		'<nav id="interlangcp">\n' +
			'\t<p>\n' +
				...
				'\t\t<select id="interlangcp-select">\n' + // orid = original order, during the development. not important
					...
					'\t\t\t<option data-orid="8" value="rooms">Stamps</option>\n' +
				'\t\t</select><br />\n' +
