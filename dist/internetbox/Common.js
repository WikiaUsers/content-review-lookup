...
window.pPreview = $.extend(true, window.pPreview, {
    ...
    scale: false,
    RegExp: {
       ilinks: [new RegExp('(Talk:)|(User:)|(Project:)|(Project_talk:)|(The_Internet_Box_Wiki:)|(The_Internet_Box_Wiki_talk:)|(File:)|(File_talk:)|(MediaWiki:)|(MediaWiki_talk:)|(Template:)|(Template_talk:)|(Help:)|(Help_talk:)|(Category:)|(Category_talk:)|(Forum:)|(Forum_talk:)|(User_blog:)|(User_blog_comment)|(Blog:)|(Blog_talk:)|(Module:)|(Module_talk:)|(Message_Wall:)|(Thread:)|(Message_Wall_Greeting:)')],
