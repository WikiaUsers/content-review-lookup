...
/** Collapsible tables *********************************************************
 ...
 if (mwCustomEditButtons) {
   ...
   mwCustomEditButtons[mwCustomEditButtons.length] = {
     "imageFile": "https://images.wikia.nocookie.net/nintendo/en/images/3/36/Button_Link.png",
     "speedTip": "Link",
     "tagOpen": "[[",
     "tagClose": "]]",
     "sampleText": "Insert text"};
...
/* Histats Counter */
$(function($) {
	$(document.body).append('<div id="counter"><a href="http://www.histats.com" alt="web statistics" target="_blank">' +
'<img src="http://sstatic1.histats.com/0.gif?2031268&101" alt="web statistics" border="0"></a></div>');
});
// **************************************************
