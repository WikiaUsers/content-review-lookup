...
// Disable message (1 = enabled, 0 = disabled)
    ...
    window.chatRestr.undereditMessage = "Oi "+ wgUserName+"! Bem-vindo ao chat. Infelizmente, o Wiki Turma da Mônica tem uma política que exige que todos os usuários façam pelo menos 25 edições. Pedimos desculpas pelo inconveniente e esperamos vê-lo em breve.";
