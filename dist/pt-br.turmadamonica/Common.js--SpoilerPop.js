$(function () {
    ...
    window.SpoilerAlert = (function (my, console, Math) {
        ...
        my = $.extend({
            question: 'Este artigo contém revelações do enredo de gibis caros ou recentes, ele contém spoilers. Você tem certeza de que deseja continuar?',
            yes: 'Sim, eu tenho (continuar)',
            no: 'Não, eu não tenho',
            isSpoiler: function () {
