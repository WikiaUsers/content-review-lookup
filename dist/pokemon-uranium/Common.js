...
window.UserTagsJS = {
	modules: {},
	tags: {
		sysop: { u:'Administrator', link:'Project:Administrators', order:-1/0 },
		newuser: { u:'New Uranium Wiki Editor', title:'This user has made less than 10 edits and/or has been a member of this wiki for less then 5 days' },
		headadmin: { u:'Head-Administrator', link:'Project:Bureaucrats', title:'This user is an admin and a bureaucrat', order:-1/0 },
        bot: { link:'Help:Bots' },
