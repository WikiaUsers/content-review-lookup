...
var chatTopic = 'Welcome to ye old Castlepedia! Have a good time and follow the rules!'
 
//Switch to night button
var night_button = 'Switch to Night Chat';
 
//Switch to day button
var day_button = 'Switch to Wiki';

//
//Color scheme for Night Chat
//
  //Link color
    var linkColor = '#102F53';

  //All text Color
    var textColor = '#36322F';

  //Self text background color
    var selfTextColor = '#9F9F9F';

  //Chat background color
    var backgroundColor = '#103A5A';

  //Chat foreground color
    var foregroundColor = '#9C9B9A';
