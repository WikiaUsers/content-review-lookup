...
if(wgCanonicalSpecialPageName == 'Chat') {
	...
	function OpenChatWindow() {
		window.chatwindow = window.open('/wiki/Special:Chat?allinone=0&useskin', 'chatwindow');
		window.chatwindow.onload = setTimeout("window.chatwindow.importScriptPage('User:' + wgUserName + '/global.js', 'c');", 6000);
	}
}