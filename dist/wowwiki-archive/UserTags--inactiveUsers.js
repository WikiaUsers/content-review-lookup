...
(function (module, $, mw) {
  ...
  var log = (function () {
    ...
    var log = typeof window.console.log === 'object' && Function.prototype.bind && Function.prototype.bind.call ?
        Function.prototype.bind.call(window.console.log, window.console) : window.console.log;
    return function () {
