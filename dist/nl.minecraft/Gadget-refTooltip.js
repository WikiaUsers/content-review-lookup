$( function() {
	...
	var i18n = {
		...
		doneButton: 'Gereed',
		enableLabel: 'Referentietooltips tonen',
		optionsButtonTitle: 'Referentietooltipinstellingen wijzigen',
		referencesSectionName: 'Referenties',
		saveFailedStorageFull: "Is de lokale opslag van de browser vol?",
		saveFailedTitle: 'Opslaan van instellingen mislukt'
	};
	...
	$( document.getElementById( mw.util.escapeId( i18n.referencesSectionName ) ) ).before(
		$( '<button>' ).addClass( 'pixel-image ref-tooltip-options-button' )
			.attr( 'title', i18n.optionsButtonTitle )
	);
