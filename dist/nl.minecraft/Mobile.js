...
var i18n = {
	...
	// Page loader
	loadErrorTitle: 'Er trad een fout op bij het laden van de inhoud'
};
...
$('.navbox_full_list_link').append(
    '<a onclick=unhideFullVersionNavbox() title="toon de volledige versielijst hieronder">toon alles</a>'
);

/* Add Minecraft Wiki logo to top bar. */
window.addEventListener("load", function() {
	$('.branding-box').find('span').empty();
	$('.branding-box').css("background-image", "https://minecraft-nl.gamepedia.com/media/minecraft-nl.gamepedia.com/9/90/Minecraft_Wiki_header.svg");
});