...
jQuery(function($) { /* Osiris: New Dawn resource map generation */
	var mapImageSize = 2048;
	var topLeft = [-32.0, 32.0];
	var bottomRight = [32.0, -32.0];
	...
	$('.osiris-map').each(generateMap);
}); /* Osiris: New Dawn resource map generation */