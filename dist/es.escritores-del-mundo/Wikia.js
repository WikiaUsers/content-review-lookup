...
$(function() {
	if ( document.location.href.indexOf('?action=edit&preload=Escritores_del_mundo_Wiki:Preload_') > -1 ) {
...
// Wikis Aliadas
$(function(){
    $('#WikiaFooter').prepend('<section id="comunidadesaliadas"><div class="header-container"><h1>Comunidades aliadas (<a href="http://es.escritores-del-mundo.wikia.com/d/f?sort=latest">agrega tu wikia de literatura</a>)</h1></div><ul></ul></section>');
        // es.biblioteca-virtual
        $('<li data-wiki="Biblioteca Virtual Wikia"><a href="http://es.biblioteca-virtual.wikia.com"></a></li>').appendTo('#comunidadesaliadas ul');
        // literatura.respuestas
        $('<li data-wiki="Literatura Respuestas"><a href="http://literatura.respuestas.wikia.com"></a></li>').appendTo('#comunidadesaliadas ul');
});