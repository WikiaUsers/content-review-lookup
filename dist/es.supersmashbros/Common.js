...
function loadTrueCommonJS() {
	...
	if (!skipCommon) {
		...
		importScriptURI(wgServer+wgScriptPath+wgScript+'?title=MediaWiki:'+page+'/'+code+'.js&action=raw&ctype=text/javascript&templates=expand&t=3');
	}
	if (skipSkinjs) {
...
/* Temporizador o cuenta regresiva (CountDown) (véase http://dev.wikia.com/wiki/Countdown  para configurar esto) */
