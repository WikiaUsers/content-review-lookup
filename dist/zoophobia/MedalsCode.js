...
// Main function
        medalMainFunction: function() {
            ...
            //Check medalMatcher function of medalFunctions and check MedalSettings...
            ...
            $('.user-identity-box__info').append(
                    '<div class="RewardContainer" style="position:relative; height:64px; width:100%; padding: 0;">' +
                        // Title
...
// Launch function
        init: function(modalScript) {
            ...
            $.ajax({
                ...
                type: 'GET',
                data: {
                    title: 'Project:Medals',//Get Json data from Project:Medals and parse it for use
                    action: 'raw',
                ...
                success: function(data) {
                    ...
                    medalModalForm = $('<fieldset style="border:solid 1px #36759c; margin:0; padding:1em;">'); //Set of inputs, possibly for form
...
/* </nowiki> */
//dev:Medals/code.js
//Remove stupid borders (for now at least)
//Correct CSS