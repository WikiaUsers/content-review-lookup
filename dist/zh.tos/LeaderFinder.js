$("div.LeaderFinder").append('<form id="leader_finder_form"><p>請輸入召喚獸編號<input id ="leader_finder_input" type="number" min="1" max="9999" required="required" /><input type="submit" value="查詢" /><span id="leader_finder_image"></span><span id="leader_finder_status"></span></p></form><table class="wikitable sortable leader_finder_data_table" style="text-align:center; font-size:9.5pt; display: none" ><thead><tr><th>UID</th><th>召喚師<br />名稱</th><th>召喚師<br />等級</th><th>召喚獸<br />等級</th><th>技能等級</th><th>技能CD</th><th>昇華</th><th>主掛</th><th>副掛</th> <th>徵求</th><th>備註</th><th>最後更新時間</th></tr></thead><tbody> </tbody></table>')
                ...
                success: function (cards) {
                    ...
                    $.get('http://zh.tos.wikia.com/api.php', {
                        ...
                        for (var i = 0; i < cards.length; i++) {
                            ...
                            var area = $('<a />').attr('href','http://zh.tos.wikia.com/wiki/User:' + card.get('user')).attr('target','_blank');
                        ...
                        newTable.width(parseInt($('#WikiaPage').width()));
                        newTable.show();
