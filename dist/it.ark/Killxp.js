...
if (creatureKillXPDiv = document.getElementById('creatureKillXP')) {
  if (creatureKillXPDiv.dataset.basexp) {
    creatureKillXPDiv.innerHTML = 'Livello <input type="number" min="1" max="999999" maxlength="6" value="1" onchange="creatureKillXPResultEl.innerHTML = updateXPLevel(' + creatureKillXPDiv.dataset.basexp + ', this.value)" style="width:3.5em">: <span id="creatureKillXPResult"></span>';
