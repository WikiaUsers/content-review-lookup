 ...
 * taken directly from http://runescape.wikia.com/wiki/MediaWiki:Common.js/gemwupdate.js
 * with only minor adaptations to this wiki.
 *
 ...
 *
 *        UPDATE: Cqm sent in another email in Nov 2016 which did get a response
 *        saying it may be added to the web team's backlog
 */
    ...
    var 
        ...
        */
        ...
        self = {
            ...
            getPrice: function () {
                var id = $( '#GEDBID' ).text(),
                    url = 'http://services.runescape.com/m=itemdb_oldschool/api/graph/' + id + '.json',
                    via = 'crossorigin',
             ...
             *                     Can be one of 'yahoo', 'crossorigin' or 'whateverorigin'
            ...
            getVols: function () {
                ...
                $
                    .getJSON(
                        ...
                        self.crossDomain( 'http://services.runescape.com/m=itemdb_oldschool/top100.ws' )
                    )
                    .done( function ( resp ) {
