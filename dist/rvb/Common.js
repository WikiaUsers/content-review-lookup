...
$(function() {
	if(skin == "oasis") {
		...
		var comboString = "<div style='margin-top:5px; align:center'><table style='width:100%'><td style='*'>Take a look around!<br /><br /><a href='http://roosterteeth.com/'>Rooster Teeth</a><br /><a href='http://rvb.wikia.com/wiki/Category:Characters'>Characters</a><br /><a href='http://rvb.wikia.com/wiki/Category:Episodes'>Episodes</a><br /><a href='http://rvb.wikia.com/wiki/Category:Locations'>Locations</a><br /><a href='http://rvb.wikia.com/wiki/Category:Voice Actors'>Cast</a><br /></td><td style='text-align:right'><a href='http://roosterteeth.com/archive/?sid=rvb' target='_top'><img src='https://images.wikia.nocookie.net/rvb/images/thumb/d/d2/Church_pos.png/166px-Church_pos.png' alt='Red vs. Blue' border=0 /></a></td></tr></table></div>";
...
var s1=(s!=00)?60-s:s;
var m1=(m!=00)?60-m:m;
var h1=(24 - (h-11)) % 24; // <--11 is used as a time zone offset
...
m1=checkTime(m1);
s1=checkTime(s1);
document.getElementById('Clock').innerHTML = (24 + (h-11)) % 24 + ":" + m + ":" + s;
document.getElementById('CountdownTimer').innerHTML = h1 + ":" + m1 + ":" + s1;
