...
function startTime() {
 ...
 if($("#CountdownTarget") != undefined) {
  var dr = Date.parse($("#CountdownTarget").html());
...
//Teraz następuje sprawdzenie, czy czas do podanej daty już minął i ewentualne zatrzymanie licznika
 if (d<0){
   $("#CountdownTimer").html('<tr><td>0<br /><span class="CountdownLabel">Dni</span></td><td>0<br /><span class="CountdownLabel">Godzin</span></td><td>00<br /><span  class="CountdownLabel">Minut</span></td><td>00<br /><span class="CountdownLabel">Sekund</span></td>');
  }
