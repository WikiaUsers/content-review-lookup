 ...
 * Imported edits show as unpatrolled, as there is no way to tell they are
   imported
 * Rollbacked edits in diff view show as unpatrolled if the rollback isn't visible
 */
...
$( function() {
	var i18n = {
		...
		rightsError: 'Failed to retrieve autopatrol rights',
			...
			var makePatrolReq = function( cont ) {
				...
				return patrolReq.then( function( resp ) {
					...
					resp.query.logevents.forEach( function( patrol ) {
						...
						var icon = makePatrolIcon( 'patrolled', patrol.user );
