...
var i18n = {
	blockedNotice: '차단된 사용자는 스프라이트를 편집할 수 없습니다..',
	blockedReason: '이유: $1',
	browserActionNotSupported: '지원하지 않는 브라우저입니다.',
	changesSavedNotice: '변경 사항이 저장되었습니다.',
	controlNewName: '새로운 이름',
	ctxDeleteImage: '삭제',
	ctxDownloadImage: '내려받기',
	ctxReplaceImage: '대치',
	diffError: '차이 불러오기 실패',
	diffErrorMissingPage: '페이지 가져오기 실패',
	dupeName: '이미 존재하는 이름입니다.',
	dupeNamesNotice: '충돌하는 이름이 있습니다. 저장하기 전에 충돌이 해결되어야 합니다.',
	errorApi: 'API 오류',
	errorConnection: '연결 오류',
	errorConnectionText: '네트워크 연결을 확인하십시오',
	errorGeneric: '오류',
	errorHttp: 'HTTP 오류',
	genericError: '오류가 발생하였습니다',
	...
	noPermissionNotice: '스프라이트를 편집할 권한이 없습니다.',
	panelChangesIdTitle: '데이터 변경 사항',
	panelChangesNoDiffFromCur: '현재 버전에서 변경 사항 없음',
	panelChangesSheetTitle: '스프라이트시트 변경 사항',
	panelChangesTitle: '변경 사항 검토',
	panelCloseTip: '닫기',
	panelConflictCurText: '현재 텍스트',
	panelConflictReview: '변경 사항 검토',
	panelConflictSave: '저장',
	panelConflictText: '편집 충돌이 발생했습니다. 자동 해결에 실패했습니다.',
	panelConflictTitle: '편집 충돌',
	panelConflictYourText: '당신의 텍스트',
	panelDiscardContinue: '계속 편집',
	panelDiscardDiscard: '변경 사항 버리기',
	panelDiscardText: '변경 사항을 버리겠습니까?',
	panelDiscardTitle: '저장되지 않은 변경 사항',
	panelEcchangesReturn: '편집 충돌 창으로 돌아가기',
	panelEcchangesTitle: '수동 편집 사항 검토',
	sectionPlaceholder: '섹션 이름을 입력하십시오',
	sectionUncategorized: '기타 카테고리',
	titleEditing: '$1 스프라이트 편집 중',
	toolbarHelp: '도움말',
	toolbarHelpPage: 'Help:스프라이트 편집기',
	toolbarNewImage: '새 이미지',
	toolbarNewSection: '새 섹션',
	toolbarRedo: '다시 적용',
	toolbarReviewChanges: '변경 사항 검토',
	toolbarSave: '저장',
	toolbarSummaryLabelTip: '남은 바이트 수',
	toolbarSummaryPlaceholder: '변경 사항의 요약을 입력하십시오',
	toolbarToolDeprecate: '사용 중단으로 표시',
	toolbarToolDeprecateTip: '이름을 사용 중단된 것으로 지정',
	toolbarTools: '도구',
	toolbarUndo: '되돌리기',
};
