...
$( function() {
	var i18n = {
		cancelButton: '취소',
		doneButton: '완료',
		enableLabel: '참고 자료 툴팁 사용',
		optionsButtonTitle: '참고 자료 툴팁의 설정 변경',
		referencesSectionName: '참고 자료',
		saveFailedStorageFull: "브라우저의 로컬 저장 공간이 가득 찼습니다",
		saveFailedTitle: '설정을 저장하지 못했습니다'
	};
