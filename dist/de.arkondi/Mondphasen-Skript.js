...
function moon_day(today) {
  ...
  var oldJ;
  while (jday < thisJD) {
    var F = 0.0001178 * T2 - 1.55e-7 * T3 + (0.75933 + 0.53058868 * K0) - (0.000837 * T + 0.000335 * T2) + 1.530588 * phase;
    var M5 = (360 * (GetFrac(K0 * 0.08084821133)) + 359.2242 - 0.0000333 * T2 - 0.00000347 * T3 + phase * 29.10535608) * degToRad;
    var M6 = (360 * (GetFrac(K0 * 0.07171366128)) + 306.0253 + 0.0107306 * T2 + 0.00001236 * T3 + phase * 385.81691806) * degToRad;
    var B6 = (360 * (GetFrac(K0 * 0.08519585128)) + 21.2964 - (0.0016528 * T2) - (0.00000239 * T3) + phase * 390.67050646) * degToRad;
    ...
    F += 0.5 / 1440;
    oldJ = jday;
    jday = 2415020 + 29 * K0 + 28 * phase + Math.floor(F);
    phase++;
  }
