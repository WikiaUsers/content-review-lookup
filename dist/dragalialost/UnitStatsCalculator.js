(function(mw) {
	...
	var MIN_LEVEL = 1;
	var UB_LEVEL_0, UB_LEVEL_1, UB_LEVEL_2, UB_LEVEL_3, MAX_LEVEL, MIN_HP, MAX_HP, MIN_STR, MAX_STR, ele;
	...
	function init($content) {
		var main = $content.find('#UnitStatsCalculator')[0];
		if (!main) return;

		var data = main.dataset;
		UB_LEVEL_0 = Number(data.ubLevel0);
