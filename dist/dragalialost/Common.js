...
$(document).ready(function() {
    ...
    // 3DModelViewer
    $(".modelViewerDgk a").click(function() {
        var container = $(this).parent();
        var modelId = container.data('id');
        container.html('<iframe width="400px" height="400px" src="https://dgk3593.github.io/dl-model/#/id='
          + modelId + '/showAC=false/showSettings=false/bg=transparent/AA=true" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe><br/><span style="font-size:0.8em">Click <a href="https://dgk3593.github.io/dl-model/#/id='
          + modelId + '">here</a> if model fails to load. Report any missing models <a href="https://github.com/dgk3593/dl-model/issues">here</a>.</span>'
          );
        return false;
    });
});
