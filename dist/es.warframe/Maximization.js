...
$(function() {
  ...
  var AshMap = {
    ...
    rising_storm: [
      ["ash4_aug_dur", "Combo Counter increase"]
    ]
  };
  var AtlasMap = {
    landslide: [
  ...
  function update_table() {
    ...
    formula_loader(['excalibur', 'excalibur3_aug'], [
      ['str', (STR * 5 * Math.min(TARGET, 12)).toFixed(2) + "%"],
  ...
  table_loader("wukong1", abilityGenerator(WukongMap.defy));
  table_loader("wukong1", abilityGenerator(WukongMap.primal_fury));
