 update_scaling() {
    if((curr_lvl = ehp_input.value) >= base_lvl_v) {
        ...
        ferritehealth.innerHTML  = (Math.round(ferritehealth_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.015)* 100) / 100).toLocaleString();
        alloyhealth.innerHTML    = (Math.round(alloyhealth_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.015)* 100) / 100).toLocaleString();
        shieldhealth.innerHTML   = (Math.round(shieldhealth_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.015)* 100) / 100).toLocaleString();
        protohealth.innerHTML    = (Math.round(protohealth_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.015)* 100) / 100).toLocaleString();
        ...
        shieldarmor.innerHTML    = (Math.round(shieldarmor_v * (1 + Math.pow(curr_lvl - base_lvl_v, 1.75) * 0.005)* 100) / 100).toLocaleString();
        protoarmor.innerHTML     = (Math.round(protoarmor_v * (1 + Math.pow(curr_lvl - base_lvl_v, 1.75) * 0.005)* 100) / 100).toLocaleString();
        ...
        ferriteshield.innerHTML  = (Math.round(ferriteshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        alloyshield.innerHTML    = (Math.round(alloyshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        cfleshshield.innerHTML   = (Math.round(cfleshshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        fleshshield.innerHTML    = (Math.round(fleshshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        fossilshield.innerHTML   = (Math.round(fossilshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        infestedshield.innerHTML = (Math.round(infestedshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        ifleshshield.innerHTML   = (Math.round(ifleshshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        sinewshield.innerHTML    = (Math.round(sinewshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        machineshield.innerHTML  = (Math.round(machineshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
        roboshield.innerHTML     = (Math.round(roboshield_v * (1 + Math.pow(curr_lvl - base_lvl_v, 2) * 0.0075)* 100) / 100).toLocaleString();
