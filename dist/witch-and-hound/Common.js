...
window.welcomeMessage = {
    ...
    messageTitle: 'Welcome to Witch and Hound Wiki, $1!',
    messageText: '{{' + 'subst:Welcome message|$1|$2|$3|$4|' + '{{' + 'subst:CURRENTTIME}}, {{' + 'subst:CURRENTDAY}} {{' + 'subst:CURRENTMONTHNAME}} {{' + 'subst:CURRENTYEAR}} (UTC)}}'
};
