...
// Изменяет ссылку логотипа сообщества:
// при нажатии на логотип в левом верхнем углу
// пользователь переходит на Заглавную страницу вики.

$(document).ready(function () {
    $('.fandom-community-header__image')
        .closest('a')
        .attr('href', mw.util.getUrl('Total_War_Wiki'));
});