...
$(function(){
    $('#WikiaFooter').prepend('<section id="comunidadesaliadas"><div class="header-container"><h1>Comunidades aliadas</h1></div><ul></ul></section>');
        // es.monsterlegendes
        $('<li data-wiki="Monster Legendes Wiki"><a href="http://es.monsterlegendes.wikia.com"></a></li>').appendTo('#comunidadesaliadas ul');
        // es.angrybirds
        $('<li data-wiki="Angry Birds Wiki"><a href="http://es.angrybirds.wikia.com"></a></li>').appendTo('#comunidadesaliadas ul');
