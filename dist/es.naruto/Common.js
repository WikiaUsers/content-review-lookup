	...
	_initTextarea = function( $textarea ) {
		$textarea.wikiEditor( 'addToToolbar', {
			'sections': {
				'smash-utiles': {
					'type': 'booklet',
					'label': 'Útiles Naruto Wiki',
					'pages': {
						General: {
							label: 'General',
							layout: 'characters',
							characters: [ 'Hyūga','Ōtsutsuki','Bijū','Gokū','Kokuō','Chōmei','Gyūki','Jinchūriki','Mangekyō','Saṃsāra','Rikudō','Banshō','Shippūden','Chōjūrō', 'Terumī', 'Chūnin', 'Jōnin', 'Dōjutsu', 'æ','Æ','º','ª','¡','¿','€','♂','♀','|','~','–','—','…',_combinado('«','»'),'↑','↓','←','→','−','±','×','✔','†' ]
						},
						MediaWiki: {
							label: 'MediaWiki',
							layout: 'characters',
