...
(function ($) {
    ...
    f.update = function (targets, d) {
                ...
                $target.each(function () {
                    ...
                    if ($this.data('newplural') !== undefined) {
                        ...
                        if (second === '1') {
                            ...
                            pages = ($this.data('newplural') !== 0) ? 'статью' : 'статья';
        ...
        */
        ...
        if (wordmark.match('video151')) { // Если логотипа не существует
