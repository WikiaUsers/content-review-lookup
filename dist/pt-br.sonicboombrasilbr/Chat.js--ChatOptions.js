...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; color:black; font-size:120%; font-family:Comic Sans MS; margin-top: 6px; bottom:4px; padding-bottom:2px; border-bottom: solid 5px #0000FF; width:40%;" align="center">Opções do Chat</div>'); // Prevent multiple buttons from being appended
}
