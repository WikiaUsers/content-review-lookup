...
require(['jquery', 'mw'], function ($, mw) {
                                ...
                                '<fieldset>' +
                                    '<div class="rf-wrapper">' +
                                        ...
                                        '<div class="rf-section"><div class="rf-section-title"><b>' + i18n.msg("formWikiURL").escape() + '</b></div>' +
                                            '<input id="wikiurl" class="rf-wikiurl" type="text" placeholder="vstf.fandom.com"/>' +
                                        '</div>' +
                    ...
                    vandalism: {
                        ...
                        form: '<form class="WikiaForm ReportForm" method="" name="" id="vandalism">' +
                                '<fieldset>' +
                                    '<div class="rf-wrapper">' +
                                        '<div class="rf-section"><div class="rf-section-title"><b>' + i18n.msg("formWikiName").escape() + '</b></div>' +
                                            '<input id="wikiname" class="rf-wikiname optional" type="text" placeholder="VSTF Wiki"/>' +
                                        '</div>' + 
                                        '<div class="rf-section"><div class="rf-section-title"><b>' + i18n.msg("formWikiURL").escape() + '</b></div>' +
                                            '<input id="wikiurl" class="rf-wikiurl" type="text" placeholder="vstf.fandom.com"/>' +
                                        '</div>' +
                        ...
                        form: '<form class="WikiaForm ReportForm" method="" name="" id="wiki">' +
                                '<fieldset>' +
                                    '<div class="rf-wrapper">' +
                                        ...
                                        '<li>2. Do not add wikis just because you feel that they are "unproductive." This list is for <a href="https://www.fandom.com/terms-of-use">Terms of Use</a> violations only -- advertisement spam or obscene and illegal content.</li>' +
                                        '<li>3. Please <a href="/Special:Contact">contact Staff</a> to report social issues such as harassment.</li>' +
                                        '<li>4. Do not add wikis where you feel the administrators are being unfair. Please <a href="/Special:Contact">contact Staff</a> about bad admins.</li>' +
                                        '<li>5. New entries may be added to the <a href="#New reports (To be VSTF checked)">non-VSTF checked section</a> only. Check to ensure you are not duplicating an entry already there.</li></ol>' +
                                        '</div>' +
                                        '<div class="rf-section" style="color:#F00; font-size:16px; display:none;" id="formAnon"><b>' + i18n.msg("formAnon").escape() + '</b></div>' +
                                    '</div>' +
                                '</fieldset>' +
    ...
    function submitForm(opts) {
        ...
        if(opts.page === "Report:Wiki") {
            ...
            .done(function (res) {
                if (c.wgPageName == "VSTF_Wiki") {
                    location.replace('https://vstf.fandom.com/wiki/' + opts.page + '?action=purge');
                } else {
    ...
    function loadButton(type) {
        ...
        mw.hook('vstf.reports').fire($newButton);
    }
    ...
    function init() {
        ...
        importStylesheetURI('https://vstf.fandom.com/index.php?title=MediaWiki:Reports.css&action=raw&ctype=text/css');
    }
