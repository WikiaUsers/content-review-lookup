...
//* Zy - Aug 28 - Added img tags.
//*
//* Zy - Aug 29 - img tag shouldn't snort now, you have to erase "http://" before adding img tags :|
//* Also you have to specify the width. 300 is probs fine.
//*
/**************************************************************************/
...
chatags.bbCode = {
    ...
    "img": {
        ...
        1: {
            "bbFind": /\[img ([^\[\]\;\\"]{1,})\]/,
            "bbReplace": "<img width=\"$1\" src=\"http://"
        }
    },
    "i": {
        0: {
