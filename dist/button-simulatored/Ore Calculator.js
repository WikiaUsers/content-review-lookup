// Original Creator by User:TheSeal27 for the Roblox Grass Cutting Incremental Wiki on Fandom. Original page: https://roblox-grass-cutting-incremental.fandom.com/wiki/MediaWiki:CurrencyGainCalculator.js
function addOreCalculator() { // Function for ensuring all the calculator's variables and functions stay within.
    if (document.getElementById("OreCalculator") !== null && document.getElementById("OreCalculatorContainer") === null) {
        ...
        var Selected; // Determines the Selected from the 'updateInputs' function, used for the 'updateResult' function.
        ...
        // Update the inputs according to the Selected.
        function updateInputs(e) {
            function unknownFormula(status) {
                if (status === true) {
                    document.getElementById("CGCInputsInnerContainer").innerHTML = "<div class='rainbow' style='text-align:center;font-weight:bold'>Error: Selected's formula is unknown. Inputs and results unavailable.</div>";
            ...
            if (document.getElementsByClassName("Selected")[0] !== undefined) {
                document.getElementById(document.getElementsByClassName("Selected")[0].getAttribute("id")).setAttribute("class", "");
            } else {
            ...
            switch (e) {
                ...
                case "ap":
                    Selected = "ap";
                    console.log("Selected: Anonymity Point");
                ...
                case "oil":
                    Selected = "";
                    console.log("Selected: Oil");
                    document.getElementById("CGCOilSelection").setAttribute("class", "Selected");
                    document.getElementById("CGCSelectedency").innerHTML = "<span style='color:#6F6F6F'>Oil</span>";
                    unknownFormula(true);
                    break;
                case "momentum":
                    Selected = "momentum";
                    console.log("Selected: Momentum");
                    document.getElementById("CGCMomentumSelection").setAttribute("class", "Selected");
                    document.getElementById("CGCSelectedency").innerHTML = "<span style='color:#FFA500'>Momentum</span>";
                ...
                case "dm":
                    Selected = "dm";
                    console.log("Selected: Dark Matter");
                ...
                case "np":
                    Selected = "np";
                    console.log("Selected: Normality Point");
                ...
                case "lunarpower":
                    Selected = "lunarpower";
                    console.log("Selected: Lunar Power");
                ...
                case "stardust":
                    Selected = "stardust";
                    console.log("Selected: Stardust");
                    document.getElementById("CGCStardustSelection").setAttribute("class", "Selected");
                    document.getElementById("CGCSelectedency").innerHTML = "<span style='color:#DD00FF'>Stardust</span>";
                    document.getElementById("CGCInputsInnerContainer").innerHTML = "<p>Planetoid Level: <input id='CGCPlanetoidLevelInput' style='width:10%'/></p>";
                ...
                case "solarshard":
                    Selected = "solarshard";
                    console.log("Selected: Solar Shard");
                ...
                case "solarray":
                    Selected = "solarray";
                    console.log("Selected: Solar Ray");
        ...
        document.getElementById("Amethyst").addEventListener("click", function() {
            updateInputs("pp");
            updateResults();
        });
