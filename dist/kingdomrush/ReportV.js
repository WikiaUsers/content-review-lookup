...
console.log('Saving...');
    var $form = $('#vandalism'),
        ...
        page = '*Wiki: http://' + url + '.wikia.com\n*Vandal: http://kingdomrushtd.fandom.com/wiki/Special:Contributions/' + encodeURIComponent(user.replace(/ /g, "_")) + '\n*Reason: ' + comments + '\n*Signature: ' + van.signature + '';
