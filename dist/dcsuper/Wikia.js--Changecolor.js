...
(function (mw, $, window) {
    ...
    function loadStylesheet () {
        if (!css) {
            ...
            defer = $.ajax({
                url: 'http://dcsuper.wikia.com/index.php?title=MediaWiki:Ns0.css&action=raw&ctype=text/css&maxage=3600&smaxage=3600',
                dataType: 'text',
                async: false,
                cache: true
            })
    ...
    $(function () {
        ...
        // this is the button:
        $('<input type="button" value="Giao diện đêm" class="color-changer">')
