...
$(function() {
    if (document.getElementsByClassName("pocket-button")[0] !== null) {
        $('#mw-content-text .pocket-button').append('<a data-pocket-label="pocket" data-pocket-count="none" class="pocket-btn" data-lang="en"></a>');
        ! function(d, i) {
