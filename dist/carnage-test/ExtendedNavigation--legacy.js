...
(function () {
  ...
  function main() {
    // Early exit, since script is not compatible nor permitted with new navigation (2017-06-13)
    console.warn('ExtendedNavigation: Exiting:\n' +
      '  Script disabled per <http://community.wikia.com/wiki/Thread:1247796>.\n' +
      '  Removing this script from the wiki’s JS imports is recommended.');
    return;
