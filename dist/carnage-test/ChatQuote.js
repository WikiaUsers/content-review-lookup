(function($, mw, mainRoom){
    ...
    ChatQuote.prototype.process = function(){
        ...
        textC = (textC.isBright() ? textC.lighten(-10) : textC.lighen(10)).hex();
    ...
    $(importArticles({
        ...
        type: 'style',
        articles: ['u:carnage-test:MediaWiki:ChatQuotes.css']
    })).load(function(){
