...
$(function () {
    var rights = {};
    var botTag = "<a href='http://pt-br.warframe.wikia.com/wiki/WARFRAME_Wiki_PT-BR_:Administradores#Bots'>Bot</a>";
    var chatMod = "<a href='http://pt-br.warframe.wikia.com/wiki/WARFRAME_Wiki_PT-BR_:Administradores#Moderator do Chat'>Moderator do Chat</a>";
    var adminTag = "<a href='http://pt-br.warframe.wikia.com/wiki/WARFRAME_Wiki_PT-BR_:Administradores'>Administrador <img src='https://vignette.wikia.nocookie.net/warframe/images/c/c7/Wikia_Badge_2.png' alt='Admin' /></a>";
    var bureaucratTag = "<a href='http://pt-br.warframe.wikia.com/wiki/WARFRAME_Wiki_PT-BR_:Burocratas'>Burocrata <img src='https://vignette.wikia.nocookie.net/warframe/images/c/c7/Wikia_Badge_2.png' alt='Admin' /></a>";
    var moderatorTag = "<a href='http://pt-br.warframe.wikia.com/wiki/WARFRAME_Wiki_PT-BR_:Administradores#Moderadores'>Moderador</a>";
    var VSTF = "<a href='http://warframe.wikia.com/wiki/Help:VSTF'>VSTF</a>";
    var staff = "<a href='http://pt-br.warframe.wikia.com/wiki/Ajuda:Wikia_Staff'>Staff</a>";
    var councilor = "<a href='http://pt-br.warframe.wikia.com/wiki/Ajuda:Community_Council'>Councilor</a>";
    var star = "<a href='http://www.wikia.com/Stars'>Wikia Star</a>";
    var founder = "<a href='http://pt-br.warframe.wikia.com/wiki/WARFRAME_Wiki_PT-BR_:Administradores'>Founder</a>";
    ...
    rights["--FOTS--Eduardo.sdss"]     = [hunter],
...
//    rights["NAME"]                = [adminTag],
    ...
    //Bureaucrats
    rights["-DaxKyle-"]                 = [bureaucratTag, adminTag],
    rights["Dioniso7"]                  = [bureaucratTag, adminTag],

    //Moderator
 
    rights["Joaoppd"]                  = [moderatorTag, chatMod],
    rights["Ricop02"]                  = [moderatorTag, chatMod],
    
    //Chat Moderator
    rights["JahmallHobbs"]             = [chatMod],
