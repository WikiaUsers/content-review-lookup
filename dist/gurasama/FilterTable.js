	...
	$("table.filterable").each(function(){
		...
		$(this).find("tr:first-child th").each(function(){
			if (!$(this).hasClass("unfilterable")){
				...
				$(this).html('<a href="javascript:void(0)" class="showFilterMenu" style="background:#4080bf;color:#fff">'+$(this).html()+'▼</a>');
				$(this).append($('<div class="filterMenu" style="position:absolute;top:'+$(this).height()+'px;left:0;width:'+(22+l*7)+'px;text-align:left;padding:5px;border:2px #ccc outset;background:#4080bf;z-index:1;display:none"></div>'));
				for (j=0; j<cols.length; j++){
