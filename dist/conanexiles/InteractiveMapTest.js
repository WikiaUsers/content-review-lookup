;(function(mw) {
	...
	function myInit() {
		...
		var myTestElement = document.getElementById('myTestElement');
		if(!myTestElement) return;
		
		var style = document.createElement('style');
		style.innerHTML = '.leaflet-container {\n' +
		...
		divMap.innerHTML = '<div id="control-pane-container">' +
			...
			'			<li class="options-group"><label class="options-group-label" onclick="toggleGroups(\'options-group-poi\')">Points Of Interest</label>' +
			...
			'				</ul>' +
			'			</li>' +
			'			<li class="options-group"><label class="options-group-label" onclick="toggleGroups(\'options-group-camps\')">NPC Camps</label>' +
			...
			'				</ul>' +
			'			</li>' +
			'			<li class="options-group"><label class="options-group-label" onclick="toggleGroups(\'options-group-thralls\')">Thralls</label>' +
			...
			'				</ul>					' +
			'			</li>' +
			'			<li class="options-group"><label class="options-group-label" onclick="toggleGroups(\'options-group-pets\')">Pets</label>' +
			...
			'				</ul>' +
			'			</li>' +
			'			<li class="options-group"><label class="options-group-label" onclick="toggleGroups(\'options-group-misc\')">Misc</label>' +
