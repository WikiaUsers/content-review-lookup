...
function initDiscordModule() {
    ...
    var discordJSON = "https://discordapp.com/api/guilds/334985310184144896/widget.json";
                ...
                '<tr>' +
                    ...
                    '</td>' +
                      '<td style="vertical-align:middle; width:90px;">' +
                        '<center>' +
                            '<img alt="Discord" src="https://vignette.wikia.nocookie.net/mocreatures/images/8/8f/Display_Wyvern_Lair_Grass.png/revision/latest?cb=20170719202107&path-prefix=ru" class="discord-icon">' +
