...
// combined and modified by [[wikipedia:User:Ilmari Karonen]]
...
var EditTools =
{
  charinsert : {
     ...
     'Wiki markup': '{\{+}} {\{\{+}}} | [+] [\[+]] [\[Category:+]] #REDIRECT.[\[+]] [\[w:c:elderscrolls:+|]] [\[w:c:oblivion:+|]] &nbsp; <s>+</s> <sup>+</sup> <sub>+</sub> <source>+</source> <code>+</code> <pre>+</pre> <blockquote>+</blockquote> <ref>+</ref> {\{Reflist}} <references/> <includeonly>+</includeonly> <noinclude>+</noinclude> <gallery>+</gallery> {\{DEFAULTSORT:+}} <nowiki>+</nowiki> <!--.+_--> <span.class="plainlinks">+</span> {\{PAGENAME}} {\{FULLPAGENAME}}',
     'Symbols': '~ | ¡¿†‡↔↑↓•¶  # ¹²³½⅓⅔¼¾⅛⅜⅝⅞∞  ‘“’” «+»  ¤₳฿₵¢₡₢$₫₯€₠₣ƒ₴₭₤ℳ₥₦№₧₰£៛₨₪৳₮₩¥  ♠♣♥♦  m² m³', 
