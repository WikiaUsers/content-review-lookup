...
function setupUploadForm()
{
  ...
  if (wpLicense)
  {
    if (window.location.search.indexOf('basic=true') == -1)
    {
      ...
      newRowControl.innerHTML = '<textarea id="attentionBox" cols="60" rows="2" style="overflow: auto;" tabindex="5" onfocus="document.editform.wpTextbox1 = this;"></textarea>';
