	...
	$('#ssv_main_body').append(
		'<div id="ssv_wrapper" style="max-height: 768px; overflow: hidden;">' +
			...
			'<div class="ssv_overlay">' +
				'<div class="ssv_menu">' +
					'<img class="ssv_fullWidthImg" src="' + imageUrl + '4/4a/Viewer_menu_%28starships%29.png?action=purge" />' +
				...
				'<div id="ssv_submenu">' +
					...
					'<div>' +
						'<img id="ssv_buttonEngine" class="ssv_subButton" src="' + imageUrl + '8/80/Viewer_button_engine_%28starships%29.png" />' +
					'</div>' +
					'<div>' +
						'<img id="ssv_buttonShield" class="ssv_subButton" src="' + imageUrl + '5/55/Viewer_button_shield_%28starships%29.png" />' +
					'</div>' +
					'<div>' +
						'<img id="ssv_buttonArmor" class="ssv_subButton" src="' + imageUrl + '2/2a/Viewer_button_armor_%28starships%29.png" />' +
					'</div>' +
					'<div>' +
						'<img id="ssv_buttonLaser" class="ssv_subButton" src="' + imageUrl + '8/8b/Viewer_button_laser_%28starships%29.png" />' +
					'</div>' +
					'<div>' +
						'<img id="ssv_buttonCannon" class="ssv_subButton" src="' + imageUrl + '6/6e/Viewer_button_cannon_%28starships%29.png" />' +
					'</div>' +
					'<div>' +
						'<img id="ssv_buttonTorpedo" class="ssv_subButton" src="' + imageUrl + 'a/ac/Viewer_button_torpedo_%28starships%29.png" />' +
					'</div>' +
					'<div>' +
						'<img id="ssv_buttonSensor" class="ssv_subButton" src="' + imageUrl + '5/5c/Viewer_button_sensor_%28starships%29.png" />' +
					'</div>' +
					'<div>' +
						'<img id="ssv_buttonStealth" class="ssv_subButton" src="' + imageUrl + '9/9c/Viewer_button_stealth_%28starships%29.png" />' +
					'</div>' +
					'<div>' +
						'<img id="ssv_buttonHangar" class="ssv_subButton" src="' + imageUrl + '6/64/Viewer_button_hangar_%28starships%29.png" />' +
					'</div>' +
				'</div>' +
				'<div id="ssv_infoArea">' +
					'<div id="ssv_infoEngine" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + '5/57/Viewer_supremacy_engine_%28starships%29.png" />' +
					...
					'<div id="ssv_infoShield" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + 'f/fe/Viewer_supremacy_shield_%28starships%29.png" />' +
					...
					'<div id="ssv_infoArmor" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + 'c/c5/Viewer_supremacy_fuel_%28starships%29.png" />' +
					...
					'<div id="ssv_infoLaser" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + 'f/fb/Viewer_supremacy_laser_%28starships%29.png" />' +
					...
					'<div id="ssv_infoCannon" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + 'b/b2/Viewer_supremacy_cannon_%28starships%29.png" />' +
					...
					'<div id="ssv_infoTorpedo" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + '0/01/Viewer_supremacy_front_%28starships%29.png" />' +
					...
					'<div id="ssv_infoSensor" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + 'd/d5/Viewer_supremacy_sensor_%28starships%29.png" />' +
					...
					'<div id="ssv_infoStealth" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + 'c/c8/Viewer_supremacy_stealth_%28starships%29.png" />' +
					...
					'<div id="ssv_infoHangar" class="ssv_infoPanel">' +
						...
						'</div>' +
						'<div class="ssv_clear"></div>' +
						'<img src="' + imageUrl + '6/67/Viewer_supremacy_hangar_%28starships%29.png" />' +
				...
				'</div>' +
				'<div class="ssv_badge">' +
					'<img class="ssv_fullWidthImg" src="' + imageUrl + '4/41/Viewer_supremacy_badge_%28starships%29.png?action=purge" />' +
