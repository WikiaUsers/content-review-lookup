...
console.log('Saving...');
    var $form = $('#spam'),
        ...
        page = '*Wiki: http://' + kingdomrushtd + '.wikia.com\n*Spammer: http://' + kingdomrushtd + '.wikia.com/wiki/Special:Contributions/' + encodeURIComponent(user.replace(/ /g, "_")) + '\n*Reason: ' + comments + '\n*Signature: ' + spa.signature + '';
