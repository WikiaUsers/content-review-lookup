...
require(['jquery', 'mw'], function ($, mw) {
            ...
            i18no.loadMessages('u:vstf:MediaWiki:Custom-Reports/i18n.json').done(function(i18n) {
                options = {
                    ...
                    */
                    ...
                    profile: {
                        page: 'User:Applemasterexpert/Report_User',
                                ...
                                '<fieldset>' +
                                    '<div class="rf-wrapper">' +
                                        ...
                                        '<div class="rf-section"><div class="rf-section-title"><b>' + i18n.msg("formWikiName").escape() + '</b></div>' +
                                            '<input id="wikiname" class="rf-wikiname optional" type="text" placeholder="Kingdom Rush Wiki"/>' +
                                        '</div>' + 
                                        '<div class="rf-section"><div class="rf-section-title"><b>' + i18n.msg("formWikiURL").escape() + '</b></div>' +
                                            '<input id="wikiurl" class="rf-wikiurl" type="text" placeholder="kingdomrushtd.fandom.com"/>' +
                                        '</div>' +
                    ...
                    vandalism: {
                        page: 'User:Applemasterexpert/Report_Vandalism',
                        buttonText: i18n.msg("buttonVandalism").escape(),
                        form: '<form class="WikiaForm ReportForm" method="" name="" id="vandalism">' +
                                '<fieldset>' +
                                    '<div class="rf-wrapper">' +
                                        '<div class="rf-section"><div class="rf-section-title"><b>' + i18n.msg("formWikiName").escape() + '</b></div>' +
                                            '<input id="wikiname" class="rf-wikiname optional" type="text" placeholder="Kingdom RushWiki"/>' +
                                        '</div>' + 
                                        '<div class="rf-section"><div class="rf-section-title"><b>' + i18n.msg("formWikiURL").escape() + '</b></div>' +
                                            '<input id="wikiurl" class="rf-wikiurl" type="text" placeholder="kingdomrushtd.wikia.com"/>' +
                                        '</div>' +
                                        '<div class="rf-section"><div class="rf-section-title"><b>' + i18n.msg("formUsername").escape() + '</b> ' + i18n.msg("formOfBadUser").escape() + ' (' + i18n.msg("formMultipleUsers").escape() + ')</div>' +
                    ...
                    spam: {
                        page: 'User:Applemasterexpert/Report_Spam',
                    ...
                    phalanx: 'User:Applemasterexpert/Report_AbuseFilter',
        ...
        if(opts.page === "Report:Wiki") {
            ...
            .done(function (res) {
                if (c.wgPageName == "VSTF_Wiki") {
                    location.replace('https://vstf.wikia.com/wiki/' + opts.page + '?action=purge');
                } else {
    ...
    function init() {
        ...
        importStylesheetURI('https://vstf.wikia.com/index.php?title=MediaWiki:Reports.css&action=raw&ctype=text/css');
    }
