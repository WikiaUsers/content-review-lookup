...
(function wrapper ($) {
    ...
    var Defaults = {
        ...
        defimage: 'https://vignette4.wikia.nocookie.net/twinpeaks/images/8/89/Wiki-wordmark.png',
        noimage : 'https://vignette4.wikia.nocookie.net/twinpeaks/images/8/89/Wiki-wordmark.png',
    };//defaults
    var pp = {};
    ...
    function init () {
        ...
        //parents to ignore
        Settings.RegExp.iparents = Settings.RegExp.iparents || ['[id^=flytabs] .tabs', '.editsection'];
        //classes to ignore
        ...
        //delete tags
        Settings.RegExp.dtag = Settings.RegExp.dtag || new RegExp('<(?!b).*>', 'gm');
        ...
        Settings.RegExp.prep.push(/<blockquote[\s\S]*?<\/blockquote>/igm);
        Settings.RegExp.prep.push(/<figure[\s\S]*?<\/figure>/igm);
