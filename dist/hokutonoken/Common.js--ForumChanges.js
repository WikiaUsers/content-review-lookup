...
jQuery(function ($) {
    ...
    var users = {
        // Tag all bureaucrats
        ONEY_PUNCH    : 'Founder • Bureaucrat',
        Linleybaruch : 'Co-Founder • Bureaucrat',

        // Tag all sysops
        New_World_God      : 'Sysop • Graphic Designer',
    ...
    $.each(users, function (name, v) {
        $('<strong style="color:blue"></strong>').text('(' + v + ')').insertAfter($('a.subtle[href$="User_talk:' + name.replace(/(["])/g, '\\$1') + '"]'));
    });
