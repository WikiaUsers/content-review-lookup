...
window.UserTagsJS = {
	modules: {
			...
			newuser: true,},
	tags: {
		bureaucrat: { link:'Hotel Transylvania: The Series Wiki:Administrators' },
		sysop: { link:'Hotel Transylvania: The Series Wiki:Administrators' },
		chatmoderator: { link:'Hotel Transylvania: The Series Wiki:Administrators' },
		rollback: { u:'Rollback', link:'Hotel Transylvania: The Series Wiki:Administrators' },
