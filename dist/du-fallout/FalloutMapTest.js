...
var isize=[32,32];
      	...
      	var panchor=[0,-2];
      	var map;
        var url="http://www.digital-utopia.org/";
				var i_Airfield = L.icon({iconUrl: url+'fallout4/markers/Airfield.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_BoS = L.icon({iconUrl: url+'fallout4/markers/BoS.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Brownstone = L.icon({iconUrl: url+'fallout4/markers/Brownstone.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Bunker = L.icon({iconUrl: url+'fallout4/markers/Bunker.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_BunkerHill = L.icon({iconUrl: url+'fallout4/markers/BunkerHill.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Camper = L.icon({iconUrl: url+'fallout4/markers/Camper.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Car = L.icon({iconUrl: url+'fallout4/markers/Car.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Castle = L.icon({iconUrl: url+'fallout4/markers/Castle.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Cave = L.icon({iconUrl: url+'fallout4/markers/Cave.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Church = L.icon({iconUrl: url+'fallout4/markers/Church.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_City = L.icon({iconUrl: url+'fallout4/markers/City.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_CountryClub = L.icon({iconUrl: url+'fallout4/markers/CountryClub.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_CustomHouse = L.icon({iconUrl: url+'fallout4/markers/CustomHouse.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_DiamondCity = L.icon({iconUrl: url+'fallout4/markers/DiamondCity.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Disciples = L.icon({iconUrl: url+'fallout4/markers/Disciples.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_DriveIn = L.icon({iconUrl: url+'fallout4/markers/DriveIn.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_ElevatedHighway = L.icon({iconUrl: url+'fallout4/markers/ElevatedHighway.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Encampment = L.icon({iconUrl: url+'fallout4/markers/Encampment.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Factory = L.icon({iconUrl: url+'fallout4/markers/Factory.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_FaneuilHall = L.icon({iconUrl: url+'fallout4/markers/FaneuilHall.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Farm = L.icon({iconUrl: url+'fallout4/markers/Farm.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_FillingStation = L.icon({iconUrl: url+'fallout4/markers/FillingStation.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Forested = L.icon({iconUrl: url+'fallout4/markers/Forested.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Galactic = L.icon({iconUrl: url+'fallout4/markers/Galactic.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Goodneighbor = L.icon({iconUrl: url+'fallout4/markers/Goodneighbor.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Graveyard = L.icon({iconUrl: url+'fallout4/markers/Graveyard.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Hospital = L.icon({iconUrl: url+'fallout4/markers/Hospital.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_IndustrialDome = L.icon({iconUrl: url+'fallout4/markers/IndustrialDome.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_IndustrialStacks = L.icon({iconUrl: url+'fallout4/markers/IndustrialStacks.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Institute = L.icon({iconUrl: url+'fallout4/markers/Institute.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_IrishPride = L.icon({iconUrl: url+'fallout4/markers/IrishPride.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Junkyard = L.icon({iconUrl: url+'fallout4/markers/Junkyard.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Landmark = L.icon({iconUrl: url+'fallout4/markers/Landmark.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Libertalia = L.icon({iconUrl: url+'fallout4/markers/Libertalia.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_LowRise = L.icon({iconUrl: url+'fallout4/markers/LowRise.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Mechanist = L.icon({iconUrl: url+'fallout4/markers/Mechanist.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Metro = L.icon({iconUrl: url+'fallout4/markers/Metro.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_MilitaryBase = L.icon({iconUrl: url+'fallout4/markers/MilitaryBase.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Minutemen = L.icon({iconUrl: url+'fallout4/markers/Minutemen.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Monorail = L.icon({iconUrl: url+'fallout4/markers/Monorail.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Monument = L.icon({iconUrl: url+'fallout4/markers/Monument.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Observatory = L.icon({iconUrl: url+'fallout4/markers/Observatory.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Office = L.icon({iconUrl: url+'fallout4/markers/Office.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Operators = L.icon({iconUrl: url+'fallout4/markers/Operators.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Pack = L.icon({iconUrl: url+'fallout4/markers/Pack.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Pier = L.icon({iconUrl: url+'fallout4/markers/Pier.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_PoliceStation = L.icon({iconUrl: url+'fallout4/markers/PoliceStation.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_PondLake = L.icon({iconUrl: url+'fallout4/markers/PondLake.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_PotentitalVassalSettlement = L.icon({iconUrl: url+'fallout4/markers/PotentitalVassalSettlement.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Prydwen = L.icon({iconUrl: url+'fallout4/markers/Prydwen.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Quarry = L.icon({iconUrl: url+'fallout4/markers/Quarry.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_RadioactiveArea = L.icon({iconUrl: url+'fallout4/markers/RadioactiveArea.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_RadioTower = L.icon({iconUrl: url+'fallout4/markers/RadioTower.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_RaiderSettlement = L.icon({iconUrl: url+'fallout4/markers/RaiderSettlement.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Railroad = L.icon({iconUrl: url+'fallout4/markers/Railroad.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_RailroadFaction = L.icon({iconUrl: url+'fallout4/markers/RailroadFaction.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Rides = L.icon({iconUrl: url+'fallout4/markers/Rides.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Safari = L.icon({iconUrl: url+'fallout4/markers/Safari.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Salem = L.icon({iconUrl: url+'fallout4/markers/Salem.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_SancHills = L.icon({iconUrl: url+'fallout4/markers/SancHills.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Satellite = L.icon({iconUrl: url+'fallout4/markers/Satellite.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_School = L.icon({iconUrl: url+'fallout4/markers/School.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Sentinel = L.icon({iconUrl: url+'fallout4/markers/Sentinel.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Settlement = L.icon({iconUrl: url+'fallout4/markers/Settlement.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Sewer = L.icon({iconUrl: url+'fallout4/markers/Sewer.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Shipwreck = L.icon({iconUrl: url+'fallout4/markers/Shipwreck.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Skyscraper = L.icon({iconUrl: url+'fallout4/markers/Skyscraper.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Submarine = L.icon({iconUrl: url+'fallout4/markers/Submarine.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_SwanPond = L.icon({iconUrl: url+'fallout4/markers/SwanPond.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_SynthHead = L.icon({iconUrl: url+'fallout4/markers/SynthHead.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Town = L.icon({iconUrl: url+'fallout4/markers/Town.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_TownRuins = L.icon({iconUrl: url+'fallout4/markers/TownRuins.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_UrbanRuins = L.icon({iconUrl: url+'fallout4/markers/UrbanRuins.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_USSConstitution = L.icon({iconUrl: url+'fallout4/markers/USSConstitution.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_VassalSettlement = L.icon({iconUrl: url+'fallout4/markers/VassalSettlement.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
				var i_Vault = L.icon({iconUrl: url+'fallout4/markers/Vault.png',iconSize: isize,iconAnchor: ianchor, popupAnchor: panchor,});
...
var childMapData=[
	...
	{width:6144,height:8192,zoom:3},*/
      	...
      	var topbar='<table cellspacing="0" cellpadding="0" class="mapva-navbox-border mapva-navbox-bottom"><tbody><tr><td class="mapva-navbox-padding"><table cellspacing="0" cellpadding="0" class="mapva-navbox collapsible autocollapse"><tbody><tr><th class="mapva-navbox-title mapva-navbox-maintitle" colspan="1" width="100%"><span class="collapseButton" style="float:left;text-align:left;font-weight:normal;">[<span tabindex="0" class="collapseLink" style="cursor:pointer;">Filter</span>]</span></th></tr></tbody></table></td></tr></tbody></table>';
      	var allHidden=false;
      	...
      	function markerGen(map)
      	{
      			...
      			var m=new L.marker(map.unproject([mx,my],6),
					...
					m.on('mouseover',function(e){
						...
						$("#tooltip").css("display","block");
      			        $("#tooltip").insertAfter($(e.target._icon));
						$("#tooltext").html(e.target.options.ctitle);
					
						var pos=$(e.target._icon).position();
					...
					markers.push(m);
					var popupContent="<div page=\""+locale[lang].markerData[i].page+"\"id=\"mapWikiaMainContentContainer\" class=\"mapWikiaMainContentContainer\"><header id=\"mapWikiaPageHeader\" class=\"mapWikiaPageHeader\"><h1 id=\"title\">"+locale[lang].markerData[i].title+"</h1></header><div id=\"overlay\"><span class=\"helper\"></span><img class=\"ajax\" src=\"ajax.gif\"/></div><div id=\"mapmw-content-text\" lang=\"en\" dir=\"ltr\" class=\"mapmw-content-ltr\"><table id=\"mapva-infobox0\" class=\"mapva-infobox\" style=\"width: 100px;\" cellspacing=\"0\" cellpadding=\"0\"><tbody><tr><td class=\"mapva-infobox-mainimage-image\" style=\"\"><img id=\"image\"/></td></tr></tbody></table></div><span class=\"seeMore\"><a target=\"blank\"href=\""+locale[lang].url+locale[lang].markerData[i].page+"\">"+locale[lang].text["See more"]+"></a></span></div>";
      		...
      		m.on('popupopen',function(e){
						...
						var jqxhr = $.getJSON( "pageGrabber.php?p="+$("#mapWikiaMainContentContainer").attr("page")+"&lng="+lang, function(data) {
						  $("#mapmw-content-text").css("display","block");
						  $("#mapmw-content-text").append(data.content);
						  $("#image").attr("src",data.img);
						  $("#overlay").css("display","none");
						  $(".editsection").css("display","none");
						  $("#mapva-titleicons").css("display","none");
						  $(".mapva-quotation").css("display","none");
      	...
      	function rectGen(map)
      	{
      		for(var i=0; i < rectData.length; i++)
      		{
      			...
      			r.on('mouseover',function(e){
		      		...
		      		L.tileLayer(url+"fo4maps/"+p.options.world+"/{z}/{x}_{y}.png", {
		      			continuousWorld: 'true',
		      			errorTileUrl: url+'fo4maps/'+p.options.world+'/blank.png',
		      		...
		      		for(var j=0; j < rectData[idx].markerData.length; j++)
      		{
				...
				/*	$('.leaflet-marker-icon').mouseover(function(e){
                  ...
                  console.log(currentMarker.options.ctitle);
      		...
      		$('.leaflet-marker-icon').mouseout(function(){
      			$("#tooltip").css("display","none");
					...
					markers.push(m);
					var popupContent="<div page=\""+locale[lang].rectData[idx].markerData[j].page+"\"id=\"WikiaMainContentContainer\" class=\"WikiaMainContentContainer\"><header id=\"WikiaPageHeader\" class=\"WikiaPageHeader\"><h1 id=\"title\">"+locale[lang].rectData[idx].markerData[j].title+"</h1></header><div id=\"overlay\"><span class=\"helper\"></span><img class=\"ajax\" src=\"ajax.gif\"/></div><div id=\"mapmw-content-text\" lang=\"en\" dir=\"ltr\" class=\"mapmw-content-ltr\"><table id=\"va-infobox0\" class=\"va-infobox\" style=\"width: 100px;\" cellspacing=\"0\" cellpadding=\"0\"><tbody><tr><td class=\"va-infobox-mainimage-image\" style=\"\"><img id=\"image\"/></td></tr></tbody></table></div><span class=\"seeMore\"><a target=\"blank\"href=\"http://"+lang+".fallout.wikia.com/wiki/"+locale[lang].rectData[idx].markerData[j].page+"\">See more ></a></span></div>";
      		var p=new L.popup({maxWidth:415,minWidth:415}).setContent(popupContent);
      		m.bindPopup(popupContent,{maxWidth:415,minWidth:415});
      		m.on('popupopen',function(e){
						if($("#overlay").css("display")!="none"){
						var jqxhr = $.getJSON( url+"fallout4/pageGrabber.php?p="+$("#mapWikiaMainContentContainer").attr("page")+"&lng="+lang, function(data) {
						  $("#mapmw-content-text").css("display","block");
						  $("#mapmw-content-text").append(data.content);
						  $("#image").attr("src",data.img);
						  $("#overlay").css("display","none");
      	...
      	function init(mname)
      	{
      		if(mname !== typeof undefined && mname !== false)
      		{
      		...
      		//L.tileLayer('zipimg.php?n=wasteland&z={z}&x={x}&y={y}', {
      		    L.tileLayer(url+'fo4maps/commonwealth/{z}/{x}_{y}.png', {
      			    continuousWorld: 'true',
      			    errorTileUrl: url+'fo4maps/blank.png',
				...
				$( document ).ready(function() {
					if($("#map").length > 0){
                        //$("#The_Commonwealth").parent().after('<div id="map"></div><div id="tooltip"><span id="tooltext">Testing 123</span></div>');
                       
                    init($("#map").attr("data-map"));
					$('#map').append(fcontent);
					//$('#map').append(topbar);
					...
					$.each(locale[lang].filterText, function(k,v){
						...
						$(".menu-img",sl).attr("src",url+"fallout4/markers/"+k+".png");
						$(".menu-img-over",sl).attr("src",url+"fallout4/markers/"+k+"-inv.png");
					});
