...
window.SkinNotification = {
	...
	render: function() {
		...
		var sn = $('<div data-type="100"><a class="sprite close-notification"></a>La wiki anda en un proceso inicial mientras tanto('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'">puedes crear un artículo</a>.</div>');
...
function Juegos de Lucha_WikiaSkinLoad() {
	var ug = '';
