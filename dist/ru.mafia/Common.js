...
var AjaxRCRefreshHoverText = 'Включить автообновление страницы'; //
...
/* Иконка ВК */
$('.WikiaRail').prepend('<div style="right:-1px; top:108px; position: absolute;"><div style="position: absolute;" class="SocialIcon"><div style="float:right;"><a href="http://vk.com/mafia_wiki"><img src="https://images.wikia.nocookie.net/__cb20140425100139/callofduty/ru/images/3/30/Vkontakte_logo.png"></a></div></div>');
...
dev.StarRatings.ui.simple = function($this, callbacks/*, conf*/) {
	...
	return {
		...
		onAjaxFail: function() {
			$status.text('Неудача. Ошибка сервера.');
		}
	};
};
