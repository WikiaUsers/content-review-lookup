...
(function($, mw) {
	...
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/Wiki Sekirei:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Wiki Sekirei:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Wiki Sekirei:Reversores">reversor</a>',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
