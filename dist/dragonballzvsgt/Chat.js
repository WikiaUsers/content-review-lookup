...
var chatOptions = {
	look: {
		...
		modalIcon: "https://images.wikia.nocookie.net/dragonballzvsgt/images/f/fc/Z.png"
	},
	modules: {
		chatHacks: {
			element: "#chatHacks",
...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; font-size:150%; bottom:4px; padding-bottom:2px; border-bottom: 1px solid #FF7F00; width:90%;" align="center"><img src="' + chatOptions.look.modalIcon + '" width="18px"/>&nbsp;Options</div>'); // Prevent multiple buttons from being appended
}
