(function() {
    ...
    if (currentPage !== 'О_рекламах_Вики:Топ' && currentPage !== 'Лост_Сообщество_Вики:Топ') {
    ...
    function displayTopUsers() {
        ...
        sortedUsers.forEach(function(user) {
            output += '<li><a href="https://aboutad.fandom.com/ru/wiki/User:' + user.name + '">' + user.name + '</a>: ' + user.count + '<details><summary>Страницы</summary><ol>';
            user.pages.forEach(function(page) {
                output += '<li><a href="https://aboutad.fandom.com/ru/wiki/' + page + '">' + page + '</a></li>';
            });
