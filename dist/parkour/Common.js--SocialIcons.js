 ...
 * SCRIPT OBTAINED FROM Wikia Developers Wiki @ w:c:dev:SocialIcons/code.js
 * Modified slightly just for this wiki
...
(function ($, mw) {
	...
	var config = window.SocialMediaButtons = $.extend(true, {
		...
		de: {
			...
			via: "via+@Wikia_de+@KFPWikiOfficial"
		},
		// English
		en: {
		...
		es: {
			...
			via: "vía+@Wikia_es+@KFPWikiOfficial"
		},
		// Hungarian
		hu: {
		...
		ja: {
			...
			via: "を用いて+@Wikia+@KFPWikiOfficial"
		},
		// Dutch
		nl: {
			...
			via: "via+@Wikia_nl+@KFPWikiOfficial"
		},
		// Polish
		pl: {
			...
			via: "przez+@Wikia_pl+@KFPWikiOfficial"
		},
		// Portuguese
		pt: {
			...
			via: "via+@Wikia_pt+@KFPWikiOfficial"
		},
		// Chinese
		zh: {
			google: "在Google+上分享",
		...
		fr: {
			...
			via: "via+@wikia_fr+@KFPWikiOfficial"			
		}
