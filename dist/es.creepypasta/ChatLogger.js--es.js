...
$('form#Write').append('<a class="wikia-button" href="javascript:submitLog()" style="position:absolute; right:50px; top:0;" title="submit chat log">Publicar</a>');
...
function submitLog(restart) {
	...
	callAPI({
		...
		'prop': 'info|revisions',
		'intoken': 'edit',
		'titles': 'Project:Registros/Chat/'+date,
		'rvprop': 'content',
		'rvlimit': '1',
		'indexpageids': 'true',
	}, 'GET', function(response) {
		...
		callAPI({
			'minor': 'yes',
			'bot': 'yes',
			'summary': 'Publicando registros del chat',
			'action': 'edit',
			'title': 'Project:Registros/Chat/'+date,
