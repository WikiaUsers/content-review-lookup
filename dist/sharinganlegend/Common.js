 ...
 * http://sharinganlegend.wikia.com/wiki/MediaWiki:Common.js
...
(function (window, $, mw) {
	...
	// List Files. See [[Sasuke Uchihas Sharingan Legend Wiki:ListFiles]]
	...
	if (mw.config.get('wgPageName') === 'Sasuke Uchihas Sharingan Legend Wiki:Duplicate_Images') {
