...
/**
 * Modified from http://avatar.wikia.com/wiki/MediaWiki:Common.js/icons.js
 */
$( function eraIconsOasis() {
	var $eraIcons = $( '#title-eraicons' );
	if ( $eraIcons.length ) {
		$( '.WikiaPageHeader' ).css( { 'margin-bottom' : '20px' } ).append( $eraIcons );
		$eraIcons.css( { 'position' : 'absolute', 'right' : '0', 'bottom' : '-2em' } ).show();
	}
} );