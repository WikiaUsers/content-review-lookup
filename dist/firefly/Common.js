...
// AjaxRC
window.ajaxPages = [ 'Special:RecentChanges', 'Special:Watchlist', 'Special:Log', 'Special:NewFiles' ];
mw.loader.load( '//dev.wikia.com/index.php?title=AjaxRC/code.js&action=raw&ctype=text/javascript' );
