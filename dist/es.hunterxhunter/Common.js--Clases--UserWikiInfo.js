...
(function($, mw, jsSHA) {
	...
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/Wiki_Hunter_x_Hunter:Administradores">burócrata</a>',
		sysop: '<a href="/wiki/Wiki_Hunter_x_Hunter:Administradores">administrador</a>',
		rollback: '<a href="/wiki/Wiki_Hunter_x_Hunter:Administradores">reversor</a>',
		asistente: '<a href="/wiki/Wiki_Hunter_x_Hunter:Administradores">asistente</a>',
		bot: '<a href="/wiki/Wiki_Hunter_x_Hunter:Administradores">bot</a>',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
