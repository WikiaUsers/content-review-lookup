...
jQuery(function ($) {
    ...
    if(!$("#forum-warning-banner").length) {
        $("li.SpeechBubble").first().before(
            ...
            '<br><br> For any assistance, request action from a forum moderator by going to the <a href="/Narutopedia:Sysop_Requests?action=edit&section=4">Requests page.</a></div>'
        );
    }
