...
***/
        var imageUrl = 'https://static.wikia.nocookie.net/blasphemous/images/e/e0/Blasphemous_map_ru.jpg/revision/latest?cb=20200930084325&path-prefix=ru';
        var bounds = [[0, 0], [2650, 4600]];
        var map = L.map('map1', {
            crs: L.CRS.Simple,
            minZoom: -2,
            maxZoom: 1,
