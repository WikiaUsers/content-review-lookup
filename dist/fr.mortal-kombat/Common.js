...
AjaxRCRefreshText = 'Auto-refresh'; AjaxRCRefreshHoverText = 'Automatically refresh the page'; importScriptPage('AjaxRC/code.js', 'dev'); var ajaxPages =["Special:WikiActivity"];

// See dev.wikia.com/wiki/ShowHide
...
window.AjaxRCRefreshText = '---';
window.AjaxRCRefreshHoverText = 'Purge automatiquement la page';
importScriptPage('AjaxRC/code.js', 'dev');