...
window.MessageWallUserTags = {
    ...
    users: {
        ...
        'Neon the Spelunker': 'Administrator',
        'Docter98': 'Administrator',
        'JosephTheElite': 'Administrator',
        'KamariU': 'Administrator',
        'Lumoshi': 'Administrator'
    }
};
...
window.AutoCreateUserPagesConfig = {
    content: {
        2: 'MediaWiki:Welcome-user-page',
        3: 'MediaWiki:Welcome-message-wall-user'
    },
