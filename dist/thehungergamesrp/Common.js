...
/* Message Wall and Forum background color*/
$(".replies .speech-bubble-avatar>a[href*='BaconCanadian']").each(function(){
  $(this).parent().parent().css('background','silver'); //setting background color
  $(this).parent().parent().addClass('myCommentClass'); //add class
});
...
window.UserTagsJS = {
	...
	tags: {
        ...
        Enraptured Misfit: { u:'Chanel Oberlin' },
    
        Probably Reading: { u:'Chanel Oberlin' }
		
	}
};
 
UserTagsJS.modules.custom = {
	'Enraptured Misfit': ['Enraptured Misfit'],
	'Probably Reading': ['Probably Reading']
