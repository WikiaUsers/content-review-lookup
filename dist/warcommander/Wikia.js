...
function inlineVersionsInit() {
	...
	if (iv.length == 0) return;
	$("#ptabs.fswitch").remove(); // [[Template:Faction disambiguation]] emits a prototype tab header which is deprecated
...
/*
background {
.tableres (color:#321e25);
.tabledata (color:#181b1e);
.eventunit (color:#293a41);
}
*/