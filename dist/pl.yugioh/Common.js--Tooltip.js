...
function showTip(e) {
    ...
    if ($p.hasClass("selflink") == false) {
        ...
        $tfb.load(url, function() {
            ...
            if ($tfb.html() == "") $tfb.html('<div class="tooltip-content module" style="background:#000000 !important; color:#ffffff">Ten artykuł nie istnieje<br />lub nie posiada podglądu.</div>');
