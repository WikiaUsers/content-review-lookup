...
$(document).ready(function() {
	...
	$.each(ground, function(i, groundItem) {
		...
		'<div class="img-toggler-wrapper" data-type="ground" data-id="' + i + '" title="' + groundName + '"><img class="img-toggler" src="' + location + groundImage + '" width="100" height="100" /></div>'
    	);
	});
	...
	$.each(walls, function(i, wallsItem) {
		...
		'<div class="img-toggler-wrapper" data-type="walls" data-id="' + i + '" title="' + wallsName + '"><img class="img-toggler" src="' + location + wallsImage + '" width="100" height="100" /></div>'
    	);
	});
	...
	$.each(roof, function(i, roofItem) {
		...
		'<div class="img-toggler-wrapper" data-type="roof" data-id="' + i + '" title="' + roofName + '"><img class="img-toggler" src="' + location + roofImage + '" width="100" height="100" /></div>'
    	);
	});
	...
	$.each(decoration, function(i, decorationItem) {
		...
		'<div class="img-toggler-wrapper" data-type="decoration" data-id="' + i + '" title="' + decorationName + '"><img class="img-toggler" src="' + location + decorationImage + '" width="100" height="100" /></div>'
    	);
	});
