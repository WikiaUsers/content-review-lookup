...
$(function () {
    ...
    window.SpoilerAlert = (function (my, console, Math) {
        ...
        my = $.extend({
            question: 'This page Could contain material of an appropriate nature to small children. Please do not go on this page if you are at a place of education or work. Are you willing to check this page?',
            yes: 'Yes, I am.',
            no: 'No, I'm not.',
            isSpoiler: function () {
        ...
        function getBackgroundColor () {
            ...
            if ('transparent' !== color) return color;
            console.log('Spoiler Alert: Cannot determine color');
            return color;
        }
