...
/** CSS einbinden */
 function addCSS(title) {
     document.write(
                '<style type="text/css">/*<![CDATA[*/ @importgame "/index.php?title=' + 
...
function changeStart()
{
	...
	foo.style.background="url('https://images.wikia.nocookie.net/game-pedia/de/images/8/87/Banner.png') no-repeat middle middle";
