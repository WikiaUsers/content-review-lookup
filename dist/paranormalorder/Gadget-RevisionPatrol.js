...
$( function() {
	var i18n = {
		...
		unpatrollable: 'Não patrulhável',
		unpatrolled: 'Não patrulhada',
		autopatrolledLegend: 'edição autopatrulhada',
		patrolledLegend: 'edição patrulhada',
		unpatrollableLegend: 'edição não patrulhável',
		unpatrolledLegend: 'edição não patrulhada',
		error: 'Falha ao recuperar informações de patrulha',
		rightsError: 'Falha ao recuperar direitos de patrulha automática',
