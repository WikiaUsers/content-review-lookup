 ...
 * <code> mw.loader.load("https://thray.fandom.com/wiki/MediaWiki:Common.js?action=raw\u0026ctype=text/javascript"); </code>
 * as the content of common.js to import from this script.
 *
 * See [https://thray.fandom.com/zh/wiki/MediaWiki:Common.js zh wiki] for example.
 */
    ...
    $("table.ajax").each(function (i) {
        ...
        table.find(".ajax-load-link").parent().andSelf().filter('a').click(function(event) {
            ...
            $.get(baseLink + $.param({ action: 'render', title: sourceTitle }), function (data) {
                ...
                cell.find('.thray:not(.ajaxForceThray)').removeClass('thray');
...
$(function() {
    ...
    $('a[href^="//thray.fandom.com/"]').removeAttr('target');
