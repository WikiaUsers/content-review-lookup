...
window.snowStorm = {
	...
	flakesMax: 80,			// Limit total amount of snow made (falling + sticking)
	flakesMaxActive: 5,		// Limit amount of snow falling at once (less = lower CPU use)
	...
	snowColor: '#6495ED',		// Don't eat (or use?) yellow snow.
	snowCharacter: 'Merry Christmas!',
