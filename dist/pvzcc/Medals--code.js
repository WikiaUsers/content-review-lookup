        ...
        tooltip: function(that) {
            ...
            $('body').append(
                '<div class="badgetooltip" style="position:absolute; z-index:5000;">' +
                    ...
                    '<div class="badgetooltipwindow" style="width: 180px; background-color:white; border:2px solid black; border-radius:5px; text-align:center; padding:5px; color:black;">' +
