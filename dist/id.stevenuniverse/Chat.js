...
setInterval(function () {
    ...
    $('.User.chat-mod .username').each(function () {
        if (this.innerHTML.match(/Pearl is awesome|HallowedArcher|Yolka Crazy!|Brandon the Klaine Lover/)) {
        ...
        if (this.innerHTML.match(/Flambo the Epic Epic(;/)) {
            $(this).parent().addClass('patroller').removeClass('chat-mod');
        }
        if (this.innerHTML.match(/StevenBot|Flambot/)) {
