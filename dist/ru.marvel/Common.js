...
$(document).ready(function() {
	...
	var wiki_name_text=["Эксельсиор!", "Мстители, общий сбор!", "Ко мне, мои Люди Икс!", "С великой силой...", "Халк крушить!", "Пламя!", "Ваканда навеки!", "Я – Железный Человек", "Время крушить!", "Мы – Веном", "Я есть Грут", "Гений, миллиардер, плейбой, филантроп", "Пока вы спали, мир изменился!" "Твип!", "Великая сила, никакой ответственности!", 'Посмотри правде в глаза, Тигр ... ты только что сорвал джекпот!' ][wiki_name_number];
    ...
    if (mw.config.get('wgCanonicalSpecialPageName') === 'Upload') {
        ...
        function populateDescriptions() {
			...
			while (true) {
			  var field = document.querySelector('#wpUploadDescription' + descIndex);
			  if (!field) {
			    break;
			  }
		...
		var observer = new MutationObserver(function() {
		  if (document.querySelector('#wpUploadDescription' + descIndex)) {
