 ...
 * © Peter Coester, 2012 - Modified by Alvin Wiki (notice parameter), 2017
 *
 * __NOWYSIWYG__
 */
...
$(function () {
    ...
    window.SpoilerAlert = (function (my, console, Math) {
        ...
        my = $.extend({
            question: 'This page may contain spoilers. Are you sure you wish to continue?',
            yes: 'Yes, please',
            no: 'No, not yet',
            notice: 'Don\'t wish to see this message in the future? Edit your <a href="/wiki/Special:BlankPage?blankspecial=CodeLoadPrefs">script preferences</a>.',
            isSpoiler: function () {
        ...
        '<table id="dialog" border="0" cellpadding="20" style="background-color: white; border-radius: 4px; border: 2px solid black;">' +
            ...
            '</tr>' +
            '<tr>' +
                '<td style="padding: 0 30px 15px; text-align: center; border-style: none;">' +
            ...
            '</tr>' +
            '<tr>' +
                '<td colspan="2" style="padding: 0 20px 15px; border-style: none; text-align: center; font-size: 13px; color: black">' +
                    my.notice +
                '</td>' +
            '</tr>' +            
        '</table>';
