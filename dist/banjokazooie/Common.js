...
// The following enables the Recent Changes to be reset every 60 seconds if "Auto-refreshing" is ticked.
// Code courtesy of pcj of WoWWiki.
// This is a modified version of the WoWWiki site version, in that it is designed for global.js use.
// This was actually taken from the RuneScape Wiki
...
return banjokazooie(document.cookie.substring(c_start,c_end))
} 
}
return ""
}
...
document.getElementsByTagName("h1")[s].innerHTML += '&nbsp;<span style="font-size: xx-small; border-bottom: 1px dotted; cursor:help;" title="Enable auto-refreshing recent changes">Auto-refreshing:</span><input type="checkbox" id="ajaxRCtoggle" onClick="toggleRC();">';
