/*
* Please note: this is translated into Russian 
* version of the script
*
* Обратите внимание: это переведенная 
* на русский язык версия скрипта
*/
...
function openOptions() {
	...
	var $optionsWindowHTML = $.showCustomModal( "Опции", '<form method="" name="" class="WikiaForm "><fieldset><p style="font-size:120%; font-weight:bold; font-style:italic;">Выбор цвета</p><p style="font-size:80%;">Введите <a href="https://www.w3schools.com/colors/colors_names.asp" target="_blank"> имя цвета </a> или <a href="https://html-color-codes.info/" target="_blank">HEX-код цвета</a><p>Задний фон чата&nbsp;<input type="text" name="backgroundColourinput" id="backgroundColourinput" value="' + chatOptions.look.backgroundColor + '"/></p><br/><p>Цвет фона сообщений&nbsp;<input type="text" name="selfPostColourinput" id="selfPostColourinput" value="' + chatOptions.look.selfPostColor + '"/></p><br/><p>Окружение&nbsp;<input type="text" name="surroundColourinput" id="surroundColourinput" value="' + chatOptions.look.surroundColor + '"/></p><br/><p>Цвет шрифта&nbsp;<input type="text" name="fontColourinput" id="fontColourinput" value="' + chatOptions.look.fontColor + '"/></p><br/><p style="font-size:120%; font-weight:bold; font-style:italic;">Шрифт</p><p>Семейство шрифтов <select id="fontList"><option value="arial" style="font-family:arial;">Arial</option><option value="courier new" style="font-family:courier new;">Courier new</option><option value="georgia" style="font-family:georgia;">Georgia</option><option value="palatino linotype" style="font-family:palatino linotype;">Palatino linotype</option><option value="Comic Sans MS" style="font-family:Comic Sans MS;">Comic sans</option><option value="tahoma" style="font-family:tahoma;">Tahoma</option><option value="Trebuchet MS" style="font-family:Trebuchet MS;">Trebuchet MS</option><option value="Verdana" style="font-family:Verdana;">Verdana</option><option value="Lucida Console" style="font-family:Lucida Console;">Lucida Console</option></select></p><br/><p style="font-size:120%; font-weight:bold; font-style:italic;">Функции</p><input type="checkbox" name="chatHacks" value="chatHacks" id="chatHacks"/> Включить <a href="//dev.wikia.com/wiki/MediaWiki:ChatHacks.js" target="_blank">чат-хаки</a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="multiPM" value="multiPM" id="multiPM"/> Включить <a href="//dev.wikia.com/wiki/MediaWiki:Multipms.js" target="_blank">мульти ЛС</a><br/><input type="checkbox" name="tabComplete" value="tabComplete" id="tabComplete"/>Включить <a href="//dev.wikia.com/wiki/MediaWiki:Tabinsert.js" target="_blank">поиск участников</a>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="searchBar" value="searchBar" id="searchBar"/>Включить <a href="//dev.wikia.com/wiki/MediaWiki:ChatSearchbar/code.js" target="_blank">поисковик</a><br/><input type="checkbox" name="multiKick" value="multiKick" id="multiKick" />Включить <a href="//dev.wikia.com/wiki/MediaWiki:Multikick.js" target="_blank">мульти-кик</a>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ignoreURL" value="ignoreURL" id="ignoreURL"/>Игнорировать ссылки в главном чате<br /><input type="checkbox" name="stopSideScroll" value="stopSideScroll" id="stopSideScroll"/>Остановить полосу прокрутки после спама</fieldset></form>', {
		id: "optionsWindow",
        width: 600,
        buttons: [
		{
...
if (!$("#chatOptionsButton").length) {
	$('.Rail').prepend('<div id="chatOptionsButton" onclick="openOptions();" style="margin:auto; cursor: pointer; font-size:150%; bottom:4px; padding-bottom:2px; border-bottom: 1px solid #CCCCCC; width:90%;" align="center"><img src="' + chatOptions.look.modalIcon + '" width="18px"/>&nbsp;Опции</div>'); // Prevent multiple buttons from being appended
}
