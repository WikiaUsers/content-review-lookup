...
var UserWikiInfo = {
	tmpl: '<div id="UserWikiInfo"><div class="useravatar"><a href="/wiki/Usuario:{u}" title="Avatar de {U}"><img src="https://images.wikia.nocookie.net/__cb20081128203240/messaging/images/thumb/1/19/Avatar.jpg/50px-Avatar.jpg" width="75" height="75" alt="Avatar" /></a>{editavatar}</div>' +
		'<span class="userlink"><a href="/wiki/Usuario:{u}" title="Página de usuario">{U}</a></span> &#124; <span class="talklink"><a href="/wiki/Usuario_Discusión:{u}" title="Página de discusión">Disc.</a> <a href="/index.php?title=Usuario_Discusión:{u}&amp;action=edit&amp;section=new" title="Dejar un nuevo mensaje en la página de discusión">(+)</a></span> &#124; <span class="bloglink"><a href="/wiki/Usuario_Blog:{u}" title="Blog del usuario">Blog</a></span>{email} &#124; <span class="contribslink"><a href="/wiki/Especial:Contribuciones/{u}" title="Contribuciones de usuario">Contribuciones</a></span>{group}'+
		'<div class="contribdetails"></div></div>',
	emailtmpl: ' &#124; <span class="emaillink"><a href="/wiki/Especial:MandarEmailUsuario/{u}" title="Enviar e-mail a usuario">E-mail</a></span>',
	contrtmpl: 'Hola, ¿Sabías que he realizado {c} ediciones desde el {fe}?<br /><span class="contenteditcount"><a href="/wiki/Especial:Editcount/{U}" title="{cu} ediciones (el {r}% del total) se han hecho en artículos, categorías, imágenes y plantillas. Ver estadísticas avanzadas."><span class="psmax"><span class="psact pslvl{l}" style="width:{r}%;"></span></span></a></span>',
	grouptmpl: ' &#124; <span class="usergroups" title="Grupos a los que pertenece el usuario"> {g}</span>',
	datefm: '{d} de {m} de {y}',
	editavatar: '<a class="editavatar" href="/wiki/Especial:Preferencias#wkUserChooseDivText">Cambiar avatar</a>',
	months: ['enero', 'febrero', 'marzo', 'abril', 'mayo', 'junio', 'julio', 'agosto', 'septiembre', 'octubre', 'noviembre', 'diciembre'],
	groupseparator: ', ',
	groups: {
		bureaucrat: '<a href="/wiki/Mundo Pokémon Wiki:Administradores">Burócrata</a>',
		sysop: '<a href="/wiki/Mundo Pokémon Wiki:Administradores">Administrador</a>',
		rollback: '<a href="/wiki/Mundo Pokémon Wiki:Reversores">Reversor</a>',
		asistente: '<a href="/wiki/Mundo Pokémon Wiki:Asistentes">Asistente</a>'
	},
