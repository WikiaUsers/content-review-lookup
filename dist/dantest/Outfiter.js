    ...
    $('div.outfiter').each(function () {
      ...
      var
        ...
        outfiter_mount_names = [
          ...
          /*130*/
          'Rabbit_Rickshaw', 'Bunny_Dray', 'Cony_Cart'
        ], //new mounts must also be added to Outfiter/Code_Template and Template:Infobox_Mount
        ...
        outfiter_names = [
          ...
          /*75*/
          'Dream_Warrior', 'Percht_Raider', 'Owl_Keeper', 'Guidon_Bearer'
        ]; //new outfits must also be added to Outfiter/Code_Template and Template:OutfiterLink
      ...
      var
        outfiter_names_extra = [105, 103, 106, 107, 108, 109, 128, 134, 104, 111, 112, 113, 114, 115, 116, 130, 117, 131, 102, 101, 124, 125, 120, 100, 118, 129, 110, 135, 137, 139, 138, 136, 121, 122, 132, 133, 119, 127, 123, 126], //outfits not on the main list
    ...
    //      'None': 2,
        ...
        outfiter_get_ajax = function (name, type) {
          var
            ...
            t;
          if (name === 'Gnome' || name === 'Dreamelf' || name === 'Hireling_Trader' || name === 'Hireling_Banker' || name === 'Hireling_Cook' || name === 'Hireling_Steward' || name === 'Hireling_Servant') { rname = name + (outfiter_GET.female ? '_Female' : ''); }
        ...
        outfiter_outfit_speed = function (i) {
          var res = 100;
          if (outfiter_special_delays.hasOwnProperty(outfiter_names[outfiter_GET.outfit])) {
            res = outfiter_special_delays[outfiter_names[outfiter_GET.outfit]][i];
          } else {
