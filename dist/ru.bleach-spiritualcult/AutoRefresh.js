...
var	ajaxIndicator = 'https://images.wikia.nocookie.net/dev/images/8/82/Facebook_throbber.gif',
	...
	refreshHover = 'Включить автоматическое обновление страницы каждую минуту',
	refreshCap   = 'Обновление страницы...',
	doRefresh    = true;
 
if ( !window.ajaxPages ) {
	var ajaxPages = new Array( 'Служебная:RecentChanges', 'Служебная:Watchlist', 'Служебная:Log', 'Служебная:NewFiles', 'Special:RecentChanges', 'Special:Watchlist', 'Special:Log', 'Special:NewFiles' );
}
...
function preloadAJAXRL() {
	...
	appTo.append( '&nbsp;<span style="font-size: xx-small; line-height: 100%;" id="ajaxRefresh"><span style="border-bottom: 1px dotted; cursor: help;" id="ajaxToggleText" title="' + refreshHover + '">' + refreshText + ':</span><input type="checkbox" style="margin-bottom: 0;" id="ajaxToggle"><span style="display: none;" id="ajaxLoadProgress"><img src="' + ajaxIndicator + '" style="vertical-align: baseline; float: none;" border="0" alt="' + refreshCap + '" /></span></span>' );
