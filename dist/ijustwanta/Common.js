...
$(function () {
    ...
    // twitter counter
    $.ajax('http://cdn.api.twitter.com/1/urls/count.json', {data:{url:url},
        dataType:'jsonp',
    ...
    // facebook counter
    $.ajax('http://graph.facebook.com/' + url,{
        dataType:'jsonp',
        success:function (data) {
