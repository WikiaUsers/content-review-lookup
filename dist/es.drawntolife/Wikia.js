...
window.SkinNotification = {
	...
	render: function() {
		...
		var sn = $('<div data-type="100"><a class="sprite close-notification"></a><a href="'+wgServer+wgArticlePath.replace('$1',SkinNotification.article.replace(/\s/g,'_'))+'" title="'+SkinNotification.article+'">Visita el foro</a>.</div>');
...
function Wiki_Drawn_to_Life_WikiaSkinLoad() {
	var ug = '';
...
Wiki_Drawn_to_Life_WikiaSkinLoad();
/*</pre>*/