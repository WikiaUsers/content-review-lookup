...
/* Adding tags */
  usertags["LS11sVaultBoy"] = ["Inactive"];
  usertags["Mr.Wiki.Pro"] = ["Inactive"];
  usertags["Johny_hil"] = ["Inactive"];
  usertags["Jav4534"] = ["Bureaucrat"];
  usertags["Monoman03"] = ["Inactive"];
  usertags["PokeMageTech"] = ["Bureaucrat"];
  usertags["Dragonballgtgoku"] = ["Bureaucrat"];
