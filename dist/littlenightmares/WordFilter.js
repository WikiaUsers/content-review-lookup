...
$('#Write textarea').keydown(function(e) {
    if (e.keyCode == 13 && wordFilter() === true && mainRoom.active === true) {
        ...
        $("div.Chat>ul").append("<li class='inline-alert'>WARNING: The message you just posted contains words marked as inappropriate. Are you sure you want to send this message?<span id='temporary'> ~<br><br>~ <span onclick='ignoreWarning();' style='color:brown;cursor:pointer;'>Yes</span> or <span onclick='endMessage();' style='color:brown;cursor:pointer;'>Cancel</span><span></li>");
