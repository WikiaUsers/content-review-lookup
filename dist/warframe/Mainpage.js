// Feature Video Responsive slider
...
$(".mainpage-box-featuredvideos-responsive .vid-item4").mouseenter(function () {
        $(".mainpage-box-featuredvideos-responsive .vid-item1").css('left', 'calc(-480px + ((100% - 480px) * 0.33))');
        $(".mainpage-box-featuredvideos-responsive .vid-item2").css('left', 'calc(-480px + ((100% - 480px) * 0.66))');
        $(".mainpage-box-featuredvideos-responsive .vid-item3").css('left', 'calc(-480px + (100% - 480px))');
	});
