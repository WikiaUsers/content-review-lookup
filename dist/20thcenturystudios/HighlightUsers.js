/***********************************************************************************************
 * TAKEN FROM THE DEV WIKI, WITH A CHANGE, THAT MOST PEOPLE THAT USE THE SCRIPT MAY NOT WANT.
 * see: w:c:dev:MediaWiki:HighlightUsers/code.js
 **********************************************************************************************/
/**
 * 
...
require(['wikia.window', 'jquery', 'mw'], function (window, $, mw) {
    ...
    HighlightUsers.prototype._generate = function() {
        this.styles = mw.util.addCSS('/* HighlightUsers styling */').ownerNode;
        this.styles.id = 'highlightUserStyles';
