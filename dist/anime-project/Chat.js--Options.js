...
function isEnabled(module){
         ...
         switch (module){
                 ...
                 case "stopSideScroll":
                      ...
                      break;
                 case "messageBlocker":
                      c = getCookie("customisation", 12);
                      break;
                 case "chatRefresh":
                      c = getCookie("customisation", 14);
                      break;
                 case "nightChatToggle":
                      c = getCookie("customisation", 15);
                      break;
                 case "chatParty":
                      c = getCookie("customisation", 16);
                      break;
                 default:
                      return false;
           }
...
var chatOptions = {
           look: {
                 ...
                 chatListColor = getCookie("customisation", 13);
