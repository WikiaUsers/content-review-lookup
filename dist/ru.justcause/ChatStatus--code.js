                ...
                var cws = {
                    data: {
                        ...
                        statuses: {
                            ...
                            "Редактирует": i18n.msg('редактирует').plain(),
                            "Играет": i18n.msg('Играет').plain(),
                            "Ест": i18n.msg('Ест').plain(),
                            "Читает": i18n.msg('Читает').plain(),
                            "Делает ДЗ": i18n.msg('Делает ДЗ').plain(),
                            "Программирует": i18n.msg('Программирует').plain()
                        },
                        // statuses of users
                        users: {},
                        // current user's name
