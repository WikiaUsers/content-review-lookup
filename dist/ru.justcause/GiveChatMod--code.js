/*
 * Название:     GiveChatMod
 * Описание:     Создаёт кнопку в чате, позволяя администратору или бюрократу назначать участника модератором чата.
 * Зачем:        Он был создан, поскольку Фэндом планирует удалить эту функцию из чата.
 * Автор:        Rendann
 * Поддержка:    Kopcap94
