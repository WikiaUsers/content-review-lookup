...
window.pPreview.RegExp.noinclude = [".NoLinkPreview", ".LinkPreview-ignore", ".quote", ".mw-ext-cite-error", ".error", ".references", ".reference", ".sup.reference",".TabsClass",".toc",".spoiler",".spoiler-button-main",".note-box",];
