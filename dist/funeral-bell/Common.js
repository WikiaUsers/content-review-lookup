importArticles({
   ...
   articles: [
	...
	'w:c:dev:Countdown/code.js',
        ...
        /*####################################*/
		// Adds toggler add-on
	'w:c:zcrushersstrikeforce:MediaWiki:Common.js/toggle.js',
	...
	'w:c:rhythmheaven:MediaWiki:Wikia.js/Ticker.js',
		// Adds "edit count" to user tabs
	'w:c:rhythmheaven:MediaWiki:Wikia.js/editCount.js',
		// Adds Ajax RC
	'w:c:candybox:MediaWiki:Common.js/ajax.js',
		// Adds custom user tags to profile mastheads
	'w:c:funeral-bell:MediaWiki:Common.js/userRightsIcons.js',
		// Adds additional rail module
	'w:c:funeral-bell:MediaWiki:Common.js/module.js',
	]
});
...
/* Replace with Username (couples with Template:Username) */
