...
(function($) {
	...
	var _tmpl = '<div class="useravatar"><a title="{U} avatar"><img src="https://images.wikia.nocookie.net/__cb20081128203240/messaging/images/thumb/1/19/Avatar.jpg/50px-Avatar.jpg" width="100" height="100" alt="Avatar" /></a></div>' +
		'<span class="userlink"><a title="User Page">User:{U}</a></span> &#124; <span class="talklink"><a title="Talk Page">Talk Page</a> <a href="/index.php?title=User_talk:{u}&amp;action=edit&amp;section=new" title="Leave a new message on the talk page">[+]</a></span>{email} &#124; <span class="contribslink"><a title="User Contributions">Contributions</a></span>{group}'+
		'<div class="contribdetails"></div>',
	_emailtmpl = ' &#124; <span class="emaillink"><a href="/wiki/Special:EmailUser/{u}" title="Send email to user">Send Email</a></span>',
	_contrtmpl = '{U} has made {c} edits since {fe}<br /><span class="contenteditcount"><a href="/wiki/Especial:Editcount/{U}" title="{cu} edits (the {r}% of the total) have been made in articles, categories, images and templates. View advanced statistics."><span class="psmax"><span class="psact pslvl{l}" style="width:{r}%;"></span></span></a></span>',
	_grouptmpl = ' &#124; <span class="usergroups">{g}</span>',
	_nosuchuser = 'User does not exist',
	_editavatar = 'Change avatar',
	_editavatardescription = 'Select an image from your PC to use as your avatar. Should be square (same height as width). If the image is elongated cut, so it can be deformed. It is recommended that you edit first in an image editing program to have these dimensions. The optimal size is 150x150px.',
	_previewsaveavatar = 'This is the image you uploaded and will be used as an avatar. If you agree, confirm the change. Note that the above may still appear for a while because your browser has saved the old version. If you see the image in accepting you just uploaded is that everything went well.',
	_saveavatar = 'Apply the new avatar',
	_datefm = '{d} de {m} de {y}',
	_months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
	_groupseparator = ', ',
	_groups = {
		bureaucrat: '<a href="/wiki/Project:Bureaucrats">Bureaucrat</a>',
		sysop: '<a href="/wiki/Project:Administrators">Administrator</a>',
		patroller: '<a href="/wiki/Project:Patrollers">Patroller</a>',
		custodian: '<a href="/wiki/Project:Custodians">Custodian</a>',
		rollback: '<a href="/wiki/Project:Rollback">Rollback</a>',
		chatmoderator: '<a href="/wiki/Project:Chat_Moderators">Guardian</a>•',
		'fb-user': false,
		'*': false,
		user: false,
		autoconfirmed: false,
	...
	_dataRecv = function(data) {
		...
		if (!_isIP) {
			...
			img.alt = 'avatar';
			img.src = 'https://images.wikia.nocookie.net/common/avatars/thumb/'+hash.substr(0,1)+'/'+hash.substr(0,2)+'/'+avatar+'/'+_avatarWidth.toString()+'px-'+avatar;
		}
		// Contribs
		_username = u;
		_userid = userid;
